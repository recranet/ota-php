...
class InfoCodesAType
{
     ...
     *
     * @var \Recranet\OTA\RestaurantType\InfoCodesAType\InfoCodeAType[] $infoCode
     */
    private $infoCode = [
     ...
     */
    public function addToInfoCode(\Recranet\OTA\RestaurantType\InfoCodesAType\InfoCodeAType $infoCode)
    {
