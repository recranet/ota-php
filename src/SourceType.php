...
class SourceType
{
     ...
     *
     * @var \Recranet\OTA\SourceType\RequestorIDAType $requestorID
     */
     ...
     *
     * @var \Recranet\OTA\SourceType\PositionAType $position
     */
     ...
     *
     * @var \Recranet\OTA\SourceType\BookingChannelAType $bookingChannel
     */
     ...
     * An identifier of the entity making the request (e.g. ATA/IATA/ID number, Electronic Reservation Service Provider (ERSP), Association of British Travel Agents.(ABTA)).
     *
     * @return \Recranet\OTA\SourceType\RequestorIDAType
     */
     ...
     * An identifier of the entity making the request (e.g. ATA/IATA/ID number, Electronic Reservation Service Provider (ERSP), Association of British Travel Agents.(ABTA)).
     *
     * @param \Recranet\OTA\SourceType\RequestorIDAType $requestorID
     * @return self
     */
    public function setRequestorID(?\Recranet\OTA\SourceType\RequestorIDAType $requestorID = null)
    {
     ...
     * Specifies the latitude and longitude of a source.
     *
     * @return \Recranet\OTA\SourceType\PositionAType
     */
     ...
     * Specifies the latitude and longitude of a source.
     *
     * @param \Recranet\OTA\SourceType\PositionAType $position
     * @return self
     */
    public function setPosition(?\Recranet\OTA\SourceType\PositionAType $position = null)
    {
     ...
     * Specifies the booking channel type and whether it is the primary means of connectivity of the source.
     *
     * @return \Recranet\OTA\SourceType\BookingChannelAType
     */
     ...
     * Specifies the booking channel type and whether it is the primary means of connectivity of the source.
     *
     * @param \Recranet\OTA\SourceType\BookingChannelAType $bookingChannel
     * @return self
     */
    public function setBookingChannel(?\Recranet\OTA\SourceType\BookingChannelAType $bookingChannel = null)
    {
