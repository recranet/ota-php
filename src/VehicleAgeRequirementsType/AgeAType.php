...
namespace Recranet\OTA\VehicleAgeRequirementsType;
...
class AgeAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeSurchargeAType[] $ageSurcharge
     */
     ...
     *
     * @var \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeInfosAType\AgeInfoAType[] $ageInfos
     */
     ...
     *
     * @var \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\VehiclesAType\VehicleAType[] $vehicles
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeSurchargeAType $ageSurcharge
     */
    public function addToAgeSurcharge(\Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeSurchargeAType $ageSurcharge)
    {
     ...
     * Surcharge information that may be applied based upon age of the renter.
     *
     * @return \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeSurchargeAType[]
     */
     ...
     */
    public function addToAgeInfos(\Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeInfosAType\AgeInfoAType $ageInfo)
    {
     ...
     * Collection of descriptions about the different requirements related to age of driver
     *
     * @param \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\AgeInfosAType\AgeInfoAType[] $ageInfos
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\VehiclesAType\VehicleAType $vehicle
     */
    public function addToVehicles(\Recranet\OTA\VehicleAgeRequirementsType\AgeAType\VehiclesAType\VehicleAType $vehicle)
    {
     ...
     * A collection of vehicle information associated to the age requirements.
     *
     * @return \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\VehiclesAType\VehicleAType[]
     */
     ...
     * A collection of vehicle information associated to the age requirements.
     *
     * @param \Recranet\OTA\VehicleAgeRequirementsType\AgeAType\VehiclesAType\VehicleAType[] $vehicles
     * @return self
     */
