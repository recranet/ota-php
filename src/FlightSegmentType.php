...
class FlightSegmentType extends FlightSegmentBaseType
{
     ...
     *
     * @var \Recranet\OTA\FlightSegmentType\MarketingAirlineAType $marketingAirline
     */
     ...
     * The marketing airline. This is required for use with scheduled airline messages but may be omitted for requests by tour operators.
     *
     * @return \Recranet\OTA\FlightSegmentType\MarketingAirlineAType
     */
     ...
     * The marketing airline. This is required for use with scheduled airline messages but may be omitted for requests by tour operators.
     *
     * @param \Recranet\OTA\FlightSegmentType\MarketingAirlineAType $marketingAirline
     * @return self
     */
    public function setMarketingAirline(?\Recranet\OTA\FlightSegmentType\MarketingAirlineAType $marketingAirline = null)
    {
