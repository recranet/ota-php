...
class BlackoutDatesAType
{
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType[] $blackoutDate
     */
     ...
     */
    public function addToBlackoutDate(\Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType $blackoutDate)
    {
