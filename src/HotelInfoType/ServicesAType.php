...
class ServicesAType
{
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType[] $service
     */
    private $service = [
     ...
     */
    public function addToService(\Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType $service)
    {
