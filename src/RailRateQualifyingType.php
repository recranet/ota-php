...
class RailRateQualifyingType
{
     ...
     *
     * @var \Recranet\OTA\TravelPurposeType $travelPurpose
     */
     ...
     *
     * @var \Recranet\OTA\RailRateQualifyingType\DiscountTypeAType $discountType
     */
     ...
     * The travel purpose for the passenger.
     *
     * @return \Recranet\OTA\TravelPurposeType
     */
     ...
     * The travel purpose for the passenger.
     *
     * @param \Recranet\OTA\TravelPurposeType $travelPurpose
     * @return self
     */
    public function setTravelPurpose(?\Recranet\OTA\TravelPurposeType $travelPurpose = null)
    {
     ...
     * A set of values that represent discounts, such AAA, AARP, Red Tour. Refer to OpenTravel Code List Discount Available (DIS).
     *
     * @return \Recranet\OTA\RailRateQualifyingType\DiscountTypeAType
     */
     ...
     * A set of values that represent discounts, such AAA, AARP, Red Tour. Refer to OpenTravel Code List Discount Available (DIS).
     *
     * @param \Recranet\OTA\RailRateQualifyingType\DiscountTypeAType $discountType
     * @return self
     */
    public function setDiscountType(?\Recranet\OTA\RailRateQualifyingType\DiscountTypeAType $discountType = null)
    {
