...
class AirArrangerType
{
     ...
     *
     * @var \Recranet\OTA\AirArrangerType\ProfileRefAType $profileRef
     */
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $companyInfo
     */
     ...
     *
     * @var \Recranet\OTA\PersonNameType $contactName
     */
     ...
     * Stored information about a customer. May contain readily available information relevant to the booking.
     *
     * @return \Recranet\OTA\AirArrangerType\ProfileRefAType
     */
     ...
     * Stored information about a customer. May contain readily available information relevant to the booking.
     *
     * @param \Recranet\OTA\AirArrangerType\ProfileRefAType $profileRef
     * @return self
     */
    public function setProfileRef(?\Recranet\OTA\AirArrangerType\ProfileRefAType $profileRef = null)
    {
     ...
     * Name and contact person information for the company associated with the air travel.
     *
     * @param \Recranet\OTA\CompanyNameType $companyInfo
     * @return self
     */
    public function setCompanyInfo(?\Recranet\OTA\CompanyNameType $companyInfo = null)
    {
     ...
     * Name information for the person associated with the air travel.
     *
     * @param \Recranet\OTA\PersonNameType $contactName
     * @return self
     */
    public function setContactName(?\Recranet\OTA\PersonNameType $contactName = null)
    {
