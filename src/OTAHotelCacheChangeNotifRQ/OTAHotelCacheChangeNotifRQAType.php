...
namespace Recranet\OTA\OTAHotelCacheChangeNotifRQ;
...
class OTAHotelCacheChangeNotifRQAType
{
     ...
     *
     * @var \Recranet\OTA\NotifCacheType[] $cacheChangeInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\NotifCacheType $cacheChangeInfo
     */
    public function addToCacheChangeInfo(\Recranet\OTA\NotifCacheType $cacheChangeInfo)
    {
     ...
     * Information that has changed and should be updated in the cache via an OTA_HotelAvailRQ request message.
     *
     * @return \Recranet\OTA\NotifCacheType[]
     */
