...
namespace Recranet\OTA\OTAHotelCommNotifRQ;
...
class OTAHotelCommNotifRQAType
{
     ...
     *
     * @var \Recranet\OTA\CommissionEventType[] $commissionEvents
     */
     ...
     */
    public function addToCommissionEvents(\Recranet\OTA\CommissionEventType $commissionEvent)
    {
     ...
     * A collection of CommissionsEvent elements that result from a guest stay to be sent to the system responsible for processing agent commission payments.
     *
     * @param \Recranet\OTA\CommissionEventType[] $commissionEvents
     * @return self
     */
