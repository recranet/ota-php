...
namespace Recranet\OTA\AncillaryServiceActionType;
...
class ProductGroupAType
{
     ...
     *
     * @var \Recranet\OTA\AncillaryServiceActionType\ProductGroupAType\SubGroupAType[] $subGroup
     */
    private $subGroup = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\AncillaryServiceActionType\ProductGroupAType\SubGroupAType $subGroup
     */
    public function addToSubGroup(\Recranet\OTA\AncillaryServiceActionType\ProductGroupAType\SubGroupAType $subGroup)
    {
     ...
     * Airline or ATPCO encoded sub-group code(s) that are associated with the group code.
     *
     * @return \Recranet\OTA\AncillaryServiceActionType\ProductGroupAType\SubGroupAType[]
     */
