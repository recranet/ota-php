...
class VehicleAdditionalDriverRequirementsType
{
     ...
     *
     * @var \Recranet\OTA\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType $addlDriverInfos
     */
     ...
     * Collection of descriptions about the different requirements related to additional drivers.
     *
     * @return \Recranet\OTA\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType
     */
     ...
     * Collection of descriptions about the different requirements related to additional drivers.
     *
     * @param \Recranet\OTA\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType $addlDriverInfos
     * @return self
     */
    public function setAddlDriverInfos(?\Recranet\OTA\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType $addlDriverInfos = null)
    {
