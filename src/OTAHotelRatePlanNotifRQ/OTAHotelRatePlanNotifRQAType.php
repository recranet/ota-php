...
namespace Recranet\OTA\OTAHotelRatePlanNotifRQ;
...
class OTAHotelRatePlanNotifRQAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelRatePlanNotifRQ\OTAHotelRatePlanNotifRQAType\RatePlansAType $ratePlans
     */
     ...
     *
     * @var \Recranet\OTA\OfferType[] $offers
     */
    private $offers = null;
     ...
     * A collection of rate plans for a given hotel.
     *
     * @return \Recranet\OTA\OTAHotelRatePlanNotifRQ\OTAHotelRatePlanNotifRQAType\RatePlansAType
     */
     ...
     * A collection of rate plans for a given hotel.
     *
     * @param \Recranet\OTA\OTAHotelRatePlanNotifRQ\OTAHotelRatePlanNotifRQAType\RatePlansAType $ratePlans
     * @return self
     */
    public function setRatePlans(\Recranet\OTA\OTAHotelRatePlanNotifRQ\OTAHotelRatePlanNotifRQAType\RatePlansAType $ratePlans)
    {
     ...
     */
    public function addToOffers(\Recranet\OTA\OfferType $offer)
    {
        $this->offers[] = $offer;
        return $this;
    }
     ...
     * A collection of offers that apply to all of the rate plans.
     *
     * @param \Recranet\OTA\OfferType[] $offers
     * @return self
     */
