...
class VendorPrefsAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleAvailRQCoreType\VendorPrefsAType\VendorPrefAType[] $vendorPref
     */
    private $vendorPref = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\VehicleAvailRQCoreType\VendorPrefsAType\VendorPrefAType $vendorPref
     */
    public function addToVendorPref(\Recranet\OTA\VehicleAvailRQCoreType\VendorPrefsAType\VendorPrefAType $vendorPref)
    {
     ...
     * Indicates the preferred Vendor Company for the vehicle rental. If a company name is supplied, the rates will be supplied for the specific Vendor Company. The company name is unique amongst the vendors.
     *
     * @return \Recranet\OTA\VehicleAvailRQCoreType\VendorPrefsAType\VendorPrefAType[]
     */
