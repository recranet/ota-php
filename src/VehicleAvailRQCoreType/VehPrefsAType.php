...
class VehPrefsAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleAvailRQCoreType\VehPrefsAType\VehPrefAType[] $vehPref
     */
    private $vehPref = [
     ...
     */
    public function addToVehPref(\Recranet\OTA\VehicleAvailRQCoreType\VehPrefsAType\VehPrefAType $vehPref)
    {
