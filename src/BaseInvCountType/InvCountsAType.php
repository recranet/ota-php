...
namespace Recranet\OTA\BaseInvCountType;
...
class InvCountsAType
{
     ...
     *
     * @var \Recranet\OTA\BaseInvCountType\InvCountsAType\InvCountAType[] $invCount
     */
    private $invCount = [
     ...
     */
    public function addToInvCount(\Recranet\OTA\BaseInvCountType\InvCountsAType\InvCountAType $invCount)
    {
