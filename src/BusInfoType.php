...
class BusInfoType
{
     ...
     *
     * @var \Recranet\OTA\BusIdentificationType $bus
     */
    private $bus = null;
     ...
     *
     * @var \Recranet\OTA\BusInfoType\ValidDateAType $validDate
     */
     ...
     * Identification and classification information of the bus.
     *
     * @return \Recranet\OTA\BusIdentificationType
     */
     ...
     * Identification and classification information of the bus.
     *
     * @param \Recranet\OTA\BusIdentificationType $bus
     * @return self
     */
    public function setBus(\Recranet\OTA\BusIdentificationType $bus)
    {
        $this->bus = $bus;
        return $this;
    }
     ...
     * The validate dates for the bus information.
     *
     * @return \Recranet\OTA\BusInfoType\ValidDateAType
     */
     ...
     * The validate dates for the bus information.
     *
     * @param \Recranet\OTA\BusInfoType\ValidDateAType $validDate
     * @return self
     */
    public function setValidDate(?\Recranet\OTA\BusInfoType\ValidDateAType $validDate = null)
    {
