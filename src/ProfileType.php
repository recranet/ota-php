...
class ProfileType
{
     ...
     *
     * @var \Recranet\OTA\AccessesType $accesses
     */
     ...
     *
     * @var \Recranet\OTA\CustomerType $customer
     */
     ...
     *
     * @var \Recranet\OTA\ProfileType\UserIDAType[] $userID
     */
    private $userID = [
     ...
     *
     * @var \Recranet\OTA\PreferencesType $prefCollections
     */
     ...
     *
     * @var \Recranet\OTA\CompanyInfoType $companyInfo
     */
     ...
     *
     * @var \Recranet\OTA\AffiliationsType $affiliations
     */
     ...
     *
     * @var \Recranet\OTA\AgreementsType $agreements
     */
     ...
     *
     * @var \Recranet\OTA\ProfileType\CommentsAType\CommentAType[] $comments
     */
     ...
     * A collection of actions taken on a record.
     *
     * @return \Recranet\OTA\AccessesType
     */
     ...
     * A collection of actions taken on a record.
     *
     * @param \Recranet\OTA\AccessesType $accesses
     * @return self
     */
    public function setAccesses(?\Recranet\OTA\AccessesType $accesses = null)
    {
     ...
     * Detailed customer information for this profile.
     *
     * @return \Recranet\OTA\CustomerType
     */
     ...
     * Detailed customer information for this profile.
     *
     * @param \Recranet\OTA\CustomerType $customer
     * @return self
     */
    public function setCustomer(?\Recranet\OTA\CustomerType $customer = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\ProfileType\UserIDAType $userID
     */
    public function addToUserID(\Recranet\OTA\ProfileType\UserIDAType $userID)
    {
        $this->userID[] = $userID;
        return $this;
    }
     ...
     * The user ids and pin numbers of the profile.
     *
     * @return \Recranet\OTA\ProfileType\UserIDAType[]
     */
     ...
     * A collection of preference collections.
     *
     * @return \Recranet\OTA\PreferencesType
     */
     ...
     * A collection of preference collections.
     *
     * @param \Recranet\OTA\PreferencesType $prefCollections
     * @return self
     */
    public function setPrefCollections(?\Recranet\OTA\PreferencesType $prefCollections = null)
    {
     ...
     * Company information related to the profile.
     *
     * @return \Recranet\OTA\CompanyInfoType
     */
     ...
     * Company information related to the profile.
     *
     * @param \Recranet\OTA\CompanyInfoType $companyInfo
     * @return self
     */
    public function setCompanyInfo(?\Recranet\OTA\CompanyInfoType $companyInfo = null)
    {
     ...
     * Affiliation information related to the profile.
     *
     * @return \Recranet\OTA\AffiliationsType
     */
     ...
     * Affiliation information related to the profile.
     *
     * @param \Recranet\OTA\AffiliationsType $affiliations
     * @return self
     */
    public function setAffiliations(?\Recranet\OTA\AffiliationsType $affiliations = null)
    {
     ...
     * Agreement information related to the profile.
     *
     * @return \Recranet\OTA\AgreementsType
     */
     ...
     * Agreement information related to the profile.
     *
     * @param \Recranet\OTA\AgreementsType $agreements
     * @return self
     */
    public function setAgreements(?\Recranet\OTA\AgreementsType $agreements = null)
    {
     ...
     */
    public function addToComments(\Recranet\OTA\ProfileType\CommentsAType\CommentAType $comment)
    {
     ...
     * Comments related to the profile.
     *
     * @param \Recranet\OTA\ProfileType\CommentsAType\CommentAType[] $comments
     * @return self
     */
