...
class RFPTransientResponseType
{
     ...
     *
     * @var \Recranet\OTA\RFPResponseDetailType $rFPResponseDetail
     */
     ...
     *
     * @var \Recranet\OTA\HotelDescriptiveContentType $hotelDescription
     */
     ...
     *
     * @var \Recranet\OTA\AccountSpecificInformationType $accountSpecificInformation
     */
     ...
     * Provides the method and time for when the detailed response should be expected as well as other information.
     *
     * @param \Recranet\OTA\RFPResponseDetailType $rFPResponseDetail
     * @return self
     */
    public function setRFPResponseDetail(?\Recranet\OTA\RFPResponseDetailType $rFPResponseDetail = null)
    {
     ...
     * Provides the details associated with a hotel (e.g. the amenities and services provided and distance to local attractions.)
     *
     * @return \Recranet\OTA\HotelDescriptiveContentType
     */
     ...
     * Provides the details associated with a hotel (e.g. the amenities and services provided and distance to local attractions.)
     *
     * @param \Recranet\OTA\HotelDescriptiveContentType $hotelDescription
     * @return self
     */
    public function setHotelDescription(?\Recranet\OTA\HotelDescriptiveContentType $hotelDescription = null)
    {
     ...
     * Defines the information that is specific to the RFP for this account.
     *
     * @return \Recranet\OTA\AccountSpecificInformationType
     */
     ...
     * Defines the information that is specific to the RFP for this account.
     *
     * @param \Recranet\OTA\AccountSpecificInformationType $accountSpecificInformation
     * @return self
     */
    public function setAccountSpecificInformation(?\Recranet\OTA\AccountSpecificInformationType $accountSpecificInformation = null)
    {
