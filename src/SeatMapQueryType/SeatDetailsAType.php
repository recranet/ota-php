...
class SeatDetailsAType
{
     ...
     *
     * @var \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\CabinClassAType[] $cabinClass
     */
    private $cabinClass = [
     ...
     *
     * @var \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\ResBookDesignationsAType\ResBookDesignationAType[] $resBookDesignations
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\CabinClassAType $cabinClass
     */
    public function addToCabinClass(\Recranet\OTA\SeatMapQueryType\SeatDetailsAType\CabinClassAType $cabinClass)
    {
     ...
     * If the seat map display is to be requested for a specific cabin class, the cabin class can be specified in this element.
     *
     * @return \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\CabinClassAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\ResBookDesignationsAType\ResBookDesignationAType $resBookDesignation
     */
    public function addToResBookDesignations(\Recranet\OTA\SeatMapQueryType\SeatDetailsAType\ResBookDesignationsAType\ResBookDesignationAType $resBookDesignation)
    {
     ...
     * A collection of ResBookDesignations.
     *
     * @return \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\ResBookDesignationsAType\ResBookDesignationAType[]
     */
     ...
     * A collection of ResBookDesignations.
     *
     * @param \Recranet\OTA\SeatMapQueryType\SeatDetailsAType\ResBookDesignationsAType\ResBookDesignationAType[] $resBookDesignations
     * @return self
     */
     ...
     * @return self
     */
    public function setFareBasisCode(?\Recranet\OTA\FareBasisCodeType $fareBasisCode = null)
    {
