...
class CancelPenaltiesType
{
     ...
     *
     * @var \Recranet\OTA\CancelPenaltyType[] $cancelPenalty
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CancelPenaltyType $cancelPenalty
     */
    public function addToCancelPenalty(\Recranet\OTA\CancelPenaltyType $cancelPenalty)
    {
     ...
     * Defines the cancellation penalty of the hotel facility.
     *
     * @return \Recranet\OTA\CancelPenaltyType[]
     */
