...
class RailReservationSummaryType
{
     ...
     *
     * @var \Recranet\OTA\RailReservationSummaryType\ODInfoAType[] $oDInfo
     */
    private $oDInfo = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\RailReservationSummaryType\ODInfoAType $oDInfo
     */
    public function addToODInfo(\Recranet\OTA\RailReservationSummaryType\ODInfoAType $oDInfo)
    {
        $this->oDInfo[] = $oDInfo;
        return $this;
    }
     ...
     * The rail booking origin/destination summary information contained in the reservation.
     *
     * @return \Recranet\OTA\RailReservationSummaryType\ODInfoAType[]
     */
