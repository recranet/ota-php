...
namespace Recranet\OTA\AvailRequestSegmentsType;
...
class AvailRequestSegmentAType
{
     ...
     *
     * @var \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\HotelSearchCriteriaAType $hotelSearchCriteria
     */
     ...
     *
     * @var \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RateRangeAType[] $rateRange
     */
    private $rateRange = [
     ...
     *
     * @var \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RoomStayCandidatesAType\RoomStayCandidateAType[] $roomStayCandidates
     */
     ...
     * Availability search criteria should be specified here for implementations using OpenTravel messages that are LATER than 2005B which was version 1.005 of this message, e.g. 2006A through the current specification.
     *
     * @return \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\HotelSearchCriteriaAType
     */
     ...
     * Availability search criteria should be specified here for implementations using OpenTravel messages that are LATER than 2005B which was version 1.005 of this message, e.g. 2006A through the current specification.
     *
     * @param \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\HotelSearchCriteriaAType $hotelSearchCriteria
     * @return self
     */
    public function setHotelSearchCriteria(?\Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\HotelSearchCriteriaAType $hotelSearchCriteria = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RateRangeAType $rateRange
     */
    public function addToRateRange(\Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RateRangeAType $rateRange)
    {
     ...
     * Requested rate or rate range. Repeats to allow the identification of multiple ranges for multiple room stay candidates. *This element is maintained at this level to support those who have implemented this message prior to 2005B. For new implementations consider using this element under HotelSearchCriteria.**
     *
     * @return \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RateRangeAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RoomStayCandidatesAType\RoomStayCandidateAType $roomStayCandidate
     */
    public function addToRoomStayCandidates(\Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RoomStayCandidatesAType\RoomStayCandidateAType $roomStayCandidate)
    {
     ...
     * Collection of room stay candidates. **This element is maintained at this level to support those who have implemented this message prior to 2005B. For new implementations consider using this element under HotelSearchCriteria.**
     *
     * @return \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RoomStayCandidatesAType\RoomStayCandidateAType[]
     */
     ...
     * Collection of room stay candidates. **This element is maintained at this level to support those who have implemented this message prior to 2005B. For new implementations consider using this element under HotelSearchCriteria.**
     *
     * @param \Recranet\OTA\AvailRequestSegmentsType\AvailRequestSegmentAType\RoomStayCandidatesAType\RoomStayCandidateAType[] $roomStayCandidates
     * @return self
     */
