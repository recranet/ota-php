...
class VehicleReservationSummaryType
{
     ...
     *
     * @var \Recranet\OTA\VehicleReservationSummaryType\ConfIDAType[] $confID
     */
    private $confID = [
     ...
     *
     * @var \Recranet\OTA\LocationType $pickUpLocation
     */
     ...
     *
     * @var \Recranet\OTA\LocationType $returnLocation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\VehicleReservationSummaryType\ConfIDAType $confID
     */
    public function addToConfID(\Recranet\OTA\VehicleReservationSummaryType\ConfIDAType $confID)
    {
        $this->confID[] = $confID;
        return $this;
    }
     ...
     * A confirmation number by which this reservation can be uniquely identified. Can also be used for reservation, contract and PNR IDs as well.
     *
     * @return \Recranet\OTA\VehicleReservationSummaryType\ConfIDAType[]
     */
     ...
     * A code to identify the pick up location, along with an optional code context.
     *
     * @param \Recranet\OTA\LocationType $pickUpLocation
     * @return self
     */
    public function setPickUpLocation(?\Recranet\OTA\LocationType $pickUpLocation = null)
    {
     ...
     * A code to identify the return location, along with an optional code context.
     *
     * @param \Recranet\OTA\LocationType $returnLocation
     * @return self
     */
    public function setReturnLocation(?\Recranet\OTA\LocationType $returnLocation = null)
    {
