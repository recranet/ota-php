...
class RFPResponseType
{
     ...
     *
     * @var \Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType[] $rFPResponseSegments
     */
     ...
     *
     * @var \Recranet\OTA\RFPResponseType\MessageIDAType $messageID
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType $rFPResponseSegment
     */
    public function addToRFPResponseSegments(\Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType $rFPResponseSegment)
    {
     ...
     * A collection of ResponseSegments that allows multiple responses for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @return \Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType[]
     */
     ...
     * A collection of ResponseSegments that allows multiple responses for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @param \Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType[] $rFPResponseSegments
     * @return self
     */
     ...
     * This is a UniqueID that is associated with the messages that may include more than one RFP. The instance attribute is used to indicate subsequent transmissions of new or updated information (e.g. an initial message will be instance 1 and an update to this message will be reflected with instance 2).
     *
     * @return \Recranet\OTA\RFPResponseType\MessageIDAType
     */
     ...
     * This is a UniqueID that is associated with the messages that may include more than one RFP. The instance attribute is used to indicate subsequent transmissions of new or updated information (e.g. an initial message will be instance 1 and an update to this message will be reflected with instance 2).
     *
     * @param \Recranet\OTA\RFPResponseType\MessageIDAType $messageID
     * @return self
     */
    public function setMessageID(?\Recranet\OTA\RFPResponseType\MessageIDAType $messageID = null)
    {
