...
class HotelAdditionalChargesType
{
     ...
     *
     * @var \Recranet\OTA\HotelAdditionalChargesType\AdditionalChargeAType[] $additionalCharge
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelAdditionalChargesType\AdditionalChargeAType $additionalCharge
     */
    public function addToAdditionalCharge(\Recranet\OTA\HotelAdditionalChargesType\AdditionalChargeAType $additionalCharge)
    {
     ...
     * Amenities or services to which a charge applies.
     *
     * @return \Recranet\OTA\HotelAdditionalChargesType\AdditionalChargeAType[]
     */
