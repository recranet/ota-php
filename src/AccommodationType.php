...
class AccommodationType
{
     ...
     *
     * @var \Recranet\OTA\AccommodationType\SeatAvailabilityDetailAType\CarAType[] $seatAvailabilityDetail
     */
     ...
     *
     * @var \Recranet\OTA\AccommodationType\BerthAvailabilityDetailAType\CarAType[] $berthAvailabilityDetail
     */
     ...
     *
     * @var \Recranet\OTA\AccommodationType\CompartmentAType $compartment
     */
     ...
     */
    public function addToSeatAvailabilityDetail(\Recranet\OTA\AccommodationType\SeatAvailabilityDetailAType\CarAType $car)
    {
     ...
     * Provides details on the seat map.
     *
     * @param \Recranet\OTA\AccommodationType\SeatAvailabilityDetailAType\CarAType[] $seatAvailabilityDetail
     * @return self
     */
     ...
     */
    public function addToBerthAvailabilityDetail(\Recranet\OTA\AccommodationType\BerthAvailabilityDetailAType\CarAType $car)
    {
     ...
     * Provides details on the berth map.
     *
     * @param \Recranet\OTA\AccommodationType\BerthAvailabilityDetailAType\CarAType[] $berthAvailabilityDetail
     * @return self
     */
     ...
     * The compartment type, such as Family and Single.
     *
     * @return \Recranet\OTA\AccommodationType\CompartmentAType
     */
     ...
     * The compartment type, such as Family and Single.
     *
     * @param \Recranet\OTA\AccommodationType\CompartmentAType $compartment
     * @return self
     */
    public function setCompartment(?\Recranet\OTA\AccommodationType\CompartmentAType $compartment = null)
    {
