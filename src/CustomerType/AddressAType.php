...
class AddressAType extends AddressInfoType
{
     ...
     *
     * @var \Recranet\OTA\PersonNameType $addresseeName
     */
     ...
     * Name of the person to whom this address relates.
     *
     * @param \Recranet\OTA\PersonNameType $addresseeName
     * @return self
     */
    public function setAddresseeName(?\Recranet\OTA\PersonNameType $addresseeName = null)
    {
