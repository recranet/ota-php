...
class PaymentFormAType extends PaymentFormType
{
     ...
     *
     * @var \Recranet\OTA\CustomerType\PaymentFormAType\AssociatedSupplierAType $associatedSupplier
     */
     ...
     * The supplier for whom this is the preferred method of payment.
     *
     * @return \Recranet\OTA\CustomerType\PaymentFormAType\AssociatedSupplierAType
     */
     ...
     * The supplier for whom this is the preferred method of payment.
     *
     * @param \Recranet\OTA\CustomerType\PaymentFormAType\AssociatedSupplierAType $associatedSupplier
     * @return self
     */
    public function setAssociatedSupplier(?\Recranet\OTA\CustomerType\PaymentFormAType\AssociatedSupplierAType $associatedSupplier = null)
    {
