...
class CustomerType
{
     ...
     *
     * @var \Recranet\OTA\CustomerType\TelephoneAType[] $telephone
     */
    private $telephone = [
     ...
     *
     * @var \Recranet\OTA\CustomerType\EmailAType[] $email
     */
    private $email = [
     ...
     *
     * @var \Recranet\OTA\CustomerType\AddressAType[] $address
     */
    private $address = [
     ...
     *
     * @var \Recranet\OTA\CustomerType\URLAType[] $uRL
     */
    private $uRL = [
     ...
     *
     * @var \Recranet\OTA\CustomerType\CitizenCountryNameAType[] $citizenCountryName
     */
     ...
     *
     * @var \Recranet\OTA\CustomerType\PhysChallNameAType[] $physChallName
     */
     ...
     *
     * @var \Recranet\OTA\CustomerType\PaymentFormAType[] $paymentForm
     */
    private $paymentForm = [
     ...
     *
     * @var \Recranet\OTA\RelatedTravelerType[] $relatedTraveler
     */
     ...
     *
     * @var \Recranet\OTA\ContactPersonType[] $contactPerson
     */
     ...
     *
     * @var \Recranet\OTA\DocumentType[] $document
     */
    private $document = [
     ...
     *
     * @var \Recranet\OTA\CustomerType\CustLoyaltyAType[] $custLoyalty
     */
    private $custLoyalty = [
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $employerInfo
     */
     ...
     *
     * @var \Recranet\OTA\CustomerType\AdditionalLanguageAType[] $additionalLanguage
     */
     ...
     */
    public function addToPersonName(\Recranet\OTA\PersonNameType $personName)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\TelephoneAType $telephone
     */
    public function addToTelephone(\Recranet\OTA\CustomerType\TelephoneAType $telephone)
    {
     ...
     * Information on a telephone number for the customer.
     *
     * @return \Recranet\OTA\CustomerType\TelephoneAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\EmailAType $email
     */
    public function addToEmail(\Recranet\OTA\CustomerType\EmailAType $email)
    {
        $this->email[] = $email;
        return $this;
    }
     ...
     * Information on an email address for the customer.
     *
     * @return \Recranet\OTA\CustomerType\EmailAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\AddressAType $address
     */
    public function addToAddress(\Recranet\OTA\CustomerType\AddressAType $address)
    {
     ...
     * Detailed information on an address for the customer.
     *
     * @return \Recranet\OTA\CustomerType\AddressAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\URLAType $uRL
     */
    public function addToURL(\Recranet\OTA\CustomerType\URLAType $uRL)
    {
        $this->uRL[] = $uRL;
        return $this;
    }
     ...
     * Information on a URL for the customer.
     *
     * @return \Recranet\OTA\CustomerType\URLAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\CitizenCountryNameAType $citizenCountryName
     */
    public function addToCitizenCountryName(\Recranet\OTA\CustomerType\CitizenCountryNameAType $citizenCountryName)
    {
     ...
     * Name of the (self-professed) country that is claimed for citizenship.
     *
     * @return \Recranet\OTA\CustomerType\CitizenCountryNameAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\PhysChallNameAType $physChallName
     */
    public function addToPhysChallName(\Recranet\OTA\CustomerType\PhysChallNameAType $physChallName)
    {
     ...
     * Describes the customer's physical challenge.
     *
     * @return \Recranet\OTA\CustomerType\PhysChallNameAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\PaymentFormAType $paymentForm
     */
    public function addToPaymentForm(\Recranet\OTA\CustomerType\PaymentFormAType $paymentForm)
    {
     ...
     * Methods of providing funds and guarantees for travel by the customer.
     *
     * @return \Recranet\OTA\CustomerType\PaymentFormAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RelatedTravelerType $relatedTraveler
     */
    public function addToRelatedTraveler(\Recranet\OTA\RelatedTravelerType $relatedTraveler)
    {
     ...
     * Identifies a traveler associated with the customer.
     *
     * @return \Recranet\OTA\RelatedTravelerType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ContactPersonType $contactPerson
     */
    public function addToContactPerson(\Recranet\OTA\ContactPersonType $contactPerson)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\DocumentType $document
     */
    public function addToDocument(\Recranet\OTA\DocumentType $document)
    {
     ...
     * Detailed document information for the customer (e.g., driver license, passport, visa).
     *
     * @return \Recranet\OTA\DocumentType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\CustLoyaltyAType $custLoyalty
     */
    public function addToCustLoyalty(\Recranet\OTA\CustomerType\CustLoyaltyAType $custLoyalty)
    {
     ...
     * Loyalty program information for the customer.
     *
     * @return \Recranet\OTA\CustomerType\CustLoyaltyAType[]
     */
     ...
     * Identifies the customer's employer.
     *
     * @param \Recranet\OTA\CompanyNameType $employerInfo
     * @return self
     */
    public function setEmployerInfo(?\Recranet\OTA\CompanyNameType $employerInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\CustomerType\AdditionalLanguageAType $additionalLanguage
     */
    public function addToAdditionalLanguage(\Recranet\OTA\CustomerType\AdditionalLanguageAType $additionalLanguage)
    {
     ...
     * Additional languages spoken by the traveler.
     *
     * @return \Recranet\OTA\CustomerType\AdditionalLanguageAType[]
     */
