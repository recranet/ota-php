...
namespace Recranet\OTA\VehicleLocationLiabilitiesType\CoveragesAType;
...
class CoverageAType
{
     ...
     *
     * @var \Recranet\OTA\FormattedTextType $coverageInfo
     */
     ...
     *
     * @var \Recranet\OTA\VehicleLocationLiabilitiesType\CoveragesAType\CoverageAType\CoverageFeesAType\CoverageFeeAType[] $coverageFees
     */
     ...
     * General information about this specific coverage, insurance or fees.
     *
     * @param \Recranet\OTA\FormattedTextType $coverageInfo
     * @return self
     */
    public function setCoverageInfo(?\Recranet\OTA\FormattedTextType $coverageInfo = null)
    {
     ...
     */
    public function addToCoverageFees(\Recranet\OTA\VehicleLocationLiabilitiesType\CoveragesAType\CoverageAType\CoverageFeesAType\CoverageFeeAType $coverageFee)
    {
     ...
     * A collection of fees associated with this coverage, insurance or waiver. There may be multiple charges if the charge varies by vehicle type.
     *
     * @param \Recranet\OTA\VehicleLocationLiabilitiesType\CoveragesAType\CoverageAType\CoverageFeesAType\CoverageFeeAType[] $coverageFees
     * @return self
     */
