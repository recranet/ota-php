...
namespace Recranet\OTA\VehicleLocationLiabilitiesType;
...
class CoveragesAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleLocationLiabilitiesType\CoveragesAType\CoverageAType[] $coverage
     */
    private $coverage = [
     ...
     */
    public function addToCoverage(\Recranet\OTA\VehicleLocationLiabilitiesType\CoveragesAType\CoverageAType $coverage)
    {
