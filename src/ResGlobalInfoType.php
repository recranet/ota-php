...
class ResGlobalInfoType extends ResCommonDetailType
{
     ...
     *
     * @var \Recranet\OTA\CommissionType $totalCommissions
     */
     ...
     * Description: The total commission for all rate segments in the reservation.
     *
     * @param \Recranet\OTA\CommissionType $totalCommissions
     * @return self
     */
    public function setTotalCommissions(?\Recranet\OTA\CommissionType $totalCommissions = null)
    {
