...
class SpecialRemarkType
{
     ...
     *
     * @var \Recranet\OTA\SpecialRemarkType\TravelerRefNumberAType[] $travelerRefNumber
     */
     ...
     *
     * @var \Recranet\OTA\SpecialRemarkType\FlightRefNumberAType[] $flightRefNumber
     */
     ...
     *
     * @var \Recranet\OTA\SpecialRemarkType\AuthorizedViewersAType\AuthorizedViewerAType[] $authorizedViewers
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SpecialRemarkType\TravelerRefNumberAType $travelerRefNumber
     */
    public function addToTravelerRefNumber(\Recranet\OTA\SpecialRemarkType\TravelerRefNumberAType $travelerRefNumber)
    {
     ...
     * One or more travelers to whom this request applies.
     *
     * @return \Recranet\OTA\SpecialRemarkType\TravelerRefNumberAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SpecialRemarkType\FlightRefNumberAType $flightRefNumber
     */
    public function addToFlightRefNumber(\Recranet\OTA\SpecialRemarkType\FlightRefNumberAType $flightRefNumber)
    {
     ...
     * One or more flights to whom this request applies
     *
     * @return \Recranet\OTA\SpecialRemarkType\FlightRefNumberAType[]
     */
     ...
     */
    public function addToAirline(\Recranet\OTA\CompanyNameType $airline)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\SpecialRemarkType\AuthorizedViewersAType\AuthorizedViewerAType $authorizedViewer
     */
    public function addToAuthorizedViewers(\Recranet\OTA\SpecialRemarkType\AuthorizedViewersAType\AuthorizedViewerAType $authorizedViewer)
    {
     ...
     * A container for authorized viewers.
     *
     * @return \Recranet\OTA\SpecialRemarkType\AuthorizedViewersAType\AuthorizedViewerAType[]
     */
     ...
     * A container for authorized viewers.
     *
     * @param \Recranet\OTA\SpecialRemarkType\AuthorizedViewersAType\AuthorizedViewerAType[] $authorizedViewers
     * @return self
     */
