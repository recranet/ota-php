...
namespace Recranet\OTA\OTAHotelCacheChangeRS;
...
class OTAHotelCacheChangeRSAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType[] $cacheChangeInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType $cacheChangeInfo
     */
    public function addToCacheChangeInfo(\Recranet\OTA\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType $cacheChangeInfo)
    {
     ...
     * Information that has changed and should be updated in the cache via an OTA_HotelAvailRQ request message.
     *
     * @return \Recranet\OTA\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType[]
     */
