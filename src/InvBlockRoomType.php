...
class InvBlockRoomType
{
     ...
     *
     * @var \Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType[] $roomTypeAllocations
     */
     ...
     *
     * @var \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType[] $ratePlans
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType $roomTypeAllocations
     */
    public function addToRoomTypeAllocations(\Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType $roomTypeAllocations)
    {
     ...
     * This allows for multiple allocations to be blocked for a specific room type.
     *
     * @return \Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType[]
     */
     ...
     */
    public function addToRatePlans(\Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType $ratePlan)
    {
     ...
     * This allows for multiple rate plans for a specific room type.
     *
     * @param \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType[] $ratePlans
     * @return self
     */
