...
class CommissionEventType
{
     ...
     *
     * @var \Recranet\OTA\ProfileCertificationType $profileCertification
     */
    ...
    /**
     * @var \Recranet\OTA\PersonNameType $payee
     */
    private $payee = null;

    /**
     * @var \Recranet\OTA\AddressType $payeeAddress
     */
     ...
     *
     * @var \Recranet\OTA\CommissionType[] $commissions
     */
     ...
     *
     * @var \Recranet\OTA\PersonNameType[] $guestNames
     */
     ...
     *
     * @var \Recranet\OTA\CommissionEventType\HotelReferenceAType $hotelReference
     */
     ...
     * The ProfileCertification element identifies the travel agency to be paid by providing the IATA number or ARC certifying number. (Implementation note: This attribute is optional, but if it is not set, the Profile attribute must be set.)
     *
     * @return \Recranet\OTA\ProfileCertificationType
     */
     ...
     * The ProfileCertification element identifies the travel agency to be paid by providing the IATA number or ARC certifying number. (Implementation note: This attribute is optional, but if it is not set, the Profile attribute must be set.)
     *
     * @param \Recranet\OTA\ProfileCertificationType $profileCertification
     * @return self
     */
    public function setProfileCertification(?\Recranet\OTA\ProfileCertificationType $profileCertification = null)
    {
     ...
     * Sets a new payee
     *
     * @param \Recranet\OTA\PersonNameType $payee
     * @return self
     */
    public function setPayee(?\Recranet\OTA\PersonNameType $payee = null)
    {
        $this->payee = $payee;
        return $this;
    }
     ...
     *
     * @param \Recranet\OTA\AddressType $payeeAddress
     * @return self
     */
    public function setPayeeAddress(?\Recranet\OTA\AddressType $payeeAddress = null)
    {
     ...
     */
    public function addToCommissions(\Recranet\OTA\CommissionType $commission)
    {
     ...
     * A collection of Commission elements.
     *
     * @param \Recranet\OTA\CommissionType[] $commissions
     * @return self
     */
     ...
     */
    public function addToGuestNames(\Recranet\OTA\PersonNameType $guestName)
    {
     ...
     * A collection of guest names.
     *
     * @param \Recranet\OTA\PersonNameType[] $guestNames
     * @return self
     */
     ...
     * The hotel reference identifies the specific hotel for which the commission applies.
     *
     * @return \Recranet\OTA\CommissionEventType\HotelReferenceAType
     */
     ...
     * The hotel reference identifies the specific hotel for which the commission applies.
     *
     * @param \Recranet\OTA\CommissionEventType\HotelReferenceAType $hotelReference
     * @return self
     */
    public function setHotelReference(?\Recranet\OTA\CommissionEventType\HotelReferenceAType $hotelReference = null)
    {
