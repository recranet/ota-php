...
class BookingRulesType
{
     ...
     *
     * @var \Recranet\OTA\Type\BookingRulesType\BookingRuleAType[] $bookingRule
     */
    private $bookingRule = [
     ...
     */
    public function addToBookingRule(\Recranet\OTA\Type\BookingRulesType\BookingRuleAType $bookingRule)
    {
