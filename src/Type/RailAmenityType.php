...
class RailAmenityType
{
     ...
     *
     * @var \Recranet\OTA\Type\RailAmenityType\RailAmenityAType[] $railAmenity
     */
    private $railAmenity = [
     ...
     */
    public function addToRailAmenity(\Recranet\OTA\Type\RailAmenityType\RailAmenityAType $railAmenity)
    {
