...
namespace Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType;
...
class LoyaltyAType
{
     ...
     *
     * @var string $reservationActionType
     */
    private $reservationActionType = null;

    /**
     * @var string $selectedLoyaltyRPH
     */
