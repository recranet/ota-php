...
namespace Recranet\OTA\Type\HotelRoomListType\GuestsAType;
...
class GuestAType extends ContactPersonType
{
    ...
    /**
     * @var \Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\LoyaltyAType[] $loyalty
     */
    private $loyalty = [
     ...
     *
     * @var \Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\GuaranteePaymentAType[] $guaranteePayment
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\LoyaltyAType $loyalty
     */
    public function addToLoyalty(\Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\LoyaltyAType $loyalty)
    {
     ...
     * Gets as loyalty
     *
     * @return \Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\LoyaltyAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\GuaranteePaymentAType $guaranteePayment
     */
    public function addToGuaranteePayment(\Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\GuaranteePaymentAType $guaranteePayment)
    {
     ...
     * Guarantee or Payment information for an individual guest.
     *
     * @return \Recranet\OTA\Type\HotelRoomListType\GuestsAType\GuestAType\GuaranteePaymentAType[]
     */
