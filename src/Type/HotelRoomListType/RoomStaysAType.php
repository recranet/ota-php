...
class RoomStaysAType
{
     ...
     *
     * @var \Recranet\OTA\Type\HotelRoomListType\RoomStaysAType\RoomStayAType[] $roomStay
     */
    private $roomStay = [
     ...
     */
    public function addToRoomStay(\Recranet\OTA\Type\HotelRoomListType\RoomStaysAType\RoomStayAType $roomStay)
    {
