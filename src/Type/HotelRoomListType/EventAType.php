...
class EventAType
{
     ...
     *
     * @var \Recranet\OTA\Type\ContactPersonType $eventContact
     */
     ...
     * The event organizer or host.
     *
     * @param \Recranet\OTA\Type\ContactPersonType $eventContact
     * @return self
     */
    public function setEventContact(\Recranet\OTA\Type\ContactPersonType $eventContact)
    {
