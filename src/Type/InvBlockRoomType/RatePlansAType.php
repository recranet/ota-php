...
class RatePlansAType
{
     ...
     *
     * @var \Recranet\OTA\Type\InvBlockRoomType\RatePlansAType\RatePlanAType[] $ratePlan
     */
    private $ratePlan = [
     ...
     */
    public function addToRatePlan(\Recranet\OTA\Type\InvBlockRoomType\RatePlansAType\RatePlanAType $ratePlan)
    {
