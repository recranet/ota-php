...
class VehicleType extends VehicleCoreType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleType\VehMakeModelAType $vehMakeModel
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleType\VehIdentityAType $vehIdentity
     */
     ...
     * The make and model of the vehicle (e.g., Ford Focus). The Code attribute may be used for the SIPP code.
     *
     * @return \Recranet\OTA\Type\VehicleType\VehMakeModelAType
     */
     ...
     * The make and model of the vehicle (e.g., Ford Focus). The Code attribute may be used for the SIPP code.
     *
     * @param \Recranet\OTA\Type\VehicleType\VehMakeModelAType $vehMakeModel
     * @return self
     */
    public function setVehMakeModel(?\Recranet\OTA\Type\VehicleType\VehMakeModelAType $vehMakeModel = null)
    {
     ...
     * The specific identifiers of the vehicle (e.g., Motor Vehicle Asset Number).
     *
     * @return \Recranet\OTA\Type\VehicleType\VehIdentityAType
     */
     ...
     * The specific identifiers of the vehicle (e.g., Motor Vehicle Asset Number).
     *
     * @param \Recranet\OTA\Type\VehicleType\VehIdentityAType $vehIdentity
     * @return self
     */
    public function setVehIdentity(?\Recranet\OTA\Type\VehicleType\VehIdentityAType $vehIdentity = null)
    {
