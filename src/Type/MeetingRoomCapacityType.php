...
class MeetingRoomCapacityType
{
     ...
     *
     * @var \Recranet\OTA\Type\MeetingRoomCapacityType\OccupancyAType $occupancy
     */
     ...
     * The Occupancy details of a meeting room.
     *
     * @return \Recranet\OTA\Type\MeetingRoomCapacityType\OccupancyAType
     */
     ...
     * The Occupancy details of a meeting room.
     *
     * @param \Recranet\OTA\Type\MeetingRoomCapacityType\OccupancyAType $occupancy
     * @return self
     */
    public function setOccupancy(?\Recranet\OTA\Type\MeetingRoomCapacityType\OccupancyAType $occupancy = null)
    {
