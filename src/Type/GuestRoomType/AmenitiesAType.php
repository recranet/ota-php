...
class AmenitiesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\GuestRoomType\AmenitiesAType\AmenityAType[] $amenity
     */
    private $amenity = [
     ...
     */
    public function addToAmenity(\Recranet\OTA\Type\GuestRoomType\AmenitiesAType\AmenityAType $amenity)
    {
