...
class ContactPersonType
{
     ...
     *
     * @var \Recranet\OTA\Type\ContactPersonType\TelephoneAType[] $telephone
     */
    private $telephone = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ContactPersonType\TelephoneAType $telephone
     */
    public function addToTelephone(\Recranet\OTA\Type\ContactPersonType\TelephoneAType $telephone)
    {
     ...
     * Information about a telephone number, including the actual number and its usage.
     *
     * @return \Recranet\OTA\Type\ContactPersonType\TelephoneAType[]
     */
