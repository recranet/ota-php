...
namespace Recranet\OTA\Type\PoliciesType\PolicyAType\GroupPoliciesAType;
...
{
    /**
     * Currency used for contracts.
     * Example: usd
     *
     * @var string $contractCurrency
     */
    private $contractCurrency = null;

    /**
     * Language used for contract.
     * Example: en
     *
     * @var string $contractLanguage
     */
    private $contractLanguage = null;

    /**
     * Local Destination Management Company Role (e.g. suggested or required).
     * Example: Required
     *
     * @var string $localDMCRole
     */
    private $localDMCRole = null;

    /**
     * Maximum number of people that the property will accept as a group.
     * Example: 500
     *
