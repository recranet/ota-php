...
{
    /**
     * @var \Recranet\OTA\Type\PoliciesType\PolicyAType\TaxPoliciesAType\TaxPolicyAType[] $taxPolicy
     */
    private $taxPolicy = [
     ...
     */
    public function addToTaxPolicy(\Recranet\OTA\Type\PoliciesType\PolicyAType\TaxPoliciesAType\TaxPolicyAType $taxPolicy)
    {
