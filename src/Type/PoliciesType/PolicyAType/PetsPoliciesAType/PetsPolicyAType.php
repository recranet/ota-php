...
namespace Recranet\OTA\Type\PoliciesType\PolicyAType\PetsPoliciesAType;
...
class PetsPolicyAType
{
     ...
     *
     * @var int $maxPetQuantity
     */
    private $maxPetQuantity = null;

    /**
     * @var float $refundableDeposit
     */
    ...
    /**
     * Used to provide charge information for a pet. Refer to OpenTravel Code list Charge Type (CHG).
     *
    ...
    /**
     * When true, there is a restriction associated with this pet policy. When false, there is not a restriction associated with this pet policy.
     *
     * @var bool $restrictionInd
     */
    private $restrictionInd = null;

    /**
     * This is used to designate the minimum pet weight allowed. The unit of measure code may indicate the associated unit of weight measure (e.g., pounds or kilograms).
     *
     * @var float $minUnitOfMeasureQuantity
     */
