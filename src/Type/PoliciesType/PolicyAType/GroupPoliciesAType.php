...
class GroupPoliciesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PoliciesType\PolicyAType\GroupPoliciesAType\GroupPolicyAType[] $groupPolicy
     */
    private $groupPolicy = [
     ...
     */
    public function addToGroupPolicy(\Recranet\OTA\Type\PoliciesType\PolicyAType\GroupPoliciesAType\GroupPolicyAType $groupPolicy)
    {
