...
class MembershipType
{
     ...
     *
     * @var \Recranet\OTA\Type\MembershipType\MembershipAType[] $membership
     */
    private $membership = [
     ...
     */
    public function addToMembership(\Recranet\OTA\Type\MembershipType\MembershipAType $membership)
    {
