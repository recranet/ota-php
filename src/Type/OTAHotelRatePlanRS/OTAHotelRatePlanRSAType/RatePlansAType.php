...
namespace Recranet\OTA\Type\OTAHotelRatePlanRS\OTAHotelRatePlanRSAType;
...
class RatePlansAType
{
     ...
     *
     * @var \Recranet\OTA\Type\HotelRatePlanType[] $ratePlan
     */
    private $ratePlan = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\HotelRatePlanType $ratePlan
     */
    public function addToRatePlan(\Recranet\OTA\Type\HotelRatePlanType $ratePlan)
    {
     ...
     * An individual rate plan.
     *
     * @return \Recranet\OTA\Type\HotelRatePlanType[]
     */
