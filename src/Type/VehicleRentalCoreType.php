...
class VehicleRentalCoreType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalCoreType\PickUpLocationAType[] $pickUpLocation
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalCoreType\ReturnLocationAType $returnLocation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleRentalCoreType\PickUpLocationAType $pickUpLocation
     */
    public function addToPickUpLocation(\Recranet\OTA\Type\VehicleRentalCoreType\PickUpLocationAType $pickUpLocation)
    {
     ...
     * A code to identify the pick up location, along with an optional code context.
     *
     * @return \Recranet\OTA\Type\VehicleRentalCoreType\PickUpLocationAType[]
     */
     ...
     * A code to identify the return location, along with an optional code context.
     *
     * @return \Recranet\OTA\Type\VehicleRentalCoreType\ReturnLocationAType
     */
     ...
     * A code to identify the return location, along with an optional code context.
     *
     * @param \Recranet\OTA\Type\VehicleRentalCoreType\ReturnLocationAType $returnLocation
     * @return self
     */
    public function setReturnLocation(?\Recranet\OTA\Type\VehicleRentalCoreType\ReturnLocationAType $returnLocation = null)
    {
