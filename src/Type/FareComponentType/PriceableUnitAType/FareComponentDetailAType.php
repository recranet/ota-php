...
namespace Recranet\OTA\Type\FareComponentType\PriceableUnitAType;
...
class FareComponentDetailAType
{
     ...
     *
     * @var \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType[] $couponSequence
     */
    private $couponSequence = [
     ...
     *
     * @var \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType[] $constructionPrinciple
     */
    private $constructionPrinciple = [
     ...
     *
     * @var \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType[] $baseAmount
     */
    private $baseAmount = [
     ...
     *
     * @var \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType[] $ticketDesignator
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType $couponSequence
     */
    public function addToCouponSequence(\Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType $couponSequence)
    {
     ...
     * Sequence number, coupon/itinerary sequence nbr, from and to city codes, stopover indicator, and airline designator.
     *
     * @return \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType $constructionPrinciple
     */
    public function addToConstructionPrinciple(\Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType $constructionPrinciple)
    {
     ...
     * Principle indicator, from and to airport/city code, amount and percent.
     *
     * @return \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType[]
     */
     ...
     * @return self
     */
    public function setConstructionPrinciple(array $constructionPrinciple = null)
    {
        $this->constructionPrinciple = $constructionPrinciple;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType $baseAmount
     */
    public function addToBaseAmount(\Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType $baseAmount)
    {
     ...
     * The base, base net, and base sell amounts.
     *
     * @return \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType $ticketDesignator
     */
    public function addToTicketDesignator(\Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType $ticketDesignator)
    {
     ...
     * Ticket designation code and qualifier.
     *
     * @return \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType[]
     */
     ...
     * @return self
     */
    public function setTicketDesignator(array $ticketDesignator = null)
    {
        $this->ticketDesignator = $ticketDesignator;
        return $this;
    }
