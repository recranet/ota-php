...
namespace Recranet\OTA\Type\FareComponentType;
...
class PriceableUnitAType
{
     ...
     *
     * @var \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType[] $fareComponentDetail
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType $fareComponentDetail
     */
    public function addToFareComponentDetail(\Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType $fareComponentDetail)
    {
     ...
     * Component number, tariff number, rule number, fare owner, waiver code, PTC, rule code, fare basis code, ticket designator. ticket designator qualifier, and agreement code.
     *
     * @return \Recranet\OTA\Type\FareComponentType\PriceableUnitAType\FareComponentDetailAType[]
     */
