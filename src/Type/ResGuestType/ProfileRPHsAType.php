...
namespace Recranet\OTA\Type\ResGuestType;
...
class ProfileRPHsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType[] $profileRPH
     */
    private $profileRPH = [
     ...
     */
    public function addToProfileRPH(\Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType $profileRPH)
    {
