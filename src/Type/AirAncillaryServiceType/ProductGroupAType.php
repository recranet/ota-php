...
namespace Recranet\OTA\Type\AirAncillaryServiceType;
...
class ProductGroupAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType\SubGroupAType[] $subGroup
     */
    private $subGroup = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType\SubGroupAType $subGroup
     */
    public function addToSubGroup(\Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType\SubGroupAType $subGroup)
    {
     ...
     * Airline or ATPCO encoded sub-group code(s) that are associated with the group code.
     *
     * @return \Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType\SubGroupAType[]
     */
