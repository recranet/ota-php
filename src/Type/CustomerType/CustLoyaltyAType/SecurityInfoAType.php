...
class SecurityInfoAType
{
     ...
     *
     * @var \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\SecurityInfoAType\PasswordHintAType[] $passwordHint
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\SecurityInfoAType\PasswordHintAType $passwordHint
     */
    public function addToPasswordHint(\Recranet\OTA\Type\CustomerType\CustLoyaltyAType\SecurityInfoAType\PasswordHintAType $passwordHint)
    {
     ...
     * Alternate method to password for account access.
     *
     * @return \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\SecurityInfoAType\PasswordHintAType[]
     */
