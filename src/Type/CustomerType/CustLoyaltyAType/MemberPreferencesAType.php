...
class MemberPreferencesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\AdditionalRewardAType[] $additionalReward
     */
     ...
     *
     * @var \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\OfferAType[] $offer
     */
    private $offer = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\AdditionalRewardAType $additionalReward
     */
    public function addToAdditionalReward(\Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\AdditionalRewardAType $additionalReward)
    {
     ...
     * Additional programs that are honored by the primary loyalty account.
     *
     * @return \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\AdditionalRewardAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\OfferAType $offer
     */
    public function addToOffer(\Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\OfferAType $offer)
    {
        $this->offer[] = $offer;
        return $this;
    }
     ...
     * Source from which members can receive information.
     *
     * @return \Recranet\OTA\Type\CustomerType\CustLoyaltyAType\MemberPreferencesAType\OfferAType[]
     */
