...
class VehicleCoreType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleCoreType\VehTypeAType $vehType
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleCoreType\VehClassAType $vehClass
     */
     ...
     * The type of vehicle, for example, truck, car.
     *
     * @return \Recranet\OTA\Type\VehicleCoreType\VehTypeAType
     */
     ...
     * The type of vehicle, for example, truck, car.
     *
     * @param \Recranet\OTA\Type\VehicleCoreType\VehTypeAType $vehType
     * @return self
     */
    public function setVehType(?\Recranet\OTA\Type\VehicleCoreType\VehTypeAType $vehType = null)
    {
     ...
     * The class of vehicle, for example, intermediate, compact.
     *
     * @return \Recranet\OTA\Type\VehicleCoreType\VehClassAType
     */
     ...
     * The class of vehicle, for example, intermediate, compact.
     *
     * @param \Recranet\OTA\Type\VehicleCoreType\VehClassAType $vehClass
     * @return self
     */
    public function setVehClass(?\Recranet\OTA\Type\VehicleCoreType\VehClassAType $vehClass = null)
    {
