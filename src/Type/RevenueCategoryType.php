...
class RevenueCategoryType
{
    ...
    /**
     * @var \Recranet\OTA\Type\RevenueCategoryType\SummaryAmountAType $summaryAmount
     */
     ...
     *
     * @var \Recranet\OTA\Type\RevenueDetailType[] $revenueDetails
     */
     ...
     *
     * @return \Recranet\OTA\Type\RevenueCategoryType\SummaryAmountAType
     */
     ...
     *
     * @param \Recranet\OTA\Type\RevenueCategoryType\SummaryAmountAType $summaryAmount
     * @return self
     */
    public function setSummaryAmount(?\Recranet\OTA\Type\RevenueCategoryType\SummaryAmountAType $summaryAmount = null)
    {
     ...
     */
    public function addToRevenueDetails(\Recranet\OTA\Type\RevenueDetailType $revenueDetail)
    {
     ...
     * A collection of revenue details.
     *
     * @param \Recranet\OTA\Type\RevenueDetailType[] $revenueDetails
     * @return self
     */
