...
class AirSearchPrefsType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirSearchPrefsType\VendorPrefAType[] $vendorPref
     */
    private $vendorPref = [
     ...
     *
     * @var \Recranet\OTA\Type\AirSearchPrefsType\FlightTypePrefAType[] $flightTypePref
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirSearchPrefsType\FareRestrictPrefAType[] $fareRestrictPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirSearchPrefsType\CabinPrefAType[] $cabinPref
     */
    private $cabinPref = [
     ...
     *
     * @var \Recranet\OTA\Type\AirSearchPrefsType\TicketDistribPrefAType[] $ticketDistribPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirSearchPrefsType\BookingSeatPrefAType $bookingSeatPref
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSearchPrefsType\VendorPrefAType $vendorPref
     */
    public function addToVendorPref(\Recranet\OTA\Type\AirSearchPrefsType\VendorPrefAType $vendorPref)
    {
     ...
     * Specify vendors to include and exclude from the response.
     *
     * @return \Recranet\OTA\Type\AirSearchPrefsType\VendorPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSearchPrefsType\FlightTypePrefAType $flightTypePref
     */
    public function addToFlightTypePref(\Recranet\OTA\Type\AirSearchPrefsType\FlightTypePrefAType $flightTypePref)
    {
     ...
     * Defines preferred flight characteristics to be used in a search.
     *
     * @return \Recranet\OTA\Type\AirSearchPrefsType\FlightTypePrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSearchPrefsType\FareRestrictPrefAType $fareRestrictPref
     */
    public function addToFareRestrictPref(\Recranet\OTA\Type\AirSearchPrefsType\FareRestrictPrefAType $fareRestrictPref)
    {
     ...
     * Constrains a fare search to those with restrictions that satisfy user-imposed limitations.
     *
     * @return \Recranet\OTA\Type\AirSearchPrefsType\FareRestrictPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSearchPrefsType\CabinPrefAType $cabinPref
     */
    public function addToCabinPref(\Recranet\OTA\Type\AirSearchPrefsType\CabinPrefAType $cabinPref)
    {
     ...
     * Defines preferred cabin(s) to be used in a search.
     *
     * @return \Recranet\OTA\Type\AirSearchPrefsType\CabinPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSearchPrefsType\TicketDistribPrefAType $ticketDistribPref
     */
    public function addToTicketDistribPref(\Recranet\OTA\Type\AirSearchPrefsType\TicketDistribPrefAType $ticketDistribPref)
    {
     ...
     * Defines Distribution prefernces.
     *
     * @return \Recranet\OTA\Type\AirSearchPrefsType\TicketDistribPrefAType[]
     */
     ...
     * The booking class seat preferences.
     *
     * @return \Recranet\OTA\Type\AirSearchPrefsType\BookingSeatPrefAType
     */
     ...
     * The booking class seat preferences.
     *
     * @param \Recranet\OTA\Type\AirSearchPrefsType\BookingSeatPrefAType $bookingSeatPref
     * @return self
     */
    public function setBookingSeatPref(?\Recranet\OTA\Type\AirSearchPrefsType\BookingSeatPrefAType $bookingSeatPref = null)
    {
