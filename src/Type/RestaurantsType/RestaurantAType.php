...
namespace Recranet\OTA\Type\RestaurantsType;

use Recranet\OTA\Type\RestaurantType;
...
class RestaurantAType extends RestaurantType
{
     ...
     *
     * @var \Recranet\OTA\Type\RestaurantsType\RestaurantAType\SrvcInfoCodesAType\SrvcInfoCodeAType[] $srvcInfoCodes
     */
     ...
     */
    public function addToSrvcInfoCodes(\Recranet\OTA\Type\RestaurantsType\RestaurantAType\SrvcInfoCodesAType\SrvcInfoCodeAType $srvcInfoCode)
    {
     ...
     * Collection of type of restaurant offered.
     *
     * @param \Recranet\OTA\Type\RestaurantsType\RestaurantAType\SrvcInfoCodesAType\SrvcInfoCodeAType[] $srvcInfoCodes
     * @return self
     */
