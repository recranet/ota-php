...
namespace Recranet\OTA\Type\OTAHotelBookingRuleNotifRQ;

/**
 * Class representing OTAHotelBookingRuleNotifRQAType
 */
class OTAHotelBookingRuleNotifRQAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelBookingRuleNotifRQ\OTAHotelBookingRuleNotifRQAType\RuleMessagesAType $ruleMessages
     */
     ...
     * Container for the individual RuleMessage(s). An OTA_HotelBookingRuleNotifRQ contains the booking rules for a single hotel. Hotel identification information are the attributes of this element.
     *
     * @return \Recranet\OTA\Type\OTAHotelBookingRuleNotifRQ\OTAHotelBookingRuleNotifRQAType\RuleMessagesAType
     */
     ...
     * Container for the individual RuleMessage(s). An OTA_HotelBookingRuleNotifRQ contains the booking rules for a single hotel. Hotel identification information are the attributes of this element.
     *
     * @param \Recranet\OTA\Type\OTAHotelBookingRuleNotifRQ\OTAHotelBookingRuleNotifRQAType\RuleMessagesAType $ruleMessages
     * @return self
     */
    public function setRuleMessages(?\Recranet\OTA\Type\OTAHotelBookingRuleNotifRQ\OTAHotelBookingRuleNotifRQAType\RuleMessagesAType $ruleMessages = null)
    {
