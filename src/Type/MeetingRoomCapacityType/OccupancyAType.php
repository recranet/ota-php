...
namespace Recranet\OTA\Type\MeetingRoomCapacityType;
...
class OccupancyAType
{
     ...
     *
     * @var \Recranet\OTA\Type\FeeType $minRoomCharge
     */
     ...
     * The minimum room charge for this meeting room such as room rental fee.
     *
     * @param \Recranet\OTA\Type\FeeType $minRoomCharge
     * @return self
     */
    public function setMinRoomCharge(?\Recranet\OTA\Type\FeeType $minRoomCharge = null)
    {
