...
class BookingClassAvailsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\BookFlightSegmentType\BookingClassAvailsAType\BookingClassAvailAType[] $bookingClassAvail
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BookFlightSegmentType\BookingClassAvailsAType\BookingClassAvailAType $bookingClassAvail
     */
    public function addToBookingClassAvail(\Recranet\OTA\Type\BookFlightSegmentType\BookingClassAvailsAType\BookingClassAvailAType $bookingClassAvail)
    {
     ...
     * Booking codes available to be sold for a particular flight segment.
     *
     * @return \Recranet\OTA\Type\BookFlightSegmentType\BookingClassAvailsAType\BookingClassAvailAType[]
     */
