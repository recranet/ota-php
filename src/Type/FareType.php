...
class FareType
{
     ...
     *
     * @var \Recranet\OTA\Type\FareType\BaseFareAType $baseFare
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\EquivFareAType[] $equivFare
     */
    private $equivFare = [
     ...
     *
     * @var \Recranet\OTA\Type\FareType\TaxesAType $taxes
     */
    private $taxes = null;
     ...
     *
     * @var \Recranet\OTA\Type\FareType\FeesAType $fees
     */
    private $fees = null;
     ...
     *
     * @var \Recranet\OTA\Type\FareType\TotalFareAType $totalFare
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\FareConstructionAType $fareConstruction
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\UnstructuredFareCalcAType $unstructuredFareCalc
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\FareBaggageAllowanceAType[] $fareBaggageAllowance
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\TourCodeAType $tourCode
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\OriginalIssueInfoAType $originalIssueInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\ExchangeInfoAType $exchangeInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareType\DiscountsAType\DiscountAType[] $discounts
     */
     ...
     * Price of the inventory excluding taxes and fees.
     *
     * @return \Recranet\OTA\Type\FareType\BaseFareAType
     */
     ...
     * Price of the inventory excluding taxes and fees.
     *
     * @param \Recranet\OTA\Type\FareType\BaseFareAType $baseFare
     * @return self
     */
    public function setBaseFare(?\Recranet\OTA\Type\FareType\BaseFareAType $baseFare = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareType\EquivFareAType $equivFare
     */
    public function addToEquivFare(\Recranet\OTA\Type\FareType\EquivFareAType $equivFare)
    {
     ...
     * Price of the inventory excluding taxes and fees in the payable currency.
     *
     * @return \Recranet\OTA\Type\FareType\EquivFareAType[]
     */
     ...
     * This is a collection of Taxes
     *
     * @return \Recranet\OTA\Type\FareType\TaxesAType
     */
     ...
     * This is a collection of Taxes
     *
     * @param \Recranet\OTA\Type\FareType\TaxesAType $taxes
     * @return self
     */
    public function setTaxes(?\Recranet\OTA\Type\FareType\TaxesAType $taxes = null)
    {
        $this->taxes = $taxes;
        return $this;
    }
     ...
     * This is a collection of Fees.
     *
     * @return \Recranet\OTA\Type\FareType\FeesAType
     */
     ...
     * This is a collection of Fees.
     *
     * @param \Recranet\OTA\Type\FareType\FeesAType $fees
     * @return self
     */
    public function setFees(?\Recranet\OTA\Type\FareType\FeesAType $fees = null)
    {
        $this->fees = $fees;
        return $this;
    }
     ...
     * The total price that the passenger would pay (includes fare, taxes, fees)
     *
     * @return \Recranet\OTA\Type\FareType\TotalFareAType
     */
     ...
     * The total price that the passenger would pay (includes fare, taxes, fees)
     *
     * @param \Recranet\OTA\Type\FareType\TotalFareAType $totalFare
     * @return self
     */
    public function setTotalFare(?\Recranet\OTA\Type\FareType\TotalFareAType $totalFare = null)
    {
     ...
     * Should not contain unstructured FareCalc data.
     *
     * @return \Recranet\OTA\Type\FareType\FareConstructionAType
     */
     ...
     * Should not contain unstructured FareCalc data.
     *
     * @param \Recranet\OTA\Type\FareType\FareConstructionAType $fareConstruction
     * @return self
     */
    public function setFareConstruction(?\Recranet\OTA\Type\FareType\FareConstructionAType $fareConstruction = null)
    {
     ...
     * Contains the fare calc information for the stored fare for the passenger.
     *
     * @return \Recranet\OTA\Type\FareType\UnstructuredFareCalcAType
     */
     ...
     * Contains the fare calc information for the stored fare for the passenger.
     *
     * @param \Recranet\OTA\Type\FareType\UnstructuredFareCalcAType $unstructuredFareCalc
     * @return self
     */
    public function setUnstructuredFareCalc(?\Recranet\OTA\Type\FareType\UnstructuredFareCalcAType $unstructuredFareCalc = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareType\FareBaggageAllowanceAType $fareBaggageAllowance
     */
    public function addToFareBaggageAllowance(\Recranet\OTA\Type\FareType\FareBaggageAllowanceAType $fareBaggageAllowance)
    {
     ...
     * Checked baggage allowance for the fare.
     *
     * @return \Recranet\OTA\Type\FareType\FareBaggageAllowanceAType[]
     */
     ...
     * The tour code associated with the fare.
     *
     * @return \Recranet\OTA\Type\FareType\TourCodeAType
     */
     ...
     * The tour code associated with the fare.
     *
     * @param \Recranet\OTA\Type\FareType\TourCodeAType $tourCode
     * @return self
     */
    public function setTourCode(?\Recranet\OTA\Type\FareType\TourCodeAType $tourCode = null)
    {
     ...
     * The original ticket/document issue information.
     *
     * @return \Recranet\OTA\Type\FareType\OriginalIssueInfoAType
     */
     ...
     * The original ticket/document issue information.
     *
     * @param \Recranet\OTA\Type\FareType\OriginalIssueInfoAType $originalIssueInfo
     * @return self
     */
    public function setOriginalIssueInfo(?\Recranet\OTA\Type\FareType\OriginalIssueInfoAType $originalIssueInfo = null)
    {
     ...
     * Exchange ticket/document information.
     *
     * @return \Recranet\OTA\Type\FareType\ExchangeInfoAType
     */
     ...
     * Exchange ticket/document information.
     *
     * @param \Recranet\OTA\Type\FareType\ExchangeInfoAType $exchangeInfo
     * @return self
     */
    public function setExchangeInfo(?\Recranet\OTA\Type\FareType\ExchangeInfoAType $exchangeInfo = null)
    {
     ...
     */
    public function addToDiscounts(\Recranet\OTA\Type\FareType\DiscountsAType\DiscountAType $discount)
    {
     ...
     * Collection for discounts.
     *
     * @param \Recranet\OTA\Type\FareType\DiscountsAType\DiscountAType[] $discounts
     * @return self
     */
