...
namespace Recranet\OTA\Type\OTAHotelRFPTransientRS;

/**
 * Class representing OTAHotelRFPTransientRSAType
 */
class OTAHotelRFPTransientRSAType
{
    /**
    ...
    /**
     * This has the ability to hold both the information for an acknowlegement as well as the full response depending on its use.
     *
     * @var \Recranet\OTA\Type\RFPTransientDetailsType $rFPTransientDetail
     */
     ...
     * This has the ability to hold both the information for an acknowlegement as well as the full response depending on its use.
     *
     * @return \Recranet\OTA\Type\RFPTransientDetailsType
     */
     ...
     * This has the ability to hold both the information for an acknowlegement as well as the full response depending on its use.
     *
     * @param \Recranet\OTA\Type\RFPTransientDetailsType $rFPTransientDetail
     * @return self
     */
    public function setRFPTransientDetail(?\Recranet\OTA\Type\RFPTransientDetailsType $rFPTransientDetail = null)
    {
