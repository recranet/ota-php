...
class CodeListScheduleType
{
     ...
     * Operation times.
     *
     * @var \Recranet\OTA\Type\CodeListScheduleType\OperationTimesAType\OperationTimeAType[] $operationTimes
     */
     ...
     */
    public function addToOperationTimes(\Recranet\OTA\Type\CodeListScheduleType\OperationTimesAType\OperationTimeAType $operationTime)
    {
     ...
     * Operation times.
     *
     * @param \Recranet\OTA\Type\CodeListScheduleType\OperationTimesAType\OperationTimeAType[] $operationTimes
     * @return self
     */
