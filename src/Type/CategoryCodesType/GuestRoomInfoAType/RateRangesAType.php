...
namespace Recranet\OTA\Type\CategoryCodesType\GuestRoomInfoAType;
...
class RateRangesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\CategoryCodesType\GuestRoomInfoAType\RateRangesAType\RateRangeAType[] $rateRange
     */
    private $rateRange = [
     ...
     */
    public function addToRateRange(\Recranet\OTA\Type\CategoryCodesType\GuestRoomInfoAType\RateRangesAType\RateRangeAType $rateRange)
    {
