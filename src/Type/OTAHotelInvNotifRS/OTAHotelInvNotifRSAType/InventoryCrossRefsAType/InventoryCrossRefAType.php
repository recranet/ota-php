...
namespace Recranet\OTA\Type\OTAHotelInvNotifRS\OTAHotelInvNotifRSAType\InventoryCrossRefsAType;
...
class InventoryCrossRefAType
{
     ...
     *
     * @var string $requestInvGroupingCode
     */
     ...
     *
     * @var string $responseInvGroupingCode
     */
