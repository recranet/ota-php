...
namespace Recranet\OTA\Type\OTAHotelCacheChangeRS;

/**
 * Class representing OTAHotelCacheChangeRSAType
 */
class OTAHotelCacheChangeRSAType
{
    /**
    ...
    /**
     * Information that has changed and should be updated in the cache via an OTA_HotelAvailRQ request message.
     *
     * @var \Recranet\OTA\Type\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType[] $cacheChangeInfo
     */
    private $cacheChangeInfo = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType $cacheChangeInfo
     */
    public function addToCacheChangeInfo(\Recranet\OTA\Type\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType $cacheChangeInfo)
    {
     ...
     * Information that has changed and should be updated in the cache via an OTA_HotelAvailRQ request message.
     *
     * @return \Recranet\OTA\Type\OTAHotelCacheChangeRS\OTAHotelCacheChangeRSAType\CacheChangeInfoAType[]
     */
     ...
     * @return self
     */
    public function setCacheChangeInfo(array $cacheChangeInfo = null)
    {
        $this->cacheChangeInfo = $cacheChangeInfo;
        return $this;
    }
