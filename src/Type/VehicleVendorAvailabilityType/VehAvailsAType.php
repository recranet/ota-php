...
namespace Recranet\OTA\Type\VehicleVendorAvailabilityType;
...
class VehAvailsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleVendorAvailabilityType\VehAvailsAType\VehAvailAType[] $vehAvail
     */
    private $vehAvail = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleVendorAvailabilityType\VehAvailsAType\VehAvailAType $vehAvail
     */
    public function addToVehAvail(\Recranet\OTA\Type\VehicleVendorAvailabilityType\VehAvailsAType\VehAvailAType $vehAvail)
    {
     ...
     * Availability and rate information for one specific vehicle.
     *
     * @return \Recranet\OTA\Type\VehicleVendorAvailabilityType\VehAvailsAType\VehAvailAType[]
     */
