...
class RestrictionStatusCandidatesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType\RestrictionStatusCandidatesAType\RestrictionStatusCandidateAType[] $restrictionStatusCandidate
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType\RestrictionStatusCandidatesAType\RestrictionStatusCandidateAType $restrictionStatusCandidate
     */
    public function addToRestrictionStatusCandidate(\Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType\RestrictionStatusCandidatesAType\RestrictionStatusCandidateAType $restrictionStatusCandidate)
    {
     ...
     * Availability status assigned to the room rate combination.
     *
     * @return \Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType\RestrictionStatusCandidatesAType\RestrictionStatusCandidateAType[]
     */
