...
namespace Recranet\OTA\Type\OTAHotelAvailGetRQ;

/**
 * Class representing OTAHotelAvailGetRQAType
 */
class OTAHotelAvailGetRQAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType[] $hotelAvailRequests
     */
     ...
     */
    public function addToHotelAvailRequests(\Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType $hotelAvailRequest)
    {
     ...
     * Container for the individual HotelAvailRequests(s).
     *
     * @param \Recranet\OTA\Type\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType[] $hotelAvailRequests
     * @return self
     */
