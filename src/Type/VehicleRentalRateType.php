...
class VehicleRentalRateType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalRateType\RateDistanceAType[] $rateDistance
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalRateType\RateQualifierAType $rateQualifier
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalRateType\RateRestrictionsAType $rateRestrictions
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalRateType\RateGuaranteeAType $rateGuarantee
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalRateType\PickupReturnRuleAType[] $pickupReturnRule
     */
     ...
     *
     * @var \Recranet\OTA\Type\NoShowFeeType $noShowFeeInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleRentalRateType\RateDistanceAType $rateDistance
     */
    public function addToRateDistance(\Recranet\OTA\Type\VehicleRentalRateType\RateDistanceAType $rateDistance)
    {
     ...
     * Information on the distance that a reserved vehicle may be driven as part of the standard rental charge. Such distance may be unlimited, or a quantity of miles or kilometers for a certain period of time. This may be repeated for situations such as an 8 day rental that has 500 miles per week and 100 miles per additional day.
     *
     * @return \Recranet\OTA\Type\VehicleRentalRateType\RateDistanceAType[]
     */
     ...
     * Indicates the type of rates applicable to the customer, along with any discount number or promotional codes that affect the quoted rate.
     *
     * @return \Recranet\OTA\Type\VehicleRentalRateType\RateQualifierAType
     */
     ...
     * Indicates the type of rates applicable to the customer, along with any discount number or promotional codes that affect the quoted rate.
     *
     * @param \Recranet\OTA\Type\VehicleRentalRateType\RateQualifierAType $rateQualifier
     * @return self
     */
    public function setRateQualifier(?\Recranet\OTA\Type\VehicleRentalRateType\RateQualifierAType $rateQualifier = null)
    {
     ...
     * Information on restrictions that may be associated with this rate. Additional details on rate restrictions may be found in OTA_VehRateRulesRS.xsd.
     *
     * @return \Recranet\OTA\Type\VehicleRentalRateType\RateRestrictionsAType
     */
     ...
     * Information on restrictions that may be associated with this rate. Additional details on rate restrictions may be found in OTA_VehRateRulesRS.xsd.
     *
     * @param \Recranet\OTA\Type\VehicleRentalRateType\RateRestrictionsAType $rateRestrictions
     * @return self
     */
    public function setRateRestrictions(?\Recranet\OTA\Type\VehicleRentalRateType\RateRestrictionsAType $rateRestrictions = null)
    {
     ...
     * Used to indicate how long a specific rate is guaranteed.
     *
     * @return \Recranet\OTA\Type\VehicleRentalRateType\RateGuaranteeAType
     */
     ...
     * Used to indicate how long a specific rate is guaranteed.
     *
     * @param \Recranet\OTA\Type\VehicleRentalRateType\RateGuaranteeAType $rateGuarantee
     * @return self
     */
    public function setRateGuarantee(?\Recranet\OTA\Type\VehicleRentalRateType\RateGuaranteeAType $rateGuarantee = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleRentalRateType\PickupReturnRuleAType $pickupReturnRule
     */
    public function addToPickupReturnRule(\Recranet\OTA\Type\VehicleRentalRateType\PickupReturnRuleAType $pickupReturnRule)
    {
     ...
     * Pickup and return requirements for a specific rate.
     *
     * @return \Recranet\OTA\Type\VehicleRentalRateType\PickupReturnRuleAType[]
     */
     ...
     * Information regarding the no show fee policy for this vehicle type.
     *
     * @return \Recranet\OTA\Type\NoShowFeeType
     */
     ...
     * Information regarding the no show fee policy for this vehicle type.
     *
     * @param \Recranet\OTA\Type\NoShowFeeType $noShowFeeInfo
     * @return self
     */
    public function setNoShowFeeInfo(?\Recranet\OTA\Type\NoShowFeeType $noShowFeeInfo = null)
    {
