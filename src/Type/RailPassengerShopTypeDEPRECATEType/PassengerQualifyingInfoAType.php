...
namespace Recranet\OTA\Type\RailPassengerShopTypeDEPRECATEType;
...
class PassengerQualifyingInfoAType
{
    ...
    /**
     * A unique ID for a passenger category that may be used to associate a passenger category elsewhere in this schema.
     *
     * @var string $rPH
     */
    private $rPH = null;
