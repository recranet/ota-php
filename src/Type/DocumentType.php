...
class DocumentType
{
     ...
     *
     * @var string $docHolderNationality
     */
     ...
     *
     * @var \Recranet\OTA\Type\PersonNameType $docHolderFormattedName
     */
     ...
     *
     * @var string[] $additionalPersonNames
     */
     ...
     * The name of document holder in formatted text.
     *
     * @param \Recranet\OTA\Type\PersonNameType $docHolderFormattedName
     * @return self
     */
    public function setDocHolderFormattedName(?\Recranet\OTA\Type\PersonNameType $docHolderFormattedName = null)
    {
     ...
     * @return self
     */
    public function setAdditionalPersonNames(array $additionalPersonNames = null)
    {
