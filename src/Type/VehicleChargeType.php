...
class VehicleChargeType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleChargeType\TaxAmountsAType\TaxAmountAType[] $taxAmounts
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleChargeType\MinMaxAType $minMax
     */
    private $minMax = null;
     ...
     *
     * @var \Recranet\OTA\Type\VehicleChargeType\CalculationAType[] $calculation
     */
    private $calculation = [
     ...
     */
    public function addToTaxAmounts(\Recranet\OTA\Type\VehicleChargeType\TaxAmountsAType\TaxAmountAType $taxAmount)
    {
     ...
     * A collection of one or more taxes associated with a specific charge.
     *
     * @param \Recranet\OTA\Type\VehicleChargeType\TaxAmountsAType\TaxAmountAType[] $taxAmounts
     * @return self
     */
     ...
     * Information on any minimum or maximum amounts, if appropriate.
     *
     * @return \Recranet\OTA\Type\VehicleChargeType\MinMaxAType
     */
     ...
     * Information on any minimum or maximum amounts, if appropriate.
     *
     * @param \Recranet\OTA\Type\VehicleChargeType\MinMaxAType $minMax
     * @return self
     */
    public function setMinMax(?\Recranet\OTA\Type\VehicleChargeType\MinMaxAType $minMax = null)
    {
        $this->minMax = $minMax;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleChargeType\CalculationAType $calculation
     */
    public function addToCalculation(\Recranet\OTA\Type\VehicleChargeType\CalculationAType $calculation)
    {
     ...
     * Information on how this charge was calculated, for example, a daily rate multiplied by the number of days, a percentage, etc.
     *
     * @return \Recranet\OTA\Type\VehicleChargeType\CalculationAType[]
     */
