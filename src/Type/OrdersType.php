...
class OrdersType
{
     ...
     *
     * @var \Recranet\OTA\Type\OrdersType\OrderAType[] $order
     */
    private $order = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OrdersType\OrderAType $order
     */
    public function addToOrder(\Recranet\OTA\Type\OrdersType\OrderAType $order)
    {
        $this->order[] = $order;
        return $this;
    }
     ...
     * Information pertaining to a specific order.
     *
     * @return \Recranet\OTA\Type\OrdersType\OrderAType[]
     */
