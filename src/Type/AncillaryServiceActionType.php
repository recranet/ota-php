...
class AncillaryServiceActionType
{
    ...
    /**
     * The service family type code. Select a pre-defined value from the list, or use the "Other_" value in combination with the @ExtServiceCode attribute.
    ...
    /**
     * An indicator if the service code is required and/or should be included or excluded from the offer results.
     *
    ...
    /**
     * Airline or ATPCO encoded product group code(s) that are associated with the service code.
     *
     * @var \Recranet\OTA\Type\AncillaryServiceActionType\ProductGroupAType[] $productGroup
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AncillaryServiceActionType\ProductGroupAType $productGroup
     */
    public function addToProductGroup(\Recranet\OTA\Type\AncillaryServiceActionType\ProductGroupAType $productGroup)
    {
     ...
     * Airline or ATPCO encoded product group code(s) that are associated with the service code.
     *
     * @return \Recranet\OTA\Type\AncillaryServiceActionType\ProductGroupAType[]
     */
