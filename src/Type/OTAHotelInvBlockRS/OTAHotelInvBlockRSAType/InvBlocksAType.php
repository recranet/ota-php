...
namespace Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType;
...
class InvBlocksAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\HotelRefAType $hotelRef
     */
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\InvBlockDatesAType $invBlockDates
     */
     ...
     * This is used to identify the hotel to which the block(s) applies.
     *
     * @return \Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\HotelRefAType
     */
     ...
     * This is used to identify the hotel to which the block(s) applies.
     *
     * @param \Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\HotelRefAType $hotelRef
     * @return self
     */
    public function setHotelRef(?\Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\HotelRefAType $hotelRef = null)
    {
     ...
     * This is used to indicate the date or date range applicable to all inventory blocks in this message.
     *
     * @return \Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\InvBlockDatesAType
     */
     ...
     * This is used to indicate the date or date range applicable to all inventory blocks in this message.
     *
     * @param \Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\InvBlockDatesAType $invBlockDates
     * @return self
     */
    public function setInvBlockDates(?\Recranet\OTA\Type\OTAHotelInvBlockRS\OTAHotelInvBlockRSAType\InvBlocksAType\InvBlockDatesAType $invBlockDates = null)
    {
