...
namespace Recranet\OTA\Type\MeetingRoomsType;
...
class MeetingRoomAType
{
     ...
     *
     * @var \Recranet\OTA\Type\MeetingRoomsType\MeetingRoomAType\DimensionAType $dimension
     */
     ...
     *
     * @var \Recranet\OTA\Type\MeetingRoomCapacityType[] $availableCapacities
     */
     ...
     * Dimensions of the meeting room.
     *
     * @return \Recranet\OTA\Type\MeetingRoomsType\MeetingRoomAType\DimensionAType
     */
     ...
     * Dimensions of the meeting room.
     *
     * @param \Recranet\OTA\Type\MeetingRoomsType\MeetingRoomAType\DimensionAType $dimension
     * @return self
     */
    public function setDimension(?\Recranet\OTA\Type\MeetingRoomsType\MeetingRoomAType\DimensionAType $dimension = null)
    {
     ...
     */
    public function addToAvailableCapacities(\Recranet\OTA\Type\MeetingRoomCapacityType $meetingRoomCapacity)
    {
     ...
     * The amount of usable meeting space available at a property.
     *
     * @param \Recranet\OTA\Type\MeetingRoomCapacityType[] $availableCapacities
     * @return self
     */
