...
class PartnerInfosAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AffiliationInfoType\PartnerInfosAType\PartnerInfoAType[] $partnerInfo
     */
    private $partnerInfo = [
     ...
     */
    public function addToPartnerInfo(\Recranet\OTA\Type\AffiliationInfoType\PartnerInfosAType\PartnerInfoAType $partnerInfo)
    {
