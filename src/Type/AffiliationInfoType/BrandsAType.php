...
class BrandsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AffiliationInfoType\BrandsAType\BrandAType[] $brand
     */
    private $brand = [
     ...
     */
    public function addToBrand(\Recranet\OTA\Type\AffiliationInfoType\BrandsAType\BrandAType $brand)
    {
        $this->brand[] = $brand;
        return $this;
    }
