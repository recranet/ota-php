...
namespace Recranet\OTA\Type\AffiliationInfoType\AwardsAType;
...
class AwardAType
{
    ...
    /**
     * The actual award or rating received by the hotel facility (e.g. 4 stars, 3 diamonds). If used in conjunction with RatingSymbol only the numeric rating would be passed here.
     *
     * @var string $rating
     */
    private $rating = null;
    ...
    /**
     * When true indicates the property has received official permission from the award provider to use the rating in publications and marketing materials; when false this permission has not been granted.
     *
     * @var bool $officialAppointmentInd
     */
