...
class RoomRatesAType
{
    ...
    /**
     * @var \Recranet\OTA\Type\RoomStayType\RoomRatesAType\RoomRateAType[] $roomRate
     */
    private $roomRate = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RoomStayType\RoomRatesAType\RoomRateAType $roomRate
     */
    public function addToRoomRate(\Recranet\OTA\Type\RoomStayType\RoomRatesAType\RoomRateAType $roomRate)
    {
     ...
     * Gets as roomRate
     *
     * @return \Recranet\OTA\Type\RoomStayType\RoomRatesAType\RoomRateAType[]
     */
