...
class RestrictionsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RoomStayType\RoomRatesAType\RoomRateAType\RestrictionsAType\RestrictionAType[] $restriction
     */
    private $restriction = [
     ...
     */
    public function addToRestriction(\Recranet\OTA\Type\RoomStayType\RoomRatesAType\RoomRateAType\RestrictionsAType\RestrictionAType $restriction)
    {
