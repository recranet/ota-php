...
namespace Recranet\OTA\Type\OTAHotelRFPTransientNotifRQ;

use Recranet\OTA\Type\RFPTransientDetailsType;

/**
 * Class representing OTAHotelRFPTransientNotifRQAType
 */
class OTAHotelRFPTransientNotifRQAType extends RFPTransientDetailsType
{
    /**
