...
namespace Recranet\OTA\Type\RoomStaysType;
...
class RoomStayAType extends RoomStayType
{
     ...
     *
     * @var \Recranet\OTA\Type\MembershipType\MembershipAType[] $memberships
     */
     ...
     *
     * @var \Recranet\OTA\Type\RoomStaysType\RoomStayAType\ReferenceAType $reference
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\MembershipType\MembershipAType $membership
     */
    public function addToMemberships(\Recranet\OTA\Type\MembershipType\MembershipAType $membership)
    {
     ...
     * A collection of Membership objects. Memberships provides a list of reward programs which may be credited with points accrued from the guest's activity.
     *
     * @return \Recranet\OTA\Type\MembershipType\MembershipAType[]
     */
     ...
     * A collection of Membership objects. Memberships provides a list of reward programs which may be credited with points accrued from the guest's activity.
     *
     * @param \Recranet\OTA\Type\MembershipType\MembershipAType[] $memberships
     * @return self
     */
     ...
     * Information identifying an earlier availability quote.
     *
     * @return \Recranet\OTA\Type\RoomStaysType\RoomStayAType\ReferenceAType
     */
     ...
     * Information identifying an earlier availability quote.
     *
     * @param \Recranet\OTA\Type\RoomStaysType\RoomStayAType\ReferenceAType $reference
     * @return self
     */
    public function setReference(?\Recranet\OTA\Type\RoomStaysType\RoomStayAType\ReferenceAType $reference = null)
    {
