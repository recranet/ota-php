...
class TravelerInfoSummaryType
{
     ...
     *
     * @var \Recranet\OTA\Type\TravelerInformationType[] $airTravelerAvail
     */
     ...
     *
     * @var \Recranet\OTA\Type\TravelerInfoSummaryType\PriceRequestInformationAType $priceRequestInformation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\TravelerInformationType $airTravelerAvail
     */
    public function addToAirTravelerAvail(\Recranet\OTA\Type\TravelerInformationType $airTravelerAvail)
    {
     ...
     * Specifies passenger numbers and types.
     *
     * @return \Recranet\OTA\Type\TravelerInformationType[]
     */
     ...
     * Identifies pricing source, if negotiated fares are requested and if it is a reprice request.
     *
     * @return \Recranet\OTA\Type\TravelerInfoSummaryType\PriceRequestInformationAType
     */
     ...
     * Identifies pricing source, if negotiated fares are requested and if it is a reprice request.
     *
     * @param \Recranet\OTA\Type\TravelerInfoSummaryType\PriceRequestInformationAType $priceRequestInformation
     * @return self
     */
    public function setPriceRequestInformation(?\Recranet\OTA\Type\TravelerInfoSummaryType\PriceRequestInformationAType $priceRequestInformation = null)
    {
