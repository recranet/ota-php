...
namespace Recranet\OTA\Type\OTAHotelPostEventRS;

/**
 * Class representing OTAHotelPostEventRSAType
 */
class OTAHotelPostEventRSAType
{
    /**
    ...
    /**
     * The presence of the empty Success element explicitly indicates that the request message was successfully processed.
     *
     ...
     *
     * @var \Recranet\OTA\Type\EventReportType[] $eventReports
     */
     ...
     */
    public function addToEventReports(\Recranet\OTA\Type\EventReportType $eventReport)
    {
     ...
     * Collection of event reports.
     *
     * @param \Recranet\OTA\Type\EventReportType[] $eventReports
     * @return self
     */
