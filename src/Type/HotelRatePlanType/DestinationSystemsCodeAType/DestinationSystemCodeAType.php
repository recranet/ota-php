...
namespace Recranet\OTA\Type\HotelRatePlanType\DestinationSystemsCodeAType;
...
class DestinationSystemCodeAType
{
     ...
     *
     * @var string $chainRateLevelCrossRef
     */
     ...
     *
     * @var string $chainRateCodeCrossRef
     */
    private $chainRateCodeCrossRef = null;

    /**
     * A text field used to define a specific destination system value which represents a rule for Length of Stay settings.
     *
     * @var string $lengthOfStayRuleID
     */
    private $lengthOfStayRuleID = null;

    /**
     * A text field used to define a specific destination system value which represents a rule for defined viewership settings.
     *
     * @var string $pOSRuleID
     */
    private $pOSRuleID = null;

    /**
     * A text field used to define a specific destination system value which represents a special ID used for defined viewership settings.
     *
     * @var string $rateAccessID
     */
    private $rateAccessID = null;

    /**
     * A text field used to define a specific destination system value which represents a rule for deposits.
     *
     * @var string $guaranteeDepositRuleID
     */
    private $guaranteeDepositRuleID = null;

    /**
     * A text field used to define a specific destination system value which represents a rule for cancellations.
     *
     * @var string $cancelRuleID
     */
