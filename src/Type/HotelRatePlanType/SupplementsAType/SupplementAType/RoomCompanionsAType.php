...
namespace Recranet\OTA\Type\HotelRatePlanType\SupplementsAType\SupplementAType;
...
class RoomCompanionsAType
{
    ...
    /**
     * The minimum number of guests of the specified age group required in the room in order to apply this supplement.
     *
     * @var int $minCompanions
     */
    private $minCompanions = null;

    /**
     * The maximum number of guests of the specified age group permitted in the room in order to apply this supplement.
     *
     * @var int $maxCompanions
     */
