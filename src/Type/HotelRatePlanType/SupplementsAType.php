...
class SupplementsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\HotelRatePlanType\SupplementsAType\SupplementAType[] $supplement
     */
    private $supplement = [
     ...
     */
    public function addToSupplement(\Recranet\OTA\Type\HotelRatePlanType\SupplementsAType\SupplementAType $supplement)
    {
