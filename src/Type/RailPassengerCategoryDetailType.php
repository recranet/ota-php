...
class RailPassengerCategoryDetailType extends RailPassengerCategoryType
{
     ...
     *
     * @var \Recranet\OTA\Type\RailPassengerDetailType[] $passengerDetail
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPassengerDetailType $passengerDetail
     */
    public function addToPassengerDetail(\Recranet\OTA\Type\RailPassengerDetailType $passengerDetail)
    {
     ...
     * Passenger details including loyalty program, personal identification and email address.
     *
     * @return \Recranet\OTA\Type\RailPassengerDetailType[]
     */
