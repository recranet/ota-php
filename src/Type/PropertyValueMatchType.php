...
class PropertyValueMatchType extends BasicPropertyInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\PropertyValueMatchType\SearchValueMatchAType[] $searchValueMatch
     */
     ...
     *
     * @var \Recranet\OTA\Type\PropertyValueMatchType\AmenitiesAType\AmenityAType[] $amenities
     */
     ...
     *
     * @var \Recranet\OTA\Type\PropertyValueMatchType\RateRangeAType $rateRange
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PropertyValueMatchType\SearchValueMatchAType $searchValueMatch
     */
    public function addToSearchValueMatch(\Recranet\OTA\Type\PropertyValueMatchType\SearchValueMatchAType $searchValueMatch)
    {
     ...
     * The string value used to search for a property is returned. The SearchValueMatch element returns the input value and offers systems the ability to generate text in the Warnings that communicate the reason for failure to locate a hotel. For example, a Reference Point search may return the following processing message; "No hotels found within 5 miles of Oswego Regional Airport".
     *
     * @return \Recranet\OTA\Type\PropertyValueMatchType\SearchValueMatchAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PropertyValueMatchType\AmenitiesAType\AmenityAType $amenity
     */
    public function addToAmenities(\Recranet\OTA\Type\PropertyValueMatchType\AmenitiesAType\AmenityAType $amenity)
    {
     ...
     * A collection of available amenities.
     *
     * @return \Recranet\OTA\Type\PropertyValueMatchType\AmenitiesAType\AmenityAType[]
     */
     ...
     * A collection of available amenities.
     *
     * @param \Recranet\OTA\Type\PropertyValueMatchType\AmenitiesAType\AmenityAType[] $amenities
     * @return self
     */
     ...
     * Used to provide the minimum and maximum range of rates at this hotel property.
     *
     * @return \Recranet\OTA\Type\PropertyValueMatchType\RateRangeAType
     */
     ...
     * Used to provide the minimum and maximum range of rates at this hotel property.
     *
     * @param \Recranet\OTA\Type\PropertyValueMatchType\RateRangeAType $rateRange
     * @return self
     */
    public function setRateRange(?\Recranet\OTA\Type\PropertyValueMatchType\RateRangeAType $rateRange = null)
    {
