...
namespace Recranet\OTA\Type\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType;
...
class TransientRFPRequestSegmentAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AddressPrefType $hotelAddress
     */
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType\TransientRFPRequestSegmentAType\AccountSpecificInfoAType $accountSpecificInfo
     */
     ...
     * May be used in conjuction with the HotelName attribute found in TransientRFP_RequestSegment to specify a particular hotel, or simply to pass hotel address information.
     *
     * @param \Recranet\OTA\Type\AddressPrefType $hotelAddress
     * @return self
     */
    public function setHotelAddress(?\Recranet\OTA\Type\AddressPrefType $hotelAddress = null)
    {
     ...
     * Used to specify information that is specific to the requesting account.
     *
     * @return \Recranet\OTA\Type\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType\TransientRFPRequestSegmentAType\AccountSpecificInfoAType
     */
     ...
     * Used to specify information that is specific to the requesting account.
     *
     * @param \Recranet\OTA\Type\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType\TransientRFPRequestSegmentAType\AccountSpecificInfoAType $accountSpecificInfo
     * @return self
     */
    public function setAccountSpecificInfo(?\Recranet\OTA\Type\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType\TransientRFPRequestSegmentAType\AccountSpecificInfoAType $accountSpecificInfo = null)
    {
