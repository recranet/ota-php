...
class StayInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\LoyaltyPointsAccrualsType\SelectedLoyaltyAType[] $loyaltyPointsAccruals
     */
     ...
     *
     * @var \Recranet\OTA\Type\RevenueCategoryType[] $revenueCategories
     */
     ...
     *
     * @var \Recranet\OTA\Type\HotelReservationType $hotelReservation
     */
     ...
     */
    public function addToLoyaltyPointsAccruals(\Recranet\OTA\Type\LoyaltyPointsAccrualsType\SelectedLoyaltyAType $selectedLoyalty)
    {
     ...
     * A collection of loyalty points accruals.
     *
     * @param \Recranet\OTA\Type\LoyaltyPointsAccrualsType\SelectedLoyaltyAType[] $loyaltyPointsAccruals
     * @return self
     */
     ...
     */
    public function addToRevenueCategories(\Recranet\OTA\Type\RevenueCategoryType $revenueCategory)
    {
     ...
     * A collection of RevenueCategory classes that detail the categories of revenue data associated with the StayInfo report.
     *
     * @param \Recranet\OTA\Type\RevenueCategoryType[] $revenueCategories
     * @return self
     */
     ...
     * @return self
     */
    public function setReservationID(?\Recranet\OTA\Type\UniqueIDType $reservationID = null)
    {
     ...
     * Contains the reservation details associated with the stay information.
     *
     * @param \Recranet\OTA\Type\HotelReservationType $hotelReservation
     * @return self
     */
    public function setHotelReservation(?\Recranet\OTA\Type\HotelReservationType $hotelReservation = null)
    {
