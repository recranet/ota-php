...
class TourCodePrefAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\TourCodeInfoAType $tourCodeInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\StaffTourCodeInfoAType $staffTourCodeInfo
     */
     ...
     * Provides the tour code.
     *
     * @return \Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\TourCodeInfoAType
     */
     ...
     * Provides the tour code.
     *
     * @param \Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\TourCodeInfoAType $tourCodeInfo
     * @return self
     */
    public function setTourCodeInfo(?\Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\TourCodeInfoAType $tourCodeInfo = null)
    {
     ...
     * Provides a tour code for airline staff.
     *
     * @return \Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\StaffTourCodeInfoAType
     */
     ...
     * Provides a tour code for airline staff.
     *
     * @param \Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\StaffTourCodeInfoAType $staffTourCodeInfo
     * @return self
     */
    public function setStaffTourCodeInfo(?\Recranet\OTA\Type\AirlinePrefType\TourCodePrefAType\StaffTourCodeInfoAType $staffTourCodeInfo = null)
    {
