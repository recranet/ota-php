...
class AccountInformationAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirlinePrefType\AccountInformationAType\TaxRegistrationDetailsAType $taxRegistrationDetails
     */
     ...
     * Ticketing Goods and Services Tax (GST) details (typically the Australian market).
     *
     * @return \Recranet\OTA\Type\AirlinePrefType\AccountInformationAType\TaxRegistrationDetailsAType
     */
     ...
     * Ticketing Goods and Services Tax (GST) details (typically the Australian market).
     *
     * @param \Recranet\OTA\Type\AirlinePrefType\AccountInformationAType\TaxRegistrationDetailsAType $taxRegistrationDetails
     * @return self
     */
    public function setTaxRegistrationDetails(?\Recranet\OTA\Type\AirlinePrefType\AccountInformationAType\TaxRegistrationDetailsAType $taxRegistrationDetails = null)
    {
