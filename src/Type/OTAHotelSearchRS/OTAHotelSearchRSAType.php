...
namespace Recranet\OTA\Type\OTAHotelSearchRS;
...
class OTAHotelSearchRSAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PropertiesType\PropertyAType[] $properties
     */
     ...
     */
    public function addToProperties(\Recranet\OTA\Type\PropertiesType\PropertyAType $property)
    {
     ...
     * A collection of individual property information.
     *
     * @param \Recranet\OTA\Type\PropertiesType\PropertyAType[] $properties
     * @return self
     */
     ...
     * @return self
     */
    public function setCriteria(?\Recranet\OTA\Type\HotelSearchCriteriaType $criteria = null)
    {
