...
namespace Recranet\OTA\Type\SellableProductsType;
...
class SellableProductAType
{
     ...
     *
     * @var \Recranet\OTA\Type\SellableProductsType\SellableProductAType\DestinationSystemCodesAType\DestinationSystemCodeAType[] $destinationSystemCodes
     */
     ...
     *
     * @var \Recranet\OTA\Type\GuestRoomType $guestRoom
     */
     ...
     *
     * @var \Recranet\OTA\Type\MeetingRoomsType $meetingRooms
     */
     ...
     *
     * @var \Recranet\OTA\Type\SellableProductsType\SellableProductAType\InventoryBlockAType $inventoryBlock
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SellableProductsType\SellableProductAType\DestinationSystemCodesAType\DestinationSystemCodeAType $destinationSystemCode
     */
    public function addToDestinationSystemCodes(\Recranet\OTA\Type\SellableProductsType\SellableProductAType\DestinationSystemCodesAType\DestinationSystemCodeAType $destinationSystemCode)
    {
     ...
     * A collection of destination system codes. These are systems for which this Sellable product is targeted.
     *
     * @return \Recranet\OTA\Type\SellableProductsType\SellableProductAType\DestinationSystemCodesAType\DestinationSystemCodeAType[]
     */
     ...
     * A collection of destination system codes. These are systems for which this Sellable product is targeted.
     *
     * @param \Recranet\OTA\Type\SellableProductsType\SellableProductAType\DestinationSystemCodesAType\DestinationSystemCodeAType[] $destinationSystemCodes
     * @return self
     */
     ...
     * Guest room information if this sellable product is a guest room.
     *
     * @return \Recranet\OTA\Type\GuestRoomType
     */
     ...
     * Guest room information if this sellable product is a guest room.
     *
     * @param \Recranet\OTA\Type\GuestRoomType $guestRoom
     * @return self
     */
    public function setGuestRoom(?\Recranet\OTA\Type\GuestRoomType $guestRoom = null)
    {
     ...
     * Meeting room information if this sellable product is a meeting room.
     *
     * @return \Recranet\OTA\Type\MeetingRoomsType
     */
     ...
     * Meeting room information if this sellable product is a meeting room.
     *
     * @param \Recranet\OTA\Type\MeetingRoomsType $meetingRooms
     * @return self
     */
    public function setMeetingRooms(?\Recranet\OTA\Type\MeetingRoomsType $meetingRooms = null)
    {
     ...
     * Inventory block information if this sellable product is an inventory block.
     *
     * @return \Recranet\OTA\Type\SellableProductsType\SellableProductAType\InventoryBlockAType
     */
     ...
     * Inventory block information if this sellable product is an inventory block.
     *
     * @param \Recranet\OTA\Type\SellableProductsType\SellableProductAType\InventoryBlockAType $inventoryBlock
     * @return self
     */
    public function setInventoryBlock(?\Recranet\OTA\Type\SellableProductsType\SellableProductAType\InventoryBlockAType $inventoryBlock = null)
    {
