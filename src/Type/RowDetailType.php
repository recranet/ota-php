...
class RowDetailType
{
     ...
     * Row characteristics.
     *
     * @var \Recranet\OTA\Type\RowCharacteristicsType[] $characteristics
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RowCharacteristicsType $characteristics
     */
    public function addToCharacteristics(\Recranet\OTA\Type\RowCharacteristicsType $characteristics)
    {
     ...
     * Row characteristics.
     *
     * @return \Recranet\OTA\Type\RowCharacteristicsType[]
     */
     ...
     */
    public function addToSeatInfo(\Recranet\OTA\Type\SeatDetailsType $seatInfo)
    {
