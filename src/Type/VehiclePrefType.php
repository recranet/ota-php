...
class VehiclePrefType extends VehicleCoreType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehiclePrefType\VehMakeModelAType $vehMakeModel
     */
     ...
     * The make and model of the vehicle (e.g., Ford Focus). The Code attribute may be used for the SIPP code.
     *
     * @return \Recranet\OTA\Type\VehiclePrefType\VehMakeModelAType
     */
     ...
     * The make and model of the vehicle (e.g., Ford Focus). The Code attribute may be used for the SIPP code.
     *
     * @param \Recranet\OTA\Type\VehiclePrefType\VehMakeModelAType $vehMakeModel
     * @return self
     */
    public function setVehMakeModel(?\Recranet\OTA\Type\VehiclePrefType\VehMakeModelAType $vehMakeModel = null)
    {
