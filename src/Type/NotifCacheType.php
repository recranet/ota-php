...
class NotifCacheType
{
     ...
     *
     * @var \Recranet\OTA\Type\NotifCacheType\TimeSpanAType $timeSpan
     */
     ...
     *
     * @var \Recranet\OTA\Type\NotifCacheType\ProductInfoAType $productInfo
     */
     ...
     * The start and end date of information that should be updated in the cache for the associated @HotelCode and an optional "change date mask" that indicates if there are changes in all or a portion of the returned date range.
     *
     * @return \Recranet\OTA\Type\NotifCacheType\TimeSpanAType
     */
     ...
     * The start and end date of information that should be updated in the cache for the associated @HotelCode and an optional "change date mask" that indicates if there are changes in all or a portion of the returned date range.
     *
     * @param \Recranet\OTA\Type\NotifCacheType\TimeSpanAType $timeSpan
     * @return self
     */
    public function setTimeSpan(\Recranet\OTA\Type\NotifCacheType\TimeSpanAType $timeSpan)
    {
     ...
     * Other product information that may be returned.
     *
     * @return \Recranet\OTA\Type\NotifCacheType\ProductInfoAType
     */
     ...
     * Other product information that may be returned.
     *
     * @param \Recranet\OTA\Type\NotifCacheType\ProductInfoAType $productInfo
     * @return self
     */
    public function setProductInfo(?\Recranet\OTA\Type\NotifCacheType\ProductInfoAType $productInfo = null)
    {
