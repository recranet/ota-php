...
class GuestRoomsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\FacilityInfoType\GuestRoomsAType\GuestRoomAType[] $guestRoom
     */
    private $guestRoom = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FacilityInfoType\GuestRoomsAType\GuestRoomAType $guestRoom
     */
    public function addToGuestRoom(\Recranet\OTA\Type\FacilityInfoType\GuestRoomsAType\GuestRoomAType $guestRoom)
    {
     ...
     * The accommodation occupied by a guest.
     *
     * @return \Recranet\OTA\Type\FacilityInfoType\GuestRoomsAType\GuestRoomAType[]
     */
