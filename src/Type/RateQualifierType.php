...
class RateQualifierType
{
     ...
     *
     * @var \Recranet\OTA\Type\RateQualifierType\RateCommentsAType\RateCommentAType[] $rateComments
     */
     ...
     */
    public function addToRateComments(\Recranet\OTA\Type\RateQualifierType\RateCommentsAType\RateCommentAType $rateComment)
    {
     ...
     * Collection of rate comments.
     *
     * @param \Recranet\OTA\Type\RateQualifierType\RateCommentsAType\RateCommentAType[] $rateComments
     * @return self
     */
