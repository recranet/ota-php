...
class SSRPrefAType
{
    ...
    /**
     * Code of the special service request to be used for this rail travel situation. Refers to standard industry code list.
     *
     * @var string $sSRCode
     */
    ...
    /**
     * The default status from the rail operators. Refer to the OpenTravel Code List named Status (STS).
     *
     * @var string $defaultStatusCode
     */
