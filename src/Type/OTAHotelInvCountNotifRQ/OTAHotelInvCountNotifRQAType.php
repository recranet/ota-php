...
namespace Recranet\OTA\Type\OTAHotelInvCountNotifRQ;

/**
 * Class representing OTAHotelInvCountNotifRQAType
 */
class OTAHotelInvCountNotifRQAType
{
    /**
     ...
     * @return self
     */
    public function setInventories(\Recranet\OTA\Type\InvCountType $inventories)
    {
