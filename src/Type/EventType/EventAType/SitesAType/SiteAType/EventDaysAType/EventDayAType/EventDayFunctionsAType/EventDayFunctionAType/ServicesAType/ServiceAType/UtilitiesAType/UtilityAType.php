...
namespace Recranet\OTA\Type\EventType\EventAType\SitesAType\SiteAType\EventDaysAType\EventDayAType\EventDayFunctionsAType\EventDayFunctionAType\ServicesAType\ServiceAType\UtilitiesAType;
...
{
    /**
     * The type of this utility (e.g., air, drain, natural gas). Refer to OpenTravel Code list Utility Service Code (USC).
     *
     * @var string $code
     */
    private $code = null;
    ...
    /**
     * A telecommunication service (e.g., analog phone line, ethernet connection). Refer to OpenTravel Code list Business Srvc Type (BUS).
     *
