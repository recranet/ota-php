...
namespace Recranet\OTA\Type\EventType\EventAType\SitesAType\SiteAType\EventDaysAType\EventDayAType\ServicesAType;
...
class ServiceAType
{
    ...
    /**
     * Identifies a meeting or business service (e.g. security, first aid). Refer to OpenTravel Codelist Meeting Room Code (MRC).
     *
     * @var string $code
     */
    private $code = null;
