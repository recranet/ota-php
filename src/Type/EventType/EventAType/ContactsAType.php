...
class ContactsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\EventType\EventAType\ContactsAType\ContactAType[] $contact
     */
    private $contact = [
     ...
     */
    public function addToContact(\Recranet\OTA\Type\EventType\EventAType\ContactsAType\ContactAType $contact)
    {
