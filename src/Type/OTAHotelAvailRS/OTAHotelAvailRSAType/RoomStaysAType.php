...
class RoomStaysAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType\RoomStayAType[] $roomStay
     */
    private $roomStay = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType\RoomStayAType $roomStay
     */
    public function addToRoomStay(\Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType\RoomStayAType $roomStay)
    {
     ...
     * Details on the Room Stay including Guest Counts, Time Span of this Room Stay, and financial information related to the Room Stay, including Guarantee, Deposit and Payment and Cancellation Penalties.
     *
     * @return \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType\RoomStayAType[]
     */
