...
namespace Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\CurrencyConversionsAType;
...
class CurrencyConversionAType
{
    ...
    /**
     * Indicates the number of decimal places for the requested currency. This is equivalent to the ISO 4217 standard "minor unit".
     *
