...
class HotelStaysAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType[] $hotelStay
     */
    private $hotelStay = [
     ...
     */
    public function addToHotelStay(\Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType $hotelStay)
    {
