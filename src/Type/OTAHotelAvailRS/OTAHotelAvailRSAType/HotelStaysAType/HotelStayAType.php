...
namespace Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType;
...
class HotelStayAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\AvailabilityAType[] $availability
     */
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\PriceAType[] $price
     */
    private $price = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\AvailabilityAType $availability
     */
    public function addToAvailability(\Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\AvailabilityAType $availability)
    {
     ...
     * Details on the hotel stay including the type of availabilty and the date range for which it applies.
     *
     * @return \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\AvailabilityAType[]
     */
     ...
     * @return self
     */
    public function setBasicPropertyInfo(?\Recranet\OTA\Type\BasicPropertyInfoType $basicPropertyInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\PriceAType $price
     */
    public function addToPrice(\Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\PriceAType $price)
    {
        $this->price[] = $price;
        return $this;
    }
     ...
     * Pricing for the hotel stay including the date range for which it applies.
     *
     * @return \Recranet\OTA\Type\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType\PriceAType[]
     */
