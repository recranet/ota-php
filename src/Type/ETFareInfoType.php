...
class ETFareInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\ETFareInfoType\WaiverAType[] $waiver
     */
    private $waiver = [
     ...
     *
     * @var \Recranet\OTA\Type\ETFareInfoType\RuleIndicatorAType[] $ruleIndicator
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ETFareInfoType\WaiverAType $waiver
     */
    public function addToWaiver(\Recranet\OTA\Type\ETFareInfoType\WaiverAType $waiver)
    {
        $this->waiver[] = $waiver;
        return $this;
    }
     ...
     * A code assigned by the validating carrier that allows fare rule modification or override.
     *
     * @return \Recranet\OTA\Type\ETFareInfoType\WaiverAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ETFareInfoType\RuleIndicatorAType $ruleIndicator
     */
    public function addToRuleIndicator(\Recranet\OTA\Type\ETFareInfoType\RuleIndicatorAType $ruleIndicator)
    {
     ...
     * System generated data indicating the ticket fare is an ATPCO Category number fare.
     *
     * @return \Recranet\OTA\Type\ETFareInfoType\RuleIndicatorAType[]
     */
