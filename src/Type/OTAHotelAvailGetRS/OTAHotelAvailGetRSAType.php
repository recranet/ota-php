...
namespace Recranet\OTA\Type\OTAHotelAvailGetRS;
...
class OTAHotelAvailGetRSAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailGetRS\OTAHotelAvailGetRSAType\AvailStatusMessagesAType $availStatusMessages
     */
     ...
     * Container for the individual AvailStatusMessage(s). An OTA_HotelAvailGetRS contains the availability statuses for a single hotel. Hotel identification information are the attributes of this element.
     *
     * @return \Recranet\OTA\Type\OTAHotelAvailGetRS\OTAHotelAvailGetRSAType\AvailStatusMessagesAType
     */
     ...
     * Container for the individual AvailStatusMessage(s). An OTA_HotelAvailGetRS contains the availability statuses for a single hotel. Hotel identification information are the attributes of this element.
     *
     * @param \Recranet\OTA\Type\OTAHotelAvailGetRS\OTAHotelAvailGetRSAType\AvailStatusMessagesAType $availStatusMessages
     * @return self
     */
    public function setAvailStatusMessages(?\Recranet\OTA\Type\OTAHotelAvailGetRS\OTAHotelAvailGetRSAType\AvailStatusMessagesAType $availStatusMessages = null)
    {
