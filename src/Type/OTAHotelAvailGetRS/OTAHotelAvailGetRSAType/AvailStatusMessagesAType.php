...
namespace Recranet\OTA\Type\OTAHotelAvailGetRS\OTAHotelAvailGetRSAType;
...
class AvailStatusMessagesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AvailStatusMessageType[] $availStatusMessage
     */
    private $availStatusMessage = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AvailStatusMessageType $availStatusMessage
     */
    public function addToAvailStatusMessage(\Recranet\OTA\Type\AvailStatusMessageType $availStatusMessage)
    {
     ...
     * The RateHurdleStatusMessage class defines the setting for rate hurdle controls to be synchronized with the central reservation system.
     *
     * @return \Recranet\OTA\Type\AvailStatusMessageType[]
     */
     ...
     * @return self
     */
    public function setAvailStatusMessage(array $availStatusMessage = null)
    {
        $this->availStatusMessage = $availStatusMessage;
        return $this;
    }
