...
class SeatMapDetailsType
{
     ...
     *
     * @var \Recranet\OTA\Type\SeatMapDetailsType\CabinClassAType[] $cabinClass
     */
    private $cabinClass = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SeatMapDetailsType\CabinClassAType $cabinClass
     */
    public function addToCabinClass(\Recranet\OTA\Type\SeatMapDetailsType\CabinClassAType $cabinClass)
    {
     ...
     * Describes the Cabin details in a seat map.
     *
     * @return \Recranet\OTA\Type\SeatMapDetailsType\CabinClassAType[]
     */
