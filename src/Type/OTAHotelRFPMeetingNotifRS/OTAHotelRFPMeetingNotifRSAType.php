...
namespace Recranet\OTA\Type\OTAHotelRFPMeetingNotifRS;

/**
 * Class representing OTAHotelRFPMeetingNotifRSAType
 */
class OTAHotelRFPMeetingNotifRSAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelRFPMeetingNotifRS\OTAHotelRFPMeetingNotifRSAType\MessageIDAType $messageID
     */
     ...
     * Corresponds to the MessageID used in OTA_HotelRFP_RQ.xsd and OTA_HotelRFP_NotifRQ.xsd. This is a UniqueID that is associated with the request message.
     *
     * @return \Recranet\OTA\Type\OTAHotelRFPMeetingNotifRS\OTAHotelRFPMeetingNotifRSAType\MessageIDAType
     */
     ...
     * Corresponds to the MessageID used in OTA_HotelRFP_RQ.xsd and OTA_HotelRFP_NotifRQ.xsd. This is a UniqueID that is associated with the request message.
     *
     * @param \Recranet\OTA\Type\OTAHotelRFPMeetingNotifRS\OTAHotelRFPMeetingNotifRSAType\MessageIDAType $messageID
     * @return self
     */
    public function setMessageID(?\Recranet\OTA\Type\OTAHotelRFPMeetingNotifRS\OTAHotelRFPMeetingNotifRSAType\MessageIDAType $messageID = null)
    {
