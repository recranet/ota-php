...
class LengthsOfStayType
{
     ...
     *
     * @var \Recranet\OTA\Type\LengthsOfStayType\LengthOfStayAType[] $lengthOfStay
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\LengthsOfStayType\LengthOfStayAType $lengthOfStay
     */
    public function addToLengthOfStay(\Recranet\OTA\Type\LengthsOfStayType\LengthOfStayAType $lengthOfStay)
    {
     ...
     * A collection of patterns defining allowable lengths of stay (LOS).
     *
     * @return \Recranet\OTA\Type\LengthsOfStayType\LengthOfStayAType[]
     */
