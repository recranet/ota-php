...
class TextDescriptionType
{
     ...
     *
     * @var \Recranet\OTA\Type\TextDescriptionType\DescriptionAType[] $description
     */
    private $description = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\TextDescriptionType\DescriptionAType $description
     */
    public function addToDescription(\Recranet\OTA\Type\TextDescriptionType\DescriptionAType $description)
    {
     ...
     * The text in a specific language.
     *
     * @return \Recranet\OTA\Type\TextDescriptionType\DescriptionAType[]
     */
