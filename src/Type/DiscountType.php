...
class DiscountType extends TotalType
{
    ...
    /**
     * @var \Recranet\OTA\Type\ParagraphType $discountReason
     */
     ...
     *
     * @param \Recranet\OTA\Type\ParagraphType $discountReason
     * @return self
     */
    public function setDiscountReason(\Recranet\OTA\Type\ParagraphType $discountReason)
    {
