...
class RFPTransientResponseType
{
    ...
    /**
     * Provides the method and time for when the detailed response should be expected as well as other information.
     *
     * @var \Recranet\OTA\Type\RFPResponseDetailType $rFPResponseDetail
     */
    private $rFPResponseDetail = null;

    /**
     * Provides the details associated with a hotel (e.g. the amenities and services provided and distance to local attractions.)
     *
     * @var \Recranet\OTA\Type\HotelDescriptiveContentType $hotelDescription
     */
     ...
     *
     * @var \Recranet\OTA\Type\AccountSpecificInformationType $accountSpecificInformation
     */
     ...
     * Provides the method and time for when the detailed response should be expected as well as other information.
     *
     * @param \Recranet\OTA\Type\RFPResponseDetailType $rFPResponseDetail
     * @return self
     */
    public function setRFPResponseDetail(?\Recranet\OTA\Type\RFPResponseDetailType $rFPResponseDetail = null)
    {
     ...
     * Provides the details associated with a hotel (e.g. the amenities and services provided and distance to local attractions.)
     *
     * @return \Recranet\OTA\Type\HotelDescriptiveContentType
     */
     ...
     * Provides the details associated with a hotel (e.g. the amenities and services provided and distance to local attractions.)
     *
     * @param \Recranet\OTA\Type\HotelDescriptiveContentType $hotelDescription
     * @return self
     */
    public function setHotelDescription(?\Recranet\OTA\Type\HotelDescriptiveContentType $hotelDescription = null)
    {
     ...
     * Defines the information that is specific to the RFP for this account.
     *
     * @return \Recranet\OTA\Type\AccountSpecificInformationType
     */
     ...
     * Defines the information that is specific to the RFP for this account.
     *
     * @param \Recranet\OTA\Type\AccountSpecificInformationType $accountSpecificInformation
     * @return self
     */
    public function setAccountSpecificInformation(?\Recranet\OTA\Type\AccountSpecificInformationType $accountSpecificInformation = null)
    {
