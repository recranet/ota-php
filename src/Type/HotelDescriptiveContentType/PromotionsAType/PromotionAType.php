...
namespace Recranet\OTA\Type\HotelDescriptiveContentType\PromotionsAType;
...
class PromotionAType
{
     ...
     *
     * @var \Recranet\OTA\Type\DescriptionType $description
     */
     ...
     * A description of a promotion.
     *
     * @return \Recranet\OTA\Type\DescriptionType
     */
     ...
     * A description of a promotion.
     *
     * @param \Recranet\OTA\Type\DescriptionType $description
     * @return self
     */
    public function setDescription(?\Recranet\OTA\Type\DescriptionType $description = null)
    {
