...
namespace Recranet\OTA\Type\OTAHotelRoomListRQ;

/**
 * Class representing OTAHotelRoomListRQAType
 */
class OTAHotelRoomListRQAType
{
    /**
    ...
    /**
     * Identifies the group overall for example the association, tour operator, etc. This is independent of Hotel identification.
     *
     ...
     *
     * @var \Recranet\OTA\Type\HotelRoomListType[] $hotelRoomLists
     */
     ...
     */
    public function addToHotelRoomLists(\Recranet\OTA\Type\HotelRoomListType $hotelRoomList)
    {
     ...
     * Collection of RoomList items which may be for multiple hotels or for multiple groups at a single hotel.
     *
     * @param \Recranet\OTA\Type\HotelRoomListType[] $hotelRoomLists
     * @return self
     */
