...
class MethodInfoAType
{
     ...
     *
     * @var \Recranet\OTA\Type\BillingInstructionType $billingInstruction
     */
     ...
     * Billing instruction information.
     *
     * @return \Recranet\OTA\Type\BillingInstructionType
     */
     ...
     * Billing instruction information.
     *
     * @param \Recranet\OTA\Type\BillingInstructionType $billingInstruction
     * @return self
     */
    public function setBillingInstruction(?\Recranet\OTA\Type\BillingInstructionType $billingInstruction = null)
    {
