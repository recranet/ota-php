...
namespace Recranet\OTA\Type\RefPointsType;

use Recranet\OTA\Type\RelativePositionType;
...
{
    /**
     * The code for the type of reference point in the proximity of the hotel facility. Refer to OpenTravel Code List Reference Point Category Code (REF).
     *
     * @var string $refPointCategoryCode
     */
    private $refPointCategoryCode = null;

    /**
     * This may be used to indicate the proximity (e.g., closest, second closest) between the reference point and the hotel. This may be used in conjunction with RefPointCategoryCode.
     *
     ...
     *
     * @var string $altitudeUnitOfMeasureCode
     */
     ...
     *
     * @var string $positionAccuracyCode
     */
    ...
    /**
     * This attribute is used to explicitly define whether the reference point applies. Refer to OpenTravel Code list Option Type Code (OTC). This is used in conjunction with RefPointCategoryCode.
     *
