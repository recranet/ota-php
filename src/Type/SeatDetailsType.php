...
class SeatDetailsType
{
     ...
     *
     * @var \Recranet\OTA\Type\SeatSummaryType $summary
     */
     ...
     *
     * @var \Recranet\OTA\Type\SeatDetailsType\AmenityAType[] $amenity
     */
    private $amenity = [
     ...
     *
     * @var \Recranet\OTA\Type\AirSeatAvailabilityType $availability
     */
     ...
     *
     * @var \Recranet\OTA\Type\SeatDetailsType\ServiceAType[] $service
     */
    private $service = [
     ...
     * Summary seat information.
     *
     * @return \Recranet\OTA\Type\SeatSummaryType
     */
     ...
     * Summary seat information.
     *
     * @param \Recranet\OTA\Type\SeatSummaryType $summary
     * @return self
     */
    public function setSummary(?\Recranet\OTA\Type\SeatSummaryType $summary = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SeatDetailsType\AmenityAType $amenity
     */
    public function addToAmenity(\Recranet\OTA\Type\SeatDetailsType\AmenityAType $amenity)
    {
     ...
     * Amenities associated with a seat with optional fees.
     *
     * @return \Recranet\OTA\Type\SeatDetailsType\AmenityAType[]
     */
     ...
     * The seat availability. Select an item from the list or select the "Other_" value and enter a value known to trading partners in the @extension attribute.
     *
     * @return \Recranet\OTA\Type\AirSeatAvailabilityType
     */
     ...
     * The seat availability. Select an item from the list or select the "Other_" value and enter a value known to trading partners in the @extension attribute.
     *
     * @param \Recranet\OTA\Type\AirSeatAvailabilityType $availability
     * @return self
     */
    public function setAvailability(?\Recranet\OTA\Type\AirSeatAvailabilityType $availability = null)
    {
     ...
     */
    public function addToDescription(\Recranet\OTA\Type\FormattedTextTextType $description)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SeatDetailsType\ServiceAType $service
     */
    public function addToService(\Recranet\OTA\Type\SeatDetailsType\ServiceAType $service)
    {
     ...
     * Service(s) associated with a seat with optional fees.
     *
     * @return \Recranet\OTA\Type\SeatDetailsType\ServiceAType[]
     */
