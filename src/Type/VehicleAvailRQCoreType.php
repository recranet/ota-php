...
class VehicleAvailRQCoreType
{
     ...
     *
     * @var \Recranet\OTA\Type\MultiModalOfferType $multimodalOffer
     */
     ...
     * Vendor preferences.
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQCoreType\VendorPrefsAType $vendorPrefs
     */
     ...
     * Vehicle preferences.
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQCoreType\VehPrefsAType\VehPrefAType[] $vehPrefs
     */
     ...
     * Driver category.
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQCoreType\DriverTypeAType[] $driverType
     */
    private $driverType = [
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQCoreType\RateQualifierAType[] $rateQualifier
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQCoreType\RateRangeAType $rateRange
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQCoreType\SpecialEquipPrefsAType\SpecialEquipPrefAType[] $specialEquipPrefs
     */
     ...
     * Multimodal offer influencers.
     *
     * @return \Recranet\OTA\Type\MultiModalOfferType
     */
     ...
     * Multimodal offer influencers.
     *
     * @param \Recranet\OTA\Type\MultiModalOfferType $multimodalOffer
     * @return self
     */
    public function setMultimodalOffer(?\Recranet\OTA\Type\MultiModalOfferType $multimodalOffer = null)
    {
     ...
     * Vendor preferences.
     *
     * @return \Recranet\OTA\Type\VehicleAvailRQCoreType\VendorPrefsAType
     */
     ...
     * Vendor preferences.
     *
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\VendorPrefsAType $vendorPrefs
     * @return self
     */
    public function setVendorPrefs(?\Recranet\OTA\Type\VehicleAvailRQCoreType\VendorPrefsAType $vendorPrefs = null)
    {
     ...
     */
    public function addToVehPrefs(\Recranet\OTA\Type\VehicleAvailRQCoreType\VehPrefsAType\VehPrefAType $vehPref)
    {
     ...
     * Vehicle preferences.
     *
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\VehPrefsAType\VehPrefAType[] $vehPrefs
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\DriverTypeAType $driverType
     */
    public function addToDriverType(\Recranet\OTA\Type\VehicleAvailRQCoreType\DriverTypeAType $driverType)
    {
     ...
     * Driver category.
     *
     * @return \Recranet\OTA\Type\VehicleAvailRQCoreType\DriverTypeAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\RateQualifierAType $rateQualifier
     */
    public function addToRateQualifier(\Recranet\OTA\Type\VehicleAvailRQCoreType\RateQualifierAType $rateQualifier)
    {
     ...
     * Rate qualifiers and promotions.
     *
     * @return \Recranet\OTA\Type\VehicleAvailRQCoreType\RateQualifierAType[]
     */
     ...
     * Minimum and maximum rate range.
     *
     * @return \Recranet\OTA\Type\VehicleAvailRQCoreType\RateRangeAType
     */
     ...
     * Minimum and maximum rate range.
     *
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\RateRangeAType $rateRange
     * @return self
     */
    public function setRateRange(?\Recranet\OTA\Type\VehicleAvailRQCoreType\RateRangeAType $rateRange = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\SpecialEquipPrefsAType\SpecialEquipPrefAType $specialEquipPref
     */
    public function addToSpecialEquipPrefs(\Recranet\OTA\Type\VehicleAvailRQCoreType\SpecialEquipPrefsAType\SpecialEquipPrefAType $specialEquipPref)
    {
     ...
     * Special equipment preferences.
     *
     * @return \Recranet\OTA\Type\VehicleAvailRQCoreType\SpecialEquipPrefsAType\SpecialEquipPrefAType[]
     */
     ...
     * Special equipment preferences.
     *
     * @param \Recranet\OTA\Type\VehicleAvailRQCoreType\SpecialEquipPrefsAType\SpecialEquipPrefAType[] $specialEquipPrefs
     * @return self
     */
