...
class ExchangeInfoAType
{
     ...
     *
     * @var \Recranet\OTA\Type\FareType\ExchangeInfoAType\CouponInfoAType[] $couponInfo
     */
    private $couponInfo = [
     ...
     *
     * @var \Recranet\OTA\Type\FareType\ExchangeInfoAType\OriginalOriginDestinationAType $originalOriginDestination
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareType\ExchangeInfoAType\CouponInfoAType $couponInfo
     */
    public function addToCouponInfo(\Recranet\OTA\Type\FareType\ExchangeInfoAType\CouponInfoAType $couponInfo)
    {
     ...
     * Optional information on coupon numbers being exchanged.
     *
     * @return \Recranet\OTA\Type\FareType\ExchangeInfoAType\CouponInfoAType[]
     */
     ...
     * The original origin and destination for exchanged ticket/documents.
     *
     * @return \Recranet\OTA\Type\FareType\ExchangeInfoAType\OriginalOriginDestinationAType
     */
     ...
     * The original origin and destination for exchanged ticket/documents.
     *
     * @param \Recranet\OTA\Type\FareType\ExchangeInfoAType\OriginalOriginDestinationAType $originalOriginDestination
     * @return self
     */
    public function setOriginalOriginDestination(?\Recranet\OTA\Type\FareType\ExchangeInfoAType\OriginalOriginDestinationAType $originalOriginDestination = null)
    {
