...
class RailAvailScheduleQueryType
{
     ...
     *
     * @var \Recranet\OTA\Type\RailOriginDestinationInformationType $originDestinationInformation
     */
     ...
     *
     * @var \Recranet\OTA\Type\TrainQueryType[] $railSearchCriteria
     */
     ...
     * Information on the locations between which schedules and/or availability are to be checked.
     *
     * @return \Recranet\OTA\Type\RailOriginDestinationInformationType
     */
     ...
     * Information on the locations between which schedules and/or availability are to be checked.
     *
     * @param \Recranet\OTA\Type\RailOriginDestinationInformationType $originDestinationInformation
     * @return self
     */
    public function setOriginDestinationInformation(\Recranet\OTA\Type\RailOriginDestinationInformationType $originDestinationInformation)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\TrainQueryType $railSearchCriteria
     */
    public function addToRailSearchCriteria(\Recranet\OTA\Type\TrainQueryType $railSearchCriteria)
    {
     ...
     * The rail search criteria which may be a train number/ network code combination or just a network code.
     *
     * @return \Recranet\OTA\Type\TrainQueryType[]
     */
