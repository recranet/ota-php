...
class RoomBlockAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\BudgetedRoomRateAType[] $budgetedRoomRate
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\ReservationMethodAType[] $reservationMethod
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\StayDaysAType $stayDays
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\BudgetedRoomRateAType $budgetedRoomRate
     */
    public function addToBudgetedRoomRate(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\BudgetedRoomRateAType $budgetedRoomRate)
    {
     ...
     * A general indication of the planner's budget for individual room nights and/or delegate rates.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\BudgetedRoomRateAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\ReservationMethodAType $reservationMethod
     */
    public function addToReservationMethod(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\ReservationMethodAType $reservationMethod)
    {
     ...
     * Contains information regarding the reservation method.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\ReservationMethodAType[]
     */
     ...
     * A collection of multiple StayDays.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\StayDaysAType
     */
     ...
     * A collection of multiple StayDays.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\StayDaysAType $stayDays
     * @return self
     */
    public function setStayDays(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType\StayDaysAType $stayDays = null)
    {
