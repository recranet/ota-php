...
class ProposalSpecificationAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\KeyDecisionFactorsAType\KeyDecisionFactorAType[] $keyDecisionFactors
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\PresentationAType $presentation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\KeyDecisionFactorsAType\KeyDecisionFactorAType $keyDecisionFactor
     */
    public function addToKeyDecisionFactors(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\KeyDecisionFactorsAType\KeyDecisionFactorAType $keyDecisionFactor)
    {
     ...
     * A collection of key decision factors used in the proposal evaluation.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\KeyDecisionFactorsAType\KeyDecisionFactorAType[]
     */
     ...
     * A collection of key decision factors used in the proposal evaluation.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\KeyDecisionFactorsAType\KeyDecisionFactorAType[] $keyDecisionFactors
     * @return self
     */
     ...
     * Used to provide information on where and when the sites should present their proposals to the meeting planners.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\PresentationAType
     */
     ...
     * Used to provide information on where and when the sites should present their proposals to the meeting planners.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\PresentationAType $presentation
     * @return self
     */
    public function setPresentation(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType\PresentationAType $presentation = null)
    {
