...
class EventBlockAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\FunctionSpaceReqAType $functionSpaceReq
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventBudgetAType[] $eventBudget
     */
    private $eventBudget = [
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType $eventDays
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\ExhibitionAType[] $exhibition
     */
    private $exhibition = [
     ...
     * Used to define requirements for function space for the event.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\FunctionSpaceReqAType
     */
     ...
     * Used to define requirements for function space for the event.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\FunctionSpaceReqAType $functionSpaceReq
     * @return self
     */
    public function setFunctionSpaceReq(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\FunctionSpaceReqAType $functionSpaceReq = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventBudgetAType $eventBudget
     */
    public function addToEventBudget(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventBudgetAType $eventBudget)
    {
     ...
     * A general indication of the planner's budget for the event.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventBudgetAType[]
     */
     ...
     * A collection of multiple EventDays.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType
     */
     ...
     * A collection of multiple EventDays.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType $eventDays
     * @return self
     */
    public function setEventDays(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType $eventDays = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\ExhibitionAType $exhibition
     */
    public function addToExhibition(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\ExhibitionAType $exhibition)
    {
     ...
     * Describes an event at which products and services are displayed, typically the primary activity of attendees is visiting exhibits on the show floor.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\ExhibitionAType[]
     */
