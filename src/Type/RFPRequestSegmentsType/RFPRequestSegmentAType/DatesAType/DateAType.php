...
namespace Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\DatesAType;
...
class DateAType extends DateTimeSpanType
{
    ...
    /**
     * This reference place holder refers to the promotion date range. This is used to link a particular promotion to a particular date range.
     *
     * @var string $promotionRPH
     */
