...
namespace Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\HistoriesAType\HistoryAType\DaySummariesAType;
...
{
    /**
     * The number which indicates the day of the previous room requirements and/or previous event (e.g. 1, 2, 3, etc).
     *
     * @var int $dayNumber
     */
