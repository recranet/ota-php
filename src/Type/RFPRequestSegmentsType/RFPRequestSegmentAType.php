...
namespace Recranet\OTA\Type\RFPRequestSegmentsType;
...
class RFPRequestSegmentAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType $proposalSpecification
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\DatesAType $dates
     */
    private $dates = null;
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType[] $sites
     */
    private $sites = null;
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType $roomBlock
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType $eventBlock
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\PreferencesAType\PreferenceAType[] $preferences
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\HistoriesAType\HistoryAType[] $histories
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RFPIDAType[] $rFPID
     */
    private $rFPID = [
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\AdditionalInfosAType\AdditionalInfoAType[] $additionalInfos
     */
     ...
     * Used to provide details on the proposal such as the key factors that will play a role in the proposal evaluation.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType
     */
     ...
     * Used to provide details on the proposal such as the key factors that will play a role in the proposal evaluation.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType $proposalSpecification
     * @return self
     */
    public function setProposalSpecification(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\ProposalSpecificationAType $proposalSpecification = null)
    {
     ...
     * A collection of dates which allows you to request preferred and/or alternate dates.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\DatesAType
     */
     ...
     * A collection of dates which allows you to request preferred and/or alternate dates.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\DatesAType $dates
     * @return self
     */
    public function setDates(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\DatesAType $dates)
    {
        $this->dates = $dates;
        return $this;
    }
     ...
     */
    public function addToSites(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType $site)
    {
        $this->sites[] = $site;
        return $this;
    }
     ...
     * A collection of sites for which the request is being submitted (e.g. a hotel, national sales office, convention center).
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType[] $sites
     * @return self
     */
     ...
     * This is information pertaining to room requirements for this request.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType
     */
     ...
     * This is information pertaining to room requirements for this request.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType $roomBlock
     * @return self
     */
    public function setRoomBlock(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RoomBlockAType $roomBlock = null)
    {
     ...
     * This is information pertaining to the event requirements for this request.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType
     */
     ...
     * This is information pertaining to the event requirements for this request.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType $eventBlock
     * @return self
     */
    public function setEventBlock(?\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType $eventBlock = null)
    {
     ...
     */
    public function addToPreferences(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\PreferencesAType\PreferenceAType $preference)
    {
     ...
     * Collection of preferences or requirements for the RFP.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\PreferencesAType\PreferenceAType[] $preferences
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\HistoriesAType\HistoryAType $history
     */
    public function addToHistories(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\HistoriesAType\HistoryAType $history)
    {
     ...
     * A collection of individual Histories.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\HistoriesAType\HistoryAType[]
     */
     ...
     * A collection of individual Histories.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\HistoriesAType\HistoryAType[] $histories
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RFPIDAType $rFPID
     */
    public function addToRFPID(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RFPIDAType $rFPID)
    {
        $this->rFPID[] = $rFPID;
        return $this;
    }
     ...
     * This is a UniqueID that is associated with an individual RFP. This element repeats to accommodate the IDs of multiple systems.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\RFPIDAType[]
     */
     ...
     */
    public function addToAdditionalInfos(\Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\AdditionalInfosAType\AdditionalInfoAType $additionalInfo)
    {
     ...
     * A collection of additional information requests.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType\RFPRequestSegmentAType\AdditionalInfosAType\AdditionalInfoAType[] $additionalInfos
     * @return self
     */
