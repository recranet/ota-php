...
namespace Recranet\OTA\Type\OTAHotelRFPMeetingRQ;
...
class OTAHotelRFPMeetingRQAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPRequestSegmentsType $rFPRequestSegments
     */
     ...
     * A collection of RequestSegments which allows multiple requests for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @return \Recranet\OTA\Type\RFPRequestSegmentsType
     */
     ...
     * A collection of RequestSegments which allows multiple requests for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @param \Recranet\OTA\Type\RFPRequestSegmentsType $rFPRequestSegments
     * @return self
     */
    public function setRFPRequestSegments(\Recranet\OTA\Type\RFPRequestSegmentsType $rFPRequestSegments)
    {
