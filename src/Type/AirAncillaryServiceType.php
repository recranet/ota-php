...
class AirAncillaryServiceType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType[] $productGroup
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType $productGroup
     */
    public function addToProductGroup(\Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType $productGroup)
    {
     ...
     * Airline or ATPCO product group code(s) that are associated with the service code.
     *
     * @return \Recranet\OTA\Type\AirAncillaryServiceType\ProductGroupAType[]
     */
