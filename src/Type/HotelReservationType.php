...
class HotelReservationType
{
     ...
     *
     * @var \Recranet\OTA\Type\RoomStaysType\RoomStayAType[] $roomStays
     */
     ...
     *
     * @var \Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType[] $billingInstructionCode
     */
     ...
     *
     * @var \Recranet\OTA\Type\ResGuestType[] $resGuests
     */
     ...
     *
     * @var \Recranet\OTA\Type\HotelReservationType\ResGlobalInfoAType $resGlobalInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\HotelReservationType\QueueAType $queue
     */
    private $queue = null;
     ...
     */
    public function addToRoomStays(\Recranet\OTA\Type\RoomStaysType\RoomStayAType $roomStay)
    {
     ...
     * Collection of room stays.
     *
     * @param \Recranet\OTA\Type\RoomStaysType\RoomStayAType[] $roomStays
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType $billingInstructionCode
     */
    public function addToBillingInstructionCode(\Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType $billingInstructionCode)
    {
     ...
     * Billing codes that apply to a set of instructions for a set of transactions that are routed to a designated folio.
     *
     * @return \Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType[]
     */
     ...
     */
    public function addToResGuests(\Recranet\OTA\Type\ResGuestType $resGuest)
    {
     ...
     * Collection of guests associated with the reservation.
     *
     * @param \Recranet\OTA\Type\ResGuestType[] $resGuests
     * @return self
     */
     ...
     * ResGlobalInfo is a container for various information that affects the Reservation as a whole. These include global comments, counts, reservation IDs, loyalty programs, and payment methods.
     *
     * @return \Recranet\OTA\Type\HotelReservationType\ResGlobalInfoAType
     */
     ...
     * ResGlobalInfo is a container for various information that affects the Reservation as a whole. These include global comments, counts, reservation IDs, loyalty programs, and payment methods.
     *
     * @param \Recranet\OTA\Type\HotelReservationType\ResGlobalInfoAType $resGlobalInfo
     * @return self
     */
    public function setResGlobalInfo(?\Recranet\OTA\Type\HotelReservationType\ResGlobalInfoAType $resGlobalInfo = null)
    {
     ...
     * Information to specify the queue on which the reservation should be placed.
     *
     * @return \Recranet\OTA\Type\HotelReservationType\QueueAType
     */
     ...
     * Information to specify the queue on which the reservation should be placed.
     *
     * @param \Recranet\OTA\Type\HotelReservationType\QueueAType $queue
     * @return self
     */
    public function setQueue(?\Recranet\OTA\Type\HotelReservationType\QueueAType $queue = null)
    {
        $this->queue = $queue;
        return $this;
    }
