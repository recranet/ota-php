...
namespace Recranet\OTA\Type\VehicleAvailRQAdditionalInfoType;
...
class CoveragePrefsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAvailRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType[] $coveragePref
     */
     ...
     */
    public function addToCoveragePref(\Recranet\OTA\Type\VehicleAvailRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType $coveragePref)
    {
