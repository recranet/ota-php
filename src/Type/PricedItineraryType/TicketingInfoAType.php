...
use Recranet\OTA\Type\TicketingInfoRSType;
...
class TicketingInfoAType extends TicketingInfoRSType
{
     ...
     *
     * @var \Recranet\OTA\Type\PricedItineraryType\TicketingInfoAType\DeliveryInfoAType[] $deliveryInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PricedItineraryType\TicketingInfoAType\DeliveryInfoAType $deliveryInfo
     */
    public function addToDeliveryInfo(\Recranet\OTA\Type\PricedItineraryType\TicketingInfoAType\DeliveryInfoAType $deliveryInfo)
    {
     ...
     * Shipping information for the ticket.
     *
     * @return \Recranet\OTA\Type\PricedItineraryType\TicketingInfoAType\DeliveryInfoAType[]
     */
