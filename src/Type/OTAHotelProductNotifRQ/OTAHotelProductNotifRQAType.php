...
namespace Recranet\OTA\Type\OTAHotelProductNotifRQ;

/**
 * Class representing OTAHotelProductNotifRQAType
 */
class OTAHotelProductNotifRQAType
{
    /**
    ...
    /**
     * The unique identifier element allows the trading partners to uniquely identify each HotelProductNotifRQ, (i.e. the entire message) for tracing of transactions.
     *
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelProductNotifRQ\OTAHotelProductNotifRQAType\HotelProductsAType $hotelProducts
     */
     ...
     * A collection of products.
     *
     * @return \Recranet\OTA\Type\OTAHotelProductNotifRQ\OTAHotelProductNotifRQAType\HotelProductsAType
     */
     ...
     * A collection of products.
     *
     * @param \Recranet\OTA\Type\OTAHotelProductNotifRQ\OTAHotelProductNotifRQAType\HotelProductsAType $hotelProducts
     * @return self
     */
    public function setHotelProducts(\Recranet\OTA\Type\OTAHotelProductNotifRQ\OTAHotelProductNotifRQAType\HotelProductsAType $hotelProducts)
    {
