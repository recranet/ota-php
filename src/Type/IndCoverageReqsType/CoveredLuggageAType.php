...
class CoveredLuggageAType
{
     ...
     *
     * @var \Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType[] $luggageItem
     */
    private $luggageItem = [
     ...
     */
    public function addToLuggageItem(\Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType $luggageItem)
    {
