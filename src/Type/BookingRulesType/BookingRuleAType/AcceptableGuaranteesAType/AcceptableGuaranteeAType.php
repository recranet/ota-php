...
namespace Recranet\OTA\Type\BookingRulesType\BookingRuleAType\AcceptableGuaranteesAType;
...
class AcceptableGuaranteeAType extends GuaranteeType
{
     ...
     *
     * @var string $guaranteePolicyType
     */
     ...
     *
     * @var string $unacceptablePaymentType
     */
