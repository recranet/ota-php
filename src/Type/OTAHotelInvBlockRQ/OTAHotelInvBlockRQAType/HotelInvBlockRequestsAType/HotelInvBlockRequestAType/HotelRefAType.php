...
namespace Recranet\OTA\Type\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType;
...
class HotelRefAType
{
     ...
     *
     * @var string $architecturalStyleCode
     */
