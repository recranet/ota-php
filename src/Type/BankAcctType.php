...
class BankAcctType
{
     ...
     *
     * @var \Recranet\OTA\Type\EncryptionTokenType $bankAcctNumber
     */
     ...
     * OpenTravel Best Practice: Bank Account Payment Instruction Tokens: Some OpenTravel schema may contain combinations of elements and attributes that have bank account number and other personally identifying information within the schema, such as customer name and date of birth. For enhanced customer privacy and security, it is RECOMMENDED that the bank account number and ID be encrypted, using tokenization or some other method.
     *
     * @var \Recranet\OTA\Type\EncryptionTokenType $bankID
     */
    private $bankID = null;
     ...
     * Example: Checking
     *
     * @var \Recranet\OTA\Type\ListBankAccountType $type
     */
    private $type = null;
     ...
     * OpenTravel Best Practice: Bank Account Payment Instruction Tokens: Some OpenTravel schema may contain combinations of elements and attributes that have bank account number and other personally identifying information within the schema, such as customer name and date of birth. For enhanced customer privacy and security, it is RECOMMENDED that the bank account number and ID be encrypted, using tokenization or some other method.
     *
     * @param \Recranet\OTA\Type\EncryptionTokenType $bankAcctNumber
     * @return self
     */
    public function setBankAcctNumber(?\Recranet\OTA\Type\EncryptionTokenType $bankAcctNumber = null)
    {
     ...
     * OpenTravel Best Practice: Bank Account Payment Instruction Tokens: Some OpenTravel schema may contain combinations of elements and attributes that have bank account number and other personally identifying information within the schema, such as customer name and date of birth. For enhanced customer privacy and security, it is RECOMMENDED that the bank account number and ID be encrypted, using tokenization or some other method.
     *
     * @param \Recranet\OTA\Type\EncryptionTokenType $bankID
     * @return self
     */
    public function setBankID(?\Recranet\OTA\Type\EncryptionTokenType $bankID = null)
    {
        $this->bankID = $bankID;
        return $this;
    }
     ...
     * Example: Checking
     *
     * @return \Recranet\OTA\Type\ListBankAccountType
     */
     ...
     * Example: Checking
     *
     * @param \Recranet\OTA\Type\ListBankAccountType $type
     * @return self
     */
    public function setType(?\Recranet\OTA\Type\ListBankAccountType $type = null)
    {
        $this->type = $type;
        return $this;
    }
