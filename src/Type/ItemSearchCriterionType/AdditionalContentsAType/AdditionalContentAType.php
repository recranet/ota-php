...
namespace Recranet\OTA\Type\ItemSearchCriterionType\AdditionalContentsAType;
...
{
    /**
     * When used, the response message will be filtered to return only the content that was requested. Refer to OpenTravel code list Information Type (INF).
     *
     * @var string $contentGroupCode
     */
