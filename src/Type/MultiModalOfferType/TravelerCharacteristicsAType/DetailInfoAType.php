...
namespace Recranet\OTA\Type\MultiModalOfferType\TravelerCharacteristicsAType;
...
class DetailInfoAType
{
     ...
     *
     * @var \Recranet\OTA\Type\MultiModalOfferType\TravelerCharacteristicsAType\DetailInfoAType\IdentificationAType $identification
     */
     ...
     *
     * @var \Recranet\OTA\Type\OntologyValueType $customerValue
     */
     ...
     * Implementer: Exchanging this level of personal information between trading partners may be subject to state, local and government legislation and internal or negotiated data use and sharing permissions.
     *
     * @return \Recranet\OTA\Type\MultiModalOfferType\TravelerCharacteristicsAType\DetailInfoAType\IdentificationAType
     */
     ...
     * Implementer: Exchanging this level of personal information between trading partners may be subject to state, local and government legislation and internal or negotiated data use and sharing permissions.
     *
     * @param \Recranet\OTA\Type\MultiModalOfferType\TravelerCharacteristicsAType\DetailInfoAType\IdentificationAType $identification
     * @return self
     */
    public function setIdentification(?\Recranet\OTA\Type\MultiModalOfferType\TravelerCharacteristicsAType\DetailInfoAType\IdentificationAType $identification = null)
    {
     ...
     * Offer requestor assessed customer value.
     *
     * @param \Recranet\OTA\Type\OntologyValueType $customerValue
     * @return self
     */
    public function setCustomerValue(?\Recranet\OTA\Type\OntologyValueType $customerValue = null)
    {
