...
namespace Recranet\OTA\Type\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType\CalculationMethodAType;
...
class DurationAType
{
     ...
     * Duration value.
     * Example: 2
     * Implementer: The time duration unit of measure is set in the @DurationUOM attribute.
     *
     * @var float $value
     */
    private $value = null;
