...
class PaymentDetailType extends PaymentFormType
{
     ...
     *
     * @var \Recranet\OTA\Type\PaymentDetailType\PaymentAmountAType[] $paymentAmount
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PaymentDetailType\PaymentAmountAType $paymentAmount
     */
    public function addToPaymentAmount(\Recranet\OTA\Type\PaymentDetailType\PaymentAmountAType $paymentAmount)
    {
     ...
     * Provides the monetary amount due for payment as quoted. A second instance could show the actual paid amount in a different currency.
     *
     * @return \Recranet\OTA\Type\PaymentDetailType\PaymentAmountAType[]
     */
