...
class SearchTravelerType
{
     ...
     *
     * @var \Recranet\OTA\Type\SearchTravelerType\CitizenCountryNameAType $citizenCountryName
     */
     ...
     *
     * @var \Recranet\OTA\Type\IndCoverageReqsType $indCoverageReqs
     */
     ...
     * Information about the traveler's citizenship.
     *
     * @return \Recranet\OTA\Type\SearchTravelerType\CitizenCountryNameAType
     */
     ...
     * Information about the traveler's citizenship.
     *
     * @param \Recranet\OTA\Type\SearchTravelerType\CitizenCountryNameAType $citizenCountryName
     * @return self
     */
    public function setCitizenCountryName(?\Recranet\OTA\Type\SearchTravelerType\CitizenCountryNameAType $citizenCountryName = null)
    {
     ...
     * Insurance coverage requirement information, including estimated trip cost, the amount of requested accidental flight insurance, descriptions of luggage or equipment to be covered and a description of the traveler's pre-existing conditions.
     *
     * @return \Recranet\OTA\Type\IndCoverageReqsType
     */
     ...
     * Insurance coverage requirement information, including estimated trip cost, the amount of requested accidental flight insurance, descriptions of luggage or equipment to be covered and a description of the traveler's pre-existing conditions.
     *
     * @param \Recranet\OTA\Type\IndCoverageReqsType $indCoverageReqs
     * @return self
     */
    public function setIndCoverageReqs(?\Recranet\OTA\Type\IndCoverageReqsType $indCoverageReqs = null)
    {
