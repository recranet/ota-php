...
class PoliciesType
{
     ...
     * Describes the policies of the hotel, such as the type of payments, or whether children or pets are accepted.
     *
     * @var \Recranet\OTA\Type\PoliciesType\PolicyAType[] $policy
     */
    private $policy = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PoliciesType\PolicyAType $policy
     */
    public function addToPolicy(\Recranet\OTA\Type\PoliciesType\PolicyAType $policy)
    {
        $this->policy[] = $policy;
        return $this;
    }
     ...
     * Describes the policies of the hotel, such as the type of payments, or whether children or pets are accepted.
     *
     * @return \Recranet\OTA\Type\PoliciesType\PolicyAType[]
     */
