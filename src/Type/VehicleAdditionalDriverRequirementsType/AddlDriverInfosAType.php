...
namespace Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType;
...
class AddlDriverInfosAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\AddlDriverInfoAType[] $addlDriverInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\VehiclesAType\VehicleAType[] $vehicles
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\AddlDriverInfoAType $addlDriverInfo
     */
    public function addToAddlDriverInfo(\Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\AddlDriverInfoAType $addlDriverInfo)
    {
     ...
     * Textual description about a specific restriction related to additional drivers.
     *
     * @return \Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\AddlDriverInfoAType[]
     */
     ...
     */
    public function addToVehicles(\Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\VehiclesAType\VehicleAType $vehicle)
    {
     ...
     * A collection of vehicles associated with additional driver information.
     *
     * @param \Recranet\OTA\Type\VehicleAdditionalDriverRequirementsType\AddlDriverInfosAType\VehiclesAType\VehicleAType[] $vehicles
     * @return self
     */
