...
namespace Recranet\OTA\Type\FeaturesType;
...
class FeatureAType
{
    ...
    /**
     * Refer to OpenTravel Code List Disability Feature Code (PHY). For any of the codes which apply to a room count, use the GuestRoom\@Quantity. Additionally, GuestRoom\@RoomTypeName may be used to pass the specific room type or you could pass "all" or "total" to indicate the AccessibleCode applies to the total hotel.
     *
     * @var string $accessibleCode
     */
     ...
     *
     * @var \Recranet\OTA\Type\FeaturesType\FeatureAType\ChargeAType $charge
     */
    private $charge = null;
     ...
     * Indicates whether this feature is chargeable.
     *
     * @return \Recranet\OTA\Type\FeaturesType\FeatureAType\ChargeAType
     */
     ...
     * Indicates whether this feature is chargeable.
     *
     * @param \Recranet\OTA\Type\FeaturesType\FeatureAType\ChargeAType $charge
     * @return self
     */
    public function setCharge(?\Recranet\OTA\Type\FeaturesType\FeatureAType\ChargeAType $charge = null)
    {
        $this->charge = $charge;
        return $this;
    }
