...
class ContactsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\ContactsAType\ContactAType[] $contact
     */
    private $contact = [
     ...
     */
    public function addToContact(\Recranet\OTA\Type\PostEventSiteReportType\ContactsAType\ContactAType $contact)
    {
