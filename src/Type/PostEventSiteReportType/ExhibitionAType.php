...
class ExhibitionAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitDetailsAType $exhibitDetails
     */
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitorInfoAType $exhibitorInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\AdditionalDatesAType\AdditionalDateAType[] $additionalDates
     */
     ...
     * A collection of exhibit details.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitDetailsAType
     */
     ...
     * A collection of exhibit details.
     *
     * @param \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitDetailsAType $exhibitDetails
     * @return self
     */
    public function setExhibitDetails(?\Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitDetailsAType $exhibitDetails = null)
    {
     ...
     * Exhibitor (i.e., the people working the booths) information for the event.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitorInfoAType
     */
     ...
     * Exhibitor (i.e., the people working the booths) information for the event.
     *
     * @param \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitorInfoAType $exhibitorInfo
     * @return self
     */
    public function setExhibitorInfo(?\Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\ExhibitorInfoAType $exhibitorInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\AdditionalDatesAType\AdditionalDateAType $additionalDate
     */
    public function addToAdditionalDates(\Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\AdditionalDatesAType\AdditionalDateAType $additionalDate)
    {
     ...
     * A collection of additional dates.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\AdditionalDatesAType\AdditionalDateAType[]
     */
     ...
     * A collection of additional dates.
     *
     * @param \Recranet\OTA\Type\PostEventSiteReportType\ExhibitionAType\AdditionalDatesAType\AdditionalDateAType[] $additionalDates
     * @return self
     */
