...
namespace Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType;
...
class StayDayAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RatesAType\RateAType[] $rates
     */
    private $rates = null;
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RoomPickUpAType[] $roomPickUp
     */
    private $roomPickUp = [
     ...
     */
    public function addToRates(\Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RatesAType\RateAType $rate)
    {
        $this->rates[] = $rate;
        return $this;
    }
     ...
     * Collection of rates for a particular room type.
     *
     * @param \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RatesAType\RateAType[] $rates
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RoomPickUpAType $roomPickUp
     */
    public function addToRoomPickUp(\Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RoomPickUpAType $roomPickUp)
    {
     ...
     * Individual room pick-up by day or by day and room type.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType\StayDayAType\RoomPickUpAType[]
     */
