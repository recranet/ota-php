...
namespace Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType;
...
class RoomBlockAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\ReservationMethodAType[] $reservationMethod
     */
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType $stayDays
     */
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\TotalRoomPickUpAType[] $totalRoomPickUp
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\ReservationMethodAType $reservationMethod
     */
    public function addToReservationMethod(\Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\ReservationMethodAType $reservationMethod)
    {
     ...
     * Information regarding the reservation method.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\ReservationMethodAType[]
     */
     ...
     * A collection of stay days.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType
     */
     ...
     * A collection of stay days.
     *
     * @param \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType $stayDays
     * @return self
     */
    public function setStayDays(?\Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\StayDaysAType $stayDays = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\TotalRoomPickUpAType $totalRoomPickUp
     */
    public function addToTotalRoomPickUp(\Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\TotalRoomPickUpAType $totalRoomPickUp)
    {
     ...
     * Total room pick-up for the room block for a specific time parameter.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType\TotalRoomPickUpAType[]
     */
