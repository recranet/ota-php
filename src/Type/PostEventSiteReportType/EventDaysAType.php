...
class EventDaysAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PostEventSiteReportType\EventDaysAType\EventDayAType[] $eventDay
     */
    private $eventDay = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PostEventSiteReportType\EventDaysAType\EventDayAType $eventDay
     */
    public function addToEventDay(\Recranet\OTA\Type\PostEventSiteReportType\EventDaysAType\EventDayAType $eventDay)
    {
     ...
     * Defines the functions for a specific day of the event.
     *
     * @return \Recranet\OTA\Type\PostEventSiteReportType\EventDaysAType\EventDayAType[]
     */
