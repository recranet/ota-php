...
class OfferType
{
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType[] $offerRules
     */
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\DiscountAType $discount
     */
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\FreeUpgradeAType $freeUpgrade
     */
     ...
     *
     * @var \Recranet\OTA\Type\ParagraphType $offerDescription
     */
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\CompatibleOffersAType\CompatibleOfferAType[] $compatibleOffers
     */
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType[] $inventories
     */
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\GuestsAType\GuestAType[] $guests
     */
    private $guests = null;
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType $offerRule
     */
    public function addToOfferRules(\Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType $offerRule)
    {
     ...
     * Collection of offer rules.
     *
     * @return \Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType[]
     */
     ...
     * Collection of offer rules.
     *
     * @param \Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType[] $offerRules
     * @return self
     */
     ...
     * Defines the characteristics of the offer.
     *
     * @return \Recranet\OTA\Type\OfferType\DiscountAType
     */
     ...
     * Defines the characteristics of the offer.
     *
     * @param \Recranet\OTA\Type\OfferType\DiscountAType $discount
     * @return self
     */
    public function setDiscount(?\Recranet\OTA\Type\OfferType\DiscountAType $discount = null)
    {
     ...
     * Defines offers of the type "book A and get B".
     *
     * @return \Recranet\OTA\Type\OfferType\FreeUpgradeAType
     */
     ...
     * Defines offers of the type "book A and get B".
     *
     * @param \Recranet\OTA\Type\OfferType\FreeUpgradeAType $freeUpgrade
     * @return self
     */
    public function setFreeUpgrade(?\Recranet\OTA\Type\OfferType\FreeUpgradeAType $freeUpgrade = null)
    {
     ...
     * A description of the offer. If the offer is based on a written contract, the appropriate paragraph from the contract could be quoted here.
     *
     * @param \Recranet\OTA\Type\ParagraphType $offerDescription
     * @return self
     */
    public function setOfferDescription(?\Recranet\OTA\Type\ParagraphType $offerDescription = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OfferType\CompatibleOffersAType\CompatibleOfferAType $compatibleOffer
     */
    public function addToCompatibleOffers(\Recranet\OTA\Type\OfferType\CompatibleOffersAType\CompatibleOfferAType $compatibleOffer)
    {
     ...
     * Collection of compatible offers.
     *
     * @return \Recranet\OTA\Type\OfferType\CompatibleOffersAType\CompatibleOfferAType[]
     */
     ...
     * Collection of compatible offers.
     *
     * @param \Recranet\OTA\Type\OfferType\CompatibleOffersAType\CompatibleOfferAType[] $compatibleOffers
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType $inventory
     */
    public function addToInventories(\Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType $inventory)
    {
     ...
     * Collection of inventory.
     *
     * @return \Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType[]
     */
     ...
     * Collection of inventory.
     *
     * @param \Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType[] $inventories
     * @return self
     */
     ...
     */
    public function addToGuests(\Recranet\OTA\Type\OfferType\GuestsAType\GuestAType $guest)
    {
        $this->guests[] = $guest;
        return $this;
    }
     ...
     * Collection of guests.
     *
     * @param \Recranet\OTA\Type\OfferType\GuestsAType\GuestAType[] $guests
     * @return self
     */
