...
class SeatRequestsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType[] $seatRequest
     */
    private $seatRequest = [
     ...
     */
    public function addToSeatRequest(\Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType $seatRequest)
    {
