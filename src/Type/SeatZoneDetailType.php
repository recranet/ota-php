...
class SeatZoneDetailType
{
     ...
     *
     * @var \Recranet\OTA\Type\SeatZoneDetailType\SeatTypeDetailAType[] $seatTypeDetail
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SeatZoneDetailType\SeatTypeDetailAType $seatTypeDetail
     */
    public function addToSeatTypeDetail(\Recranet\OTA\Type\SeatZoneDetailType\SeatTypeDetailAType $seatTypeDetail)
    {
     ...
     * Seat zone seat details, including seat type, total quantity and available quantity.
     *
     * @return \Recranet\OTA\Type\SeatZoneDetailType\SeatTypeDetailAType[]
     */
