...
{
    /**
     * A code that points to a valid baggage type and is known to the trading partner system. Note that these item types should map to ancillary item codes.
     *
     * @var string $code
     */
    private $code = null;
    ...
    /**
     * Identifies the context of the baggage origin city code such as IATA, ARC, or internal code.
     *
    ...
    /**
     * Identifies the context of the baggage destination city code such as IATA, ARC, or internal code.
     *
    ...
    /**
     * A reference to a traveler RPH defined elsewhere in this message.
     * (Developer Notes) RPH value set in:
    ...
    /**
     * A unique identifier for a flight segment within an O/D priced option. Only use this if you intend to price an item by flight segments. 
     * (Developer Notes) The corresponding value for this RPH is set here:
     ...
     *
     * @var \Recranet\OTA\Type\BaggageQueryType\AirlineCarrierAType $airlineCarrier
     */
     ...
     * Airline carrier information.
     *
     * @return \Recranet\OTA\Type\BaggageQueryType\AirlineCarrierAType
     */
     ...
     * Airline carrier information.
     *
     * @param \Recranet\OTA\Type\BaggageQueryType\AirlineCarrierAType $airlineCarrier
     * @return self
     */
    public function setAirlineCarrier(?\Recranet\OTA\Type\BaggageQueryType\AirlineCarrierAType $airlineCarrier = null)
    {
