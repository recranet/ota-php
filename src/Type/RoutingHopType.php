...
class RoutingHopType
{
     ...
     *
     * @var \Recranet\OTA\Type\RoutingHopType\RoutingHopAType[] $routingHop
     */
    private $routingHop = [
     ...
     */
    public function addToRoutingHop(\Recranet\OTA\Type\RoutingHopType\RoutingHopAType $routingHop)
    {
