...
namespace Recranet\OTA\Type\OTAHotelCommNotifRQ;

/**
 * Class representing OTAHotelCommNotifRQAType
 */
class OTAHotelCommNotifRQAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\CommissionEventType[] $commissionEvents
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CommissionEventType $commissionEvent
     */
    public function addToCommissionEvents(\Recranet\OTA\Type\CommissionEventType $commissionEvent)
    {
     ...
     * A collection of CommissionsEvent elements that result from a guest stay to be sent to the system responsible for processing agent commission payments.
     *
     * @return \Recranet\OTA\Type\CommissionEventType[]
     */
     ...
     * A collection of CommissionsEvent elements that result from a guest stay to be sent to the system responsible for processing agent commission payments.
     *
     * @param \Recranet\OTA\Type\CommissionEventType[] $commissionEvents
     * @return self
     */
