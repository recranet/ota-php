...
namespace Recranet\OTA\Type\OTAHotelRateAmountNotifRQ\OTAHotelRateAmountNotifRQAType;
...
class RateAmountMessagesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RateAmountMessageType[] $rateAmountMessage
     */
    private $rateAmountMessage = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RateAmountMessageType $rateAmountMessage
     */
    public function addToRateAmountMessage(\Recranet\OTA\Type\RateAmountMessageType $rateAmountMessage)
    {
     ...
     * RateAmountMessages that define the rate changes to be made.
     *
     * @return \Recranet\OTA\Type\RateAmountMessageType[]
     */
