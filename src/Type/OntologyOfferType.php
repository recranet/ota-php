...
class OntologyOfferType
{
     ...
     * One offer type.
     *
     * @var \Recranet\OTA\Type\OntologyOfferType\OfferAType[] $offer
     */
    private $offer = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OntologyOfferType\OfferAType $offer
     */
    public function addToOffer(\Recranet\OTA\Type\OntologyOfferType\OfferAType $offer)
    {
        $this->offer[] = $offer;
        return $this;
    }
     ...
     * One offer type.
     *
     * @return \Recranet\OTA\Type\OntologyOfferType\OfferAType[]
     */
