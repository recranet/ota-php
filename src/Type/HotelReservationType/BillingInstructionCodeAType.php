...
class BillingInstructionCodeAType
{
     ...
     *
     * @var \Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType\ResGuestRPHAType[] $resGuestRPH
     */
    private $resGuestRPH = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType\ResGuestRPHAType $resGuestRPH
     */
    public function addToResGuestRPH(\Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType\ResGuestRPHAType $resGuestRPH)
    {
     ...
     * A reference to a guest ID object that may be defined in ResGuests/ResGuest
     *
     * @return \Recranet\OTA\Type\HotelReservationType\BillingInstructionCodeAType\ResGuestRPHAType[]
     */
