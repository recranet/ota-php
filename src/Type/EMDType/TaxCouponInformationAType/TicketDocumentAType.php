...
namespace Recranet\OTA\Type\EMDType\TaxCouponInformationAType;
...
class TicketDocumentAType
{
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType\CouponNumberAType[] $couponNumber
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType\CouponNumberAType $couponNumber
     */
    public function addToCouponNumber(\Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType\CouponNumberAType $couponNumber)
    {
     ...
     * The applicable coupon number.
     *
     * @return \Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType\CouponNumberAType[]
     */
