...
use Recranet\OTA\Type\ETFareInfoType;
...
class FareInfoAType extends ETFareInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\VoluntaryChangesType[] $penaltyAmount
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VoluntaryChangesType $penaltyAmount
     */
    public function addToPenaltyAmount(\Recranet\OTA\Type\VoluntaryChangesType $penaltyAmount)
    {
