...
class TaxCouponInformationAType
{
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType[] $ticketDocument
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType $ticketDocument
     */
    public function addToTicketDocument(\Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType $ticketDocument)
    {
     ...
     * The ticket/document number to which the tax coupon data applies.
     *
     * @return \Recranet\OTA\Type\EMDType\TaxCouponInformationAType\TicketDocumentAType[]
     */
