...
namespace Recranet\OTA\Type\OTAHotelAvailRQ;
...
class OTAHotelAvailRQAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelAvailRQ\OTAHotelAvailRQAType\AvailRequestSegmentsAType $availRequestSegments
     */
     ...
     * A collection of AvailRequestSegment. Each segment includes a collection of criteria that requests a bookable entity, which may include designated rate plans, room types, amenities or services, and the request can be used for guest rooms or other inventory items for which availability is sought. Each segment would be presumed to have a unique date range for each request.
     *
     * @return \Recranet\OTA\Type\OTAHotelAvailRQ\OTAHotelAvailRQAType\AvailRequestSegmentsAType
     */
     ...
     * A collection of AvailRequestSegment. Each segment includes a collection of criteria that requests a bookable entity, which may include designated rate plans, room types, amenities or services, and the request can be used for guest rooms or other inventory items for which availability is sought. Each segment would be presumed to have a unique date range for each request.
     *
     * @param \Recranet\OTA\Type\OTAHotelAvailRQ\OTAHotelAvailRQAType\AvailRequestSegmentsAType $availRequestSegments
     * @return self
     */
    public function setAvailRequestSegments(\Recranet\OTA\Type\OTAHotelAvailRQ\OTAHotelAvailRQAType\AvailRequestSegmentsAType $availRequestSegments)
    {
