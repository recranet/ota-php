...
namespace Recranet\OTA\Type\OTAHotelCacheChangeNotifRQ;

/**
 * Class representing OTAHotelCacheChangeNotifRQAType
 */
class OTAHotelCacheChangeNotifRQAType
{
    /**
    ...
    /**
     * The unique identifier element allows the trading partners to uniquely identify each HotelCacheChangeNotif message, for tracing of transactions.
     *
     ...
     *
     * @var \Recranet\OTA\Type\NotifCacheType[] $cacheChangeInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\NotifCacheType $cacheChangeInfo
     */
    public function addToCacheChangeInfo(\Recranet\OTA\Type\NotifCacheType $cacheChangeInfo)
    {
     ...
     * Information that has changed and should be updated in the cache via an OTA_HotelAvailRQ request message.
     *
     * @return \Recranet\OTA\Type\NotifCacheType[]
     */
