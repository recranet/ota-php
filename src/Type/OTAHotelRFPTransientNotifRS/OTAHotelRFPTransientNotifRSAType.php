...
namespace Recranet\OTA\Type\OTAHotelRFPTransientNotifRS;

/**
 * Class representing OTAHotelRFPTransientNotifRSAType
 */
class OTAHotelRFPTransientNotifRSAType
{
    /**
    ...
    /**
     * The presence of the empty Successs element explicitly indicates that the OpenTravel versioned message succeeded.
     *
    ...
    /**
     * @var \Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\CommentsAType $comments
     */
    ...
    /**
     * Corresponds to the MessageID used in OTA_HotelRFP_RQ.xsd and OTA_HotelRFP_NotifRQ.xsd. This is a UniqueID that is associated with the request message.
     *
     * @var \Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\MessageIDAType $messageID
     */
     ...
     * Gets as comments
     *
     * @return \Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\CommentsAType
     */
     ...
     * Sets a new comments
     *
     * @param \Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\CommentsAType $comments
     * @return self
     */
    public function setComments(?\Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\CommentsAType $comments = null)
    {
     ...
     * Corresponds to the MessageID used in OTA_HotelRFP_RQ.xsd and OTA_HotelRFP_NotifRQ.xsd. This is a UniqueID that is associated with the request message.
     *
     * @return \Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\MessageIDAType
     */
     ...
     * Corresponds to the MessageID used in OTA_HotelRFP_RQ.xsd and OTA_HotelRFP_NotifRQ.xsd. This is a UniqueID that is associated with the request message.
     *
     * @param \Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\MessageIDAType $messageID
     * @return self
     */
    public function setMessageID(?\Recranet\OTA\Type\OTAHotelRFPTransientNotifRS\OTAHotelRFPTransientNotifRSAType\MessageIDAType $messageID = null)
    {
