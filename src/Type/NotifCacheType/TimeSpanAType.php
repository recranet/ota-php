...
namespace Recranet\OTA\Type\NotifCacheType;
...
class TimeSpanAType
{
    ...
    /**
     * If not present, indicates that everything between the Start and End date has changed.
     *
     * @var string $changeDateMask
     */
    private $changeDateMask = null;

    /**
     * Length of Stay indicates how many days of availability from start date should be shopped.
     *
    ...
    /**
     * Full Pattern Length Of Stay to indicate which days from start date should be shopped.
     *
     * @var string $fPLOS
     */
    private $fPLOS = null;
