...
class RFPTransientDetailsType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPTransientResponseType[] $rFPTransientResponses
     */
     ...
     *
     * @var \Recranet\OTA\Type\RFPTransientDetailsType\MessageIDAType $messageID
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RFPTransientResponseType $rFPTransientResponse
     */
    public function addToRFPTransientResponses(\Recranet\OTA\Type\RFPTransientResponseType $rFPTransientResponse)
    {
     ...
     * A collection of RFP Transient Responses
     *
     * @return \Recranet\OTA\Type\RFPTransientResponseType[]
     */
     ...
     * A collection of RFP Transient Responses
     *
     * @param \Recranet\OTA\Type\RFPTransientResponseType[] $rFPTransientResponses
     * @return self
     */
     ...
     * The ID is used to identify the original request. The instance attribute is used to indicate subsequent transmissions of new or updated information (e.g. an initial message will be instance 1 and an update to this message will be reflected with instance 2).
     *
     * @return \Recranet\OTA\Type\RFPTransientDetailsType\MessageIDAType
     */
     ...
     * The ID is used to identify the original request. The instance attribute is used to indicate subsequent transmissions of new or updated information (e.g. an initial message will be instance 1 and an update to this message will be reflected with instance 2).
     *
     * @param \Recranet\OTA\Type\RFPTransientDetailsType\MessageIDAType $messageID
     * @return self
     */
    public function setMessageID(?\Recranet\OTA\Type\RFPTransientDetailsType\MessageIDAType $messageID = null)
    {
