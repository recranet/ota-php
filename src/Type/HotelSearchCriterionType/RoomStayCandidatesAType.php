...
class RoomStayCandidatesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RoomStayCandidateType[] $roomStayCandidate
     */
     ...
     */
    public function addToRoomStayCandidate(\Recranet\OTA\Type\RoomStayCandidateType $roomStayCandidate)
    {
