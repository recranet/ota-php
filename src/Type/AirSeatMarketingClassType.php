...
class AirSeatMarketingClassType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType[] $cabinInfo
     */
    private $cabinInfo = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType $cabinInfo
     */
    public function addToCabinInfo(\Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType $cabinInfo)
    {
     ...
     * Cabin information for the aircraft equipment type, including seat types, cabin class code and cabin sub-class information.
     *
     * @return \Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType[]
     */
