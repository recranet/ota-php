...
class CustomQuestionType
{
     ...
     *
     * @var \Recranet\OTA\Type\FormattedTextTextType $questionText
     */
     ...
     *
     * @var \Recranet\OTA\Type\CustomQuestionType\ProvidedAnswerChoicesAType[] $providedAnswerChoices
     */
     ...
     *
     * @var \Recranet\OTA\Type\FormattedTextTextType $answerText
     */
     ...
     * Text for a specific question.
     *
     * @param \Recranet\OTA\Type\FormattedTextTextType $questionText
     * @return self
     */
    public function setQuestionText(?\Recranet\OTA\Type\FormattedTextTextType $questionText = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CustomQuestionType\ProvidedAnswerChoicesAType $providedAnswerChoices
     */
    public function addToProvidedAnswerChoices(\Recranet\OTA\Type\CustomQuestionType\ProvidedAnswerChoicesAType $providedAnswerChoices)
    {
     ...
     * Allows the requestor to provide prewritten answers for the question.
     *
     * @return \Recranet\OTA\Type\CustomQuestionType\ProvidedAnswerChoicesAType[]
     */
     ...
     * Answer for a specific question.
     *
     * @param \Recranet\OTA\Type\FormattedTextTextType $answerText
     * @return self
     */
    public function setAnswerText(?\Recranet\OTA\Type\FormattedTextTextType $answerText = null)
    {
