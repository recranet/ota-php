...
class PricedEquipsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleRentalTransactionType\PricedEquipsAType\PricedEquipAType[] $pricedEquip
     */
    private $pricedEquip = [
     ...
     */
    public function addToPricedEquip(\Recranet\OTA\Type\VehicleRentalTransactionType\PricedEquipsAType\PricedEquipAType $pricedEquip)
    {
