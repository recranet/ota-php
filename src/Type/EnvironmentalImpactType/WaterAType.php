...
class WaterAType
{
     ...
     * Example: Gallon(s)
     *
     * @var \Recranet\OTA\Type\ListUnitOfMeasureType $waterUOM
     */
     ...
     * Example: Gallon(s)
     *
     * @param \Recranet\OTA\Type\ListUnitOfMeasureType $waterUOM
     * @return self
     */
    public function setWaterUOM(?\Recranet\OTA\Type\ListUnitOfMeasureType $waterUOM = null)
    {
