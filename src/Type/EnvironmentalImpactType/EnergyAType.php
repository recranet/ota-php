...
class EnergyAType
{
     ...
     * Power usage detail.
     *
     * @var \Recranet\OTA\Type\EnvironmentalImpactType\EnergyAType\UsageAType[] $usage
     */
    private $usage = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EnvironmentalImpactType\EnergyAType\UsageAType $usage
     */
    public function addToUsage(\Recranet\OTA\Type\EnvironmentalImpactType\EnergyAType\UsageAType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     * Power usage detail.
     *
     * @return \Recranet\OTA\Type\EnvironmentalImpactType\EnergyAType\UsageAType[]
     */
