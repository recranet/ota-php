...
namespace Recranet\OTA\Type\OTAHotelPostEventRQ;
...
class OTAHotelPostEventRQAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\RequestorAType[] $requestor
     */
    private $requestor = [
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType[] $events
     */
    private $events = null;
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType $sites
     */
    private $sites = null;
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\RequestorAType $requestor
     */
    public function addToRequestor(\Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\RequestorAType $requestor)
    {
     ...
     * Specifies to whom the post event report should be sent.
     *
     * @return \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\RequestorAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType $event
     */
    public function addToEvents(\Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType $event)
    {
        $this->events[] = $event;
        return $this;
    }
     ...
     * A collection of individual events for which the post event report is being requested. Provides the ability to request information for a specific event or event planner for one or more sites.
     *
     * @return \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType[]
     */
     ...
     * A collection of individual events for which the post event report is being requested. Provides the ability to request information for a specific event or event planner for one or more sites.
     *
     * @param \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType[] $events
     * @return self
     */
     ...
     * A collection of sites for which a post event report is being requested. Provides the ability to request information for a site or group of sites without the specific details of an event. Typically this would be a batch transmission of post event history.
     *
     * @return \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType
     */
     ...
     * A collection of sites for which a post event report is being requested. Provides the ability to request information for a site or group of sites without the specific details of an event. Typically this would be a batch transmission of post event history.
     *
     * @param \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType $sites
     * @return self
     */
    public function setSites(?\Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType $sites = null)
    {
        $this->sites = $sites;
        return $this;
    }
