...
class SitesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType\SiteAType[] $site
     */
    private $site = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType\SiteAType $site
     */
    public function addToSite(\Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType\SiteAType $site)
    {
        $this->site[] = $site;
        return $this;
    }
     ...
     * A location for which a post event report is being requested.
     *
     * @return \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\SitesAType\SiteAType[]
     */
