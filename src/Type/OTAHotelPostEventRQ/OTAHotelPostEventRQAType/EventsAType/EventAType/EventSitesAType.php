...
namespace Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType;
...
class EventSitesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType\EventSitesAType\EventSiteAType[] $eventSite
     */
    private $eventSite = [
     ...
     */
    public function addToEventSite(\Recranet\OTA\Type\OTAHotelPostEventRQ\OTAHotelPostEventRQAType\EventsAType\EventAType\EventSitesAType\EventSiteAType $eventSite)
    {
