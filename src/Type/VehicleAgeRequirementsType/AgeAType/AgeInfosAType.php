...
class AgeInfosAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleAgeRequirementsType\AgeAType\AgeInfosAType\AgeInfoAType[] $ageInfo
     */
    private $ageInfo = [
     ...
     */
    public function addToAgeInfo(\Recranet\OTA\Type\VehicleAgeRequirementsType\AgeAType\AgeInfosAType\AgeInfoAType $ageInfo)
    {
