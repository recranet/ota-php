...
class SpecialReqDetailsType
{
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType[] $seatRequests
     */
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType\SpecialServiceRequestsAType\SpecialServiceRequestAType[] $specialServiceRequests
     */
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType\OtherServiceInformationsAType\OtherServiceInformationAType[] $otherServiceInformations
     */
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType\RemarksAType\RemarkAType[] $remarks
     */
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType\SpecialRemarksAType\SpecialRemarkAType[] $specialRemarks
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType $seatRequest
     */
    public function addToSeatRequests(\Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType $seatRequest)
    {
     ...
     * A collection of Seat Request
     *
     * @return \Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType[]
     */
     ...
     * A collection of Seat Request
     *
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\SeatRequestsAType\SeatRequestAType[] $seatRequests
     * @return self
     */
     ...
     */
    public function addToSpecialServiceRequests(\Recranet\OTA\Type\SpecialReqDetailsType\SpecialServiceRequestsAType\SpecialServiceRequestAType $specialServiceRequest)
    {
     ...
     * A collection of Special Service Request.
     *
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\SpecialServiceRequestsAType\SpecialServiceRequestAType[] $specialServiceRequests
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\OtherServiceInformationsAType\OtherServiceInformationAType $otherServiceInformation
     */
    public function addToOtherServiceInformations(\Recranet\OTA\Type\SpecialReqDetailsType\OtherServiceInformationsAType\OtherServiceInformationAType $otherServiceInformation)
    {
     ...
     * A collection of Other Service Information.
     *
     * @return \Recranet\OTA\Type\SpecialReqDetailsType\OtherServiceInformationsAType\OtherServiceInformationAType[]
     */
     ...
     * A collection of Other Service Information.
     *
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\OtherServiceInformationsAType\OtherServiceInformationAType[] $otherServiceInformations
     * @return self
     */
     ...
     */
    public function addToRemarks(\Recranet\OTA\Type\SpecialReqDetailsType\RemarksAType\RemarkAType $remark)
    {
        $this->remarks[] = $remark;
        return $this;
    }
     ...
     * A collection of Remark.
     *
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\RemarksAType\RemarkAType[] $remarks
     * @return self
     */
     ...
     */
    public function addToSpecialRemarks(\Recranet\OTA\Type\SpecialReqDetailsType\SpecialRemarksAType\SpecialRemarkAType $specialRemark)
    {
     ...
     * A collection of Special Remark.
     *
     * @param \Recranet\OTA\Type\SpecialReqDetailsType\SpecialRemarksAType\SpecialRemarkAType[] $specialRemarks
     * @return self
     */
