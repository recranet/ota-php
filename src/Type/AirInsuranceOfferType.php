...
class AirInsuranceOfferType
{
     ...
     *
     * @var \Recranet\OTA\Type\CompanyNameType $providerCompany
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirInsuranceOfferType\TotalTripCostAType $totalTripCost
     */
     ...
     *
     * @var \Recranet\OTA\Type\SearchTravelerType[] $coveredTraveler
     */
     ...
     * Identifies the company providing the insurance product.
     *
     * @param \Recranet\OTA\Type\CompanyNameType $providerCompany
     * @return self
     */
    public function setProviderCompany(?\Recranet\OTA\Type\CompanyNameType $providerCompany = null)
    {
     ...
     * Estimated trip cost, or the total price of the journey for all travelers.
     *
     * @return \Recranet\OTA\Type\AirInsuranceOfferType\TotalTripCostAType
     */
     ...
     * Estimated trip cost, or the total price of the journey for all travelers.
     *
     * @param \Recranet\OTA\Type\AirInsuranceOfferType\TotalTripCostAType $totalTripCost
     * @return self
     */
    public function setTotalTripCost(?\Recranet\OTA\Type\AirInsuranceOfferType\TotalTripCostAType $totalTripCost = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SearchTravelerType $coveredTraveler
     */
    public function addToCoveredTraveler(\Recranet\OTA\Type\SearchTravelerType $coveredTraveler)
    {
     ...
     * Traveler information with individual insurance coverage details.
     *
     * @return \Recranet\OTA\Type\SearchTravelerType[]
     */
