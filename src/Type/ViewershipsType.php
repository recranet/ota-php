...
class ViewershipsType
{
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType[] $viewership
     */
    private $viewership = [
     ...
     */
    public function addToViewership(\Recranet\OTA\Type\ViewershipsType\ViewershipAType $viewership)
    {
