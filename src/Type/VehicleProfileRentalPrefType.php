...
class VehicleProfileRentalPrefType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleProfileRentalPrefType\LoyaltyPrefAType[] $loyaltyPref
     */
    private $loyaltyPref = [
     ...
     *
     * @var \Recranet\OTA\Type\VehicleProfileRentalPrefType\PaymentFormPrefAType[] $paymentFormPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehicleProfileRentalPrefType\CoveragePrefAType[] $coveragePref
     */
     ...
     *
     * @var \Recranet\OTA\Type\VehiclePrefType[] $vehTypePref
     */
    private $vehTypePref = [
     ...
     *
     * @var \Recranet\OTA\Type\VehicleProfileRentalPrefType\SpecialEquipPrefAType[] $specialEquipPref
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleProfileRentalPrefType\LoyaltyPrefAType $loyaltyPref
     */
    public function addToLoyaltyPref(\Recranet\OTA\Type\VehicleProfileRentalPrefType\LoyaltyPrefAType $loyaltyPref)
    {
     ...
     * Indicates a preference for the loyalty program to be used for vehicle rental. The RPH (Reference Place Holder) attribute designates a specific loyalty program from a collection stored in the profile.
     *
     * @return \Recranet\OTA\Type\VehicleProfileRentalPrefType\LoyaltyPrefAType[]
     */
     ...
     */
    public function addToVendorPref(\Recranet\OTA\Type\CompanyNamePrefType $vendorPref)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleProfileRentalPrefType\PaymentFormPrefAType $paymentFormPref
     */
    public function addToPaymentFormPref(\Recranet\OTA\Type\VehicleProfileRentalPrefType\PaymentFormPrefAType $paymentFormPref)
    {
     ...
     * A preference for a payment indicates a specific type of payment, such as a credit card or direct bill, to be assigned to the car rental preference collection. The RPH (Reference Place Holder) attribute designates a specific payment form in a collection stored in the profile.
     *
     * @return \Recranet\OTA\Type\VehicleProfileRentalPrefType\PaymentFormPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleProfileRentalPrefType\CoveragePrefAType $coveragePref
     */
    public function addToCoveragePref(\Recranet\OTA\Type\VehicleProfileRentalPrefType\CoveragePrefAType $coveragePref)
    {
     ...
     * A preference for a specific type of vehicle coverage to be used when renting a car in a given travel situation.
     *
     * @return \Recranet\OTA\Type\VehicleProfileRentalPrefType\CoveragePrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehiclePrefType $vehTypePref
     */
    public function addToVehTypePref(\Recranet\OTA\Type\VehiclePrefType $vehTypePref)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleProfileRentalPrefType\SpecialEquipPrefAType $specialEquipPref
     */
    public function addToSpecialEquipPref(\Recranet\OTA\Type\VehicleProfileRentalPrefType\SpecialEquipPrefAType $specialEquipPref)
    {
     ...
     * Indicates a preference for special equipment in a rented car.
     *
     * @return \Recranet\OTA\Type\VehicleProfileRentalPrefType\SpecialEquipPrefAType[]
     */
