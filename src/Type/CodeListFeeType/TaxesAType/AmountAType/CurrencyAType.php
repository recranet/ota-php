...
namespace Recranet\OTA\Type\CodeListFeeType\TaxesAType\AmountAType;
...
class CurrencyAType
{
     ...
     * Currency code.
     * Example: USD
     * OpenTravel Best Practice for Currency Type Designation: Unless otherwise noted, all currency code designations are three alpha characters and WILL follow ISO 4217 prescribed format. Additionally, all currency amounts SHOULD have an ISO 4217 standard decimal places (minor units) specified.
