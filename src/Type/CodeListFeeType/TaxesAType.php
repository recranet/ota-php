...
class TaxesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\CodeListFeeType\TaxesAType\AmountAType $amount
     */
    private $amount = null;
     ...
     *
     * @var \Recranet\OTA\Type\CodeListFeeType\TaxesAType\QualifiersAType $qualifiers
     */
     ...
     * Tax amount or percentage information.
     *
     * @return \Recranet\OTA\Type\CodeListFeeType\TaxesAType\AmountAType
     */
     ...
     * Tax amount or percentage information.
     *
     * @param \Recranet\OTA\Type\CodeListFeeType\TaxesAType\AmountAType $amount
     * @return self
     */
    public function setAmount(?\Recranet\OTA\Type\CodeListFeeType\TaxesAType\AmountAType $amount = null)
    {
        $this->amount = $amount;
        return $this;
    }
     ...
     * Tax qualifier information.
     *
     * @return \Recranet\OTA\Type\CodeListFeeType\TaxesAType\QualifiersAType
     */
     ...
     * Tax qualifier information.
     *
     * @param \Recranet\OTA\Type\CodeListFeeType\TaxesAType\QualifiersAType $qualifiers
     * @return self
     */
    public function setQualifiers(?\Recranet\OTA\Type\CodeListFeeType\TaxesAType\QualifiersAType $qualifiers = null)
    {
