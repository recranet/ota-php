...
class CoverageLimitType
{
     ...
     *
     * @var \Recranet\OTA\Type\CoverageLimitType\DeductibleAType $deductible
     */
     ...
     *
     * @var \Recranet\OTA\Type\CoverageLimitType\PolicyLimitAType $policyLimit
     */
     ...
     *
     * @var \Recranet\OTA\Type\CoverageLimitType\IndividualLimitAType $individualLimit
     */
     ...
     * The amount of out-of-pocket expense a covered individual must pay per claim.
     *
     * @return \Recranet\OTA\Type\CoverageLimitType\DeductibleAType
     */
     ...
     * The amount of out-of-pocket expense a covered individual must pay per claim.
     *
     * @param \Recranet\OTA\Type\CoverageLimitType\DeductibleAType $deductible
     * @return self
     */
    public function setDeductible(?\Recranet\OTA\Type\CoverageLimitType\DeductibleAType $deductible = null)
    {
     ...
     * The maximum currency amount of available coverage for the policy.
     *
     * @return \Recranet\OTA\Type\CoverageLimitType\PolicyLimitAType
     */
     ...
     * The maximum currency amount of available coverage for the policy.
     *
     * @param \Recranet\OTA\Type\CoverageLimitType\PolicyLimitAType $policyLimit
     * @return self
     */
    public function setPolicyLimit(?\Recranet\OTA\Type\CoverageLimitType\PolicyLimitAType $policyLimit = null)
    {
     ...
     * The maximum amount of available coverage for a covered individual.
     *
     * @return \Recranet\OTA\Type\CoverageLimitType\IndividualLimitAType
     */
     ...
     * The maximum amount of available coverage for a covered individual.
     *
     * @param \Recranet\OTA\Type\CoverageLimitType\IndividualLimitAType $individualLimit
     * @return self
     */
    public function setIndividualLimit(?\Recranet\OTA\Type\CoverageLimitType\IndividualLimitAType $individualLimit = null)
    {
