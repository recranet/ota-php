...
namespace Recranet\OTA\Type\FareInfoType;
...
class FareInfoAType
{
     ...
     *
     * @var \Recranet\OTA\Type\FareInfoType\FareInfoAType\DateAType[] $date
     */
    private $date = [
     ...
     *
     * @var \Recranet\OTA\Type\FareInfoType\FareInfoAType\FareAType $fare
     */
    private $fare = null;
     ...
     *
     * @var \Recranet\OTA\Type\FareInfoType\FareInfoAType\PTCAType[] $pTC
     */
    private $pTC = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareInfoType\FareInfoAType\DateAType $date
     */
    public function addToDate(\Recranet\OTA\Type\FareInfoType\FareInfoAType\DateAType $date)
    {
        $this->date[] = $date;
        return $this;
    }
     ...
     * Date information applicable to the fare.
     *
     * @return \Recranet\OTA\Type\FareInfoType\FareInfoAType\DateAType[]
     */
     ...
     * The base and total fare and tax amounts associated with the rule.
     *
     * @return \Recranet\OTA\Type\FareInfoType\FareInfoAType\FareAType
     */
     ...
     * The base and total fare and tax amounts associated with the rule.
     *
     * @param \Recranet\OTA\Type\FareInfoType\FareInfoAType\FareAType $fare
     * @return self
     */
    public function setFare(?\Recranet\OTA\Type\FareInfoType\FareInfoAType\FareAType $fare = null)
    {
        $this->fare = $fare;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FareInfoType\FareInfoAType\PTCAType $pTC
     */
    public function addToPTC(\Recranet\OTA\Type\FareInfoType\FareInfoAType\PTCAType $pTC)
    {
        $this->pTC[] = $pTC;
        return $this;
    }
     ...
     * The passenger types for which the fare is applicable.
     *
     * @return \Recranet\OTA\Type\FareInfoType\FareInfoAType\PTCAType[]
     */
