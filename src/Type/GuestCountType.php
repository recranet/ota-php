...
class GuestCountType
{
     ...
     *
     * @var \Recranet\OTA\Type\GuestCountType\GuestCountAType[] $guestCount
     */
    private $guestCount = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\GuestCountType\GuestCountAType $guestCount
     */
    public function addToGuestCount(\Recranet\OTA\Type\GuestCountType\GuestCountAType $guestCount)
    {
     ...
     * A recurring element that identifies the number of guests and ages of the guests.
     *
     * @return \Recranet\OTA\Type\GuestCountType\GuestCountAType[]
     */
