...
class AmountType
{
     ...
     *
     * @var \Recranet\OTA\Type\AmountType\AdditionalGuestAmountsAType $additionalGuestAmounts
     */
     ...
     *
     * @var \Recranet\OTA\Type\AmountType\DiscountAType[] $discount
     */
    private $discount = [
     ...
     * @return self
     */
    public function setBase(?\Recranet\OTA\Type\TotalType $base = null)
    {
        $this->base = $base;
        return $this;
    }
     ...
     * A collection of charges that apply to for additional occupants, guests or service users (over and above the rate's MaxGuest Applicable).
     *
     * @return \Recranet\OTA\Type\AmountType\AdditionalGuestAmountsAType
     */
     ...
     * A collection of charges that apply to for additional occupants, guests or service users (over and above the rate's MaxGuest Applicable).
     *
     * @param \Recranet\OTA\Type\AmountType\AdditionalGuestAmountsAType $additionalGuestAmounts
     * @return self
     */
    public function setAdditionalGuestAmounts(?\Recranet\OTA\Type\AmountType\AdditionalGuestAmountsAType $additionalGuestAmounts = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AmountType\DiscountAType $discount
     */
    public function addToDiscount(\Recranet\OTA\Type\AmountType\DiscountAType $discount)
    {
     ...
     * Discount percentage and/or Amount, code and textual reason for discount
     *
     * @return \Recranet\OTA\Type\AmountType\DiscountAType[]
     */
