...
class DonationType
{
     ...
     *
     * @var \Recranet\OTA\Type\DonationType\FrontOfficeInfoAType $frontOfficeInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\DonationType\CreditCardInfoAType $creditCardInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\DonationType\DonorInfoAType $donorInfo
     */
     ...
     * The identifying fields for the front office for a Massive Good donation: Product Name, Product version, Office ID and Corporate ID.
     *
     * @return \Recranet\OTA\Type\DonationType\FrontOfficeInfoAType
     */
     ...
     * The identifying fields for the front office for a Massive Good donation: Product Name, Product version, Office ID and Corporate ID.
     *
     * @param \Recranet\OTA\Type\DonationType\FrontOfficeInfoAType $frontOfficeInfo
     * @return self
     */
    public function setFrontOfficeInfo(?\Recranet\OTA\Type\DonationType\FrontOfficeInfoAType $frontOfficeInfo = null)
    {
     ...
     * Donation credit card information.
     *
     * @return \Recranet\OTA\Type\DonationType\CreditCardInfoAType
     */
     ...
     * Donation credit card information.
     *
     * @param \Recranet\OTA\Type\DonationType\CreditCardInfoAType $creditCardInfo
     * @return self
     */
    public function setCreditCardInfo(\Recranet\OTA\Type\DonationType\CreditCardInfoAType $creditCardInfo)
    {
     ...
     * Donor information, including Email Address, First Name, Last Name, Street Address, City and Zip Code.
     *
     * @return \Recranet\OTA\Type\DonationType\DonorInfoAType
     */
     ...
     * Donor information, including Email Address, First Name, Last Name, Street Address, City and Zip Code.
     *
     * @param \Recranet\OTA\Type\DonationType\DonorInfoAType $donorInfo
     * @return self
     */
    public function setDonorInfo(?\Recranet\OTA\Type\DonationType\DonorInfoAType $donorInfo = null)
    {
