...
namespace Recranet\OTA\Type\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType;
...
class DesignatorCodeAType
{
    ...
    /**
     * A string value that represents an extended enumerated value for the @DesignatorCode. To use this feature, select the "Other_" item from the DesignatorCode list.
     * NOTE: Any extended enumeration values should be agreed upon between trading partners prior to use.
     *
     * @var string $extDesignatorCode
     */
