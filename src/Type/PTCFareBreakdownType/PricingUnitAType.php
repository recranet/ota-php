...
class PricingUnitAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType[] $fareComponent
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType $fareComponent
     */
    public function addToFareComponent(\Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType $fareComponent)
    {
     ...
     * Provides the data for a component of the fare.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType[]
     */
