...
namespace Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType;
...
class FareComponentAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType\FlightLegAType[] $flightLeg
     */
    private $flightLeg = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType\FlightLegAType $flightLeg
     */
    public function addToFlightLeg(\Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType\FlightLegAType $flightLeg)
    {
     ...
     * The flight leg information for the fare component.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType\FareComponentAType\FlightLegAType[]
     */
