...
class EndorsementsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType\EndorsementAType[] $endorsement
     */
    private $endorsement = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType\EndorsementAType $endorsement
     */
    public function addToEndorsement(\Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType\EndorsementAType $endorsement)
    {
     ...
     * Specifies ticket endorsement information.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType\EndorsementAType[]
     */
