...
class BookedTrainSegmentType extends TrainSegmentType
{
     ...
     *
     * @var \Recranet\OTA\Type\ClassCodeType $classCode
     */
     ...
     *
     * @var \Recranet\OTA\Type\BookedTrainSegmentType\AssignmentAType[] $assignment
     */
    private $assignment = [
     ...
     * The class of inventory controlled services available.
     *
     * @param \Recranet\OTA\Type\ClassCodeType $classCode
     * @return self
     */
    public function setClassCode(?\Recranet\OTA\Type\ClassCodeType $classCode = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BookedTrainSegmentType\AssignmentAType $assignment
     */
    public function addToAssignment(\Recranet\OTA\Type\BookedTrainSegmentType\AssignmentAType $assignment)
    {
     ...
     * Train seating assignment information.
     *
     * @return \Recranet\OTA\Type\BookedTrainSegmentType\AssignmentAType[]
     */
