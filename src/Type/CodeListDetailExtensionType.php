...
class CodeListDetailExtensionType extends CodeListSummaryExtensionType
{
     ...
     * Example: Property
     *
     * @var \Recranet\OTA\Type\ListApplyToLevelType[] $applyToLevel
     */
     ...
     *
     * @var \Recranet\OTA\Type\CodeListFeeType[] $charge
     */
    private $charge = [
     ...
     *
     * @var \Recranet\OTA\Type\CodeListScheduleType[] $schedule
     */
    private $schedule = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ListApplyToLevelType $applyToLevel
     */
    public function addToApplyToLevel(\Recranet\OTA\Type\ListApplyToLevelType $applyToLevel)
    {
     ...
     * Example: Property
     *
     * @return \Recranet\OTA\Type\ListApplyToLevelType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CodeListFeeType $charge
     */
    public function addToCharge(\Recranet\OTA\Type\CodeListFeeType $charge)
    {
        $this->charge[] = $charge;
        return $this;
    }
     ...
     * Associated charge information.
     *
     * @return \Recranet\OTA\Type\CodeListFeeType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CodeListScheduleType $schedule
     */
    public function addToSchedule(\Recranet\OTA\Type\CodeListScheduleType $schedule)
    {
     ...
     * Associated service schedule information.
     *
     * @return \Recranet\OTA\Type\CodeListScheduleType[]
     */
