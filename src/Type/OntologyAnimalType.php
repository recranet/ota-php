...
class OntologyAnimalType
{
     ...
     * Animal details.
     *
     * @var \Recranet\OTA\Type\OntologyAnimalType\DetailAType[] $detail
     */
    private $detail = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OntologyAnimalType\DetailAType $detail
     */
    public function addToDetail(\Recranet\OTA\Type\OntologyAnimalType\DetailAType $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * Animal details.
     *
     * @return \Recranet\OTA\Type\OntologyAnimalType\DetailAType[]
     */
