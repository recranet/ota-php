...
class RailPrefType
{
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\OperatorPrefAType[] $operatorPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\VendorPrefAType[] $vendorPref
     */
    private $vendorPref = [
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\PaymentFormPrefAType[] $paymentFormPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\LocationPrefType[] $originStationPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\LocationPrefType[] $destinationStationPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\LocationPrefType[] $connectionPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\FareRestrictPrefAType[] $fareRestrictPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\FarePrefAType[] $farePref
     */
    private $farePref = [
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\TrainPrefAType[] $trainPref
     */
    private $trainPref = [
     ...
     * Amenity preferences.
     *
     * @var \Recranet\OTA\Type\RailPrefType\AmenityPrefAType[] $amenityPref
     */
    private $amenityPref = [
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\EquipmentPrefAType[] $equipmentPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\AccommodationPrefAType[] $accommodationPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\AncillaryServicePrefAType[] $ancillaryServicePref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\PassengerInfoPrefAType[] $passengerInfoPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\SSRPrefAType[] $sSRPref
     */
    private $sSRPref = [
     ...
     *
     * @var \Recranet\OTA\Type\RailPrefType\OSIPrefAType[] $oSIPref
     */
    private $oSIPref = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\OperatorPrefAType $operatorPref
     */
    public function addToOperatorPref(\Recranet\OTA\Type\RailPrefType\OperatorPrefAType $operatorPref)
    {
     ...
     * Preferred rail operator network code(s).
     *
     * @return \Recranet\OTA\Type\RailPrefType\OperatorPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\VendorPrefAType $vendorPref
     */
    public function addToVendorPref(\Recranet\OTA\Type\RailPrefType\VendorPrefAType $vendorPref)
    {
     ...
     * Specifies any preferences in terms of the company operating the train service.
     *
     * @return \Recranet\OTA\Type\RailPrefType\VendorPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\PaymentFormPrefAType $paymentFormPref
     */
    public function addToPaymentFormPref(\Recranet\OTA\Type\RailPrefType\PaymentFormPrefAType $paymentFormPref)
    {
     ...
     * Preferred form(s) of payment.
     *
     * @return \Recranet\OTA\Type\RailPrefType\PaymentFormPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\LocationPrefType $originStationPref
     */
    public function addToOriginStationPref(\Recranet\OTA\Type\LocationPrefType $originStationPref)
    {
     ...
     * Preferred origination station location(s) for travel.
     *
     * @return \Recranet\OTA\Type\LocationPrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\LocationPrefType $destinationStationPref
     */
    public function addToDestinationStationPref(\Recranet\OTA\Type\LocationPrefType $destinationStationPref)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\LocationPrefType $connectionPref
     */
    public function addToConnectionPref(\Recranet\OTA\Type\LocationPrefType $connectionPref)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\FareRestrictPrefAType $fareRestrictPref
     */
    public function addToFareRestrictPref(\Recranet\OTA\Type\RailPrefType\FareRestrictPrefAType $fareRestrictPref)
    {
     ...
     * Preferred fare restriction(s).
     *
     * @return \Recranet\OTA\Type\RailPrefType\FareRestrictPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\FarePrefAType $farePref
     */
    public function addToFarePref(\Recranet\OTA\Type\RailPrefType\FarePrefAType $farePref)
    {
     ...
     * Preferred fare preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\FarePrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\TrainPrefAType $trainPref
     */
    public function addToTrainPref(\Recranet\OTA\Type\RailPrefType\TrainPrefAType $trainPref)
    {
     ...
     * Train characteristic preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\TrainPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\AmenityPrefAType $amenityPref
     */
    public function addToAmenityPref(\Recranet\OTA\Type\RailPrefType\AmenityPrefAType $amenityPref)
    {
     ...
     * Amenity preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\AmenityPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\EquipmentPrefAType $equipmentPref
     */
    public function addToEquipmentPref(\Recranet\OTA\Type\RailPrefType\EquipmentPrefAType $equipmentPref)
    {
     ...
     * Equipment preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\EquipmentPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\AccommodationPrefAType $accommodationPref
     */
    public function addToAccommodationPref(\Recranet\OTA\Type\RailPrefType\AccommodationPrefAType $accommodationPref)
    {
     ...
     * Accommodation preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\AccommodationPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\AncillaryServicePrefAType $ancillaryServicePref
     */
    public function addToAncillaryServicePref(\Recranet\OTA\Type\RailPrefType\AncillaryServicePrefAType $ancillaryServicePref)
    {
     ...
     * Specifies preferences of any service or product offered in conjunction with a basic rail accommodation, such as vehicle transport, pet transport and restaurant car service. Refer to OpenTravel Code List Rail Ancillary Service (RAN).
     *
     * @return \Recranet\OTA\Type\RailPrefType\AncillaryServicePrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\PassengerInfoPrefAType $passengerInfoPref
     */
    public function addToPassengerInfoPref(\Recranet\OTA\Type\RailPrefType\PassengerInfoPrefAType $passengerInfoPref)
    {
     ...
     * Occupation, passenger qualifying codes, rate qualifiers and disability requirement preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\PassengerInfoPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\SSRPrefAType $sSRPref
     */
    public function addToSSRPref(\Recranet\OTA\Type\RailPrefType\SSRPrefAType $sSRPref)
    {
     ...
     * Special Service Request preferences.
     *
     * @return \Recranet\OTA\Type\RailPrefType\SSRPrefAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailPrefType\OSIPrefAType $oSIPref
     */
    public function addToOSIPref(\Recranet\OTA\Type\RailPrefType\OSIPrefAType $oSIPref)
    {
     ...
     * Other Service Information of the rail operators.
     *
     * @return \Recranet\OTA\Type\RailPrefType\OSIPrefAType[]
     */
