...
class RateUploadType
{
     ...
     *
     * @var \Recranet\OTA\Type\RateUploadType\BaseByGuestAmtsAType\BaseByGuestAmtAType[] $baseByGuestAmts
     */
     ...
     *
     * @var \Recranet\OTA\Type\RateUploadType\AdditionalGuestAmountsAType\AdditionalGuestAmountAType[] $additionalGuestAmounts
     */
     ...
     *
     * @var \Recranet\OTA\Type\GuaranteeType[] $guaranteePolicies
     */
     ...
     *
     * @var \Recranet\OTA\Type\CancelPenaltiesType $cancelPolicies
     */
     ...
     *
     * @var \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType[] $paymentPolicies
     */
     ...
     *
     * @var \Recranet\OTA\Type\RateUploadType\MealsIncludedAType $mealsIncluded
     */
     ...
     *
     * @var \Recranet\OTA\Type\HotelAdditionalChargesType $additionalCharges
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RateUploadType\BaseByGuestAmtsAType\BaseByGuestAmtAType $baseByGuestAmt
     */
    public function addToBaseByGuestAmts(\Recranet\OTA\Type\RateUploadType\BaseByGuestAmtsAType\BaseByGuestAmtAType $baseByGuestAmt)
    {
     ...
     * A collection of Base charges by number of guests.
     *
     * @return \Recranet\OTA\Type\RateUploadType\BaseByGuestAmtsAType\BaseByGuestAmtAType[]
     */
     ...
     * A collection of Base charges by number of guests.
     *
     * @param \Recranet\OTA\Type\RateUploadType\BaseByGuestAmtsAType\BaseByGuestAmtAType[] $baseByGuestAmts
     * @return self
     */
     ...
     */
    public function addToAdditionalGuestAmounts(\Recranet\OTA\Type\RateUploadType\AdditionalGuestAmountsAType\AdditionalGuestAmountAType $additionalGuestAmount)
    {
     ...
     * A collection of charges that apply to for additional occupants, guests or service users (over and above the rate's MaxGuest Applicable).
     *
     * @param \Recranet\OTA\Type\RateUploadType\AdditionalGuestAmountsAType\AdditionalGuestAmountAType[] $additionalGuestAmounts
     * @return self
     */
     ...
     */
    public function addToGuaranteePolicies(\Recranet\OTA\Type\GuaranteeType $guaranteePolicy)
    {
     ...
     * A collection of Guarantee Policies.
     *
     * @param \Recranet\OTA\Type\GuaranteeType[] $guaranteePolicies
     * @return self
     */
     ...
     * A collection of Cancellation Policies.
     *
     * @param \Recranet\OTA\Type\CancelPenaltiesType $cancelPolicies
     * @return self
     */
    public function setCancelPolicies(?\Recranet\OTA\Type\CancelPenaltiesType $cancelPolicies = null)
    {
     ...
     */
    public function addToPaymentPolicies(\Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType $guaranteePayment)
    {
     ...
     * A collection of Payment Policies.
     *
     * @param \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType[] $paymentPolicies
     * @return self
     */
     ...
     * Defines which meals are included with this rate program.
     *
     * @return \Recranet\OTA\Type\RateUploadType\MealsIncludedAType
     */
     ...
     * Defines which meals are included with this rate program.
     *
     * @param \Recranet\OTA\Type\RateUploadType\MealsIncludedAType $mealsIncluded
     * @return self
     */
    public function setMealsIncluded(?\Recranet\OTA\Type\RateUploadType\MealsIncludedAType $mealsIncluded = null)
    {
     ...
     * Breakout of additional charges as part of the rate plan.
     *
     * @return \Recranet\OTA\Type\HotelAdditionalChargesType
     */
     ...
     * Breakout of additional charges as part of the rate plan.
     *
     * @param \Recranet\OTA\Type\HotelAdditionalChargesType $additionalCharges
     * @return self
     */
    public function setAdditionalCharges(?\Recranet\OTA\Type\HotelAdditionalChargesType $additionalCharges = null)
    {
