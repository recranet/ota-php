...
namespace Recranet\OTA\Type\OTAHotelStayInfoNotifRS;

/**
 * Class representing OTAHotelStayInfoNotifRSAType
 *
 * Information to acknowledge the receipt of a message.
 */
class OTAHotelStayInfoNotifRSAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\StayInfosType $stayInfos
     */
     ...
     * A collection of stay information.
     *
     * @return \Recranet\OTA\Type\StayInfosType
     */
     ...
     * A collection of stay information.
     *
     * @param \Recranet\OTA\Type\StayInfosType $stayInfos
     * @return self
     */
    public function setStayInfos(?\Recranet\OTA\Type\StayInfosType $stayInfos = null)
    {
