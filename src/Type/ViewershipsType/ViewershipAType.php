...
namespace Recranet\OTA\Type\ViewershipsType;
...
class ViewershipAType
{
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\ViewershipCodesAType $viewershipCodes
     */
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\SystemCodesAType $systemCodes
     */
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\ProfileTypesAType\ProfileTypeAType[] $profileTypes
     */
     ...
     *
     * @var \Recranet\OTA\Type\UniqueIDType[] $profileRefs
     */
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\LocationCodesAType $locationCodes
     */
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType $bookingChannelCodes
     */
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\DistributorTypesAType\DistributorTypeAType[] $distributorTypes
     */
     ...
     * A collection of Viewship codes
     *
     * @return \Recranet\OTA\Type\ViewershipsType\ViewershipAType\ViewershipCodesAType
     */
     ...
     * A collection of Viewship codes
     *
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\ViewershipCodesAType $viewershipCodes
     * @return self
     */
    public function setViewershipCodes(?\Recranet\OTA\Type\ViewershipsType\ViewershipAType\ViewershipCodesAType $viewershipCodes = null)
    {
     ...
     * A collection of system codes.
     *
     * @return \Recranet\OTA\Type\ViewershipsType\ViewershipAType\SystemCodesAType
     */
     ...
     * A collection of system codes.
     *
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\SystemCodesAType $systemCodes
     * @return self
     */
    public function setSystemCodes(?\Recranet\OTA\Type\ViewershipsType\ViewershipAType\SystemCodesAType $systemCodes = null)
    {
     ...
     */
    public function addToProfileTypes(\Recranet\OTA\Type\ViewershipsType\ViewershipAType\ProfileTypesAType\ProfileTypeAType $profileType)
    {
     ...
     * A collection of profile types.
     *
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\ProfileTypesAType\ProfileTypeAType[] $profileTypes
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\UniqueIDType $profileRef
     */
    public function addToProfileRefs(\Recranet\OTA\Type\UniqueIDType $profileRef)
    {
     ...
     * A collection of profile references.
     *
     * @param \Recranet\OTA\Type\UniqueIDType[] $profileRefs
     * @return self
     */
     ...
     * A collections of strings that identify the locations, such as regions or countries, etc., associated with this viewership record.
     *
     * @return \Recranet\OTA\Type\ViewershipsType\ViewershipAType\LocationCodesAType
     */
     ...
     * A collections of strings that identify the locations, such as regions or countries, etc., associated with this viewership record.
     *
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\LocationCodesAType $locationCodes
     * @return self
     */
    public function setLocationCodes(?\Recranet\OTA\Type\ViewershipsType\ViewershipAType\LocationCodesAType $locationCodes = null)
    {
     ...
     * A collections of strings that identify booking channels, such as GDSs or Internet sites, etc., associated with this viewership record.
     *
     * @return \Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType
     */
     ...
     * A collections of strings that identify booking channels, such as GDSs or Internet sites, etc., associated with this viewership record.
     *
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType $bookingChannelCodes
     * @return self
     */
    public function setBookingChannelCodes(?\Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType $bookingChannelCodes = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\DistributorTypesAType\DistributorTypeAType $distributorType
     */
    public function addToDistributorTypes(\Recranet\OTA\Type\ViewershipsType\ViewershipAType\DistributorTypesAType\DistributorTypeAType $distributorType)
    {
     ...
     * A Collection of strings that identify the distibutors (ex Tour Operators, Agency Chains, etc) which are allowed viewership.
     *
     * @return \Recranet\OTA\Type\ViewershipsType\ViewershipAType\DistributorTypesAType\DistributorTypeAType[]
     */
     ...
     * A Collection of strings that identify the distibutors (ex Tour Operators, Agency Chains, etc) which are allowed viewership.
     *
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\DistributorTypesAType\DistributorTypeAType[] $distributorTypes
     * @return self
     */
