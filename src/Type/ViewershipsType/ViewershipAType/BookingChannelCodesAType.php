...
class BookingChannelCodesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType\BookingChannelCodeAType[] $bookingChannelCode
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType\BookingChannelCodeAType $bookingChannelCode
     */
    public function addToBookingChannelCode(\Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType\BookingChannelCodeAType $bookingChannelCode)
    {
     ...
     * Specific code in relation to POS booking source (e.g. Expedia, hotels.com, etc.).
     *
     * @return \Recranet\OTA\Type\ViewershipsType\ViewershipAType\BookingChannelCodesAType\BookingChannelCodeAType[]
     */
