...
class TravelerInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\TravelerInfoType\AirTravelerAType[] $airTraveler
     */
    private $airTraveler = [
     ...
     *
     * @var \Recranet\OTA\Type\SpecialReqDetailsType[] $specialReqDetails
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\TravelerInfoType\AirTravelerAType $airTraveler
     */
    public function addToAirTraveler(\Recranet\OTA\Type\TravelerInfoType\AirTravelerAType $airTraveler)
    {
     ...
     * Information about the person traveling.
     *
     * @return \Recranet\OTA\Type\TravelerInfoType\AirTravelerAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SpecialReqDetailsType $specialReqDetails
     */
    public function addToSpecialReqDetails(\Recranet\OTA\Type\SpecialReqDetailsType $specialReqDetails)
    {
     ...
     * Provides detailed information regarding any special needs, requests, or remarks associated with the traveler
     *
     * @return \Recranet\OTA\Type\SpecialReqDetailsType[]
     */
