...
class IndCoverageReqsType
{
     ...
     *
     * @var \Recranet\OTA\Type\IndCoverageReqsType\IndTripCostAType $indTripCost
     */
     ...
     *
     * @var \Recranet\OTA\Type\IndCoverageReqsType\FlightAccidentAmountAType $flightAccidentAmount
     */
     ...
     *
     * @var \Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType[] $coveredLuggage
     */
     ...
     *
     * @var \Recranet\OTA\Type\IndCoverageReqsType\PreexistingConditionsAType\PreexistingConditionAType[] $preexistingConditions
     */
     ...
     * Estimated trip cost, or the total price of the journey for the traveler.
     *
     * @return \Recranet\OTA\Type\IndCoverageReqsType\IndTripCostAType
     */
     ...
     * Estimated trip cost, or the total price of the journey for the traveler.
     *
     * @param \Recranet\OTA\Type\IndCoverageReqsType\IndTripCostAType $indTripCost
     * @return self
     */
    public function setIndTripCost(?\Recranet\OTA\Type\IndCoverageReqsType\IndTripCostAType $indTripCost = null)
    {
     ...
     * Amount of flight accident protection (FAP) requested by the traveler (if offered by the insurance plan).
     *
     * @return \Recranet\OTA\Type\IndCoverageReqsType\FlightAccidentAmountAType
     */
     ...
     * Amount of flight accident protection (FAP) requested by the traveler (if offered by the insurance plan).
     *
     * @param \Recranet\OTA\Type\IndCoverageReqsType\FlightAccidentAmountAType $flightAccidentAmount
     * @return self
     */
    public function setFlightAccidentAmount(?\Recranet\OTA\Type\IndCoverageReqsType\FlightAccidentAmountAType $flightAccidentAmount = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType $luggageItem
     */
    public function addToCoveredLuggage(\Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType $luggageItem)
    {
     ...
     * Contains descriptions of luggage or equipment for which the traveler has requested additional baggage/equipment coverage (if offered by the insurance plan).
     *
     * @return \Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType[]
     */
     ...
     * Contains descriptions of luggage or equipment for which the traveler has requested additional baggage/equipment coverage (if offered by the insurance plan).
     *
     * @param \Recranet\OTA\Type\IndCoverageReqsType\CoveredLuggageAType\LuggageItemAType[] $coveredLuggage
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\IndCoverageReqsType\PreexistingConditionsAType\PreexistingConditionAType $preexistingCondition
     */
    public function addToPreexistingConditions(\Recranet\OTA\Type\IndCoverageReqsType\PreexistingConditionsAType\PreexistingConditionAType $preexistingCondition)
    {
     ...
     * Contains a description of the traveler's pre-existing conditions, the diagnosis date of the condition, and the date of last treatment.
     *
     * @return \Recranet\OTA\Type\IndCoverageReqsType\PreexistingConditionsAType\PreexistingConditionAType[]
     */
     ...
     * Contains a description of the traveler's pre-existing conditions, the diagnosis date of the condition, and the date of last treatment.
     *
     * @param \Recranet\OTA\Type\IndCoverageReqsType\PreexistingConditionsAType\PreexistingConditionAType[] $preexistingConditions
     * @return self
     */
