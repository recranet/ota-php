...
class FreeUpgradeAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeFromAType $upgradeFrom
     */
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeToAType $upgradeTo
     */
     ...
     * The specifics of the typical room or service.
     *
     * @return \Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeFromAType
     */
     ...
     * The specifics of the typical room or service.
     *
     * @param \Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeFromAType $upgradeFrom
     * @return self
     */
    public function setUpgradeFrom(?\Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeFromAType $upgradeFrom = null)
    {
     ...
     * The specifics of the upgraded room or service.
     *
     * @return \Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeToAType
     */
     ...
     * The specifics of the upgraded room or service.
     *
     * @param \Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeToAType $upgradeTo
     * @return self
     */
    public function setUpgradeTo(?\Recranet\OTA\Type\OfferType\FreeUpgradeAType\UpgradeToAType $upgradeTo = null)
    {
