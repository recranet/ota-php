...
class InventoriesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType[] $inventory
     */
    private $inventory = [
     ...
     */
    public function addToInventory(\Recranet\OTA\Type\OfferType\InventoriesAType\InventoryAType $inventory)
    {
