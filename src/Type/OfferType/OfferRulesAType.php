...
class OfferRulesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType[] $offerRule
     */
    private $offerRule = [
     ...
     */
    public function addToOfferRule(\Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType $offerRule)
    {
