...
namespace Recranet\OTA\Type\OfferType\OfferRulesAType\OfferRuleAType\InventoriesAType;
...
class InventoryAType
{
    ...
    /**
     * When true, the offer applies to the defined inventory. When false, the offer does not apply to the defined inventory.
     *
     * @var bool $appliesToIndicator
     */
