...
namespace Recranet\OTA\Type\OntologyDimensionType;
...
class DimensionUnitAType
{
     ...
     * Height value.
     * Example: 13
     * Implementer: Size encoding specified in RequestedOffer/ @SizeWeightEncoding.
     *
     * @var float $height
     */
    private $height = null;
    ...
    /**
     * Other type.
     * Implementer: Type if "Other_" is selected.
     *
