...
class AirRedemptionMilesType
{
     ...
     *
     * @var string $rewardCode
     */
    private $rewardCode = null;

    /**
     * The ratio used to calculate the number of miles required to pay for any monetary amount.
     * This attribute assumes the MoneyToMilesRatio:1. For example, a base fare of $100 where MoneyToMilesRatio is 1000 requires 100,000 frequent flyer miles to pay for the full base fare (100 * 1000 = 100,000 miles.)
     *
     * @var int $moneyToMilesRatio
     */
