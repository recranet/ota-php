...
class ServiceRPHsType
{
     ...
     *
     * @var \Recranet\OTA\Type\ServiceRPHsType\ServiceRPHAType[] $serviceRPH
     */
    private $serviceRPH = [
     ...
     */
    public function addToServiceRPH(\Recranet\OTA\Type\ServiceRPHsType\ServiceRPHAType $serviceRPH)
    {
