...
class AcceptablePaymentCardsInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\AcceptablePaymentCardsInfoType\AcceptablePaymentCardsAType\AcceptablePaymentCardAType[] $acceptablePaymentCards
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AcceptablePaymentCardsInfoType\AcceptablePaymentCardsAType\AcceptablePaymentCardAType $acceptablePaymentCard
     */
    public function addToAcceptablePaymentCards(\Recranet\OTA\Type\AcceptablePaymentCardsInfoType\AcceptablePaymentCardsAType\AcceptablePaymentCardAType $acceptablePaymentCard)
    {
     ...
     * A collection of payment cards that are acceptable as a form of payment.
     *
     * @return \Recranet\OTA\Type\AcceptablePaymentCardsInfoType\AcceptablePaymentCardsAType\AcceptablePaymentCardAType[]
     */
     ...
     * A collection of payment cards that are acceptable as a form of payment.
     *
     * @param \Recranet\OTA\Type\AcceptablePaymentCardsInfoType\AcceptablePaymentCardsAType\AcceptablePaymentCardAType[] $acceptablePaymentCards
     * @return self
     */
