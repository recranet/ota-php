...
class EMDType
{
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TravelerRefNumberAType $travelerRefNumber
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\OriginDestinationAType $originDestination
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\CustLoyaltyAType[] $custLoyalty
     */
    private $custLoyalty = [
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\EndorsementAType $endorsement
     */
     ...
     *
     * @var \Recranet\OTA\Type\UniqueIDType[] $addReferenceID
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\BaseFareAType[] $baseFare
     */
    private $baseFare = [
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\EquivFareAType[] $equivFare
     */
    private $equivFare = [
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TotalFareAType[] $totalFare
     */
    private $totalFare = [
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TaxesAType\TaxAType[] $taxes
     */
    private $taxes = null;
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\UnstructuredFareCalcAType[] $unstructuredFareCalc
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\FareInfoAType $fareInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TicketDocumentAType[] $ticketDocument
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\CommissionAType $commission
     */
     ...
     *
     * @var \Recranet\OTA\Type\FareComponentType $fareComponent
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\CarrierFeeInfoAType $carrierFeeInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\ExchResidualFareComponentAType[] $exchResidualFareComponent
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\OriginalIssueInfoAType $originalIssueInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\ReissuedFlownAType[] $reissuedFlown
     */
     ...
     *
     * @var \Recranet\OTA\Type\FreeTextType $responseComment
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\PresentInfoAType $presentInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\ReasonForIssuanceAType $reasonForIssuance
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\ValidatingAirlineAType $validatingAirline
     */
     ...
     *
     * @var \Recranet\OTA\Type\EMDType\TaxCouponInformationAType $taxCouponInformation
     */
     ...
     * Direct reference of traveler assigned by requesting system. Used as a cross reference between data segments.
     *
     * @return \Recranet\OTA\Type\EMDType\TravelerRefNumberAType
     */
     ...
     * Direct reference of traveler assigned by requesting system. Used as a cross reference between data segments.
     *
     * @param \Recranet\OTA\Type\EMDType\TravelerRefNumberAType $travelerRefNumber
     * @return self
     */
    public function setTravelerRefNumber(?\Recranet\OTA\Type\EMDType\TravelerRefNumberAType $travelerRefNumber = null)
    {
     ...
     */
    public function addToPaymentDetail(\Recranet\OTA\Type\PaymentDetailType $paymentDetail)
    {
     ...
     * The true origin and destination.
     *
     * @return \Recranet\OTA\Type\EMDType\OriginDestinationAType
     */
     ...
     * The true origin and destination.
     *
     * @param \Recranet\OTA\Type\EMDType\OriginDestinationAType $originDestination
     * @return self
     */
    public function setOriginDestination(?\Recranet\OTA\Type\EMDType\OriginDestinationAType $originDestination = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\CustLoyaltyAType $custLoyalty
     */
    public function addToCustLoyalty(\Recranet\OTA\Type\EMDType\CustLoyaltyAType $custLoyalty)
    {
     ...
     * Frequent flyer reference. ProgramID=airline code, MembershipID=FF number.
     *
     * @return \Recranet\OTA\Type\EMDType\CustLoyaltyAType[]
     */
     ...
     * Endorsement/ restriction remarks.
     *
     * @return \Recranet\OTA\Type\EMDType\EndorsementAType
     */
     ...
     * Endorsement/ restriction remarks.
     *
     * @param \Recranet\OTA\Type\EMDType\EndorsementAType $endorsement
     * @return self
     */
    public function setEndorsement(?\Recranet\OTA\Type\EMDType\EndorsementAType $endorsement = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\UniqueIDType $addReferenceID
     */
    public function addToAddReferenceID(\Recranet\OTA\Type\UniqueIDType $addReferenceID)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\BaseFareAType $baseFare
     */
    public function addToBaseFare(\Recranet\OTA\Type\EMDType\BaseFareAType $baseFare)
    {
     ...
     * Used to specify the base fare, the base fare net and the base fare sell amounts.
     *
     * @return \Recranet\OTA\Type\EMDType\BaseFareAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\EquivFareAType $equivFare
     */
    public function addToEquivFare(\Recranet\OTA\Type\EMDType\EquivFareAType $equivFare)
    {
     ...
     * Used to specify the equivalent - equivalent net or equivalent sell paid fare.
     *
     * @return \Recranet\OTA\Type\EMDType\EquivFareAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\TotalFareAType $totalFare
     */
    public function addToTotalFare(\Recranet\OTA\Type\EMDType\TotalFareAType $totalFare)
    {
     ...
     * Used to specify the total, total net, total sell fare or refund amount.
     *
     * @return \Recranet\OTA\Type\EMDType\TotalFareAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\TaxesAType\TaxAType $tax
     */
    public function addToTaxes(\Recranet\OTA\Type\EMDType\TaxesAType\TaxAType $tax)
    {
        $this->taxes[] = $tax;
        return $this;
    }
     ...
     * A collection of taxes.
     *
     * @return \Recranet\OTA\Type\EMDType\TaxesAType\TaxAType[]
     */
     ...
     * A collection of taxes.
     *
     * @param \Recranet\OTA\Type\EMDType\TaxesAType\TaxAType[] $taxes
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\UnstructuredFareCalcAType $unstructuredFareCalc
     */
    public function addToUnstructuredFareCalc(\Recranet\OTA\Type\EMDType\UnstructuredFareCalcAType $unstructuredFareCalc)
    {
     ...
     * Contains the fare calculation information for the stored passenger fare.
     *
     * @return \Recranet\OTA\Type\EMDType\UnstructuredFareCalcAType[]
     */
     ...
     * Nonendorsable and nonrefundable indicators, penalty restriction indicator, pricing system, tour code, ISO country code, around the world fare indicator and non-reissuable/non-exchangeable indicator.
     *
     * @return \Recranet\OTA\Type\EMDType\FareInfoAType
     */
     ...
     * Nonendorsable and nonrefundable indicators, penalty restriction indicator, pricing system, tour code, ISO country code, around the world fare indicator and non-reissuable/non-exchangeable indicator.
     *
     * @param \Recranet\OTA\Type\EMDType\FareInfoAType $fareInfo
     * @return self
     */
    public function setFareInfo(?\Recranet\OTA\Type\EMDType\FareInfoAType $fareInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\TicketDocumentAType $ticketDocument
     */
    public function addToTicketDocument(\Recranet\OTA\Type\EMDType\TicketDocumentAType $ticketDocument)
    {
     ...
     * The EMD type, in connection number, fee owner and date of issue.
     *
     * @return \Recranet\OTA\Type\EMDType\TicketDocumentAType[]
     */
     ...
     * Commission information for this ticket/document.
     *
     * @return \Recranet\OTA\Type\EMDType\CommissionAType
     */
     ...
     * Commission information for this ticket/document.
     *
     * @param \Recranet\OTA\Type\EMDType\CommissionAType $commission
     * @return self
     */
    public function setCommission(?\Recranet\OTA\Type\EMDType\CommissionAType $commission = null)
    {
     ...
     * Price quote date, account code, input designator, component count and bank exchange rate.
     *
     * @return \Recranet\OTA\Type\FareComponentType
     */
     ...
     * Price quote date, account code, input designator, component count and bank exchange rate.
     *
     * @param \Recranet\OTA\Type\FareComponentType $fareComponent
     * @return self
     */
    public function setFareComponent(?\Recranet\OTA\Type\FareComponentType $fareComponent = null)
    {
     ...
     * Data for the collection of non-airport/ government fees.
     *
     * @return \Recranet\OTA\Type\EMDType\CarrierFeeInfoAType
     */
     ...
     * Data for the collection of non-airport/ government fees.
     *
     * @param \Recranet\OTA\Type\EMDType\CarrierFeeInfoAType $carrierFeeInfo
     * @return self
     */
    public function setCarrierFeeInfo(?\Recranet\OTA\Type\EMDType\CarrierFeeInfoAType $carrierFeeInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\ExchResidualFareComponentAType $exchResidualFareComponent
     */
    public function addToExchResidualFareComponent(\Recranet\OTA\Type\EMDType\ExchResidualFareComponentAType $exchResidualFareComponent)
    {
     ...
     * The exchanged residual fare component information.
     *
     * @return \Recranet\OTA\Type\EMDType\ExchResidualFareComponentAType[]
     */
     ...
     * The original ticket/document issue information.
     *
     * @return \Recranet\OTA\Type\EMDType\OriginalIssueInfoAType
     */
     ...
     * The original ticket/document issue information.
     *
     * @param \Recranet\OTA\Type\EMDType\OriginalIssueInfoAType $originalIssueInfo
     * @return self
     */
    public function setOriginalIssueInfo(?\Recranet\OTA\Type\EMDType\OriginalIssueInfoAType $originalIssueInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EMDType\ReissuedFlownAType $reissuedFlown
     */
    public function addToReissuedFlown(\Recranet\OTA\Type\EMDType\ReissuedFlownAType $reissuedFlown)
    {
     ...
     * The reissued flown flight coupon information.
     *
     * @return \Recranet\OTA\Type\EMDType\ReissuedFlownAType[]
     */
     ...
     * A response message from the controlling carrier.
     *
     * @param \Recranet\OTA\Type\FreeTextType $responseComment
     * @return self
     */
    public function setResponseComment(?\Recranet\OTA\Type\FreeTextType $responseComment = null)
    {
     ...
     * The present to and at information.
     *
     * @return \Recranet\OTA\Type\EMDType\PresentInfoAType
     */
     ...
     * The present to and at information.
     *
     * @param \Recranet\OTA\Type\EMDType\PresentInfoAType $presentInfo
     * @return self
     */
    public function setPresentInfo(?\Recranet\OTA\Type\EMDType\PresentInfoAType $presentInfo = null)
    {
     ...
     * The reason for issuance information.
     *
     * @return \Recranet\OTA\Type\EMDType\ReasonForIssuanceAType
     */
     ...
     * The reason for issuance information.
     *
     * @param \Recranet\OTA\Type\EMDType\ReasonForIssuanceAType $reasonForIssuance
     * @return self
     */
    public function setReasonForIssuance(?\Recranet\OTA\Type\EMDType\ReasonForIssuanceAType $reasonForIssuance = null)
    {
     ...
     * The validating airline for all EMD's for this passenger.
     *
     * @return \Recranet\OTA\Type\EMDType\ValidatingAirlineAType
     */
     ...
     * The validating airline for all EMD's for this passenger.
     *
     * @param \Recranet\OTA\Type\EMDType\ValidatingAirlineAType $validatingAirline
     * @return self
     */
    public function setValidatingAirline(?\Recranet\OTA\Type\EMDType\ValidatingAirlineAType $validatingAirline = null)
    {
     ...
     * Used to specify tax coupon information.
     *
     * @return \Recranet\OTA\Type\EMDType\TaxCouponInformationAType
     */
     ...
     * Used to specify tax coupon information.
     *
     * @param \Recranet\OTA\Type\EMDType\TaxCouponInformationAType $taxCouponInformation
     * @return self
     */
    public function setTaxCouponInformation(?\Recranet\OTA\Type\EMDType\TaxCouponInformationAType $taxCouponInformation = null)
    {
