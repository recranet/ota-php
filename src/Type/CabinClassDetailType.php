...
class CabinClassDetailType
{
     ...
     *
     * @var \Recranet\OTA\Type\CabinClassAvailabilityType[] $availabilityList
     */
     ...
     *
     * @var \Recranet\OTA\Type\RowDetailType[] $rowInfo
     */
    private $rowInfo = [
     ...
     *
     * @var \Recranet\OTA\Type\SeatDetailsType $seatInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\SeatZoneSummaryType[] $zone
     */
    private $zone = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CabinClassAvailabilityType $availabilityList
     */
    public function addToAvailabilityList(\Recranet\OTA\Type\CabinClassAvailabilityType $availabilityList)
    {
     ...
     * A quick list of each seat in a cabin and its availability. Note, accompanying seat details are in the Summary and Detail elements.
     *
     * @return \Recranet\OTA\Type\CabinClassAvailabilityType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RowDetailType $rowInfo
     */
    public function addToRowInfo(\Recranet\OTA\Type\RowDetailType $rowInfo)
    {
     ...
     * Cabin row information.
     *
     * @return \Recranet\OTA\Type\RowDetailType[]
     */
     ...
     * Summary and detailed seat information.
     *
     * @return \Recranet\OTA\Type\SeatDetailsType
     */
     ...
     * Summary and detailed seat information.
     *
     * @param \Recranet\OTA\Type\SeatDetailsType $seatInfo
     * @return self
     */
    public function setSeatInfo(?\Recranet\OTA\Type\SeatDetailsType $seatInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\SeatZoneSummaryType $zone
     */
    public function addToZone(\Recranet\OTA\Type\SeatZoneSummaryType $zone)
    {
        $this->zone[] = $zone;
        return $this;
    }
     ...
     * Zones associated with the cabin class.
     *
     * @return \Recranet\OTA\Type\SeatZoneSummaryType[]
     */
