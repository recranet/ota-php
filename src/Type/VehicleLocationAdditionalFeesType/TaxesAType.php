...
class TaxesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleLocationAdditionalFeesType\TaxesAType\TaxAType[] $tax
     */
    private $tax = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleLocationAdditionalFeesType\TaxesAType\TaxAType $tax
     */
    public function addToTax(\Recranet\OTA\Type\VehicleLocationAdditionalFeesType\TaxesAType\TaxAType $tax)
    {
        $this->tax[] = $tax;
        return $this;
    }
     ...
     * This element is used to describe one specific tax that may apply.
     *
     * @return \Recranet\OTA\Type\VehicleLocationAdditionalFeesType\TaxesAType\TaxAType[]
     */
