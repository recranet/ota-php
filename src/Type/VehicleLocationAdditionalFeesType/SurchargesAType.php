...
class SurchargesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\VehicleLocationAdditionalFeesType\SurchargesAType\SurchargeAType[] $surcharge
     */
    private $surcharge = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\VehicleLocationAdditionalFeesType\SurchargesAType\SurchargeAType $surcharge
     */
    public function addToSurcharge(\Recranet\OTA\Type\VehicleLocationAdditionalFeesType\SurchargesAType\SurchargeAType $surcharge)
    {
     ...
     * This element is used to describe one specific surcharge that may apply.
     *
     * @return \Recranet\OTA\Type\VehicleLocationAdditionalFeesType\SurchargesAType\SurchargeAType[]
     */
