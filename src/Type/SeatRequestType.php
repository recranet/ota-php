...
class SeatRequestType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirOfferType[] $offers
     */
    private $offers = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirOfferType $offers
     */
    public function addToOffers(\Recranet\OTA\Type\AirOfferType $offers)
    {
        $this->offers[] = $offers;
        return $this;
    }
     ...
     * Summary offer information that applies to this seat.
     *
     * @return \Recranet\OTA\Type\AirOfferType[]
     */
