...
namespace Recranet\OTA\Type\RatePlanCandidatesType;
...
class RatePlanCandidateAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType[] $hotelRefs
     */
     ...
     *
     * @var \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType $mealsIncluded
     */
     ...
     *
     * @var \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType $arrivalPolicy
     */
     ...
     *
     * @var \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType $ratePlanCommission
     */
     ...
     */
    public function addToHotelRefs(\Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType $hotelRef)
    {
     ...
     * A collection of hotel identifiers to which the rate plan applies.
     *
     * @param \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType[] $hotelRefs
     * @return self
     */
     ...
     * Defines which meals are included with this rate plan.
     *
     * @return \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType
     */
     ...
     * Defines which meals are included with this rate plan.
     *
     * @param \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType $mealsIncluded
     * @return self
     */
    public function setMealsIncluded(?\Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType $mealsIncluded = null)
    {
     ...
     * Defines policy types for this rate plan.
     *
     * @return \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType
     */
     ...
     * Defines policy types for this rate plan.
     *
     * @param \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType $arrivalPolicy
     * @return self
     */
    public function setArrivalPolicy(?\Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType $arrivalPolicy = null)
    {
     ...
     * Defines commission attributes for this rate plan.
     *
     * @return \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType
     */
     ...
     * Defines commission attributes for this rate plan.
     *
     * @param \Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType $ratePlanCommission
     * @return self
     */
    public function setRatePlanCommission(?\Recranet\OTA\Type\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType $ratePlanCommission = null)
    {
