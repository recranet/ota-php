...
class VehicleAType extends VehicleType
{
     ...
     *
     * @var \Recranet\OTA\Type\FormattedTextType[] $text
     */
    private $text = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FormattedTextType $text
     */
    public function addToText(\Recranet\OTA\Type\FormattedTextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
