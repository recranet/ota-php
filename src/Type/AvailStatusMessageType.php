...
class AvailStatusMessageType
{
     ...
     *
     * @var \Recranet\OTA\Type\AvailStatusMessageType\BestAvailableRatesAType\BestAvailableRateAType[] $bestAvailableRates
     */
     ...
     *
     * @var \Recranet\OTA\Type\AvailStatusMessageType\HurdleRateAType $hurdleRate
     */
     ...
     *
     * @var \Recranet\OTA\Type\AvailStatusMessageType\DeltaAType $delta
     */
    private $delta = null;
     ...
     *
     * @var \Recranet\OTA\Type\AvailStatusMessageType\RestrictionStatusAType $restrictionStatus
     */
     ...
     */
    public function addToBestAvailableRates(\Recranet\OTA\Type\AvailStatusMessageType\BestAvailableRatesAType\BestAvailableRateAType $bestAvailableRate)
    {
     ...
     * A collection of the best rates available.
     *
     * @param \Recranet\OTA\Type\AvailStatusMessageType\BestAvailableRatesAType\BestAvailableRateAType[] $bestAvailableRates
     * @return self
     */
     ...
     * Restriction based on the minimum rate to be considered for availability, ex. can sell weekend rate only if charging the hurdle rate or more.
     *
     * @return \Recranet\OTA\Type\AvailStatusMessageType\HurdleRateAType
     */
     ...
     * Restriction based on the minimum rate to be considered for availability, ex. can sell weekend rate only if charging the hurdle rate or more.
     *
     * @param \Recranet\OTA\Type\AvailStatusMessageType\HurdleRateAType $hurdleRate
     * @return self
     */
    public function setHurdleRate(?\Recranet\OTA\Type\AvailStatusMessageType\HurdleRateAType $hurdleRate = null)
    {
     ...
     * Incremental amount added to the hurdle rate (e.g. Amount= 20 USD and Ceiling=5, the maximum Delta would be 100 USD).
     *
     * @return \Recranet\OTA\Type\AvailStatusMessageType\DeltaAType
     */
     ...
     * Incremental amount added to the hurdle rate (e.g. Amount= 20 USD and Ceiling=5, the maximum Delta would be 100 USD).
     *
     * @param \Recranet\OTA\Type\AvailStatusMessageType\DeltaAType $delta
     * @return self
     */
    public function setDelta(?\Recranet\OTA\Type\AvailStatusMessageType\DeltaAType $delta = null)
    {
        $this->delta = $delta;
        return $this;
    }
     ...
     * Availability status assigned to the room rate combination.
     *
     * @return \Recranet\OTA\Type\AvailStatusMessageType\RestrictionStatusAType
     */
     ...
     * Availability status assigned to the room rate combination.
     *
     * @param \Recranet\OTA\Type\AvailStatusMessageType\RestrictionStatusAType $restrictionStatus
     * @return self
     */
    public function setRestrictionStatus(?\Recranet\OTA\Type\AvailStatusMessageType\RestrictionStatusAType $restrictionStatus = null)
    {
