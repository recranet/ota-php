...
class AllianceConsortiumType
{
     ...
     *
     * @var \Recranet\OTA\Type\AllianceConsortiumType\AllianceMemberAType[] $allianceMember
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AllianceConsortiumType\AllianceMemberAType $allianceMember
     */
    public function addToAllianceMember(\Recranet\OTA\Type\AllianceConsortiumType\AllianceMemberAType $allianceMember)
    {
     ...
     * Identification of a company that participates in an alliance or consortium to which the primary business entity identified in this profile belongs.
     *
     * @return \Recranet\OTA\Type\AllianceConsortiumType\AllianceMemberAType[]
     */
