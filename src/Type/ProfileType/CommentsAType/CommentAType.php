...
namespace Recranet\OTA\Type\ProfileType\CommentsAType;
...
class CommentAType extends ParagraphType
{
     ...
     *
     * @var \Recranet\OTA\Type\ProfileType\CommentsAType\CommentAType\AuthorizedViewerAType[] $authorizedViewer
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ProfileType\CommentsAType\CommentAType\AuthorizedViewerAType $authorizedViewer
     */
    public function addToAuthorizedViewer(\Recranet\OTA\Type\ProfileType\CommentsAType\CommentAType\AuthorizedViewerAType $authorizedViewer)
    {
     ...
     * Specifies those authorized to view a comment.
     *
     * @return \Recranet\OTA\Type\ProfileType\CommentsAType\CommentAType\AuthorizedViewerAType[]
     */
