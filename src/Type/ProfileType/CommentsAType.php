...
class CommentsAType
{
     ...
     * Comment details.
     *
     * @var \Recranet\OTA\Type\ProfileType\CommentsAType\CommentAType[] $comment
     */
    private $comment = [
     ...
     */
    public function addToComment(\Recranet\OTA\Type\ProfileType\CommentsAType\CommentAType $comment)
    {
