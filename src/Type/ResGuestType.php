...
class ResGuestType
{
     ...
     *
     * @var \Recranet\OTA\Type\SpecialRequestType\SpecialRequestAType[] $specialRequests
     */
     ...
     *
     * @var \Recranet\OTA\Type\CommentType\CommentAType[] $comments
     */
     ...
     *
     * @var \Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType[] $profileRPHs
     */
    private $profileRPHs = null;

    /**
     * @var \Recranet\OTA\Type\TransportInfoType\TransportInfoAType[] $arrivalTransport
     */
    private $arrivalTransport = null;

    /**
     * @var \Recranet\OTA\Type\TransportInfoType\TransportInfoAType[] $departureTransport
     */
    ...
    /**
     * @var \Recranet\OTA\Type\DateTimeSpanType $inHouseTimeSpan
     */
     ...
     */
    public function addToSpecialRequests(\Recranet\OTA\Type\SpecialRequestType\SpecialRequestAType $specialRequest)
    {
     ...
     * The SpecialRequest object indicates special requests for a particular guest.
     *
     * @param \Recranet\OTA\Type\SpecialRequestType\SpecialRequestAType[] $specialRequests
     * @return self
     */
     ...
     */
    public function addToComments(\Recranet\OTA\Type\CommentType\CommentAType $comment)
    {
     ...
     * A collection of Comment objects. Comments which apply to one or more guests.
     *
     * @param \Recranet\OTA\Type\CommentType\CommentAType[] $comments
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType $profileRPH
     */
    public function addToProfileRPHs(\Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType $profileRPH)
    {
     ...
     * Collection of ProfileRPH.
     *
     * @return \Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType[]
     */
     ...
     * Collection of ProfileRPH.
     *
     * @param \Recranet\OTA\Type\ResGuestType\ProfileRPHsAType\ProfileRPHAType[] $profileRPHs
     * @return self
     */
     ...
     */
    public function addToArrivalTransport(\Recranet\OTA\Type\TransportInfoType\TransportInfoAType $transportInfo)
    {
     ...
     *
     * @param \Recranet\OTA\Type\TransportInfoType\TransportInfoAType[] $arrivalTransport
     * @return self
     */
     ...
     * @param \Recranet\OTA\Type\TransportInfoType\TransportInfoAType $transportInfo
     */
    public function addToDepartureTransport(\Recranet\OTA\Type\TransportInfoType\TransportInfoAType $transportInfo)
    {
     ...
     *
     * @param \Recranet\OTA\Type\TransportInfoType\TransportInfoAType[] $departureTransport
     * @return self
     */
     ...
     *
     * @param \Recranet\OTA\Type\DateTimeSpanType $inHouseTimeSpan
     * @return self
     */
    public function setInHouseTimeSpan(?\Recranet\OTA\Type\DateTimeSpanType $inHouseTimeSpan = null)
    {
