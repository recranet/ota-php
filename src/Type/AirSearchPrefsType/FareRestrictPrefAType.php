...
class FareRestrictPrefAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AdvResTicketingType $advResTicketing
     */
     ...
     *
     * @var \Recranet\OTA\Type\StayRestrictionsType $stayRestrictions
     */
     ...
     * Identifies whether advance reservation or ticketing restrictions are acceptable in the search results.
     *
     * @return \Recranet\OTA\Type\AdvResTicketingType
     */
     ...
     * Identifies whether advance reservation or ticketing restrictions are acceptable in the search results.
     *
     * @param \Recranet\OTA\Type\AdvResTicketingType $advResTicketing
     * @return self
     */
    public function setAdvResTicketing(?\Recranet\OTA\Type\AdvResTicketingType $advResTicketing = null)
    {
     ...
     * Identifies whether restrictions on minimum or maximum stays should be included in the search results.
     *
     * @param \Recranet\OTA\Type\StayRestrictionsType $stayRestrictions
     * @return self
     */
    public function setStayRestrictions(?\Recranet\OTA\Type\StayRestrictionsType $stayRestrictions = null)
    {
