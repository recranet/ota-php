...
namespace Recranet\OTA\Type\OTAHotelRFPMeetingNotifRQ;

use Recranet\OTA\Type\RFPResponseType;

/**
 * Class representing OTAHotelRFPMeetingNotifRQAType
 */
class OTAHotelRFPMeetingNotifRQAType extends RFPResponseType
{
    /**
