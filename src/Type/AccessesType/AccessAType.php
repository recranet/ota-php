...
namespace Recranet\OTA\Type\AccessesType;
...
class AccessAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PersonNameType $accessPerson
     */
     ...
     *
     * @var \Recranet\OTA\Type\FreeTextType $accessComment
     */
     ...
     * Name of individual who originated or updated record.
     *
     * @param \Recranet\OTA\Type\PersonNameType $accessPerson
     * @return self
     */
    public function setAccessPerson(?\Recranet\OTA\Type\PersonNameType $accessPerson = null)
    {
     ...
     * Free text comment added by the person accessing the profile record.
     *
     * @param \Recranet\OTA\Type\FreeTextType $accessComment
     * @return self
     */
    public function setAccessComment(?\Recranet\OTA\Type\FreeTextType $accessComment = null)
    {
