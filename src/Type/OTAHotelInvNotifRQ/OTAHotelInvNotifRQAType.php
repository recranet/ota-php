...
namespace Recranet\OTA\Type\OTAHotelInvNotifRQ;

/**
 * Class representing OTAHotelInvNotifRQAType
 */
class OTAHotelInvNotifRQAType
{
    /**
    ...
    /**
     * The unique identifier element allows the trading partners to uniquely identify each InvNotifRQ, (i.e. the entire message) for transaction tracability.
     *
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelInvNotifRQ\OTAHotelInvNotifRQAType\SellableProductsAType $sellableProducts
     */
     ...
     * A collection of Sellable products for a given hotel.
     *
     * @return \Recranet\OTA\Type\OTAHotelInvNotifRQ\OTAHotelInvNotifRQAType\SellableProductsAType
     */
     ...
     * A collection of Sellable products for a given hotel.
     *
     * @param \Recranet\OTA\Type\OTAHotelInvNotifRQ\OTAHotelInvNotifRQAType\SellableProductsAType $sellableProducts
     * @return self
     */
    public function setSellableProducts(\Recranet\OTA\Type\OTAHotelInvNotifRQ\OTAHotelInvNotifRQAType\SellableProductsAType $sellableProducts)
    {
