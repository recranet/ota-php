...
class RatePlansAType
{
     ...
     *
     * @var \Recranet\OTA\Type\HotelProductType\RatePlansAType\RatePlanAType[] $ratePlan
     */
    private $ratePlan = [
     ...
     */
    public function addToRatePlan(\Recranet\OTA\Type\HotelProductType\RatePlansAType\RatePlanAType $ratePlan)
    {
