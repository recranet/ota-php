...
namespace Recranet\OTA\Type\HotelProductType\PolicyInfoAType;
...
class BookingRulesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\HotelProductType\PolicyInfoAType\BookingRulesAType\BookingRuleAType[] $bookingRule
     */
    private $bookingRule = [
     ...
     */
    public function addToBookingRule(\Recranet\OTA\Type\HotelProductType\PolicyInfoAType\BookingRulesAType\BookingRuleAType $bookingRule)
    {
