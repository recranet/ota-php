...
class AttractionsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AreaInfoType\AttractionsAType\AttractionAType[] $attraction
     */
    private $attraction = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AreaInfoType\AttractionsAType\AttractionAType $attraction
     */
    public function addToAttraction(\Recranet\OTA\Type\AreaInfoType\AttractionsAType\AttractionAType $attraction)
    {
     ...
     * This identifies an item of local interest (e.g. theme park, airport, museum, rail station, university).
     *
     * @return \Recranet\OTA\Type\AreaInfoType\AttractionsAType\AttractionAType[]
     */
