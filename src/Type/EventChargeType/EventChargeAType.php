...
namespace Recranet\OTA\Type\EventChargeType;
...
{
    /**
     * This describes charges related to an event (e.g. set-up; room rental; break-out; breakfast; lunch; dinner; miscellaneous). Refer to OpenTravel Code List Event Charge (EVT).
     *
     * @var string $eventCharge
     */
    private $eventCharge = null;

    /**
     * This is used to indicate the basis of the charge (e.g. per person). Refer to OpenTravel Code List Charge Type (CHG).
     *
     * @var string $primaryChargeType
     */
    private $primaryChargeType = null;

    /**
     * This is used in conjunction with the PrimaryChargeType to indicate the basis of the charge (e.g. per person, per day, where per person is the PrimaryChargeType and per day is the SecondaryChargeType). Refer to OpenTravel Code List Charge Type (CHG).
     *
     * @var string $secondaryChargeType
     */
    private $secondaryChargeType = null;

    /**
     * This is used when MinChargeAmount and MaxChargeAmount are percentages and it refers to what the percentage is applied. For example, the EventCharge may be gratuity, the AppliedPercentageEventCharge is Food and Beverage, and the MinChargeAmount is 15%, indicating the 15% gratutity applies to all Food and Beverage charges. Refer to OpenTravel Code List Event Charge (EVT).
     *
     * @var string $appliedPercentageEventCharge
     */
     ...
     *
     * @var float $maxChargeAmount
     */
    private $maxChargeAmount = null;

    /**
     * @var float $averageChargeAmount
     */
     ...
     * @return self
     */
    public function setTaxes(\Recranet\OTA\Type\TaxesType $taxes)
    {
        $this->taxes = $taxes;
        return $this;
    }
