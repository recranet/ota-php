...
namespace Recranet\OTA\Type\OTAHotelStayInfoNotifRQ;

/**
 * Class representing OTAHotelStayInfoNotifRQAType
 */
class OTAHotelStayInfoNotifRQAType
{
    /**
     ...
     * @return self
     */
    public function setStayInfos(\Recranet\OTA\Type\StayInfosType $stayInfos)
    {
