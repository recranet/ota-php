...
class PTCFareBreakdownType
{
     ...
     *
     * @var \Recranet\OTA\Type\FareBasisCodeType[] $fareBasisCodes
     */
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\PassengerFareAType[] $passengerFare
     */
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\TravelerRefNumberAType[] $travelerRefNumber
     */
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\TicketDesignatorsAType\TicketDesignatorAType[] $ticketDesignators
     */
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType $endorsements
     */
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\FareInfoAType[] $fareInfo
     */
    private $fareInfo = [
     ...
     *
     * @var \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType[] $pricingUnit
     */
    private $pricingUnit = [
     ...
     * @return self
     */
    public function setPassengerTypeQuantity(\Recranet\OTA\Type\PassengerTypeQuantityType $passengerTypeQuantity)
    {
     ...
     */
    public function addToFareBasisCodes(\Recranet\OTA\Type\FareBasisCodeType $fareBasisCode)
    {
     ...
     * This is a collection of fare basis codes.
     *
     * @param \Recranet\OTA\Type\FareBasisCodeType[] $fareBasisCodes
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\PassengerFareAType $passengerFare
     */
    public function addToPassengerFare(\Recranet\OTA\Type\PTCFareBreakdownType\PassengerFareAType $passengerFare)
    {
     ...
     * The total passenger fare with cost breakdown.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\PassengerFareAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\TravelerRefNumberAType $travelerRefNumber
     */
    public function addToTravelerRefNumber(\Recranet\OTA\Type\PTCFareBreakdownType\TravelerRefNumberAType $travelerRefNumber)
    {
     ...
     * Contains the RPH reference to the traveler.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\TravelerRefNumberAType[]
     */
     ...
     */
    public function addToTicketDesignators(\Recranet\OTA\Type\PTCFareBreakdownType\TicketDesignatorsAType\TicketDesignatorAType $ticketDesignator)
    {
     ...
     * This is a collection of ticket designator elements.
     *
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\TicketDesignatorsAType\TicketDesignatorAType[] $ticketDesignators
     * @return self
     */
     ...
     * Container for endorsements.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType
     */
     ...
     * Container for endorsements.
     *
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType $endorsements
     * @return self
     */
    public function setEndorsements(?\Recranet\OTA\Type\PTCFareBreakdownType\EndorsementsAType $endorsements = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\FareInfoAType $fareInfo
     */
    public function addToFareInfo(\Recranet\OTA\Type\PTCFareBreakdownType\FareInfoAType $fareInfo)
    {
     ...
     * Detailed information on individual priced fares.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\FareInfoAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType $pricingUnit
     */
    public function addToPricingUnit(\Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType $pricingUnit)
    {
     ...
     * A pricing unit for a passenger type code.
     *
     * @return \Recranet\OTA\Type\PTCFareBreakdownType\PricingUnitAType[]
     */
