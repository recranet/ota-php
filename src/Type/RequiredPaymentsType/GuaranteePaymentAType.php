...
namespace Recranet\OTA\Type\RequiredPaymentsType;
...
class GuaranteePaymentAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AmountPercentAType $amountPercent
     */
     ...
     *
     * @var \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\DeadlineAType[] $deadline
     */
    private $deadline = [
     ...
     *
     * @var \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AddressAType[] $address
     */
    private $address = [
     ...
     * Payment expressed as a fixed amount, or a percentage of/or room nights.
     *
     * @return \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AmountPercentAType
     */
     ...
     * Payment expressed as a fixed amount, or a percentage of/or room nights.
     *
     * @param \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AmountPercentAType $amountPercent
     * @return self
     */
    public function setAmountPercent(?\Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AmountPercentAType $amountPercent = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\DeadlineAType $deadline
     */
    public function addToDeadline(\Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\DeadlineAType $deadline)
    {
     ...
     * Payment deadline, absolute or relative.
     *
     * @return \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\DeadlineAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AddressAType $address
     */
    public function addToAddress(\Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AddressAType $address)
    {
     ...
     * The address to which a deposit may be sent.
     *
     * @return \Recranet\OTA\Type\RequiredPaymentsType\GuaranteePaymentAType\AddressAType[]
     */
