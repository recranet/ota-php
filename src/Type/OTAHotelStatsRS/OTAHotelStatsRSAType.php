...
namespace Recranet\OTA\Type\OTAHotelStatsRS;
...
class OTAHotelStatsRSAType
{
     ...
     *
     * @var \Recranet\OTA\Type\StatisticType[] $statistics
     */
     ...
     * @return self
     */
    public function setWarnings(?\Recranet\OTA\Type\WarningType $warnings = null)
    {
     ...
     */
    public function addToStatistics(\Recranet\OTA\Type\StatisticType $statistic)
    {
     ...
     * Collection of Statistic elements, one for each report being returned.
     *
     * @param \Recranet\OTA\Type\StatisticType[] $statistics
     * @return self
     */
