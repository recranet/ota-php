...
namespace Recranet\OTA\Type\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType;

use Recranet\OTA\Type\HotelDescriptiveInfoRequestType;
...
class HotelDescriptiveInfoAType extends HotelDescriptiveInfoRequestType
{
     ...
     * These may be used to filter the response of requested data.
     *
     * @var string[] $brandCodeList
     */
    private $brandCodeList = null;

    /**
     * The response returns the attribute if there was additional data. The text value should be echoed in this request to indicate where to begin the next block of data.
     *
