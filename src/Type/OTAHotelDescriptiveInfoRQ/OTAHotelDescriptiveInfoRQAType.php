...
namespace Recranet\OTA\Type\OTAHotelDescriptiveInfoRQ;

/**
 * Class representing OTAHotelDescriptiveInfoRQAType
 */
class OTAHotelDescriptiveInfoRQAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType $hotelDescriptiveInfos
     */
     ...
     * Collection of items for data from multiple hotels.
     *
     * @return \Recranet\OTA\Type\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType
     */
     ...
     * Collection of items for data from multiple hotels.
     *
     * @param \Recranet\OTA\Type\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType $hotelDescriptiveInfos
     * @return self
     */
    public function setHotelDescriptiveInfos(\Recranet\OTA\Type\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType $hotelDescriptiveInfos)
    {
