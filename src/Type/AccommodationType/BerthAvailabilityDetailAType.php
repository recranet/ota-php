...
namespace Recranet\OTA\Type\AccommodationType;
...
class BerthAvailabilityDetailAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AccommodationType\BerthAvailabilityDetailAType\CarAType[] $car
     */
    private $car = [
     ...
     */
    public function addToCar(\Recranet\OTA\Type\AccommodationType\BerthAvailabilityDetailAType\CarAType $car)
    {
        $this->car[] = $car;
        return $this;
    }
