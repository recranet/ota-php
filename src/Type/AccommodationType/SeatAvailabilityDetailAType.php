...
class SeatAvailabilityDetailAType
{
     ...
     * A car on this train.
     *
     * @var \Recranet\OTA\Type\AccommodationType\SeatAvailabilityDetailAType\CarAType[] $car
     */
    private $car = [
     ...
     */
    public function addToCar(\Recranet\OTA\Type\AccommodationType\SeatAvailabilityDetailAType\CarAType $car)
    {
        $this->car[] = $car;
        return $this;
    }
