...
class AirPricedOfferType
{
     ...
     * A detailed description of the ancillary item.
     *
     * @var \Recranet\OTA\Type\FormattedTextType[] $longDescription
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\PricingAType $pricing
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\OriginDestinationAType[] $originDestination
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\SeatInfoAType $seatInfo
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\OtherServicesAType[] $otherServices
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\TripInsuranceAType $tripInsurance
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\BookingInstructionAType $bookingInstruction
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\RestrictionAType[] $restriction
     */
    private $restriction = [
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType[] $termsAndConditions
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\MultimediaAType[] $multimedia
     */
    private $multimedia = [
     ...
     *
     * @var \Recranet\OTA\Type\UniqueIDType[] $bookingReferenceID
     */
     ...
     * @return self
     */
    public function setServiceFamily(\Recranet\OTA\Type\AncillaryServiceDetailType $serviceFamily)
    {
     ...
     */
    public function addToShortDescription(\Recranet\OTA\Type\FormattedTextTextType $shortDescription)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\FormattedTextType $longDescription
     */
    public function addToLongDescription(\Recranet\OTA\Type\FormattedTextType $longDescription)
    {
     ...
     * Offer pricing information, including amounts, tax(s), service family, pricing rules, pricing influencers, exchange rate and redemption amounts.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\PricingAType
     */
     ...
     * Offer pricing information, including amounts, tax(s), service family, pricing rules, pricing influencers, exchange rate and redemption amounts.
     *
     * @param \Recranet\OTA\Type\AirPricedOfferType\PricingAType $pricing
     * @return self
     */
    public function setPricing(\Recranet\OTA\Type\AirPricedOfferType\PricingAType $pricing)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricedOfferType\OriginDestinationAType $originDestination
     */
    public function addToOriginDestination(\Recranet\OTA\Type\AirPricedOfferType\OriginDestinationAType $originDestination)
    {
     ...
     * Origin and Destination location and time information for the trip.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\OriginDestinationAType[]
     */
     ...
     * Additional details on seat offers or change requests.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\SeatInfoAType
     */
     ...
     * Additional details on seat offers or change requests.
     *
     * @param \Recranet\OTA\Type\AirPricedOfferType\SeatInfoAType $seatInfo
     * @return self
     */
    public function setSeatInfo(?\Recranet\OTA\Type\AirPricedOfferType\SeatInfoAType $seatInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricedOfferType\OtherServicesAType $otherServices
     */
    public function addToOtherServices(\Recranet\OTA\Type\AirPricedOfferType\OtherServicesAType $otherServices)
    {
     ...
     * Information related to non air products, such as lounge passes and clothing.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\OtherServicesAType[]
     */
     ...
     * Trip insurance offer information.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\TripInsuranceAType
     */
     ...
     * Trip insurance offer information.
     *
     * @param \Recranet\OTA\Type\AirPricedOfferType\TripInsuranceAType $tripInsurance
     * @return self
     */
    public function setTripInsurance(?\Recranet\OTA\Type\AirPricedOfferType\TripInsuranceAType $tripInsurance = null)
    {
     ...
     * Booking and upgrade instructions.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\BookingInstructionAType
     */
     ...
     * Booking and upgrade instructions.
     *
     * @param \Recranet\OTA\Type\AirPricedOfferType\BookingInstructionAType $bookingInstruction
     * @return self
     */
    public function setBookingInstruction(?\Recranet\OTA\Type\AirPricedOfferType\BookingInstructionAType $bookingInstruction = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricedOfferType\RestrictionAType $restriction
     */
    public function addToRestriction(\Recranet\OTA\Type\AirPricedOfferType\RestrictionAType $restriction)
    {
     ...
     * Restrictions that apply to the priced offer, such as ???Seat requests available up to 24 hours before departure".
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\RestrictionAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType $termsAndConditions
     */
    public function addToTermsAndConditions(\Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType $termsAndConditions)
    {
     ...
     * Terms and conditions that apply to the offer.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricedOfferType\MultimediaAType $multimedia
     */
    public function addToMultimedia(\Recranet\OTA\Type\AirPricedOfferType\MultimediaAType $multimedia)
    {
     ...
     * Images, etc. of the ancillary item.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\MultimediaAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\UniqueIDType $bookingReferenceID
     */
    public function addToBookingReferenceID(\Recranet\OTA\Type\UniqueIDType $bookingReferenceID)
    {
