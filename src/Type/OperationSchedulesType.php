...
class OperationSchedulesType
{
     ...
     *
     * @var \Recranet\OTA\Type\OperationScheduleType[] $operationSchedule
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OperationScheduleType $operationSchedule
     */
    public function addToOperationSchedule(\Recranet\OTA\Type\OperationScheduleType $operationSchedule)
    {
     ...
     * The OperationSchedule class defines the dates and hours of operation.
     *
     * @return \Recranet\OTA\Type\OperationScheduleType[]
     */
