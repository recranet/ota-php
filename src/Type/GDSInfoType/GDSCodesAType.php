...
namespace Recranet\OTA\Type\GDSInfoType;
...
class GDSCodesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\GDSInfoType\GDSCodesAType\GDSCodeAType[] $gDSCode
     */
    private $gDSCode = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\GDSInfoType\GDSCodesAType\GDSCodeAType $gDSCode
     */
    public function addToGDSCode(\Recranet\OTA\Type\GDSInfoType\GDSCodesAType\GDSCodeAType $gDSCode)
    {
     ...
     * Provides detailed information regarding the specified GDS.
     *
     * @return \Recranet\OTA\Type\GDSInfoType\GDSCodesAType\GDSCodeAType[]
     */
