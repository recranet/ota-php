...
class GDSStatusesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\GDSInfoType\GDSStatusesAType\GDSStatusAType[] $gDSStatus
     */
    private $gDSStatus = [
     ...
     */
    public function addToGDSStatus(\Recranet\OTA\Type\GDSInfoType\GDSStatusesAType\GDSStatusAType $gDSStatus)
    {
