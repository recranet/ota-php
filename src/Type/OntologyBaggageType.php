...
class OntologyBaggageType
{
     ...
     *
     * @var \Recranet\OTA\Type\OntologyWeightType $totalWeight
     */
     ...
     *
     * @var \Recranet\OTA\Type\OntologyBaggageType\DetailAType[] $detail
     */
    private $detail = [
     ...
     * Total weight for all baggage items.
     *
     * @param \Recranet\OTA\Type\OntologyWeightType $totalWeight
     * @return self
     */
    public function setTotalWeight(?\Recranet\OTA\Type\OntologyWeightType $totalWeight = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OntologyBaggageType\DetailAType $detail
     */
    public function addToDetail(\Recranet\OTA\Type\OntologyBaggageType\DetailAType $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * Baggage item details.
     *
     * @return \Recranet\OTA\Type\OntologyBaggageType\DetailAType[]
     */
