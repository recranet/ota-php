...
class BasicPropertyInfoType
{
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\PositionAType $position
     */
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\ContactNumbersAType\ContactNumberAType[] $contactNumbers
     */
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\AwardAType[] $award
     */
    private $award = [
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\HotelAmenityAType[] $hotelAmenity
     */
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\HotelFeatureAType[] $hotelFeature
     */
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\RecreationAType[] $recreation
     */
    private $recreation = [
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\ServiceAType[] $service
     */
    private $service = [
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\PolicyAType $policy
     */
    private $policy = null;
     ...
     *
     * @var \Recranet\OTA\Type\BasicPropertyInfoType\HotelMeetingFacilityAType[] $hotelMeetingFacility
     */
     ...
     * An element that identifies the geographic position of the hotel. The Position element uses the representation defined by ISO Standard 6709 to define a geographic point location.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\PositionAType
     */
     ...
     * An element that identifies the geographic position of the hotel. The Position element uses the representation defined by ISO Standard 6709 to define a geographic point location.
     *
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\PositionAType $position
     * @return self
     */
    public function setPosition(?\Recranet\OTA\Type\BasicPropertyInfoType\PositionAType $position = null)
    {
     ...
     * @return self
     */
    public function setAddress(?\Recranet\OTA\Type\AddressInfoType $address = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\ContactNumbersAType\ContactNumberAType $contactNumber
     */
    public function addToContactNumbers(\Recranet\OTA\Type\BasicPropertyInfoType\ContactNumbersAType\ContactNumberAType $contactNumber)
    {
     ...
     * Collection of hotel contact numbers.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\ContactNumbersAType\ContactNumberAType[]
     */
     ...
     * Collection of hotel contact numbers.
     *
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\ContactNumbersAType\ContactNumberAType[] $contactNumbers
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\AwardAType $award
     */
    public function addToAward(\Recranet\OTA\Type\BasicPropertyInfoType\AwardAType $award)
    {
        $this->award[] = $award;
        return $this;
    }
     ...
     * An element that identifies the hotel ratings.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\AwardAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\HotelAmenityAType $hotelAmenity
     */
    public function addToHotelAmenity(\Recranet\OTA\Type\BasicPropertyInfoType\HotelAmenityAType $hotelAmenity)
    {
     ...
     * Hotel-level amenities (pool, etc) for searching.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\HotelAmenityAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\HotelFeatureAType $hotelFeature
     */
    public function addToHotelFeature(\Recranet\OTA\Type\BasicPropertyInfoType\HotelFeatureAType $hotelFeature)
    {
     ...
     * Identifies features of a property.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\HotelFeatureAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\RecreationAType $recreation
     */
    public function addToRecreation(\Recranet\OTA\Type\BasicPropertyInfoType\RecreationAType $recreation)
    {
     ...
     * Identifies recreation facilities or amenities of interest.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\RecreationAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\ServiceAType $service
     */
    public function addToService(\Recranet\OTA\Type\BasicPropertyInfoType\ServiceAType $service)
    {
     ...
     * Identifies business services of interest.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\ServiceAType[]
     */
     ...
     * Policy information for this hotel.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\PolicyAType
     */
     ...
     * Policy information for this hotel.
     *
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\PolicyAType $policy
     * @return self
     */
    public function setPolicy(?\Recranet\OTA\Type\BasicPropertyInfoType\PolicyAType $policy = null)
    {
        $this->policy = $policy;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BasicPropertyInfoType\HotelMeetingFacilityAType $hotelMeetingFacility
     */
    public function addToHotelMeetingFacility(\Recranet\OTA\Type\BasicPropertyInfoType\HotelMeetingFacilityAType $hotelMeetingFacility)
    {
     ...
     * Identifies hotel meeting facility information for a property.
     *
     * @return \Recranet\OTA\Type\BasicPropertyInfoType\HotelMeetingFacilityAType[]
     */
