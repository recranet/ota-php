...
class FlightSegmentBaseType
{
     ...
     *
     * @var \Recranet\OTA\Type\FlightSegmentBaseType\DepartureAirportAType $departureAirport
     */
     ...
     *
     * @var \Recranet\OTA\Type\FlightSegmentBaseType\ArrivalAirportAType $arrivalAirport
     */
     ...
     *
     * @var \Recranet\OTA\Type\OperatingAirlineType $operatingAirline
     */
     ...
     * Departure point of flight segment.
     *
     * @return \Recranet\OTA\Type\FlightSegmentBaseType\DepartureAirportAType
     */
     ...
     * Departure point of flight segment.
     *
     * @param \Recranet\OTA\Type\FlightSegmentBaseType\DepartureAirportAType $departureAirport
     * @return self
     */
    public function setDepartureAirport(?\Recranet\OTA\Type\FlightSegmentBaseType\DepartureAirportAType $departureAirport = null)
    {
     ...
     * Arrival point of flight segment.
     *
     * @return \Recranet\OTA\Type\FlightSegmentBaseType\ArrivalAirportAType
     */
     ...
     * Arrival point of flight segment.
     *
     * @param \Recranet\OTA\Type\FlightSegmentBaseType\ArrivalAirportAType $arrivalAirport
     * @return self
     */
    public function setArrivalAirport(?\Recranet\OTA\Type\FlightSegmentBaseType\ArrivalAirportAType $arrivalAirport = null)
    {
     ...
     * The operating airline of the flight if it is a codeshare flight.
     *
     * @return \Recranet\OTA\Type\OperatingAirlineType
     */
     ...
     * The operating airline of the flight if it is a codeshare flight.
     *
     * @param \Recranet\OTA\Type\OperatingAirlineType $operatingAirline
     * @return self
     */
    public function setOperatingAirline(?\Recranet\OTA\Type\OperatingAirlineType $operatingAirline = null)
    {
