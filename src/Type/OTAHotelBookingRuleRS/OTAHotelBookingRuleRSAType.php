...
namespace Recranet\OTA\Type\OTAHotelBookingRuleRS;

/**
 * Class representing OTAHotelBookingRuleRSAType
 */
class OTAHotelBookingRuleRSAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType $ruleMessage
     */
     ...
     * Specifies the hotel chain and property to which the booking rules apply.
     *
     * @return \Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType
     */
     ...
     * Specifies the hotel chain and property to which the booking rules apply.
     *
     * @param \Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType $ruleMessage
     * @return self
     */
    public function setRuleMessage(?\Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType $ruleMessage = null)
    {
