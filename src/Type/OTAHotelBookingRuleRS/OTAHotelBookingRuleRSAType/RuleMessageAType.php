...
namespace Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType;
...
class RuleMessageAType
{
     ...
     *
     * @var \Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType\StatusApplicationAType $statusApplication
     */
     ...
     *
     * @var \Recranet\OTA\Type\ParagraphType $advisoryText
     */
     ...
     * Specifies the check-in and check-out dates and the booking code or room type to which the booking rules apply.
     *
     * @return \Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType\StatusApplicationAType
     */
     ...
     * Specifies the check-in and check-out dates and the booking code or room type to which the booking rules apply.
     *
     * @param \Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType\StatusApplicationAType $statusApplication
     * @return self
     */
    public function setStatusApplication(?\Recranet\OTA\Type\OTAHotelBookingRuleRS\OTAHotelBookingRuleRSAType\RuleMessageAType\StatusApplicationAType $statusApplication = null)
    {
     ...
     * Advisory text related to the booking rules.
     *
     * @param \Recranet\OTA\Type\ParagraphType $advisoryText
     * @return self
     */
    public function setAdvisoryText(?\Recranet\OTA\Type\ParagraphType $advisoryText = null)
    {
