...
namespace Recranet\OTA\Type\RFPTransientDetailsType;
...
class RFPTransientResponsesAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RFPTransientResponseType[] $rFPTransientResponse
     */
     ...
     */
    public function addToRFPTransientResponse(\Recranet\OTA\Type\RFPTransientResponseType $rFPTransientResponse)
    {
