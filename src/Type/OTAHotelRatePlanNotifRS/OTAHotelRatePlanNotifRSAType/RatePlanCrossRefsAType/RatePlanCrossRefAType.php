...
namespace Recranet\OTA\Type\OTAHotelRatePlanNotifRS\OTAHotelRatePlanNotifRSAType\RatePlanCrossRefsAType;
...
class RatePlanCrossRefAType
{
     ...
     *
     * @var string $requestRatePlanCode
     */
     ...
     *
     * @var string $requestRatePlanGroupingCode
     */
     ...
     *
     * @var string $responseRatePlanCode
     */
     ...
     *
     * @var string $responseRatePlanGroupingCode
     */
