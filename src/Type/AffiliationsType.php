...
class AffiliationsType
{
     ...
     *
     * @var \Recranet\OTA\Type\OrganizationType[] $organization
     */
     ...
     *
     * @var \Recranet\OTA\Type\EmployerType[] $employer
     */
    private $employer = [
     ...
     *
     * @var \Recranet\OTA\Type\TravelClubType[] $travelClub
     */
    private $travelClub = [
     ...
     *
     * @var \Recranet\OTA\Type\InsuranceType[] $insurance
     */
    private $insurance = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\OrganizationType $organization
     */
    public function addToOrganization(\Recranet\OTA\Type\OrganizationType $organization)
    {
     ...
     * Detailed information for a membership organization that has travel benefits, programs or discounts.
     *
     * @return \Recranet\OTA\Type\OrganizationType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\EmployerType $employer
     */
    public function addToEmployer(\Recranet\OTA\Type\EmployerType $employer)
    {
     ...
     * Employer information associated to this affiliation.
     *
     * @return \Recranet\OTA\Type\EmployerType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\TravelClubType $travelClub
     */
    public function addToTravelClub(\Recranet\OTA\Type\TravelClubType $travelClub)
    {
     ...
     * A club that offers special privileges and related services for this affiliation.
     *
     * @return \Recranet\OTA\Type\TravelClubType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\InsuranceType $insurance
     */
    public function addToInsurance(\Recranet\OTA\Type\InsuranceType $insurance)
    {
     ...
     * Travel insurance associated to this affiliation.
     *
     * @return \Recranet\OTA\Type\InsuranceType[]
     */
