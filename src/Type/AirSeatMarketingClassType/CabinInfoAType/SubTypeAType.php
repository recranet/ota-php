...
namespace Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType;
...
{
    /**
     * A seat preference. Use a value from the OpenTravel Seat Type Preference (STP) code list or enter a string value known to your trading partners.
     *
     * @var string $seatType
     */
