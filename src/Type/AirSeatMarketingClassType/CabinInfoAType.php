...
namespace Recranet\OTA\Type\AirSeatMarketingClassType;
...
class CabinInfoAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType\SubTypeAType[] $subType
     */
    private $subType = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType\SubTypeAType $subType
     */
    public function addToSubType(\Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType\SubTypeAType $subType)
    {
     ...
     * Cabin sub-type information. This is typically used to describe virtual marketing cabin information associated with the cabin.
     *
     * @return \Recranet\OTA\Type\AirSeatMarketingClassType\CabinInfoAType\SubTypeAType[]
     */
