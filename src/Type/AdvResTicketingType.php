...
class AdvResTicketingType
{
     ...
     *
     * @var \Recranet\OTA\Type\AdvResTicketingType\AdvReservationAType $advReservation
     */
     ...
     *
     * @var \Recranet\OTA\Type\AdvResTicketingType\AdvTicketingAType $advTicketing
     */
     ...
     * Specifies constraints on when advance reservations can be made.
     *
     * @return \Recranet\OTA\Type\AdvResTicketingType\AdvReservationAType
     */
     ...
     * Specifies constraints on when advance reservations can be made.
     *
     * @param \Recranet\OTA\Type\AdvResTicketingType\AdvReservationAType $advReservation
     * @return self
     */
    public function setAdvReservation(?\Recranet\OTA\Type\AdvResTicketingType\AdvReservationAType $advReservation = null)
    {
     ...
     * Specifies advance ticketing restrictions.
     *
     * @return \Recranet\OTA\Type\AdvResTicketingType\AdvTicketingAType
     */
     ...
     * Specifies advance ticketing restrictions.
     *
     * @param \Recranet\OTA\Type\AdvResTicketingType\AdvTicketingAType $advTicketing
     * @return self
     */
    public function setAdvTicketing(?\Recranet\OTA\Type\AdvResTicketingType\AdvTicketingAType $advTicketing = null)
    {
