...
class CreditCardAuthorizationAType
{
     ...
     *
     * @var \Recranet\OTA\Type\PaymentCardType $creditCard
     */
     ...
     *
     * @var \Recranet\OTA\Type\UniqueIDType[] $iD
     */
    private $iD = [
     ...
     * Specifies the credit card information for which authorization is required.
     *
     * @param \Recranet\OTA\Type\PaymentCardType $creditCard
     * @return self
     */
    public function setCreditCard(?\Recranet\OTA\Type\PaymentCardType $creditCard = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\UniqueIDType $iD
     */
    public function addToID(\Recranet\OTA\Type\UniqueIDType $iD)
    {
        $this->iD[] = $iD;
        return $this;
    }
