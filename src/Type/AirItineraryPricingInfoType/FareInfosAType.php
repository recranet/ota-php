...
class FareInfosAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirItineraryPricingInfoType\FareInfosAType\FareInfoAType[] $fareInfo
     */
    private $fareInfo = [
     ...
     */
    public function addToFareInfo(\Recranet\OTA\Type\AirItineraryPricingInfoType\FareInfosAType\FareInfoAType $fareInfo)
    {
