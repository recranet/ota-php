...
class InvCountType
{
     ...
     *
     * @var \Recranet\OTA\Type\BaseInvCountType[] $inventory
     */
    private $inventory = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\BaseInvCountType $inventory
     */
    public function addToInventory(\Recranet\OTA\Type\BaseInvCountType $inventory)
    {
     ...
     * This is the inventory information for a given rate plan, room type, date, etc.
     *
     * @return \Recranet\OTA\Type\BaseInvCountType[]
     */
