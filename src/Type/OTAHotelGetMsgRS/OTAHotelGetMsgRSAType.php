...
namespace Recranet\OTA\Type\OTAHotelGetMsgRS;
...
class OTAHotelGetMsgRSAType
{
    ...
    /**
     * @var \Recranet\OTA\Type\MessageType[] $messages
     */
     ...
     */
    public function addToMessages(\Recranet\OTA\Type\MessageType $message)
    {
     ...
     * Sets a new messages
     *
     * @param \Recranet\OTA\Type\MessageType[] $messages
     * @return self
     */
