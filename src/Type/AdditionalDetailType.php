...
class AdditionalDetailType
{
    ...
    /**
     * @var \Recranet\OTA\Type\ParagraphType $detailDescription
     */
     ...
     *
     * @param \Recranet\OTA\Type\ParagraphType $detailDescription
     * @return self
     */
    public function setDetailDescription(?\Recranet\OTA\Type\ParagraphType $detailDescription = null)
    {
