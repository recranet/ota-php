...
class CacheType
{
     ...
     *
     * @var \Recranet\OTA\Type\CacheType\TimeSpanAType $timeSpan
     */
     ...
     *
     * @var \Recranet\OTA\Type\CacheType\OtherInfoAType $otherInfo
     */
     ...
     * The start and end date of information that should be updated in the cache for the associated @HotelCode and an optional "change date mask" that indicates if there are changes in all or a portion of the returned date range
     *
     * @return \Recranet\OTA\Type\CacheType\TimeSpanAType
     */
     ...
     * The start and end date of information that should be updated in the cache for the associated @HotelCode and an optional "change date mask" that indicates if there are changes in all or a portion of the returned date range
     *
     * @param \Recranet\OTA\Type\CacheType\TimeSpanAType $timeSpan
     * @return self
     */
    public function setTimeSpan(\Recranet\OTA\Type\CacheType\TimeSpanAType $timeSpan)
    {
     ...
     * Other optional information that may be returned used to further target the OTA_HotelAvailRQ message.
     *
     * @return \Recranet\OTA\Type\CacheType\OtherInfoAType
     */
     ...
     * Other optional information that may be returned used to further target the OTA_HotelAvailRQ message.
     *
     * @param \Recranet\OTA\Type\CacheType\OtherInfoAType $otherInfo
     * @return self
     */
    public function setOtherInfo(?\Recranet\OTA\Type\CacheType\OtherInfoAType $otherInfo = null)
    {
