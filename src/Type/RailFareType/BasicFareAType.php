...
class BasicFareAType
{
     ...
     *
     * @var \Recranet\OTA\Type\RailFareType\BasicFareAType\AlternateCurrencyAType[] $alternateCurrency
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailFareType\BasicFareAType\AlternateCurrencyAType $alternateCurrency
     */
    public function addToAlternateCurrency(\Recranet\OTA\Type\RailFareType\BasicFareAType\AlternateCurrencyAType $alternateCurrency)
    {
     ...
     * The rail fare in one or more alternate currency(s).
     *
     * @return \Recranet\OTA\Type\RailFareType\BasicFareAType\AlternateCurrencyAType[]
     */
