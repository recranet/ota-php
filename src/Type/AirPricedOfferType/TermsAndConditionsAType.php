...
class TermsAndConditionsAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges
     */
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds
     */
     ...
     * Specifies a voluntary change charge.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType
     */
     ...
     * Specifies a voluntary change charge.
     *
     * @param \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges
     * @return self
     */
    public function setVoluntaryChanges(?\Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges = null)
    {
     ...
     * Specifies a Voluntary Refund (cancellation) charge.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType
     */
     ...
     * Specifies a Voluntary Refund (cancellation) charge.
     *
     * @param \Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds
     * @return self
     */
    public function setVoluntaryRefunds(?\Recranet\OTA\Type\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds = null)
    {
