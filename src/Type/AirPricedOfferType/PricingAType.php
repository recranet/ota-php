...
class PricingAType
{
     ...
     *
     * @var \Recranet\OTA\Type\AirPricedOfferType\PricingAType\PricingDetailAType[] $pricingDetail
     */
     ...
     *
     * @var \Recranet\OTA\Type\AppliedRuleType[] $appliedRule
     */
    private $appliedRule = [
     ...
     *
     * @var \Recranet\OTA\Type\AirPricingQualifierType[] $pricingQualifier
     */
     ...
     *
     * @var \Recranet\OTA\Type\ApplyPriceToType $applyTo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricedOfferType\PricingAType\PricingDetailAType $pricingDetail
     */
    public function addToPricingDetail(\Recranet\OTA\Type\AirPricedOfferType\PricingAType\PricingDetailAType $pricingDetail)
    {
     ...
     * Individual offer pricing if multiple offers and/or passengers are accommodated in the offer pricing.
     *
     * @return \Recranet\OTA\Type\AirPricedOfferType\PricingAType\PricingDetailAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AppliedRuleType $appliedRule
     */
    public function addToAppliedRule(\Recranet\OTA\Type\AppliedRuleType $appliedRule)
    {
     ...
     * Rules that applied to this pricing.
     *
     * @return \Recranet\OTA\Type\AppliedRuleType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\AirPricingQualifierType $pricingQualifier
     */
    public function addToPricingQualifier(\Recranet\OTA\Type\AirPricingQualifierType $pricingQualifier)
    {
     ...
     * Additional information that influenced the pricing, including restrictions, promotions and tax exemptions.
     *
     * @return \Recranet\OTA\Type\AirPricingQualifierType[]
     */
     ...
     * References to unique ID(s) set elsewhere in this message to associate this pricing information with.
     *
     * @param \Recranet\OTA\Type\ApplyPriceToType $applyTo
     * @return self
     */
    public function setApplyTo(?\Recranet\OTA\Type\ApplyPriceToType $applyTo = null)
    {
