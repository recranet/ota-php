...
class RailAvailPrefsType
{
     ...
     *
     * @var \Recranet\OTA\Type\CompanyNamePrefType[] $operatorPref
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailAvailPrefsType\TransportModesAType[] $transportModes
     */
     ...
     *
     * @var \Recranet\OTA\Type\RailAmenityType\RailAmenityAType[] $railAmenities
     */
     ...
     *
     * @var \Recranet\OTA\Type\ClassCodeType[] $classCodes
     */
    private $classCodes = [
     ...
     *
     * @var \Recranet\OTA\Type\AccommodationCategory $accommodationCategory
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\CompanyNamePrefType $operatorPref
     */
    public function addToOperatorPref(\Recranet\OTA\Type\CompanyNamePrefType $operatorPref)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailAvailPrefsType\TransportModesAType $transportModes
     */
    public function addToTransportModes(\Recranet\OTA\Type\RailAvailPrefsType\TransportModesAType $transportModes)
    {
     ...
     * Describes any preferences in terms of the transporation that may be used in the itinerary. For example, some journies may require that a bus be used to connect between two locations. Preference may reflect inclusion or exclusion.
     *
     * @return \Recranet\OTA\Type\RailAvailPrefsType\TransportModesAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\RailAmenityType\RailAmenityAType $railAmenity
     */
    public function addToRailAmenities(\Recranet\OTA\Type\RailAmenityType\RailAmenityAType $railAmenity)
    {
     ...
     * Passenger preferred amenities for qualifying the availability request, such as WiFi.
     *
     * @return \Recranet\OTA\Type\RailAmenityType\RailAmenityAType[]
     */
     ...
     * Passenger preferred amenities for qualifying the availability request, such as WiFi.
     *
     * @param \Recranet\OTA\Type\RailAmenityType\RailAmenityAType[] $railAmenities
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ClassCodeType $classCodes
     */
    public function addToClassCodes(\Recranet\OTA\Type\ClassCodeType $classCodes)
    {
     ...
     * Accommodations and services offered on a train.
     *
     * @return \Recranet\OTA\Type\AccommodationCategory
     */
     ...
     * Accommodations and services offered on a train.
     *
     * @param \Recranet\OTA\Type\AccommodationCategory $accommodationCategory
     * @return self
     */
    public function setAccommodationCategory(?\Recranet\OTA\Type\AccommodationCategory $accommodationCategory = null)
    {
