...
namespace Recranet\OTA\Type\AncillaryServiceActionType\ProductGroupAType;
...
class SubGroupAType
{
    ...
    /**
     * A unique product sub-group code that may be airline defined or a RFISC (reason for issuance sub-code.)
     * The three character alphanumeric RFISC.
     *
     * @var string $code
     */
    private $code = null;
    ...
    /**
     * An additional code that further defines the sub-group.
     * The three character alphanumeric RFISC.
     *
    ...
    /**
     * A unique ID for this product sub-group that is referenced elsewhere in this schema.
     *
     * @var string $rPH
     */
    private $rPH = null;
