...
class GuaranteeType
{
    ...
    /**
     * @var \Recranet\OTA\Type\GuaranteeType\GuaranteesAcceptedAType\GuaranteeAcceptedAType[] $guaranteesAccepted
     */
     ...
     *
     * @var \Recranet\OTA\Type\GuaranteeType\DeadlineAType $deadline
     */
     ...
     *
     * @var \Recranet\OTA\Type\ParagraphType[] $guaranteeDescription
     */
     ...
     */
    public function addToGuaranteesAccepted(\Recranet\OTA\Type\GuaranteeType\GuaranteesAcceptedAType\GuaranteeAcceptedAType $guaranteeAccepted)
    {
     ...
     *
     * @param \Recranet\OTA\Type\GuaranteeType\GuaranteesAcceptedAType\GuaranteeAcceptedAType[] $guaranteesAccepted
     * @return self
     */
     ...
     * Guarantee deadline, absolute or relative.
     *
     * @return \Recranet\OTA\Type\GuaranteeType\DeadlineAType
     */
     ...
     * Guarantee deadline, absolute or relative.
     *
     * @param \Recranet\OTA\Type\GuaranteeType\DeadlineAType $deadline
     * @return self
     */
    public function setDeadline(?\Recranet\OTA\Type\GuaranteeType\DeadlineAType $deadline = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\Type\ParagraphType $guaranteeDescription
     */
    public function addToGuaranteeDescription(\Recranet\OTA\Type\ParagraphType $guaranteeDescription)
    {
