...
class TripInsuranceAType
{
     ...
     *
     * @var \Recranet\OTA\AirPricedOfferType\TripInsuranceAType\CoveredTravelerAType[] $coveredTraveler
     */
     ...
     *
     * @var \Recranet\OTA\CoverageLimitType $coverageLimit
     */
     ...
     * Plan costs.
     *
     * @var \Recranet\OTA\PlanCostType $planCost
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirPricedOfferType\TripInsuranceAType\CoveredTravelerAType $coveredTraveler
     */
    public function addToCoveredTraveler(\Recranet\OTA\AirPricedOfferType\TripInsuranceAType\CoveredTravelerAType $coveredTraveler)
    {
     ...
     * Traveler information with individual insurance coverage details.
     *
     * @return \Recranet\OTA\AirPricedOfferType\TripInsuranceAType\CoveredTravelerAType[]
     */
     ...
     * Coverage limitations, including deductible and policy limit.
     *
     * @return \Recranet\OTA\CoverageLimitType
     */
     ...
     * Coverage limitations, including deductible and policy limit.
     *
     * @param \Recranet\OTA\CoverageLimitType $coverageLimit
     * @return self
     */
    public function setCoverageLimit(?\Recranet\OTA\CoverageLimitType $coverageLimit = null)
    {
     ...
     * Plan costs.
     *
     * @return \Recranet\OTA\PlanCostType
     */
     ...
     * Plan costs.
     *
     * @param \Recranet\OTA\PlanCostType $planCost
     * @return self
     */
    public function setPlanCost(?\Recranet\OTA\PlanCostType $planCost = null)
    {
