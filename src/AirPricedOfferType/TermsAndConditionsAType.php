...
class TermsAndConditionsAType
{
     ...
     *
     * @var \Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges
     */
     ...
     *
     * @var \Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds
     */
     ...
     * Specifies a voluntary change charge.
     *
     * @return \Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType
     */
     ...
     * Specifies a voluntary change charge.
     *
     * @param \Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges
     * @return self
     */
    public function setVoluntaryChanges(?\Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryChangesAType $voluntaryChanges = null)
    {
     ...
     * Specifies a Voluntary Refund (cancellation) charge.
     *
     * @return \Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType
     */
     ...
     * Specifies a Voluntary Refund (cancellation) charge.
     *
     * @param \Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds
     * @return self
     */
    public function setVoluntaryRefunds(?\Recranet\OTA\AirPricedOfferType\TermsAndConditionsAType\VoluntaryRefundsAType $voluntaryRefunds = null)
    {
