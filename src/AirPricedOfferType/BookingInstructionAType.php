...
class BookingInstructionAType
{
     ...
     *
     * @var \Recranet\OTA\SpecialServiceRequestType[] $sSRInfo
     */
    private $sSRInfo = [
     ...
     *
     * @var \Recranet\OTA\OtherServiceInfoType[] $oSIInfo
     */
    private $oSIInfo = [
     ...
     *
     * @var \Recranet\OTA\AirPricedOfferType\BookingInstructionAType\UpgradeAType $upgrade
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SpecialServiceRequestType $sSRInfo
     */
    public function addToSSRInfo(\Recranet\OTA\SpecialServiceRequestType $sSRInfo)
    {
     ...
     * Special service request information.
     *
     * @return \Recranet\OTA\SpecialServiceRequestType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OtherServiceInfoType $oSIInfo
     */
    public function addToOSIInfo(\Recranet\OTA\OtherServiceInfoType $oSIInfo)
    {
     ...
     * Upgrade instruction information.
     *
     * @return \Recranet\OTA\AirPricedOfferType\BookingInstructionAType\UpgradeAType
     */
     ...
     * Upgrade instruction information.
     *
     * @param \Recranet\OTA\AirPricedOfferType\BookingInstructionAType\UpgradeAType $upgrade
     * @return self
     */
    public function setUpgrade(?\Recranet\OTA\AirPricedOfferType\BookingInstructionAType\UpgradeAType $upgrade = null)
    {
