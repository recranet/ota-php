...
class SystemCodesAType
{
     ...
     *
     * @var \Recranet\OTA\ViewershipsType\ViewershipAType\SystemCodesAType\SystemCodeAType[] $systemCode
     */
    private $systemCode = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\ViewershipsType\ViewershipAType\SystemCodesAType\SystemCodeAType $systemCode
     */
    public function addToSystemCode(\Recranet\OTA\ViewershipsType\ViewershipAType\SystemCodesAType\SystemCodeAType $systemCode)
    {
     ...
     * The system code (e.g., AA, 1P, 1G, 1A) associated with this viewership record.
     *
     * @return \Recranet\OTA\ViewershipsType\ViewershipAType\SystemCodesAType\SystemCodeAType[]
     */
