...
class ProfileTypesAType
{
     ...
     *
     * @var \Recranet\OTA\ViewershipsType\ViewershipAType\ProfileTypesAType\ProfileTypeAType[] $profileType
     */
    private $profileType = [
     ...
     */
    public function addToProfileType(\Recranet\OTA\ViewershipsType\ViewershipAType\ProfileTypesAType\ProfileTypeAType $profileType)
    {
