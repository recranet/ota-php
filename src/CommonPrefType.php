...
class CommonPrefType
{
     ...
     *
     * @var \Recranet\OTA\NamePrefType[] $namePref
     */
    private $namePref = [
     ...
     *
     * @var \Recranet\OTA\PhonePrefType[] $phonePref
     */
    private $phonePref = [
     ...
     *
     * @var \Recranet\OTA\AddressPrefType[] $addressPref
     */
    private $addressPref = [
     ...
     *
     * @var \Recranet\OTA\InterestPrefType[] $interestPref
     */
     ...
     *
     * @var \Recranet\OTA\InsurancePrefType[] $insurancePref
     */
     ...
     *
     * @var \Recranet\OTA\SeatingPrefType[] $seatingPref
     */
    private $seatingPref = [
     ...
     *
     * @var \Recranet\OTA\RelatedTravelerPrefType[] $relatedTravelerPref
     */
     ...
     *
     * @var \Recranet\OTA\CommonPrefType\ContactPrefAType[] $contactPref
     */
    private $contactPref = [
     ...
     *
     * @var \Recranet\OTA\EmployeeInfoType $employeeLevelInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\NamePrefType $namePref
     */
    public function addToNamePref(\Recranet\OTA\NamePrefType $namePref)
    {
     ...
     * Enables a preference to be indicated for name information.
     *
     * @return \Recranet\OTA\NamePrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PhonePrefType $phonePref
     */
    public function addToPhonePref(\Recranet\OTA\PhonePrefType $phonePref)
    {
     ...
     * Enables a preference to be indicated for telephone information.
     *
     * @return \Recranet\OTA\PhonePrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AddressPrefType $addressPref
     */
    public function addToAddressPref(\Recranet\OTA\AddressPrefType $addressPref)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\InterestPrefType $interestPref
     */
    public function addToInterestPref(\Recranet\OTA\InterestPrefType $interestPref)
    {
     ...
     * Enables a preference to be indicated for a traveler's interests.
     *
     * @return \Recranet\OTA\InterestPrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\InsurancePrefType $insurancePref
     */
    public function addToInsurancePref(\Recranet\OTA\InsurancePrefType $insurancePref)
    {
     ...
     * Enables a preference to be indicated for insurance.
     *
     * @return \Recranet\OTA\InsurancePrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatingPrefType $seatingPref
     */
    public function addToSeatingPref(\Recranet\OTA\SeatingPrefType $seatingPref)
    {
     ...
     * Enables a preference to be indicated for seating.
     *
     * @return \Recranet\OTA\SeatingPrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RelatedTravelerPrefType $relatedTravelerPref
     */
    public function addToRelatedTravelerPref(\Recranet\OTA\RelatedTravelerPrefType $relatedTravelerPref)
    {
     ...
     * Enables a preference to be indicated for a related traveler.
     *
     * @return \Recranet\OTA\RelatedTravelerPrefType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CommonPrefType\ContactPrefAType $contactPref
     */
    public function addToContactPref(\Recranet\OTA\CommonPrefType\ContactPrefAType $contactPref)
    {
     ...
     * The traveller's preferred means of being contacted.
     *
     * @return \Recranet\OTA\CommonPrefType\ContactPrefAType[]
     */
     ...
     * Defines the category of the traveler and the purpose of the trip for which these preferences apply. Typically used for company profiles.
     *
     * @param \Recranet\OTA\EmployeeInfoType $employeeLevelInfo
     * @return self
     */
    public function setEmployeeLevelInfo(?\Recranet\OTA\EmployeeInfoType $employeeLevelInfo = null)
    {
