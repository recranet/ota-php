...
class BookFlightSegmentType extends FlightSegmentType
{
     ...
     *
     * @var \Recranet\OTA\BookFlightSegmentType\BookingClassAvailsAType[] $bookingClassAvails
     */
     ...
     *
     * @var \Recranet\OTA\BookFlightSegmentType\StopLocationAType[] $stopLocation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\BookFlightSegmentType\BookingClassAvailsAType $bookingClassAvails
     */
    public function addToBookingClassAvails(\Recranet\OTA\BookFlightSegmentType\BookingClassAvailsAType $bookingClassAvails)
    {
     ...
     * A collection of availability counts per booking class.
     *
     * @return \Recranet\OTA\BookFlightSegmentType\BookingClassAvailsAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\BookFlightSegmentType\StopLocationAType $stopLocation
     */
    public function addToStopLocation(\Recranet\OTA\BookFlightSegmentType\StopLocationAType $stopLocation)
    {
     ...
     * A location where the flight is scheduled to stop en route to its destination for this flight segment.
     *
     * @return \Recranet\OTA\BookFlightSegmentType\StopLocationAType[]
     */
