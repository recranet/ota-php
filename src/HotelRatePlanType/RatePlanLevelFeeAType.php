...
class RatePlanLevelFeeAType
{
     ...
     *
     * @var \Recranet\OTA\HotelRatePlanType\RatePlanLevelFeeAType\FeeAType[] $fee
     */
    private $fee = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelRatePlanType\RatePlanLevelFeeAType\FeeAType $fee
     */
    public function addToFee(\Recranet\OTA\HotelRatePlanType\RatePlanLevelFeeAType\FeeAType $fee)
    {
        $this->fee[] = $fee;
        return $this;
    }
     ...
     * Fee Amount that is applied to the rate. Fees are used for non tax amounts like service charges.
     *
     * @return \Recranet\OTA\HotelRatePlanType\RatePlanLevelFeeAType\FeeAType[]
     */
