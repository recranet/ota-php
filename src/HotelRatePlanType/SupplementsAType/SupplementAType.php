...
namespace Recranet\OTA\HotelRatePlanType\SupplementsAType;
...
class SupplementAType
{
     ...
     *
     * @var \Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\RoomCompanionsAType[] $roomCompanions
     */
     ...
     *
     * @var \Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\PrerequisiteInventoryAType[] $prerequisiteInventory
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\RoomCompanionsAType $roomCompanions
     */
    public function addToRoomCompanions(\Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\RoomCompanionsAType $roomCompanions)
    {
     ...
     * Defines the required type and number of companions in the room in order for this supplement to apply (e.g., one adult required for a child supplement to apply).
     *
     * @return \Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\RoomCompanionsAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\PrerequisiteInventoryAType $prerequisiteInventory
     */
    public function addToPrerequisiteInventory(\Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\PrerequisiteInventoryAType $prerequisiteInventory)
    {
     ...
     * Defines inventory (e.g. room type, meal plan) which must be booked for this supplement to apply.
     *
     * @return \Recranet\OTA\HotelRatePlanType\SupplementsAType\SupplementAType\PrerequisiteInventoryAType[]
     */
