...
class OntologyTimeDurationType
{
     ...
     *
     * @var \Recranet\OTA\OntologyTimeDurationType\StartAndEndAType $startAndEnd
     */
     ...
     * Start and end date or date and time with duration information.
     *
     * @return \Recranet\OTA\OntologyTimeDurationType\StartAndEndAType
     */
     ...
     * Start and end date or date and time with duration information.
     *
     * @param \Recranet\OTA\OntologyTimeDurationType\StartAndEndAType $startAndEnd
     * @return self
     */
    public function setStartAndEnd(?\Recranet\OTA\OntologyTimeDurationType\StartAndEndAType $startAndEnd = null)
    {
