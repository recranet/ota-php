...
class NotifCacheType
{
     ...
     *
     * @var \Recranet\OTA\NotifCacheType\TimeSpanAType $timeSpan
     */
     ...
     *
     * @var \Recranet\OTA\NotifCacheType\ProductInfoAType $productInfo
     */
     ...
     * The start and end date of information that should be updated in the cache for the associated @HotelCode and an optional "change date mask" that indicates if there are changes in all or a portion of the returned date range.
     *
     * @return \Recranet\OTA\NotifCacheType\TimeSpanAType
     */
     ...
     * The start and end date of information that should be updated in the cache for the associated @HotelCode and an optional "change date mask" that indicates if there are changes in all or a portion of the returned date range.
     *
     * @param \Recranet\OTA\NotifCacheType\TimeSpanAType $timeSpan
     * @return self
     */
    public function setTimeSpan(\Recranet\OTA\NotifCacheType\TimeSpanAType $timeSpan)
    {
     ...
     * Other product information that may be returned.
     *
     * @return \Recranet\OTA\NotifCacheType\ProductInfoAType
     */
     ...
     * Other product information that may be returned.
     *
     * @param \Recranet\OTA\NotifCacheType\ProductInfoAType $productInfo
     * @return self
     */
    public function setProductInfo(?\Recranet\OTA\NotifCacheType\ProductInfoAType $productInfo = null)
    {
