...
namespace Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType;
...
class HotelInvBlockRequestAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\DateRangeAType $dateRange
     */
     ...
     *
     * @var \Recranet\OTA\InvBlockType[] $invBlock
     */
    private $invBlock = [
     ...
     *
     * @var \Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\HotelRefAType $hotelRef
     */
     ...
     * A date or range of dates for the rate plan.
     *
     * @return \Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\DateRangeAType
     */
     ...
     * A date or range of dates for the rate plan.
     *
     * @param \Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\DateRangeAType $dateRange
     * @return self
     */
    public function setDateRange(?\Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\DateRangeAType $dateRange = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\InvBlockType $invBlock
     */
    public function addToInvBlock(\Recranet\OTA\InvBlockType $invBlock)
    {
     ...
     * This is for creating a single block at a single hotel.
     *
     * @return \Recranet\OTA\InvBlockType[]
     */
     ...
     * Indicates the detail of hotel reference information.
     *
     * @return \Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\HotelRefAType
     */
     ...
     * Indicates the detail of hotel reference information.
     *
     * @param \Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\HotelRefAType $hotelRef
     * @return self
     */
    public function setHotelRef(?\Recranet\OTA\OTAHotelInvBlockRQ\OTAHotelInvBlockRQAType\HotelInvBlockRequestsAType\HotelInvBlockRequestAType\HotelRefAType $hotelRef = null)
    {
