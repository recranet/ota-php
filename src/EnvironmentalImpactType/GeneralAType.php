...
class GeneralAType
{
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $certification
     */
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $environmental
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ParagraphType $certification
     */
    public function addToCertification(\Recranet\OTA\ParagraphType $certification)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\ParagraphType $environmental
     */
    public function addToEnvironmental(\Recranet\OTA\ParagraphType $environmental)
    {
