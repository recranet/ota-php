...
class CarbonFootprintAType
{
     ...
     * Example: Gallon(s)
     *
     * @var \Recranet\OTA\ListUnitOfMeasureType $carbonUOM
     */
     ...
     * Example: Gallon(s)
     *
     * @param \Recranet\OTA\ListUnitOfMeasureType $carbonUOM
     * @return self
     */
    public function setCarbonUOM(?\Recranet\OTA\ListUnitOfMeasureType $carbonUOM = null)
    {
