...
class VehicleArrivalDetailsType
{
     ...
     *
     * @var \Recranet\OTA\LocationType $arrivalLocation
     */
     ...
     * Arrival point of the associated transportation.
     *
     * @param \Recranet\OTA\LocationType $arrivalLocation
     * @return self
     */
    public function setArrivalLocation(?\Recranet\OTA\LocationType $arrivalLocation = null)
    {
     ...
     * @return self
     */
    public function setMarketingCompany(?\Recranet\OTA\CompanyNameType $marketingCompany = null)
    {
