...
class AdditionalGuestAmountType
{
     ...
     *
     * @var \Recranet\OTA\TotalType $amount
     */
    private $amount = null;
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $addlGuestAmtDescription
     */
     ...
     * The amount charged for an additional guest.
     *
     * @param \Recranet\OTA\TotalType $amount
     * @return self
     */
    public function setAmount(\Recranet\OTA\TotalType $amount)
    {
        $this->amount = $amount;
        return $this;
    }
     ...
     *
     * @return self
     * @param \Recranet\OTA\ParagraphType $addlGuestAmtDescription
     */
    public function addToAddlGuestAmtDescription(\Recranet\OTA\ParagraphType $addlGuestAmtDescription)
    {
