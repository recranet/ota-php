...
class GeneralEventInfoAType
{
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\EventContactsAType\EventContactAType[] $eventContacts
     */
     ...
     *
     * @var \Recranet\OTA\LocationGeneralType $eventLocation
     */
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\AttendeeInfoAType[] $attendeeInfo
     */
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\DatesAType\DateAType[] $dates
     */
    private $dates = null;
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\HousingInfoAType $housingInfo
     */
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\FoodAndBeverageInfoAType $foodAndBeverageInfo
     */
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\FunctionSpaceInfoAType $functionSpaceInfo
     */
     ...
     *
     * @var \Recranet\OTA\EventReportType\GeneralEventInfoAType\ExhibitionInfoAType $exhibitionInfo
     */
     ...
     */
    public function addToEventContacts(\Recranet\OTA\EventReportType\GeneralEventInfoAType\EventContactsAType\EventContactAType $eventContact)
    {
     ...
     * A collection of contacts that pertain to this event.
     *
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\EventContactsAType\EventContactAType[] $eventContacts
     * @return self
     */
     ...
     * Provides high-level event location information (i.e., city, state/province, country).
     *
     * @param \Recranet\OTA\LocationGeneralType $eventLocation
     * @return self
     */
    public function setEventLocation(?\Recranet\OTA\LocationGeneralType $eventLocation = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\AttendeeInfoAType $attendeeInfo
     */
    public function addToAttendeeInfo(\Recranet\OTA\EventReportType\GeneralEventInfoAType\AttendeeInfoAType $attendeeInfo)
    {
     ...
     * Specifies the number of event attendees.
     *
     * @return \Recranet\OTA\EventReportType\GeneralEventInfoAType\AttendeeInfoAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\DatesAType\DateAType $date
     */
    public function addToDates(\Recranet\OTA\EventReportType\GeneralEventInfoAType\DatesAType\DateAType $date)
    {
        $this->dates[] = $date;
        return $this;
    }
     ...
     * A collection of dates for past or future events.
     *
     * @return \Recranet\OTA\EventReportType\GeneralEventInfoAType\DatesAType\DateAType[]
     */
     ...
     * A collection of dates for past or future events.
     *
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\DatesAType\DateAType[] $dates
     * @return self
     */
     ...
     * General hotel usage information.
     *
     * @return \Recranet\OTA\EventReportType\GeneralEventInfoAType\HousingInfoAType
     */
     ...
     * General hotel usage information.
     *
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\HousingInfoAType $housingInfo
     * @return self
     */
    public function setHousingInfo(?\Recranet\OTA\EventReportType\GeneralEventInfoAType\HousingInfoAType $housingInfo = null)
    {
     ...
     * General food and beverage information.
     *
     * @return \Recranet\OTA\EventReportType\GeneralEventInfoAType\FoodAndBeverageInfoAType
     */
     ...
     * General food and beverage information.
     *
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\FoodAndBeverageInfoAType $foodAndBeverageInfo
     * @return self
     */
    public function setFoodAndBeverageInfo(?\Recranet\OTA\EventReportType\GeneralEventInfoAType\FoodAndBeverageInfoAType $foodAndBeverageInfo = null)
    {
     ...
     * General function space information for this event.
     *
     * @return \Recranet\OTA\EventReportType\GeneralEventInfoAType\FunctionSpaceInfoAType
     */
     ...
     * General function space information for this event.
     *
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\FunctionSpaceInfoAType $functionSpaceInfo
     * @return self
     */
    public function setFunctionSpaceInfo(?\Recranet\OTA\EventReportType\GeneralEventInfoAType\FunctionSpaceInfoAType $functionSpaceInfo = null)
    {
     ...
     * General exhibition information for this event.
     *
     * @return \Recranet\OTA\EventReportType\GeneralEventInfoAType\ExhibitionInfoAType
     */
     ...
     * General exhibition information for this event.
     *
     * @param \Recranet\OTA\EventReportType\GeneralEventInfoAType\ExhibitionInfoAType $exhibitionInfo
     * @return self
     */
    public function setExhibitionInfo(?\Recranet\OTA\EventReportType\GeneralEventInfoAType\ExhibitionInfoAType $exhibitionInfo = null)
    {
