...
class OtherServiceInfoType
{
     ...
     *
     * @var \Recranet\OTA\OtherServiceInfoType\TravelerRefNumberAType[] $travelerRefNumber
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OtherServiceInfoType\TravelerRefNumberAType $travelerRefNumber
     */
    public function addToTravelerRefNumber(\Recranet\OTA\OtherServiceInfoType\TravelerRefNumberAType $travelerRefNumber)
    {
     ...
     * One or more travelers to whom this request applies.
     *
     * @return \Recranet\OTA\OtherServiceInfoType\TravelerRefNumberAType[]
     */
     ...
     * @return self
     */
    public function setAirline(\Recranet\OTA\CompanyNameType $airline)
    {
