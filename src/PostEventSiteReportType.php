...
class PostEventSiteReportType
{
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\EventIDAType[] $eventID
     */
    private $eventID = [
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\DateAType $date
     */
    private $date = null;
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\ContactsAType\ContactAType[] $contacts
     */
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\AttendeeInfoAType[] $attendeeInfo
     */
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\EventDaysAType $eventDays
     */
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\ExhibitionAType[] $exhibition
     */
    private $exhibition = [
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\RoomBlocksAType $roomBlocks
     */
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\TaxExemptInfoAType[] $taxExemptInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PostEventSiteReportType\EventIDAType $eventID
     */
    public function addToEventID(\Recranet\OTA\PostEventSiteReportType\EventIDAType $eventID)
    {
     ...
     * This is a UniqueID that is associated with an individual event. This element repeats to accommodate the IDs of multiple systems.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\EventIDAType[]
     */
     ...
     * Date or date range for this event for this site. This date range encompasses any pre-event, published and post event dates.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\DateAType
     */
     ...
     * Date or date range for this event for this site. This date range encompasses any pre-event, published and post event dates.
     *
     * @param \Recranet\OTA\PostEventSiteReportType\DateAType $date
     * @return self
     */
    public function setDate(?\Recranet\OTA\PostEventSiteReportType\DateAType $date = null)
    {
        $this->date = $date;
        return $this;
    }
     ...
     */
    public function addToContacts(\Recranet\OTA\PostEventSiteReportType\ContactsAType\ContactAType $contact)
    {
     ...
     * A collection of contacts associated with a specific site.
     *
     * @param \Recranet\OTA\PostEventSiteReportType\ContactsAType\ContactAType[] $contacts
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PostEventSiteReportType\AttendeeInfoAType $attendeeInfo
     */
    public function addToAttendeeInfo(\Recranet\OTA\PostEventSiteReportType\AttendeeInfoAType $attendeeInfo)
    {
     ...
     * The number of attendees by type at this site for this event.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\AttendeeInfoAType[]
     */
     ...
     * A collection of event days.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\EventDaysAType
     */
     ...
     * A collection of event days.
     *
     * @param \Recranet\OTA\PostEventSiteReportType\EventDaysAType $eventDays
     * @return self
     */
    public function setEventDays(?\Recranet\OTA\PostEventSiteReportType\EventDaysAType $eventDays = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\PostEventSiteReportType\ExhibitionAType $exhibition
     */
    public function addToExhibition(\Recranet\OTA\PostEventSiteReportType\ExhibitionAType $exhibition)
    {
     ...
     * Describes an event at which products and services are displayed.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\ExhibitionAType[]
     */
     ...
     * A collection of room blocks for this event.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\RoomBlocksAType
     */
     ...
     * A collection of room blocks for this event.
     *
     * @param \Recranet\OTA\PostEventSiteReportType\RoomBlocksAType $roomBlocks
     * @return self
     */
    public function setRoomBlocks(?\Recranet\OTA\PostEventSiteReportType\RoomBlocksAType $roomBlocks = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\PostEventSiteReportType\TaxExemptInfoAType $taxExemptInfo
     */
    public function addToTaxExemptInfo(\Recranet\OTA\PostEventSiteReportType\TaxExemptInfoAType $taxExemptInfo)
    {
     ...
     * Used to provide tax exemption information for the event.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\TaxExemptInfoAType[]
     */
