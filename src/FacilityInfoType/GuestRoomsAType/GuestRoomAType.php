...
namespace Recranet\OTA\FacilityInfoType\GuestRoomsAType;
...
class GuestRoomAType
{
     ...
     *
     * @var \Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\TypeRoomAType[] $typeRoom
     */
    private $typeRoom = [
     ...
     *
     * @var \Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\AmenitiesAType\AmenityAType[] $amenities
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\TypeRoomAType $typeRoom
     */
    public function addToTypeRoom(\Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\TypeRoomAType $typeRoom)
    {
     ...
     * Describes the guest room type; in composite types there can be multiple occurrences.
     *
     * @return \Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\TypeRoomAType[]
     */
     ...
     */
    public function addToAmenities(\Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\AmenitiesAType\AmenityAType $amenity)
    {
     ...
     * Collection of room amenity items available to the guest.
     *
     * @param \Recranet\OTA\FacilityInfoType\GuestRoomsAType\GuestRoomAType\AmenitiesAType\AmenityAType[] $amenities
     * @return self
     */
