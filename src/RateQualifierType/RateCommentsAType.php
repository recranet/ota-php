...
namespace Recranet\OTA\RateQualifierType;
...
class RateCommentsAType
{
     ...
     *
     * @var \Recranet\OTA\RateQualifierType\RateCommentsAType\RateCommentAType[] $rateComment
     */
    private $rateComment = [
     ...
     */
    public function addToRateComment(\Recranet\OTA\RateQualifierType\RateCommentsAType\RateCommentAType $rateComment)
    {
