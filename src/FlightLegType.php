...
class FlightLegType
{
     ...
     *
     * @var \Recranet\OTA\FlightLegType\DepartureAirportAType $departureAirport
     */
     ...
     *
     * @var \Recranet\OTA\FlightLegType\ArrivalAirportAType $arrivalAirport
     */
     ...
     * The departure airport for the flight.
     *
     * @return \Recranet\OTA\FlightLegType\DepartureAirportAType
     */
     ...
     * The departure airport for the flight.
     *
     * @param \Recranet\OTA\FlightLegType\DepartureAirportAType $departureAirport
     * @return self
     */
    public function setDepartureAirport(?\Recranet\OTA\FlightLegType\DepartureAirportAType $departureAirport = null)
    {
     ...
     * The arrival airport for the flight.
     *
     * @return \Recranet\OTA\FlightLegType\ArrivalAirportAType
     */
     ...
     * The arrival airport for the flight.
     *
     * @param \Recranet\OTA\FlightLegType\ArrivalAirportAType $arrivalAirport
     * @return self
     */
    public function setArrivalAirport(?\Recranet\OTA\FlightLegType\ArrivalAirportAType $arrivalAirport = null)
    {
