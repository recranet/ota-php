...
class TaxType
{
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $taxDescription
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ParagraphType $taxDescription
     */
    public function addToTaxDescription(\Recranet\OTA\ParagraphType $taxDescription)
    {
