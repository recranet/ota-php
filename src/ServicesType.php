...
class ServicesType
{
     ...
     *
     * @var \Recranet\OTA\ServiceType[] $service
     */
    private $service = [
     ...
     *
     * @var \Recranet\OTA\ServicesType\ServiceCategoryAType[] $serviceCategory
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ServiceType $service
     */
    public function addToService(\Recranet\OTA\ServiceType $service)
    {
     ...
     * A Service object represents a non-room product provided to guests. Service products may have associated inventory and charges.
     *
     * @return \Recranet\OTA\ServiceType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ServicesType\ServiceCategoryAType $serviceCategory
     */
    public function addToServiceCategory(\Recranet\OTA\ServicesType\ServiceCategoryAType $serviceCategory)
    {
     ...
     * Hotel systems often group multiple services into a single category. This refers to that category that is specific to the hotel CRS/PMS.
     *
     * @return \Recranet\OTA\ServicesType\ServiceCategoryAType[]
     */
