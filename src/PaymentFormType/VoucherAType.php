...
class VoucherAType
{
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\VoucherAType\BillingAccountNameAType $billingAccountName
     */
     ...
     *
     * @var \Recranet\OTA\AddressType $billingAccountAddress
     */
     ...
     * The name of the Billing Account for which the voucher has been issued.
     *
     * @return \Recranet\OTA\PaymentFormType\VoucherAType\BillingAccountNameAType
     */
     ...
     * The name of the Billing Account for which the voucher has been issued.
     *
     * @param \Recranet\OTA\PaymentFormType\VoucherAType\BillingAccountNameAType $billingAccountName
     * @return self
     */
    public function setBillingAccountName(?\Recranet\OTA\PaymentFormType\VoucherAType\BillingAccountNameAType $billingAccountName = null)
    {
     ...
     * The address of the Billing Account for which the voucher has been issued.
     *
     * @param \Recranet\OTA\AddressType $billingAccountAddress
     * @return self
     */
    public function setBillingAccountAddress(?\Recranet\OTA\AddressType $billingAccountAddress = null)
    {
