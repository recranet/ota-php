...
namespace Recranet\OTA\PaymentFormType;
...
class TicketAType
{
     ...
     *
     * @var \DateTime $originalIssueDate
     */
     ...
     *
     * @var string $originalPaymentForm
     */
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\TicketAType\ConjunctionTicketNbrAType[] $conjunctionTicketNbr
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PaymentFormType\TicketAType\ConjunctionTicketNbrAType $conjunctionTicketNbr
     */
    public function addToConjunctionTicketNbr(\Recranet\OTA\PaymentFormType\TicketAType\ConjunctionTicketNbrAType $conjunctionTicketNbr)
    {
     ...
     * Conjunction ticket number in case a conjunction ticket is exchanged.
     *
     * @return \Recranet\OTA\PaymentFormType\TicketAType\ConjunctionTicketNbrAType[]
     */
     ...
     * @return self
     */
    public function setConjunctionTicketNbr(array $conjunctionTicketNbr = null)
    {
        $this->conjunctionTicketNbr = $conjunctionTicketNbr;
        return $this;
    }
