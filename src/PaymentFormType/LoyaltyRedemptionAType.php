...
class LoyaltyRedemptionAType
{
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType\LoyaltyCertificateAType[] $loyaltyCertificate
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType\LoyaltyCertificateAType $loyaltyCertificate
     */
    public function addToLoyaltyCertificate(\Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType\LoyaltyCertificateAType $loyaltyCertificate)
    {
     ...
     * A certificate may be needed in order to redeem miles or points. Certificates may be used in combination with each other as part of a reservation.
     *
     * @return \Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType\LoyaltyCertificateAType[]
     */
