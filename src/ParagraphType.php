...
class ParagraphType
{
     ...
     *
     * @var \Recranet\OTA\FormattedTextTextType $text
     */
    private $text = null;
     ...
     *
     * @var \Recranet\OTA\ParagraphType\ListItemAType $listItem
     */
     ...
     * Formatted text content.
     *
     * @param \Recranet\OTA\FormattedTextTextType $text
     * @return self
     */
    public function setText(?\Recranet\OTA\FormattedTextTextType $text = null)
    {
        $this->text = $text;
        return $this;
    }
     ...
     * Formatted text content and an associated item or sequence number.
     *
     * @return \Recranet\OTA\ParagraphType\ListItemAType
     */
     ...
     * Formatted text content and an associated item or sequence number.
     *
     * @param \Recranet\OTA\ParagraphType\ListItemAType $listItem
     * @return self
     */
    public function setListItem(?\Recranet\OTA\ParagraphType\ListItemAType $listItem = null)
    {
