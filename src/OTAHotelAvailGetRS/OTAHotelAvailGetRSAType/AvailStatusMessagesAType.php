...
namespace Recranet\OTA\OTAHotelAvailGetRS\OTAHotelAvailGetRSAType;
...
class AvailStatusMessagesAType
{
     ...
     *
     * @var \Recranet\OTA\AvailStatusMessageType[] $availStatusMessage
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AvailStatusMessageType $availStatusMessage
     */
    public function addToAvailStatusMessage(\Recranet\OTA\AvailStatusMessageType $availStatusMessage)
    {
     ...
     * The RateHurdleStatusMessage class defines the setting for rate hurdle controls to be synchronized with the central reservation system.
     *
     * @return \Recranet\OTA\AvailStatusMessageType[]
     */
