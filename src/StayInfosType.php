...
class StayInfosType
{
     ...
     *
     * @var \Recranet\OTA\StayInfoType[] $stayInfo
     */
    private $stayInfo = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\StayInfoType $stayInfo
     */
    public function addToStayInfo(\Recranet\OTA\StayInfoType $stayInfo)
    {
     ...
     * Provides details of a guest's stay.
     *
     * @return \Recranet\OTA\StayInfoType[]
     */
