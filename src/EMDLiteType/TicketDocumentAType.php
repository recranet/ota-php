...
class TicketDocumentAType
{
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\TicketDocumentAType\CouponInfoAType[] $couponInfo
     */
    private $couponInfo = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\EMDLiteType\TicketDocumentAType\CouponInfoAType $couponInfo
     */
    public function addToCouponInfo(\Recranet\OTA\EMDLiteType\TicketDocumentAType\CouponInfoAType $couponInfo)
    {
     ...
     * Number, status, in connection nbr, itinerary sequence nbr, coupon ref, not valid before/after, involuntary indicator, and in connection qualfier.
     *
     * @return \Recranet\OTA\EMDLiteType\TicketDocumentAType\CouponInfoAType[]
     */
