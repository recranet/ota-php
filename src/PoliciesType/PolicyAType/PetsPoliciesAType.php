...
class PetsPoliciesAType
{
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType\PetsPolicyAType[] $petsPolicy
     */
    private $petsPolicy = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType\PetsPolicyAType $petsPolicy
     */
    public function addToPetsPolicy(\Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType\PetsPolicyAType $petsPolicy)
    {
     ...
     * Detailed policy information when Pets are Allowed.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType\PetsPolicyAType[]
     */
