...
namespace Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType;
...
class RatePolicyAType
{
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType\TypeAType $type
     */
    private $type = null;
     ...
     * Select a predefined value from the list or use the "Other_" value to create an enumerated value agreed upon between trading partners.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType\TypeAType
     */
     ...
     * Select a predefined value from the list or use the "Other_" value to create an enumerated value agreed upon between trading partners.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType\TypeAType $type
     * @return self
     */
    public function setType(?\Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType\TypeAType $type = null)
    {
        $this->type = $type;
        return $this;
    }
