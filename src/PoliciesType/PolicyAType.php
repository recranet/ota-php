...
namespace Recranet\OTA\PoliciesType;
...
class PolicyAType
{
     ...
     *
     * @var \Recranet\OTA\CancelPenaltiesType $cancelPolicy
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\GuaranteePaymentPolicyAType $guaranteePaymentPolicy
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoCodesAType\PolicyInfoCodeAType[] $policyInfoCodes
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\CheckoutChargesAType\CheckoutChargeAType[] $checkoutCharges
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoAType $policyInfo
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\TaxPoliciesAType\TaxPolicyAType[] $taxPolicies
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType $petsPolicies
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\StayRequirementsAType\StayRequirementAType[] $stayRequirements
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\CommissionPolicyAType $commissionPolicy
     */
     ...
     *
     * @var \Recranet\OTA\FeeType[] $feePolicies
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType[] $ratePolicies
     */
     ...
     *
     * @var \Recranet\OTA\PoliciesType\PolicyAType\GroupPoliciesAType\GroupPolicyAType[] $groupPolicies
     */
     ...
     * Defines the cancellation policy of the hotel facility.
     *
     * @param \Recranet\OTA\CancelPenaltiesType $cancelPolicy
     * @return self
     */
    public function setCancelPolicy(?\Recranet\OTA\CancelPenaltiesType $cancelPolicy = null)
    {
     ...
     * A collection of deposit policies, guarantees policy, and/or accepted forms of payment.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\GuaranteePaymentPolicyAType
     */
     ...
     * A collection of deposit policies, guarantees policy, and/or accepted forms of payment.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\GuaranteePaymentPolicyAType $guaranteePaymentPolicy
     * @return self
     */
    public function setGuaranteePaymentPolicy(?\Recranet\OTA\PoliciesType\PolicyAType\GuaranteePaymentPolicyAType $guaranteePaymentPolicy = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoCodesAType\PolicyInfoCodeAType $policyInfoCode
     */
    public function addToPolicyInfoCodes(\Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoCodesAType\PolicyInfoCodeAType $policyInfoCode)
    {
     ...
     * Detailed property policy information.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoCodesAType\PolicyInfoCodeAType[]
     */
     ...
     * Detailed property policy information.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoCodesAType\PolicyInfoCodeAType[] $policyInfoCodes
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PoliciesType\PolicyAType\CheckoutChargesAType\CheckoutChargeAType $checkoutCharge
     */
    public function addToCheckoutCharges(\Recranet\OTA\PoliciesType\PolicyAType\CheckoutChargesAType\CheckoutChargeAType $checkoutCharge)
    {
     ...
     * Checkout charges and information.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\CheckoutChargesAType\CheckoutChargeAType[]
     */
     ...
     * Checkout charges and information.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\CheckoutChargesAType\CheckoutChargeAType[] $checkoutCharges
     * @return self
     */
     ...
     * Basic property policy information.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoAType
     */
     ...
     * Basic property policy information.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoAType $policyInfo
     * @return self
     */
    public function setPolicyInfo(?\Recranet\OTA\PoliciesType\PolicyAType\PolicyInfoAType $policyInfo = null)
    {
     ...
     */
    public function addToTaxPolicies(\Recranet\OTA\PoliciesType\PolicyAType\TaxPoliciesAType\TaxPolicyAType $taxPolicy)
    {
     ...
     * Property tax policies.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\TaxPoliciesAType\TaxPolicyAType[] $taxPolicies
     * @return self
     */
     ...
     * Property pet policies.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType
     */
     ...
     * Property pet policies.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType $petsPolicies
     * @return self
     */
    public function setPetsPolicies(?\Recranet\OTA\PoliciesType\PolicyAType\PetsPoliciesAType $petsPolicies = null)
    {
     ...
     */
    public function addToStayRequirements(\Recranet\OTA\PoliciesType\PolicyAType\StayRequirementsAType\StayRequirementAType $stayRequirement)
    {
     ...
     * Collection of stay requirements.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\StayRequirementsAType\StayRequirementAType[] $stayRequirements
     * @return self
     */
     ...
     * Used to define the property's high-level commission policy.
     *
     * @return \Recranet\OTA\PoliciesType\PolicyAType\CommissionPolicyAType
     */
     ...
     * Used to define the property's high-level commission policy.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\CommissionPolicyAType $commissionPolicy
     * @return self
     */
    public function setCommissionPolicy(?\Recranet\OTA\PoliciesType\PolicyAType\CommissionPolicyAType $commissionPolicy = null)
    {
     ...
     */
    public function addToFeePolicies(\Recranet\OTA\FeeType $feePolicy)
    {
     ...
     * A collection of fees that may apply to a reservation.
     *
     * @param \Recranet\OTA\FeeType[] $feePolicies
     * @return self
     */
     ...
     */
    public function addToRatePolicies(\Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType $ratePolicy)
    {
     ...
     * Defines the policies for various rate types (e.g. government rates, preferred rates, etc.)
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\RatePoliciesAType\RatePolicyAType[] $ratePolicies
     * @return self
     */
     ...
     */
    public function addToGroupPolicies(\Recranet\OTA\PoliciesType\PolicyAType\GroupPoliciesAType\GroupPolicyAType $groupPolicy)
    {
     ...
     * A collection of group policy information.
     *
     * @param \Recranet\OTA\PoliciesType\PolicyAType\GroupPoliciesAType\GroupPolicyAType[] $groupPolicies
     * @return self
     */
