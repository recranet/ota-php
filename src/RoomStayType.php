...
class RoomStayType
{
     ...
     *
     * @var \Recranet\OTA\RoomTypeType[] $roomTypes
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanType[] $ratePlans
     */
     ...
     *
     * @var \Recranet\OTA\RoomStayType\RoomRatesAType $roomRates
     */
     ...
     *
     * @var \Recranet\OTA\DiscountType $discount
     */
     ...
     *
     * @var \Recranet\OTA\RoomStayType\BasicPropertyInfoAType $basicPropertyInfo
     */
     ...
     *
     * @var \Recranet\OTA\RoomStayType\MapURLAType $mapURL
     */
    private $mapURL = null;
     ...
     */
    public function addToRoomTypes(\Recranet\OTA\RoomTypeType $roomType)
    {
     ...
     * The RoomType element is used to contain all the room type information for a single RateType Code (ex A1K) for a given date range.
     *
     * @param \Recranet\OTA\RoomTypeType[] $roomTypes
     * @return self
     */
     ...
     */
    public function addToRatePlans(\Recranet\OTA\RatePlanType $ratePlan)
    {
     ...
     * The rate plan element is used to contain all the rate information for a single Rate Plan Code (ex RACK) for a given date range. A given Rate Plan may have variable rates, over the effective period of the Rate Plan, this is represented by the child element Rates.
     *
     * @param \Recranet\OTA\RatePlanType[] $ratePlans
     * @return self
     */
     ...
     * The combination of a given Rate Plan and Room Type. This allows for support for systems where Rate Plans are child of Room Type as well as systems which Room Types are child of Rate Plans.
     *
     * @return \Recranet\OTA\RoomStayType\RoomRatesAType
     */
     ...
     * The combination of a given Rate Plan and Room Type. This allows for support for systems where Rate Plans are child of Room Type as well as systems which Room Types are child of Rate Plans.
     *
     * @param \Recranet\OTA\RoomStayType\RoomRatesAType $roomRates
     * @return self
     */
    public function setRoomRates(?\Recranet\OTA\RoomStayType\RoomRatesAType $roomRates = null)
    {
     ...
     * Discount percentage and/or Amount, code and textual reason for discount.
     *
     * @return \Recranet\OTA\DiscountType
     */
     ...
     * Discount percentage and/or Amount, code and textual reason for discount.
     *
     * @param \Recranet\OTA\DiscountType $discount
     * @return self
     */
    public function setDiscount(?\Recranet\OTA\DiscountType $discount = null)
    {
     ...
     * Property Information for the Room Stay.
     *
     * @return \Recranet\OTA\RoomStayType\BasicPropertyInfoAType
     */
     ...
     * Property Information for the Room Stay.
     *
     * @param \Recranet\OTA\RoomStayType\BasicPropertyInfoAType $basicPropertyInfo
     * @return self
     */
    public function setBasicPropertyInfo(?\Recranet\OTA\RoomStayType\BasicPropertyInfoAType $basicPropertyInfo = null)
    {
     ...
     * When requested, a link to a map is returned in the response which indicates the position of the matching hotel(s).
     *
     * @return \Recranet\OTA\RoomStayType\MapURLAType
     */
     ...
     * When requested, a link to a map is returned in the response which indicates the position of the matching hotel(s).
     *
     * @param \Recranet\OTA\RoomStayType\MapURLAType $mapURL
     * @return self
     */
    public function setMapURL(?\Recranet\OTA\RoomStayType\MapURLAType $mapURL = null)
    {
        $this->mapURL = $mapURL;
        return $this;
    }
