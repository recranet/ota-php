...
namespace Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType;
...
class EarliestStartAType
{
     ...
     *
     * @var \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType\CalculationMethodAType $calculationMethod
     */
     ...
     * Method used to calculate the earliest start date/ time.
     *
     * @return \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType\CalculationMethodAType
     */
     ...
     * Method used to calculate the earliest start date/ time.
     *
     * @param \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType\CalculationMethodAType $calculationMethod
     * @return self
     */
    public function setCalculationMethod(?\Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType\CalculationMethodAType $calculationMethod = null)
    {
