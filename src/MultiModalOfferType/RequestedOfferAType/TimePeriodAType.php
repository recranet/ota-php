...
class TimePeriodAType
{
     ...
     *
     * @var \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType $earliestStart
     */
     ...
     * Example: Minute
     *
     * @var \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\MaximumDurationAType $maximumDuration
     */
     ...
     * Earliest start date/ time for offer availability.
     *
     * @return \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType
     */
     ...
     * Earliest start date/ time for offer availability.
     *
     * @param \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType $earliestStart
     * @return self
     */
    public function setEarliestStart(\Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\EarliestStartAType $earliestStart)
    {
     ...
     * Example: Minute
     *
     * @return \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\MaximumDurationAType
     */
     ...
     * Example: Minute
     *
     * @param \Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\MaximumDurationAType $maximumDuration
     * @return self
     */
    public function setMaximumDuration(?\Recranet\OTA\MultiModalOfferType\RequestedOfferAType\TimePeriodAType\MaximumDurationAType $maximumDuration = null)
    {
