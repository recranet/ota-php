...
class VehicleRentalDetailsType
{
     ...
     *
     * @var \Recranet\OTA\VehicleRentalDetailsType\FuelLevelDetailsAType $fuelLevelDetails
     */
     ...
     *
     * @var \Recranet\OTA\VehicleRentalDetailsType\OdometerReadingAType $odometerReading
     */
     ...
     *
     * @var \Recranet\OTA\VehicleRentalDetailsType\ConditionReportAType[] $conditionReport
     */
     ...
     * This provides values based on the amount of fuel present.
     *
     * @return \Recranet\OTA\VehicleRentalDetailsType\FuelLevelDetailsAType
     */
     ...
     * This provides values based on the amount of fuel present.
     *
     * @param \Recranet\OTA\VehicleRentalDetailsType\FuelLevelDetailsAType $fuelLevelDetails
     * @return self
     */
    public function setFuelLevelDetails(?\Recranet\OTA\VehicleRentalDetailsType\FuelLevelDetailsAType $fuelLevelDetails = null)
    {
     ...
     * This provides values for the odometer reading.
     *
     * @return \Recranet\OTA\VehicleRentalDetailsType\OdometerReadingAType
     */
     ...
     * This provides values for the odometer reading.
     *
     * @param \Recranet\OTA\VehicleRentalDetailsType\OdometerReadingAType $odometerReading
     * @return self
     */
    public function setOdometerReading(?\Recranet\OTA\VehicleRentalDetailsType\OdometerReadingAType $odometerReading = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\VehicleRentalDetailsType\ConditionReportAType $conditionReport
     */
    public function addToConditionReport(\Recranet\OTA\VehicleRentalDetailsType\ConditionReportAType $conditionReport)
    {
     ...
     * Used to describe condition of a vehicle (e.g., scratches, broken tail light). It is not intended for insurance purposes.
     *
     * @return \Recranet\OTA\VehicleRentalDetailsType\ConditionReportAType[]
     */
