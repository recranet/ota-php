...
namespace Recranet\OTA\RailReservationSummaryType\ODInfoAType;
...
class TrainSegmentAType
{
     ...
     *
     * @var \Recranet\OTA\LocationType $departureStation
     */
     ...
     *
     * @var \Recranet\OTA\LocationType $arrivalStation
     */
     ...
     * Train departure station location.
     *
     * @param \Recranet\OTA\LocationType $departureStation
     * @return self
     */
    public function setDepartureStation(\Recranet\OTA\LocationType $departureStation)
    {
     ...
     * Train arrival station location.
     *
     * @param \Recranet\OTA\LocationType $arrivalStation
     * @return self
     */
    public function setArrivalStation(\Recranet\OTA\LocationType $arrivalStation)
    {
