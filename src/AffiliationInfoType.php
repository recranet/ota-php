...
class AffiliationInfoType
{
     ...
     *
     * @var \Recranet\OTA\AffiliationInfoType\DistribSystemsAType $distribSystems
     */
     ...
     *
     * @var \Recranet\OTA\AffiliationInfoType\BrandsAType\BrandAType[] $brands
     */
    private $brands = null;
     ...
     *
     * @var \Recranet\OTA\AffiliationInfoType\LoyalProgramsAType\LoyalProgramAType[] $loyalPrograms
     */
     ...
     *
     * @var \Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType[] $awards
     */
    private $awards = null;
     ...
     *
     * @var \Recranet\OTA\AffiliationInfoType\PartnerInfosAType\PartnerInfoAType[] $partnerInfos
     */
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $descriptions
     */
     ...
     * A collection of DistribSystem elements.
     *
     * @return \Recranet\OTA\AffiliationInfoType\DistribSystemsAType
     */
     ...
     * A collection of DistribSystem elements.
     *
     * @param \Recranet\OTA\AffiliationInfoType\DistribSystemsAType $distribSystems
     * @return self
     */
    public function setDistribSystems(?\Recranet\OTA\AffiliationInfoType\DistribSystemsAType $distribSystems = null)
    {
     ...
     */
    public function addToBrands(\Recranet\OTA\AffiliationInfoType\BrandsAType\BrandAType $brand)
    {
        $this->brands[] = $brand;
        return $this;
    }
     ...
     * Collection of Brands.
     *
     * @param \Recranet\OTA\AffiliationInfoType\BrandsAType\BrandAType[] $brands
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AffiliationInfoType\LoyalProgramsAType\LoyalProgramAType $loyalProgram
     */
    public function addToLoyalPrograms(\Recranet\OTA\AffiliationInfoType\LoyalProgramsAType\LoyalProgramAType $loyalProgram)
    {
     ...
     * Collection of LoyalPrograms.
     *
     * @return \Recranet\OTA\AffiliationInfoType\LoyalProgramsAType\LoyalProgramAType[]
     */
     ...
     * Collection of LoyalPrograms.
     *
     * @param \Recranet\OTA\AffiliationInfoType\LoyalProgramsAType\LoyalProgramAType[] $loyalPrograms
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType $award
     */
    public function addToAwards(\Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType $award)
    {
        $this->awards[] = $award;
        return $this;
    }
     ...
     * A collection of Award elements.
     *
     * @return \Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType[]
     */
     ...
     * A collection of Award elements.
     *
     * @param \Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType[] $awards
     * @return self
     */
     ...
     */
    public function addToPartnerInfos(\Recranet\OTA\AffiliationInfoType\PartnerInfosAType\PartnerInfoAType $partnerInfo)
    {
     ...
     * Collection of PartnerInfo.
     *
     * @param \Recranet\OTA\AffiliationInfoType\PartnerInfosAType\PartnerInfoAType[] $partnerInfos
     * @return self
     */
     ...
     */
    public function addToDescriptions(\Recranet\OTA\ParagraphType $description)
    {
     ...
     * Collection of affiliation descriptions.
     *
     * @param \Recranet\OTA\ParagraphType[] $descriptions
     * @return self
     */
