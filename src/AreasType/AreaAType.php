...
namespace Recranet\OTA\AreasType;
...
class AreaAType
{
     ...
     * Area description.
     *
     * @var \Recranet\OTA\ParagraphType $areaDescription
     */
     ...
     * Area description.
     *
     * @param \Recranet\OTA\ParagraphType $areaDescription
     * @return self
     */
    public function setAreaDescription(?\Recranet\OTA\ParagraphType $areaDescription = null)
    {
