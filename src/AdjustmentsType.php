...
class AdjustmentsType
{
    ...
    /**
     * @var \Recranet\OTA\AdjustmentsType\AdjustmentAType[] $adjustment
     */
    private $adjustment = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\AdjustmentsType\AdjustmentAType $adjustment
     */
    public function addToAdjustment(\Recranet\OTA\AdjustmentsType\AdjustmentAType $adjustment)
    {
     ...
     * Gets as adjustment
     *
     * @return \Recranet\OTA\AdjustmentsType\AdjustmentAType[]
     */
