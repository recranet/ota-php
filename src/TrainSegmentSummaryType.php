...
class TrainSegmentSummaryType
{
     ...
     *
     * @var \Recranet\OTA\TrainIdentificationType $trainIdentification
     */
     ...
     * Train identification information, including a train number and a train network code.
     *
     * @param \Recranet\OTA\TrainIdentificationType $trainIdentification
     * @return self
     */
    public function setTrainIdentification(\Recranet\OTA\TrainIdentificationType $trainIdentification)
    {
