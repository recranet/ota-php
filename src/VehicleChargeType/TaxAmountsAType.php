...
namespace Recranet\OTA\VehicleChargeType;
...
class TaxAmountsAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleChargeType\TaxAmountsAType\TaxAmountAType[] $taxAmount
     */
    private $taxAmount = [
     ...
     */
    public function addToTaxAmount(\Recranet\OTA\VehicleChargeType\TaxAmountsAType\TaxAmountAType $taxAmount)
    {
