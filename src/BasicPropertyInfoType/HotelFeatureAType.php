...
{
    /**
     * Identifies a security feature at a propetry. Refer to OpenTravel Code list Security Feature Code (SEC).
     *
     * @var string $securityFeatureCode
     */
    private $securityFeatureCode = null;

    /**
     * Identifies an accessibility feature for a property. Refer to OpenTravel Code list Disability Feature Code (PHY).
     *
