...
class AirTravelerType
{
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\ProfileRefAType $profileRef
     */
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\TelephoneAType[] $telephone
     */
    private $telephone = [
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\EmailAType[] $email
     */
    private $email = [
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\AddressAType[] $address
     */
    private $address = [
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\CustLoyaltyAType[] $custLoyalty
     */
    private $custLoyalty = [
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\DocumentAType[] $document
     */
    private $document = [
     ...
     *
     * @var \Recranet\OTA\AirTravelerType\TravelerRefNumberAType $travelerRefNumber
     */
     ...
     * Stored information about a customer. May contain readily available information relevant to the booking.
     *
     * @return \Recranet\OTA\AirTravelerType\ProfileRefAType
     */
     ...
     * Stored information about a customer. May contain readily available information relevant to the booking.
     *
     * @param \Recranet\OTA\AirTravelerType\ProfileRefAType $profileRef
     * @return self
     */
    public function setProfileRef(?\Recranet\OTA\AirTravelerType\ProfileRefAType $profileRef = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirTravelerType\TelephoneAType $telephone
     */
    public function addToTelephone(\Recranet\OTA\AirTravelerType\TelephoneAType $telephone)
    {
     ...
     * Telephone number for the person traveling.
     *
     * @return \Recranet\OTA\AirTravelerType\TelephoneAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirTravelerType\EmailAType $email
     */
    public function addToEmail(\Recranet\OTA\AirTravelerType\EmailAType $email)
    {
        $this->email[] = $email;
        return $this;
    }
     ...
     * Email address of the person traveling.
     *
     * @return \Recranet\OTA\AirTravelerType\EmailAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirTravelerType\AddressAType $address
     */
    public function addToAddress(\Recranet\OTA\AirTravelerType\AddressAType $address)
    {
     ...
     * Address information of the person traveling.
     *
     * @return \Recranet\OTA\AirTravelerType\AddressAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirTravelerType\CustLoyaltyAType $custLoyalty
     */
    public function addToCustLoyalty(\Recranet\OTA\AirTravelerType\CustLoyaltyAType $custLoyalty)
    {
     ...
     * Identifies the loyalty program(s) that the customer belongs to and associated information.
     *
     * @return \Recranet\OTA\AirTravelerType\CustLoyaltyAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirTravelerType\DocumentAType $document
     */
    public function addToDocument(\Recranet\OTA\AirTravelerType\DocumentAType $document)
    {
     ...
     * Official travel document information associated with the person traveling.
     *
     * @return \Recranet\OTA\AirTravelerType\DocumentAType[]
     */
     ...
     * @return self
     */
    public function setPassengerTypeQuantity(?\Recranet\OTA\PassengerTypeQuantityType $passengerTypeQuantity = null)
    {
     ...
     * Direct reference of traveler assigned by requesting system. Used as a cross reference between data segments.
     *
     * @return \Recranet\OTA\AirTravelerType\TravelerRefNumberAType
     */
     ...
     * Direct reference of traveler assigned by requesting system. Used as a cross reference between data segments.
     *
     * @param \Recranet\OTA\AirTravelerType\TravelerRefNumberAType $travelerRefNumber
     * @return self
     */
    public function setTravelerRefNumber(?\Recranet\OTA\AirTravelerType\TravelerRefNumberAType $travelerRefNumber = null)
    {
