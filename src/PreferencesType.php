...
class PreferencesType
{
     ...
     *
     * @var \Recranet\OTA\PreferencesType\PrefCollectionAType[] $prefCollection
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PreferencesType\PrefCollectionAType $prefCollection
     */
    public function addToPrefCollection(\Recranet\OTA\PreferencesType\PrefCollectionAType $prefCollection)
    {
     ...
     * Aggregation of customer travel needs.
     *
     * @return \Recranet\OTA\PreferencesType\PrefCollectionAType[]
     */
