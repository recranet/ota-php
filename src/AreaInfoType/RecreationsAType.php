...
class RecreationsAType
{
     ...
     *
     * @var \Recranet\OTA\AreaInfoType\RecreationsAType\RecreationAType[] $recreation
     */
    private $recreation = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\AreaInfoType\RecreationsAType\RecreationAType $recreation
     */
    public function addToRecreation(\Recranet\OTA\AreaInfoType\RecreationsAType\RecreationAType $recreation)
    {
     ...
     * A recreation facility available to the guest. These may or may not be operated by the hotel or located at the hotel.
     *
     * @return \Recranet\OTA\AreaInfoType\RecreationsAType\RecreationAType[]
     */
