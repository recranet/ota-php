...
namespace Recranet\OTA\OTAHotelEventRS;

/**
 * Class representing OTAHotelEventRSAType
 */
class OTAHotelEventRSAType
{
    /**
    ...
    /**
     * If true, this transaction is a modification to an existing event.
     * Example: true
     *
     * @var bool $modifyInd
     */
    ...
    /**
     * Collection of events which may be used to echo back data from the request message.
     *
     * @var \Recranet\OTA\EventType\EventAType[] $events
     */
    private $events = null;
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventType\EventAType $event
     */
    public function addToEvents(\Recranet\OTA\EventType\EventAType $event)
    {
        $this->events[] = $event;
        return $this;
    }
     ...
     * Collection of events which may be used to echo back data from the request message.
     *
     * @return \Recranet\OTA\EventType\EventAType[]
     */
     ...
     * Collection of events which may be used to echo back data from the request message.
     *
     * @param \Recranet\OTA\EventType\EventAType[] $events
     * @return self
     */
