...
class AncillaryServiceActionType
{
     ...
     *
     * @var \Recranet\OTA\AncillaryServiceActionType\ProductGroupAType[] $productGroup
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AncillaryServiceActionType\ProductGroupAType $productGroup
     */
    public function addToProductGroup(\Recranet\OTA\AncillaryServiceActionType\ProductGroupAType $productGroup)
    {
     ...
     * Airline or ATPCO encoded product group code(s) that are associated with the service code.
     *
     * @return \Recranet\OTA\AncillaryServiceActionType\ProductGroupAType[]
     */
