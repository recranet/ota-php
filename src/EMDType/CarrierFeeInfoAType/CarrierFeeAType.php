...
class CarrierFeeAType
{
     ...
     *
     * @var \Recranet\OTA\EMDType\CarrierFeeInfoAType\CarrierFeeAType\FeeAmountAType[] $feeAmount
     */
    private $feeAmount = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\EMDType\CarrierFeeInfoAType\CarrierFeeAType\FeeAmountAType $feeAmount
     */
    public function addToFeeAmount(\Recranet\OTA\EMDType\CarrierFeeInfoAType\CarrierFeeAType\FeeAmountAType $feeAmount)
    {
     ...
     * The type of fee being imposed by a carrier, the amount and other related information.
     *
     * @return \Recranet\OTA\EMDType\CarrierFeeInfoAType\CarrierFeeAType\FeeAmountAType[]
     */
