...
namespace Recranet\OTA\RateUploadType\BaseByGuestAmtsAType;

use Recranet\OTA\TotalType;
...
class BaseByGuestAmtAType extends TotalType
{
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $numberOfGuestsDescription
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ParagraphType $numberOfGuestsDescription
     */
    public function addToNumberOfGuestsDescription(\Recranet\OTA\ParagraphType $numberOfGuestsDescription)
    {
