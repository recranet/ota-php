...
class OntologyTravelerClassType
{
     ...
     * Example: Adult
     *
     * @var \Recranet\OTA\OntologyTravelerClassType\AgeCategoryAType[] $ageCategory
     */
    private $ageCategory = [
     ...
     * Example: Disabled
     *
     * @var \Recranet\OTA\OntologyTravelerClassType\PassengerCategoryAType[] $passengerCategory
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OntologyTravelerClassType\AgeCategoryAType $ageCategory
     */
    public function addToAgeCategory(\Recranet\OTA\OntologyTravelerClassType\AgeCategoryAType $ageCategory)
    {
     ...
     * Example: Adult
     *
     * @return \Recranet\OTA\OntologyTravelerClassType\AgeCategoryAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OntologyTravelerClassType\PassengerCategoryAType $passengerCategory
     */
    public function addToPassengerCategory(\Recranet\OTA\OntologyTravelerClassType\PassengerCategoryAType $passengerCategory)
    {
     ...
     * Example: Disabled
     *
     * @return \Recranet\OTA\OntologyTravelerClassType\PassengerCategoryAType[]
     */
