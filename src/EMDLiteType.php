...
class EMDLiteType
{
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\EndorsementAType $endorsement
     */
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\TotalFareAType[] $totalFare
     */
    private $totalFare = [
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\TaxesAType\TaxAType[] $taxes
     */
    private $taxes = null;
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\FareInfoAType $fareInfo
     */
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\TicketDocumentAType[] $ticketDocument
     */
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\OriginalIssueInfoAType $originalIssueInfo
     */
     ...
     *
     * @var \Recranet\OTA\EMDLiteType\ReasonForIssuanceAType $reasonForIssuance
     */
     ...
     * Endorsement/ restriction remarks.
     *
     * @return \Recranet\OTA\EMDLiteType\EndorsementAType
     */
     ...
     * Endorsement/ restriction remarks.
     *
     * @param \Recranet\OTA\EMDLiteType\EndorsementAType $endorsement
     * @return self
     */
    public function setEndorsement(?\Recranet\OTA\EMDLiteType\EndorsementAType $endorsement = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\EMDLiteType\TotalFareAType $totalFare
     */
    public function addToTotalFare(\Recranet\OTA\EMDLiteType\TotalFareAType $totalFare)
    {
     ...
     * Used to specify the total, total net, total sell fare or refund amount.
     *
     * @return \Recranet\OTA\EMDLiteType\TotalFareAType[]
     */
     ...
     */
    public function addToTaxes(\Recranet\OTA\EMDLiteType\TaxesAType\TaxAType $tax)
    {
        $this->taxes[] = $tax;
        return $this;
    }
     ...
     * A collection of taxes.
     *
     * @param \Recranet\OTA\EMDLiteType\TaxesAType\TaxAType[] $taxes
     * @return self
     */
     ...
     * Nonendorsable and nonrefundable indicators, penalty restriction indicator, pricing system, tour code, ISO country code, around the world fare indicator and non-reissuable/non-exchangeable indicator.
     *
     * @return \Recranet\OTA\EMDLiteType\FareInfoAType
     */
     ...
     * Nonendorsable and nonrefundable indicators, penalty restriction indicator, pricing system, tour code, ISO country code, around the world fare indicator and non-reissuable/non-exchangeable indicator.
     *
     * @param \Recranet\OTA\EMDLiteType\FareInfoAType $fareInfo
     * @return self
     */
    public function setFareInfo(?\Recranet\OTA\EMDLiteType\FareInfoAType $fareInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\EMDLiteType\TicketDocumentAType $ticketDocument
     */
    public function addToTicketDocument(\Recranet\OTA\EMDLiteType\TicketDocumentAType $ticketDocument)
    {
     ...
     * The EMD type, in connection number, fee owner and date of issue.
     *
     * @return \Recranet\OTA\EMDLiteType\TicketDocumentAType[]
     */
     ...
     * The original ticket/document issue information.
     *
     * @return \Recranet\OTA\EMDLiteType\OriginalIssueInfoAType
     */
     ...
     * The original ticket/document issue information.
     *
     * @param \Recranet\OTA\EMDLiteType\OriginalIssueInfoAType $originalIssueInfo
     * @return self
     */
    public function setOriginalIssueInfo(?\Recranet\OTA\EMDLiteType\OriginalIssueInfoAType $originalIssueInfo = null)
    {
     ...
     * The reason for issuance information.
     *
     * @return \Recranet\OTA\EMDLiteType\ReasonForIssuanceAType
     */
     ...
     * The reason for issuance information.
     *
     * @param \Recranet\OTA\EMDLiteType\ReasonForIssuanceAType $reasonForIssuance
     * @return self
     */
    public function setReasonForIssuance(?\Recranet\OTA\EMDLiteType\ReasonForIssuanceAType $reasonForIssuance = null)
    {
