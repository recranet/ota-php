...
namespace Recranet\OTA\OTAHotelAvailNotifRQ;
...
class OTAHotelAvailNotifRQAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelAvailNotifRQ\OTAHotelAvailNotifRQAType\AvailStatusMessagesAType $availStatusMessages
     */
     ...
     * Container for the individual AvailStatusMessage(s). An OTA_HotelAvailNotifRQ contains the availability statuses for a single hotel. Hotel identification information are the attributes of this element.
     *
     * @return \Recranet\OTA\OTAHotelAvailNotifRQ\OTAHotelAvailNotifRQAType\AvailStatusMessagesAType
     */
     ...
     * Container for the individual AvailStatusMessage(s). An OTA_HotelAvailNotifRQ contains the availability statuses for a single hotel. Hotel identification information are the attributes of this element.
     *
     * @param \Recranet\OTA\OTAHotelAvailNotifRQ\OTAHotelAvailNotifRQAType\AvailStatusMessagesAType $availStatusMessages
     * @return self
     */
    public function setAvailStatusMessages(?\Recranet\OTA\OTAHotelAvailNotifRQ\OTAHotelAvailNotifRQAType\AvailStatusMessagesAType $availStatusMessages = null)
    {
