...
class BookingReferenceType
{
     ...
     *
     * @var \Recranet\OTA\BookingReferenceType\UniqueIDTypeAType $uniqueIDType
     */
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $company
     */
     ...
     *
     * @var \Recranet\OTA\TravelerInfoType[] $traveler
     */
    private $traveler = [
     ...
     * The unique ID type. Select a value from the list or use the "Other_" value and the @extension to define a value known between trading partners.
     *
     * @return \Recranet\OTA\BookingReferenceType\UniqueIDTypeAType
     */
     ...
     * The unique ID type. Select a value from the list or use the "Other_" value and the @extension to define a value known between trading partners.
     *
     * @param \Recranet\OTA\BookingReferenceType\UniqueIDTypeAType $uniqueIDType
     * @return self
     */
    public function setUniqueIDType(\Recranet\OTA\BookingReferenceType\UniqueIDTypeAType $uniqueIDType)
    {
     ...
     * Associated company information.
     *
     * @param \Recranet\OTA\CompanyNameType $company
     * @return self
     */
    public function setCompany(?\Recranet\OTA\CompanyNameType $company = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\TravelerInfoType $traveler
     */
    public function addToTraveler(\Recranet\OTA\TravelerInfoType $traveler)
    {
