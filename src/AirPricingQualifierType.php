...
class AirPricingQualifierType
{
     ...
     *
     * @var \Recranet\OTA\AirPricingQualifierType\RestrictionsAType $restrictions
     */
     ...
     *
     * @var \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType $taxExemption
     */
     ...
     *
     * @var \Recranet\OTA\AirPricingQualifierType\PromotionCodeAType $promotionCode
     */
     ...
     * Advanced purchase and fare penalty indicators.
     *
     * @return \Recranet\OTA\AirPricingQualifierType\RestrictionsAType
     */
     ...
     * Advanced purchase and fare penalty indicators.
     *
     * @param \Recranet\OTA\AirPricingQualifierType\RestrictionsAType $restrictions
     * @return self
     */
    public function setRestrictions(?\Recranet\OTA\AirPricingQualifierType\RestrictionsAType $restrictions = null)
    {
     ...
     * Tax exemption criteria.
     *
     * @return \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType
     */
     ...
     * Tax exemption criteria.
     *
     * @param \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType $taxExemption
     * @return self
     */
    public function setTaxExemption(?\Recranet\OTA\AirPricingQualifierType\TaxExemptionAType $taxExemption = null)
    {
     ...
     * A promotion code with associated airline code.
     *
     * @return \Recranet\OTA\AirPricingQualifierType\PromotionCodeAType
     */
     ...
     * A promotion code with associated airline code.
     *
     * @param \Recranet\OTA\AirPricingQualifierType\PromotionCodeAType $promotionCode
     * @return self
     */
    public function setPromotionCode(?\Recranet\OTA\AirPricingQualifierType\PromotionCodeAType $promotionCode = null)
    {
