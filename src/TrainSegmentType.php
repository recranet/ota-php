...
class TrainSegmentType
{
     ...
     *
     * @var \Recranet\OTA\ClassCodeType $equipment
     */
     ...
     * The type of equipment used for the train journey. Use a string value, such as the operator equipment code or a UIC code.
     *
     * @param \Recranet\OTA\ClassCodeType $equipment
     * @return self
     */
    public function setEquipment(?\Recranet\OTA\ClassCodeType $equipment = null)
    {
     ...
     * @return self
     */
    public function setTrainInfo(?\Recranet\OTA\TrainInfoType $trainInfo = null)
    {
