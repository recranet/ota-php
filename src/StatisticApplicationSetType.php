...
class StatisticApplicationSetType
{
     ...
     *
     * @var \Recranet\OTA\StatisticApplicationSetType\StatisticCodesAType\StatisticCodeAType[] $statisticCodes
     */
     ...
     *
     * @var \Recranet\OTA\StatisticApplicationSetType\RevenueCategorySummariesAType\RevenueCategorySummaryAType[] $revenueCategorySummaries
     */
     ...
     *
     * @var \Recranet\OTA\StatisticApplicationSetType\CountCategorySummariesAType\CountCategorySummaryAType[] $countCategorySummaries
     */
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $reportSummaries
     */
     ...
     */
    public function addToStatisticCodes(\Recranet\OTA\StatisticApplicationSetType\StatisticCodesAType\StatisticCodeAType $statisticCode)
    {
     ...
     * Collection of StatisticCode elements. Used if data is partitioned/aggregated.
     *
     * @param \Recranet\OTA\StatisticApplicationSetType\StatisticCodesAType\StatisticCodeAType[] $statisticCodes
     * @return self
     */
     ...
     */
    public function addToRevenueCategorySummaries(\Recranet\OTA\StatisticApplicationSetType\RevenueCategorySummariesAType\RevenueCategorySummaryAType $revenueCategorySummary)
    {
     ...
     * Collection of RevenueCategorySummary elements. Used if revenue values reported.
     *
     * @param \Recranet\OTA\StatisticApplicationSetType\RevenueCategorySummariesAType\RevenueCategorySummaryAType[] $revenueCategorySummaries
     * @return self
     */
     ...
     */
    public function addToCountCategorySummaries(\Recranet\OTA\StatisticApplicationSetType\CountCategorySummariesAType\CountCategorySummaryAType $countCategorySummary)
    {
     ...
     * Collection of CountCategorySummary elements. Used if count values reported.
     *
     * @param \Recranet\OTA\StatisticApplicationSetType\CountCategorySummariesAType\CountCategorySummaryAType[] $countCategorySummaries
     * @return self
     */
     ...
     */
    public function addToReportSummaries(\Recranet\OTA\ParagraphType $reportSummary)
    {
     ...
     * Collection of ReportSummary elements.
     *
     * @param \Recranet\OTA\ParagraphType[] $reportSummaries
     * @return self
     */
