...
namespace Recranet\OTA\FareComponentType\PriceableUnitAType;
...
class FareComponentDetailAType
{
     ...
     *
     * @var \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType[] $couponSequence
     */
     ...
     *
     * @var \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType[] $constructionPrinciple
     */
     ...
     *
     * @var \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType[] $baseAmount
     */
    private $baseAmount = [
     ...
     *
     * @var \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType[] $ticketDesignator
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType $couponSequence
     */
    public function addToCouponSequence(\Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType $couponSequence)
    {
     ...
     * Sequence number, coupon/itinerary sequence nbr, from and to city codes, stopover indicator, and airline designator.
     *
     * @return \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\CouponSequenceAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType $constructionPrinciple
     */
    public function addToConstructionPrinciple(\Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType $constructionPrinciple)
    {
     ...
     * Principle indicator, from and to airport/city code, amount and percent.
     *
     * @return \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\ConstructionPrincipleAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType $baseAmount
     */
    public function addToBaseAmount(\Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType $baseAmount)
    {
     ...
     * The base, base net, and base sell amounts.
     *
     * @return \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\BaseAmountAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType $ticketDesignator
     */
    public function addToTicketDesignator(\Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType $ticketDesignator)
    {
     ...
     * Ticket designation code and qualifier.
     *
     * @return \Recranet\OTA\FareComponentType\PriceableUnitAType\FareComponentDetailAType\TicketDesignatorAType[]
     */
