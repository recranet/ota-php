...
class CancelPenaltyType
{
     ...
     *
     * @var \Recranet\OTA\CancelPenaltyType\DeadlineAType $deadline
     */
     ...
     *
     * @var \Recranet\OTA\AmountPercentType $amountPercent
     */
     ...
     *
     * @var \Recranet\OTA\ParagraphType[] $penaltyDescription
     */
     ...
     * Cancellation deadline, absolute or relative.
     *
     * @return \Recranet\OTA\CancelPenaltyType\DeadlineAType
     */
     ...
     * Cancellation deadline, absolute or relative.
     *
     * @param \Recranet\OTA\CancelPenaltyType\DeadlineAType $deadline
     * @return self
     */
    public function setDeadline(?\Recranet\OTA\CancelPenaltyType\DeadlineAType $deadline = null)
    {
     ...
     * Cancellation fee expressed as a fixed amount, or percentage of/or room nights.
     *
     * @return \Recranet\OTA\AmountPercentType
     */
     ...
     * Cancellation fee expressed as a fixed amount, or percentage of/or room nights.
     *
     * @param \Recranet\OTA\AmountPercentType $amountPercent
     * @return self
     */
    public function setAmountPercent(?\Recranet\OTA\AmountPercentType $amountPercent = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\ParagraphType $penaltyDescription
     */
    public function addToPenaltyDescription(\Recranet\OTA\ParagraphType $penaltyDescription)
    {
