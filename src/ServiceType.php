...
class ServiceType
{
     ...
     *
     * @var \Recranet\OTA\AmountType[] $price
     */
    private $price = [
     ...
     *
     * @var \Recranet\OTA\ServiceType\ServiceDetailsAType $serviceDetails
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AmountType $price
     */
    public function addToPrice(\Recranet\OTA\AmountType $price)
    {
        $this->price[] = $price;
        return $this;
    }
     ...
     * The selling price of this Service.
     *
     * @return \Recranet\OTA\AmountType[]
     */
     ...
     * Details on the Service including Guest Counts, Time Span of this Service, pointers to Res Guests, guest Memberships, Comments and Special Requests pertaining to this particular Service and finally financial information related to the Service, including Guarantee, Deposit and Payment and Cancellation Penalties.
     *
     * @return \Recranet\OTA\ServiceType\ServiceDetailsAType
     */
     ...
     * Details on the Service including Guest Counts, Time Span of this Service, pointers to Res Guests, guest Memberships, Comments and Special Requests pertaining to this particular Service and finally financial information related to the Service, including Guarantee, Deposit and Payment and Cancellation Penalties.
     *
     * @param \Recranet\OTA\ServiceType\ServiceDetailsAType $serviceDetails
     * @return self
     */
    public function setServiceDetails(?\Recranet\OTA\ServiceType\ServiceDetailsAType $serviceDetails = null)
    {
