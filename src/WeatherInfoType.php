...
class WeatherInfoType
{
     ...
     *
     * @var \Recranet\OTA\WeatherInfoType\PrecipitationAType[] $precipitation
     */
     ...
     *
     * @var \Recranet\OTA\WeatherInfoType\TemperatureAType[] $temperature
     */
    private $temperature = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\WeatherInfoType\PrecipitationAType $precipitation
     */
    public function addToPrecipitation(\Recranet\OTA\WeatherInfoType\PrecipitationAType $precipitation)
    {
     ...
     * Provides average precipitation and the unit in which it is measured for a Period.
     *
     * @return \Recranet\OTA\WeatherInfoType\PrecipitationAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\WeatherInfoType\TemperatureAType $temperature
     */
    public function addToTemperature(\Recranet\OTA\WeatherInfoType\TemperatureAType $temperature)
    {
     ...
     * Provides average temperatures and the unit in which they are measured for a Period.
     *
     * @return \Recranet\OTA\WeatherInfoType\TemperatureAType[]
     */
