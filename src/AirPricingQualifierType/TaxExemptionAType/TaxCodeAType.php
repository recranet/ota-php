...
namespace Recranet\OTA\AirPricingQualifierType\TaxExemptionAType;
...
class TaxCodeAType
{
     ...
     *
     * @var \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType\DesignatorCodeAType $designatorCode
     */
     ...
     * Select a pre-defined value from the list, or use the "Other_" value in combination with the @ExtDesignatorCode.
     *
     * @return \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType\DesignatorCodeAType
     */
     ...
     * Select a pre-defined value from the list, or use the "Other_" value in combination with the @ExtDesignatorCode.
     *
     * @param \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType\DesignatorCodeAType $designatorCode
     * @return self
     */
    public function setDesignatorCode(\Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType\DesignatorCodeAType $designatorCode)
    {
