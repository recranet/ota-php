...
namespace Recranet\OTA\AirPricingQualifierType;
...
class TaxExemptionAType
{
     ...
     *
     * @var \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType[] $taxCode
     */
    private $taxCode = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType $taxCode
     */
    public function addToTaxCode(\Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType $taxCode)
    {
     ...
     * Exemption tax code(s) and types.
     *
     * @return \Recranet\OTA\AirPricingQualifierType\TaxExemptionAType\TaxCodeAType[]
     */
