...
class RoomBlocksAType
{
     ...
     *
     * @var \Recranet\OTA\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType[] $roomBlock
     */
    private $roomBlock = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType $roomBlock
     */
    public function addToRoomBlock(\Recranet\OTA\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType $roomBlock)
    {
     ...
     * Information pertaining to a room block for this event.
     *
     * @return \Recranet\OTA\PostEventSiteReportType\RoomBlocksAType\RoomBlockAType[]
     */
