...
class VideoDescriptionType
{
     ...
     *
     * @var \Recranet\OTA\VideoDescriptionType\VideoFormatAType[] $videoFormat
     */
    private $videoFormat = [
     ...
     *
     * @var \Recranet\OTA\VideoDescriptionType\DescriptionAType[] $description
     */
    private $description = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\VideoDescriptionType\VideoFormatAType $videoFormat
     */
    public function addToVideoFormat(\Recranet\OTA\VideoDescriptionType\VideoFormatAType $videoFormat)
    {
     ...
     * A set of video of a given category can be provided in different Format, each format will be described in this element.
     *
     * @return \Recranet\OTA\VideoDescriptionType\VideoFormatAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\VideoDescriptionType\DescriptionAType $description
     */
    public function addToDescription(\Recranet\OTA\VideoDescriptionType\DescriptionAType $description)
    {
     ...
     * The description associated with the video in a specific language.
     *
     * @return \Recranet\OTA\VideoDescriptionType\DescriptionAType[]
     */
