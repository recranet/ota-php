...
namespace Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType;
...
class InvBlocksAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\HotelRefAType $hotelRef
     */
     ...
     *
     * @var \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockDatesAType $invBlockDates
     */
     ...
     *
     * @var \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockAType[] $invBlock
     */
    private $invBlock = [
     ...
     * This is used to identify the hotel to which the block(s) applies.
     *
     * @return \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\HotelRefAType
     */
     ...
     * This is used to identify the hotel to which the block(s) applies.
     *
     * @param \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\HotelRefAType $hotelRef
     * @return self
     */
    public function setHotelRef(?\Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\HotelRefAType $hotelRef = null)
    {
     ...
     * This is used to indicate the date or date range applicable to all inventory blocks in this message.
     *
     * @return \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockDatesAType
     */
     ...
     * This is used to indicate the date or date range applicable to all inventory blocks in this message.
     *
     * @param \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockDatesAType $invBlockDates
     * @return self
     */
    public function setInvBlockDates(?\Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockDatesAType $invBlockDates = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockAType $invBlock
     */
    public function addToInvBlock(\Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockAType $invBlock)
    {
     ...
     * This is for creating a single block at a single hotel.
     *
     * @return \Recranet\OTA\OTAHotelInvBlockNotifRQ\OTAHotelInvBlockNotifRQAType\InvBlocksAType\InvBlockAType[]
     */
