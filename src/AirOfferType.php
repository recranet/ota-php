...
class AirOfferType
{
     ...
     *
     * @var \Recranet\OTA\AirOfferType\RestrictionAType[] $restriction
     */
    private $restriction = [
     ...
     *
     * @var \Recranet\OTA\AirOfferType\TermsAndConditionsAType[] $termsAndConditions
     */
     ...
     * @return self
     */
    public function setServiceFamily(?\Recranet\OTA\AncillaryServiceDetailType $serviceFamily = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirOfferType\RestrictionAType $restriction
     */
    public function addToRestriction(\Recranet\OTA\AirOfferType\RestrictionAType $restriction)
    {
     ...
     * Restrictions that apply to the priced offer, such as ???Seat requests available up to 24 hours before departure".
     *
     * @return \Recranet\OTA\AirOfferType\RestrictionAType[]
     */
     ...
     * @return self
     */
    public function setShortDescription(?\Recranet\OTA\FormattedTextTextType $shortDescription = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirOfferType\TermsAndConditionsAType $termsAndConditions
     */
    public function addToTermsAndConditions(\Recranet\OTA\AirOfferType\TermsAndConditionsAType $termsAndConditions)
    {
     ...
     * Terms and conditions that apply to the offer.
     *
     * @return \Recranet\OTA\AirOfferType\TermsAndConditionsAType[]
     */
