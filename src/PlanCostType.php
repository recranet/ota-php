...
class PlanCostType
{
     ...
     *
     * @var \Recranet\OTA\PlanCostType\BasePremiumAType $basePremium
     */
     ...
     *
     * @var \Recranet\OTA\FeeType[] $charges
     */
     ...
     * Cost for the insurance coverage alone (excluding any fees/taxes).
     *
     * @return \Recranet\OTA\PlanCostType\BasePremiumAType
     */
     ...
     * Cost for the insurance coverage alone (excluding any fees/taxes).
     *
     * @param \Recranet\OTA\PlanCostType\BasePremiumAType $basePremium
     * @return self
     */
    public function setBasePremium(?\Recranet\OTA\PlanCostType\BasePremiumAType $basePremium = null)
    {
     ...
     */
    public function addToCharges(\Recranet\OTA\FeeType $charge)
    {
        $this->charges[] = $charge;
        return $this;
    }
     ...
     * A container for any additional charges to the cost of the insurance plan.
     *
     * @param \Recranet\OTA\FeeType[] $charges
     * @return self
     */
