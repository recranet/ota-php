...
class MeetingRoomsType
{
     ...
     *
     * @var \Recranet\OTA\MeetingRoomsType\MeetingRoomAType[] $meetingRoom
     */
    private $meetingRoom = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\MeetingRoomsType\MeetingRoomAType $meetingRoom
     */
    public function addToMeetingRoom(\Recranet\OTA\MeetingRoomsType\MeetingRoomAType $meetingRoom)
    {
     ...
     * Dedicated or non-dedicated space or area in which to hold a meeting.
     *
     * @return \Recranet\OTA\MeetingRoomsType\MeetingRoomAType[]
     */
