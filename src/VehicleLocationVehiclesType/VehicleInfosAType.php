...
class VehicleInfosAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleLocationVehiclesType\VehicleInfosAType\VehicleInfoAType[] $vehicleInfo
     */
    private $vehicleInfo = [
     ...
     */
    public function addToVehicleInfo(\Recranet\OTA\VehicleLocationVehiclesType\VehicleInfosAType\VehicleInfoAType $vehicleInfo)
    {
