...
class RatePlansAType
{
     ...
     *
     * @var \Recranet\OTA\HotelRatePlanType[] $ratePlan
     */
    private $ratePlan = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelRatePlanType $ratePlan
     */
    public function addToRatePlan(\Recranet\OTA\HotelRatePlanType $ratePlan)
    {
     ...
     * An individual rate plan.
     *
     * @return \Recranet\OTA\HotelRatePlanType[]
     */
