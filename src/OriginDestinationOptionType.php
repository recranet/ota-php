...
class OriginDestinationOptionType
{
     ...
     *
     * @var \Recranet\OTA\OriginDestinationOptionType\FlightSegmentAType[] $flightSegment
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OriginDestinationOptionType\FlightSegmentAType $flightSegment
     */
    public function addToFlightSegment(\Recranet\OTA\OriginDestinationOptionType\FlightSegmentAType $flightSegment)
    {
     ...
     * A container for necessary data to describe one or more legs of a single flight number.
     *
     * @return \Recranet\OTA\OriginDestinationOptionType\FlightSegmentAType[]
     */
