...
namespace Recranet\OTA\VehicleLocationAdditionalDetailsType\ShuttleAType;
...
class ShuttleInfosAType
{
     ...
     *
     * @var \Recranet\OTA\VehicleLocationAdditionalDetailsType\ShuttleAType\ShuttleInfosAType\ShuttleInfoAType[] $shuttleInfo
     */
    private $shuttleInfo = [
     ...
     */
    public function addToShuttleInfo(\Recranet\OTA\VehicleLocationAdditionalDetailsType\ShuttleAType\ShuttleInfosAType\ShuttleInfoAType $shuttleInfo)
    {
