...
class VehicleAvailRQAdditionalInfoType
{
     ...
     *
     * @var \Recranet\OTA\VehicleAvailRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType[] $coveragePrefs
     */
     ...
     */
    public function addToCoveragePrefs(\Recranet\OTA\VehicleAvailRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType $coveragePref)
    {
     ...
     * Indicates the preferences for one or more types of coverage (insurance).
     *
     * @param \Recranet\OTA\VehicleAvailRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType[] $coveragePrefs
     * @return self
     */
