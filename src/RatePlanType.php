...
class RatePlanType
{
     ...
     *
     * @var \Recranet\OTA\RatePlanType\GuaranteeAType[] $guarantee
     */
    private $guarantee = [
     ...
     *
     * @var \Recranet\OTA\ParagraphType $ratePlanDescription
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanType\MealsIncludedAType $mealsIncluded
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanType\RestrictionStatusAType $restrictionStatus
     */
     ...
     *
     * @var \Recranet\OTA\CancelPenaltiesType $modificationFee
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RatePlanType\GuaranteeAType $guarantee
     */
    public function addToGuarantee(\Recranet\OTA\RatePlanType\GuaranteeAType $guarantee)
    {
     ...
     * Guarantee information that applies to the rate plan. A maximum of 5 occurances are available for use depending on the context.
     *
     * @return \Recranet\OTA\RatePlanType\GuaranteeAType[]
     */
     ...
     * Describes the rate plan.
     *
     * @param \Recranet\OTA\ParagraphType $ratePlanDescription
     * @return self
     */
    public function setRatePlanDescription(?\Recranet\OTA\ParagraphType $ratePlanDescription = null)
    {
     ...
     * Defines which meals are included with this rate program.
     *
     * @return \Recranet\OTA\RatePlanType\MealsIncludedAType
     */
     ...
     * Defines which meals are included with this rate program.
     *
     * @param \Recranet\OTA\RatePlanType\MealsIncludedAType $mealsIncluded
     * @return self
     */
    public function setMealsIncluded(?\Recranet\OTA\RatePlanType\MealsIncludedAType $mealsIncluded = null)
    {
     ...
     * Used to indicate whether the rate is on request or available.
     *
     * @return \Recranet\OTA\RatePlanType\RestrictionStatusAType
     */
     ...
     * Used to indicate whether the rate is on request or available.
     *
     * @param \Recranet\OTA\RatePlanType\RestrictionStatusAType $restrictionStatus
     * @return self
     */
    public function setRestrictionStatus(?\Recranet\OTA\RatePlanType\RestrictionStatusAType $restrictionStatus = null)
    {
     ...
     * A collection of modification fees. Note that although this modification fee is typed as CancelPenaltiesType to promote reuse, cancellation penalties information should be entered in the CancelPenalties element.
     *
     * @param \Recranet\OTA\CancelPenaltiesType $modificationFee
     * @return self
     */
    public function setModificationFee(?\Recranet\OTA\CancelPenaltiesType $modificationFee = null)
    {
