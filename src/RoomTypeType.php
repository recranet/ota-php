...
class RoomTypeType
{
     ...
     *
     * @var \Recranet\OTA\RoomTypeType\OccupancyAType[] $occupancy
     */
    private $occupancy = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\RoomTypeType\OccupancyAType $occupancy
     */
    public function addToOccupancy(\Recranet\OTA\RoomTypeType\OccupancyAType $occupancy)
    {
     ...
     * Provides parameters of occupancy limits.
     *
     * @return \Recranet\OTA\RoomTypeType\OccupancyAType[]
     */
