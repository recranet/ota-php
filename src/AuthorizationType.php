...
class AuthorizationType
{
     ...
     *
     * @var \Recranet\OTA\AuthorizationType\CheckAuthorizationAType $checkAuthorization
     */
     ...
     *
     * @var \Recranet\OTA\AuthorizationType\CreditCardAuthorizationAType $creditCardAuthorization
     */
     ...
     *
     * @var \Recranet\OTA\AuthorizationType\AccountAuthorizationAType $accountAuthorization
     */
     ...
     *
     * @var \Recranet\OTA\DocumentType $driversLicenseAuthorization
     */
     ...
     *
     * @var \Recranet\OTA\AuthorizationType\BookingReferenceIDAType $bookingReferenceID
     */
     ...
     * Specifies check information about the customer seeking authorization.
     *
     * @return \Recranet\OTA\AuthorizationType\CheckAuthorizationAType
     */
     ...
     * Specifies check information about the customer seeking authorization.
     *
     * @param \Recranet\OTA\AuthorizationType\CheckAuthorizationAType $checkAuthorization
     * @return self
     */
    public function setCheckAuthorization(?\Recranet\OTA\AuthorizationType\CheckAuthorizationAType $checkAuthorization = null)
    {
     ...
     * Specifies credit card information about the customer seeking authorization.
     *
     * @return \Recranet\OTA\AuthorizationType\CreditCardAuthorizationAType
     */
     ...
     * Specifies credit card information about the customer seeking authorization.
     *
     * @param \Recranet\OTA\AuthorizationType\CreditCardAuthorizationAType $creditCardAuthorization
     * @return self
     */
    public function setCreditCardAuthorization(?\Recranet\OTA\AuthorizationType\CreditCardAuthorizationAType $creditCardAuthorization = null)
    {
     ...
     * Specifies account information about the customer seeking authorization.
     *
     * @return \Recranet\OTA\AuthorizationType\AccountAuthorizationAType
     */
     ...
     * Specifies account information about the customer seeking authorization.
     *
     * @param \Recranet\OTA\AuthorizationType\AccountAuthorizationAType $accountAuthorization
     * @return self
     */
    public function setAccountAuthorization(?\Recranet\OTA\AuthorizationType\AccountAuthorizationAType $accountAuthorization = null)
    {
     ...
     * Information used for validating a drivers license or for supporting a check or credit card authorization request.
     *
     * @param \Recranet\OTA\DocumentType $driversLicenseAuthorization
     * @return self
     */
    public function setDriversLicenseAuthorization(?\Recranet\OTA\DocumentType $driversLicenseAuthorization = null)
    {
     ...
     * The booking or confirmation number for which charges are being authorized.
     *
     * @return \Recranet\OTA\AuthorizationType\BookingReferenceIDAType
     */
     ...
     * The booking or confirmation number for which charges are being authorized.
     *
     * @param \Recranet\OTA\AuthorizationType\BookingReferenceIDAType $bookingReferenceID
     * @return self
     */
    public function setBookingReferenceID(?\Recranet\OTA\AuthorizationType\BookingReferenceIDAType $bookingReferenceID = null)
    {
