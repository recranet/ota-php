...
namespace Recranet\OTA\EventType\EventAType\EventInfosAType;
...
class EventInfoAType
{
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\AdditionalDatesAType\AdditionalDateAType[] $additionalDates
     */
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ContactsAType\ContactAType[] $contacts
     */
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ExhibitionAType[] $exhibition
     */
    private $exhibition = [
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\TaxExemptInfoAType[] $taxExemptInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\AdditionalDatesAType\AdditionalDateAType $additionalDate
     */
    public function addToAdditionalDates(\Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\AdditionalDatesAType\AdditionalDateAType $additionalDate)
    {
     ...
     * A collection of additional dates.
     *
     * @return \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\AdditionalDatesAType\AdditionalDateAType[]
     */
     ...
     * A collection of additional dates.
     *
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\AdditionalDatesAType\AdditionalDateAType[] $additionalDates
     * @return self
     */
     ...
     */
    public function addToContacts(\Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ContactsAType\ContactAType $contact)
    {
     ...
     * A collection of contacts that pertain to this occurence of the event.
     *
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ContactsAType\ContactAType[] $contacts
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ExhibitionAType $exhibition
     */
    public function addToExhibition(\Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ExhibitionAType $exhibition)
    {
     ...
     * Describes an event at which products and services are displayed.
     *
     * @return \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\ExhibitionAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\TaxExemptInfoAType $taxExemptInfo
     */
    public function addToTaxExemptInfo(\Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\TaxExemptInfoAType $taxExemptInfo)
    {
     ...
     * Used to provide tax exemption information for the event.
     *
     * @return \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType\TaxExemptInfoAType[]
     */
