...
class EventInfosAType
{
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType[] $eventInfo
     */
    private $eventInfo = [
     ...
     */
    public function addToEventInfo(\Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType $eventInfo)
    {
