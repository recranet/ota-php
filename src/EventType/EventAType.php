...
namespace Recranet\OTA\EventType;
...
class EventAType
{
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\ContactsAType\ContactAType[] $contacts
     */
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\AttendeeInfoAType $attendeeInfo
     */
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType[] $eventInfos
     */
     ...
     *
     * @var \Recranet\OTA\EventType\EventAType\SitesAType\SiteAType[] $sites
     */
    private $sites = null;
     ...
     */
    public function addToContacts(\Recranet\OTA\EventType\EventAType\ContactsAType\ContactAType $contact)
    {
     ...
     * A collection of contacts associated with the event.
     *
     * @param \Recranet\OTA\EventType\EventAType\ContactsAType\ContactAType[] $contacts
     * @return self
     */
     ...
     * The number of attendees to the event.
     *
     * @return \Recranet\OTA\EventType\EventAType\AttendeeInfoAType
     */
     ...
     * The number of attendees to the event.
     *
     * @param \Recranet\OTA\EventType\EventAType\AttendeeInfoAType $attendeeInfo
     * @return self
     */
    public function setAttendeeInfo(?\Recranet\OTA\EventType\EventAType\AttendeeInfoAType $attendeeInfo = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType $eventInfo
     */
    public function addToEventInfos(\Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType $eventInfo)
    {
     ...
     * A collection of event infos.
     *
     * @return \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType[]
     */
     ...
     * A collection of event infos.
     *
     * @param \Recranet\OTA\EventType\EventAType\EventInfosAType\EventInfoAType[] $eventInfos
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\EventType\EventAType\SitesAType\SiteAType $site
     */
    public function addToSites(\Recranet\OTA\EventType\EventAType\SitesAType\SiteAType $site)
    {
        $this->sites[] = $site;
        return $this;
    }
     ...
     * A collection of sites.
     *
     * @return \Recranet\OTA\EventType\EventAType\SitesAType\SiteAType[]
     */
     ...
     * A collection of sites.
     *
     * @param \Recranet\OTA\EventType\EventAType\SitesAType\SiteAType[] $sites
     * @return self
     */
