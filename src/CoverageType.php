...
class CoverageType
{
     ...
     *
     * @var \Recranet\OTA\CoverageDetailsType[] $details
     */
    private $details = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\CoverageDetailsType $details
     */
    public function addToDetails(\Recranet\OTA\CoverageDetailsType $details)
    {
     ...
     * Textual information about coverage, such as coverage limit or descriptions.
     *
     * @return \Recranet\OTA\CoverageDetailsType[]
     */
