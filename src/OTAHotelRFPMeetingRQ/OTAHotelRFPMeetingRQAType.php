...
namespace Recranet\OTA\OTAHotelRFPMeetingRQ;

/**
 * Class representing OTAHotelRFPMeetingRQAType
 */
class OTAHotelRFPMeetingRQAType
{
    /**
    ...
    /**
     * A collection of RequestSegments which allows multiple requests for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @var \Recranet\OTA\RFPRequestSegmentsType $rFPRequestSegments
     */
     ...
     * A collection of RequestSegments which allows multiple requests for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @return \Recranet\OTA\RFPRequestSegmentsType
     */
     ...
     * A collection of RequestSegments which allows multiple requests for different blocks of rooms and/or meeting space to be sent in one message.
     *
     * @param \Recranet\OTA\RFPRequestSegmentsType $rFPRequestSegments
     * @return self
     */
    public function setRFPRequestSegments(\Recranet\OTA\RFPRequestSegmentsType $rFPRequestSegments)
    {
