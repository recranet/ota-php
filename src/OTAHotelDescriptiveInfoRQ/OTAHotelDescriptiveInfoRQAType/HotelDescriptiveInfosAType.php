...
namespace Recranet\OTA\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType;
...
class HotelDescriptiveInfosAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType\HotelDescriptiveInfoAType[] $hotelDescriptiveInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType\HotelDescriptiveInfoAType $hotelDescriptiveInfo
     */
    public function addToHotelDescriptiveInfo(\Recranet\OTA\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType\HotelDescriptiveInfoAType $hotelDescriptiveInfo)
    {
     ...
     * This allows the requestor to indicate which specific information is requested if complete hotel details are not required.
     *
     * @return \Recranet\OTA\OTAHotelDescriptiveInfoRQ\OTAHotelDescriptiveInfoRQAType\HotelDescriptiveInfosAType\HotelDescriptiveInfoAType[]
     */
