...
class OSIPrefAType
{
     ...
     *
     * @var \Recranet\OTA\RailPrefType\OSIPrefAType\TravelerRefNumberAType[] $travelerRefNumber
     */
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $operator
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RailPrefType\OSIPrefAType\TravelerRefNumberAType $travelerRefNumber
     */
    public function addToTravelerRefNumber(\Recranet\OTA\RailPrefType\OSIPrefAType\TravelerRefNumberAType $travelerRefNumber)
    {
     ...
     * One or more travelers to whom this request applies
     *
     * @return \Recranet\OTA\RailPrefType\OSIPrefAType\TravelerRefNumberAType[]
     */
     ...
     * The operators to which the OSI applies
     *
     * @param \Recranet\OTA\CompanyNameType $operator
     * @return self
     */
    public function setOperator(\Recranet\OTA\CompanyNameType $operator)
    {
