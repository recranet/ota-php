...
class VehicleAgeRequirementsType
{
     ...
     *
     * @var \Recranet\OTA\VehicleAgeRequirementsType\AgeAType $age
     */
    private $age = null;
     ...
     * Information associated with the age requirements of renting a vehicle.
     *
     * @return \Recranet\OTA\VehicleAgeRequirementsType\AgeAType
     */
     ...
     * Information associated with the age requirements of renting a vehicle.
     *
     * @param \Recranet\OTA\VehicleAgeRequirementsType\AgeAType $age
     * @return self
     */
    public function setAge(?\Recranet\OTA\VehicleAgeRequirementsType\AgeAType $age = null)
    {
        $this->age = $age;
        return $this;
    }
