...
class CompanyInfoType
{
     ...
     *
     * @var \Recranet\OTA\CompanyInfoType\AddressInfoAType[] $addressInfo
     */
    private $addressInfo = [
     ...
     *
     * @var \Recranet\OTA\CompanyInfoType\TelephoneInfoAType[] $telephoneInfo
     */
     ...
     *
     * @var \Recranet\OTA\CompanyInfoType\EmailAType[] $email
     */
    private $email = [
     ...
     *
     * @var \Recranet\OTA\AddressType[] $businessLocale
     */
     ...
     *
     * @var \Recranet\OTA\CompanyInfoType\PaymentFormAType[] $paymentForm
     */
    private $paymentForm = [
     ...
     *
     * @var \Recranet\OTA\RequiredPaymentsType\GuaranteePaymentAType[] $depositPayment
     */
     ...
     *
     * @var \Recranet\OTA\CompanyInfoType\TripPurposeAType[] $tripPurpose
     */
    private $tripPurpose = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\CompanyInfoType\AddressInfoAType $addressInfo
     */
    public function addToAddressInfo(\Recranet\OTA\CompanyInfoType\AddressInfoAType $addressInfo)
    {
     ...
     * Detailed information on an address for the company.
     *
     * @return \Recranet\OTA\CompanyInfoType\AddressInfoAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CompanyInfoType\TelephoneInfoAType $telephoneInfo
     */
    public function addToTelephoneInfo(\Recranet\OTA\CompanyInfoType\TelephoneInfoAType $telephoneInfo)
    {
     ...
     * Information on a telephone number for the company.
     *
     * @return \Recranet\OTA\CompanyInfoType\TelephoneInfoAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CompanyInfoType\EmailAType $email
     */
    public function addToEmail(\Recranet\OTA\CompanyInfoType\EmailAType $email)
    {
        $this->email[] = $email;
        return $this;
    }
     ...
     * Information on an email address for the company.
     *
     * @return \Recranet\OTA\CompanyInfoType\EmailAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AddressType $businessLocale
     */
    public function addToBusinessLocale(\Recranet\OTA\AddressType $businessLocale)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\CompanyInfoType\PaymentFormAType $paymentForm
     */
    public function addToPaymentForm(\Recranet\OTA\CompanyInfoType\PaymentFormAType $paymentForm)
    {
     ...
     * Method of providing funds for travel by the company.
     *
     * @return \Recranet\OTA\CompanyInfoType\PaymentFormAType[]
     */
     ...
     */
    public function addToDepositPayment(\Recranet\OTA\RequiredPaymentsType\GuaranteePaymentAType $guaranteePayment)
    {
     ...
     * Description: A deposit policy that is associated to this profile.
     *
     * @param \Recranet\OTA\RequiredPaymentsType\GuaranteePaymentAType[] $depositPayment
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CompanyInfoType\TripPurposeAType $tripPurpose
     */
    public function addToTripPurpose(\Recranet\OTA\CompanyInfoType\TripPurposeAType $tripPurpose)
    {
     ...
     * Trip purpose codes used by this company.
     *
     * @return \Recranet\OTA\CompanyInfoType\TripPurposeAType[]
     */
