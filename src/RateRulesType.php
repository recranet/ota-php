...
class RateRulesType
{
     ...
     *
     * @var \Recranet\OTA\RateRulesType\AdvanceBookingAType $advanceBooking
     */
     ...
     *
     * @var \Recranet\OTA\RateRulesType\PickupReturnRulesAType[] $pickupReturnRules
     */
     ...
     *
     * @var \Recranet\OTA\RateRulesType\RateGuaranteeAType $rateGuarantee
     */
     ...
     *
     * @var \Recranet\OTA\RateRulesType\PaymentRulesAType $paymentRules
     */
     ...
     *
     * @var \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType[] $cancelPenaltyInfo
     */
     ...
     *
     * @var \Recranet\OTA\RateRulesType\RateDepositAType $rateDeposit
     */
     ...
     * Indicates whether or not advance booking is required for this rate and if so, what the advance booking requirements are.
     *
     * @return \Recranet\OTA\RateRulesType\AdvanceBookingAType
     */
     ...
     * Indicates whether or not advance booking is required for this rate and if so, what the advance booking requirements are.
     *
     * @param \Recranet\OTA\RateRulesType\AdvanceBookingAType $advanceBooking
     * @return self
     */
    public function setAdvanceBooking(?\Recranet\OTA\RateRulesType\AdvanceBookingAType $advanceBooking = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\RateRulesType\PickupReturnRulesAType $pickupReturnRules
     */
    public function addToPickupReturnRules(\Recranet\OTA\RateRulesType\PickupReturnRulesAType $pickupReturnRules)
    {
     ...
     * Pickup and return requirements for a specific rate.
     *
     * @return \Recranet\OTA\RateRulesType\PickupReturnRulesAType[]
     */
     ...
     * Used to indicate how long a specific rate is guaranteed.
     *
     * @return \Recranet\OTA\RateRulesType\RateGuaranteeAType
     */
     ...
     * Used to indicate how long a specific rate is guaranteed.
     *
     * @param \Recranet\OTA\RateRulesType\RateGuaranteeAType $rateGuarantee
     * @return self
     */
    public function setRateGuarantee(?\Recranet\OTA\RateRulesType\RateGuaranteeAType $rateGuarantee = null)
    {
     ...
     * A collection of payment rules associated with this reservation. This instance of PaymentRules would be used if there were payment rules that were applicable to a specific vehicle type.
     *
     * @return \Recranet\OTA\RateRulesType\PaymentRulesAType
     */
     ...
     * A collection of payment rules associated with this reservation. This instance of PaymentRules would be used if there were payment rules that were applicable to a specific vehicle type.
     *
     * @param \Recranet\OTA\RateRulesType\PaymentRulesAType $paymentRules
     * @return self
     */
    public function setPaymentRules(?\Recranet\OTA\RateRulesType\PaymentRulesAType $paymentRules = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType $cancelPenaltyInfo
     */
    public function addToCancelPenaltyInfo(\Recranet\OTA\RateRulesType\CancelPenaltyInfoAType $cancelPenaltyInfo)
    {
     ...
     * Information regarding the cancellation or modification policy for this vehicle type.
     *
     * @return \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType[]
     */
     ...
     * Information pertaining to the the deposit.
     *
     * @return \Recranet\OTA\RateRulesType\RateDepositAType
     */
     ...
     * Information pertaining to the the deposit.
     *
     * @param \Recranet\OTA\RateRulesType\RateDepositAType $rateDeposit
     * @return self
     */
    public function setRateDeposit(?\Recranet\OTA\RateRulesType\RateDepositAType $rateDeposit = null)
    {
