...
namespace Recranet\OTA\OTAHotelAvailRS;
...
class OTAHotelAvailRSAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType[] $hotelStays
     */
     ...
     *
     * @var \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType $roomStays
     */
     ...
     *
     * @var \Recranet\OTA\HotelSearchCriterionType[] $criteria
     */
     ...
     *
     * @var \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\CurrencyConversionsAType\CurrencyConversionAType[] $currencyConversions
     */
     ...
     */
    public function addToHotelStays(\Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType $hotelStay)
    {
     ...
     * A collection of summarized information about the requested hotels' general availability for each day in the requested range.
     *
     * @param \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\HotelStaysAType\HotelStayAType[] $hotelStays
     * @return self
     */
     ...
     * A collection of details on the Room Stay including Guest Counts, Time Span of this Room Stay, and financial information related to the Room Stay, including Guarantee, Deposit and Payment and Cancellation Penalties.
     *
     * @return \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType
     */
     ...
     * A collection of details on the Room Stay including Guest Counts, Time Span of this Room Stay, and financial information related to the Room Stay, including Guarantee, Deposit and Payment and Cancellation Penalties.
     *
     * @param \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType $roomStays
     * @return self
     */
    public function setRoomStays(?\Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\RoomStaysAType $roomStays = null)
    {
     ...
     */
    public function addToCriteria(\Recranet\OTA\HotelSearchCriterionType $criterion)
    {
     ...
     * The availability search criteria specified in the request message.
     *
     * @param \Recranet\OTA\HotelSearchCriterionType[] $criteria
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\CurrencyConversionsAType\CurrencyConversionAType $currencyConversion
     */
    public function addToCurrencyConversions(\Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\CurrencyConversionsAType\CurrencyConversionAType $currencyConversion)
    {
     ...
     * A collection of currency conversion elements.
     *
     * @return \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\CurrencyConversionsAType\CurrencyConversionAType[]
     */
     ...
     * A collection of currency conversion elements.
     *
     * @param \Recranet\OTA\OTAHotelAvailRS\OTAHotelAvailRSAType\CurrencyConversionsAType\CurrencyConversionAType[] $currencyConversions
     * @return self
     */
