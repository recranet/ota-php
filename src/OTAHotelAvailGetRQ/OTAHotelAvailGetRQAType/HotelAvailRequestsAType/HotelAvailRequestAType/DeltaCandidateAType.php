...
{
    /**
     * Boolean flag indicating the best available rate delta is requested. If this attrinbute is true, the currency code attributes may be included to ensure the responder currency matches the sender currency.
     *
     * @var bool $sendAmount
     */
