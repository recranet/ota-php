...
namespace Recranet\OTA\OTAHotelAvailGetRQ;
...
class OTAHotelAvailGetRQAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType[] $hotelAvailRequests
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType $hotelAvailRequest
     */
    public function addToHotelAvailRequests(\Recranet\OTA\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType $hotelAvailRequest)
    {
     ...
     * Container for the individual HotelAvailRequests(s).
     *
     * @return \Recranet\OTA\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType[]
     */
     ...
     * Container for the individual HotelAvailRequests(s).
     *
     * @param \Recranet\OTA\OTAHotelAvailGetRQ\OTAHotelAvailGetRQAType\HotelAvailRequestsAType\HotelAvailRequestAType[] $hotelAvailRequests
     * @return self
     */
