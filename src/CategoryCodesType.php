...
class CategoryCodesType
{
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType\LocationCategoryAType[] $locationCategory
     */
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType\SegmentCategoryAType[] $segmentCategory
     */
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType\HotelCategoryAType[] $hotelCategory
     */
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType\ArchitecturalStyleAType[] $architecturalStyle
     */
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType\GuestRoomInfoAType[] $guestRoomInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CategoryCodesType\LocationCategoryAType $locationCategory
     */
    public function addToLocationCategory(\Recranet\OTA\CategoryCodesType\LocationCategoryAType $locationCategory)
    {
     ...
     * Defines the general location of the hotel such as airport, suburban, downtown.
     *
     * @return \Recranet\OTA\CategoryCodesType\LocationCategoryAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CategoryCodesType\SegmentCategoryAType $segmentCategory
     */
    public function addToSegmentCategory(\Recranet\OTA\CategoryCodesType\SegmentCategoryAType $segmentCategory)
    {
     ...
     * Defines the type of hotel such as luxury, extended stay, economy.
     *
     * @return \Recranet\OTA\CategoryCodesType\SegmentCategoryAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CategoryCodesType\HotelCategoryAType $hotelCategory
     */
    public function addToHotelCategory(\Recranet\OTA\CategoryCodesType\HotelCategoryAType $hotelCategory)
    {
     ...
     * Defines the particular type of hotel (e.g., golf, ski, bed and breakfast).
     *
     * @return \Recranet\OTA\CategoryCodesType\HotelCategoryAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CategoryCodesType\ArchitecturalStyleAType $architecturalStyle
     */
    public function addToArchitecturalStyle(\Recranet\OTA\CategoryCodesType\ArchitecturalStyleAType $architecturalStyle)
    {
     ...
     * Describes the appearance of the building such as art deco, modern, historic.
     *
     * @return \Recranet\OTA\CategoryCodesType\ArchitecturalStyleAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\CategoryCodesType\GuestRoomInfoAType $guestRoomInfo
     */
    public function addToGuestRoomInfo(\Recranet\OTA\CategoryCodesType\GuestRoomInfoAType $guestRoomInfo)
    {
     ...
     * The types and quantities of guest rooms at a hotel.
     *
     * @return \Recranet\OTA\CategoryCodesType\GuestRoomInfoAType[]
     */
