...
namespace Recranet\OTA\OTAHotelRateAmountNotifRQ\OTAHotelRateAmountNotifRQAType;
...
class RateAmountMessagesAType
{
     ...
     *
     * @var \Recranet\OTA\RateAmountMessageType[] $rateAmountMessage
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RateAmountMessageType $rateAmountMessage
     */
    public function addToRateAmountMessage(\Recranet\OTA\RateAmountMessageType $rateAmountMessage)
    {
     ...
     * RateAmountMessages that define the rate changes to be made.
     *
     * @return \Recranet\OTA\RateAmountMessageType[]
     */
