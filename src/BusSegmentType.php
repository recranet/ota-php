...
class BusSegmentType
{
     ...
     *
     * @var \Recranet\OTA\StationDetailsType $departureStation
     */
     ...
     *
     * @var \Recranet\OTA\StationDetailsType $arrivalStation
     */
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $marketingCompany
     */
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $operatingCompany
     */
     ...
     *
     * @var \Recranet\OTA\BusSegmentType\EquipmentAType $equipment
     */
     ...
     *
     * @var \Recranet\OTA\BusInfoType $busInfo
     */
     ...
     * The departure point of the bus segment.
     *
     * @return \Recranet\OTA\StationDetailsType
     */
     ...
     * The departure point of the bus segment.
     *
     * @param \Recranet\OTA\StationDetailsType $departureStation
     * @return self
     */
    public function setDepartureStation(\Recranet\OTA\StationDetailsType $departureStation)
    {
     ...
     * The arrival point of the bus segment.
     *
     * @param \Recranet\OTA\StationDetailsType $arrivalStation
     * @return self
     */
    public function setArrivalStation(\Recranet\OTA\StationDetailsType $arrivalStation)
    {
     ...
     * The marketing bus company.
     *
     * @param \Recranet\OTA\CompanyNameType $marketingCompany
     * @return self
     */
    public function setMarketingCompany(\Recranet\OTA\CompanyNameType $marketingCompany)
    {
     ...
     * The operating bus company, if different from the Marketing Company.
     *
     * @param \Recranet\OTA\CompanyNameType $operatingCompany
     * @return self
     */
    public function setOperatingCompany(?\Recranet\OTA\CompanyNameType $operatingCompany = null)
    {
     ...
     * The type of equipment used for the bus journey. Use a string value, such as an operator equipment code or UIC code, or an OpenTravel code list value (to be defined in 2011B specification.)
     *
     * @return \Recranet\OTA\BusSegmentType\EquipmentAType
     */
     ...
     * The type of equipment used for the bus journey. Use a string value, such as an operator equipment code or UIC code, or an OpenTravel code list value (to be defined in 2011B specification.)
     *
     * @param \Recranet\OTA\BusSegmentType\EquipmentAType $equipment
     * @return self
     */
    public function setEquipment(?\Recranet\OTA\BusSegmentType\EquipmentAType $equipment = null)
    {
     ...
     * Detailed information about the bus.
     *
     * @return \Recranet\OTA\BusInfoType
     */
     ...
     * Detailed information about the bus.
     *
     * @param \Recranet\OTA\BusInfoType $busInfo
     * @return self
     */
    public function setBusInfo(?\Recranet\OTA\BusInfoType $busInfo = null)
    {
