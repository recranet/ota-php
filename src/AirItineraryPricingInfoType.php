...
class AirItineraryPricingInfoType
{
     ...
     *
     * @var \Recranet\OTA\AirItineraryPricingInfoType\ItinTotalFareAType[] $itinTotalFare
     */
     ...
     *
     * @var \Recranet\OTA\PTCFareBreakdownType[] $pTCFareBreakdowns
     */
     ...
     *
     * @var \Recranet\OTA\AirItineraryPricingInfoType\FareInfosAType\FareInfoAType[] $fareInfos
     */
     ...
     *
     * @var \Recranet\OTA\PriceRequestInformationType $priceRequestInformation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirItineraryPricingInfoType\ItinTotalFareAType $itinTotalFare
     */
    public function addToItinTotalFare(\Recranet\OTA\AirItineraryPricingInfoType\ItinTotalFareAType $itinTotalFare)
    {
     ...
     * Total price of the itinerary.
     *
     * @return \Recranet\OTA\AirItineraryPricingInfoType\ItinTotalFareAType[]
     */
     ...
     */
    public function addToPTCFareBreakdowns(\Recranet\OTA\PTCFareBreakdownType $pTCFareBreakdown)
    {
     ...
     * This is a collection of PTC Fare Breakdowns.
     *
     * @param \Recranet\OTA\PTCFareBreakdownType[] $pTCFareBreakdowns
     * @return self
     */
     ...
     */
    public function addToFareInfos(\Recranet\OTA\AirItineraryPricingInfoType\FareInfosAType\FareInfoAType $fareInfo)
    {
     ...
     * This is a collection of FareInfo.
     *
     * @param \Recranet\OTA\AirItineraryPricingInfoType\FareInfosAType\FareInfoAType[] $fareInfos
     * @return self
     */
     ...
     * Identifies pricing source, if negotiated fares are requested and if it is a reprice request.
     *
     * @return \Recranet\OTA\PriceRequestInformationType
     */
     ...
     * Identifies pricing source, if negotiated fares are requested and if it is a reprice request.
     *
     * @param \Recranet\OTA\PriceRequestInformationType $priceRequestInformation
     * @return self
     */
    public function setPriceRequestInformation(?\Recranet\OTA\PriceRequestInformationType $priceRequestInformation = null)
    {
