...
class RoomTypeAllocationsAType
{
     ...
     *
     * @var \Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType\RoomTypeAllocationAType[] $roomTypeAllocation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType\RoomTypeAllocationAType $roomTypeAllocation
     */
    public function addToRoomTypeAllocation(\Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType\RoomTypeAllocationAType $roomTypeAllocation)
    {
     ...
     * This is the number of rooms blocked for a specific room type for specific dates.
     *
     * @return \Recranet\OTA\InvBlockRoomType\RoomTypeAllocationsAType\RoomTypeAllocationAType[]
     */
