...
namespace Recranet\OTA\InvBlockRoomType\RatePlansAType;

use Recranet\OTA\RateUploadType;
...
class RatePlanAType extends RateUploadType
{
     ...
     *
     * @var \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MarketCodeAType[] $marketCode
     */
    private $marketCode = [
     ...
     *
     * @var \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MethodInfoAType[] $methodInfo
     */
    private $methodInfo = [
     ...
     *
     * @var \Recranet\OTA\DOWRulesType[] $daysOfWeeks
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MarketCodeAType $marketCode
     */
    public function addToMarketCode(\Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MarketCodeAType $marketCode)
    {
     ...
     * This is user specific information used for tracking and market segmentation reporting.
     *
     * @return \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MarketCodeAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MethodInfoAType $methodInfo
     */
    public function addToMethodInfo(\Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MethodInfoAType $methodInfo)
    {
     ...
     * This is used to indicate the reservation and billing methods for the rate plan.
     *
     * @return \Recranet\OTA\InvBlockRoomType\RatePlansAType\RatePlanAType\MethodInfoAType[]
     */
     ...
     */
    public function addToDaysOfWeeks(\Recranet\OTA\DOWRulesType $daysOfWeek)
    {
     ...
     * This is available so multiple rules or multiple date ranges may be applied.
     *
     * @param \Recranet\OTA\DOWRulesType[] $daysOfWeeks
     * @return self
     */
