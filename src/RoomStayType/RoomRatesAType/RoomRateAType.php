...
namespace Recranet\OTA\RoomStayType\RoomRatesAType;

use Recranet\OTA\RoomRateType;
...
class RoomRateAType extends RoomRateType
{
     ...
     *
     * @var \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\AdvanceBookingRestrictionAType $advanceBookingRestriction
     */
     ...
     *
     * @var \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\RestrictionsAType\RestrictionAType[] $restrictions
     */
     ...
     *
     * @var \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\GuestCountsAType\GuestCountAType[] $guestCounts
     */
     ...
     * The period during which the booking must be made.
     *
     * @return \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\AdvanceBookingRestrictionAType
     */
     ...
     * The period during which the booking must be made.
     *
     * @param \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\AdvanceBookingRestrictionAType $advanceBookingRestriction
     * @return self
     */
    public function setAdvanceBookingRestriction(?\Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\AdvanceBookingRestrictionAType $advanceBookingRestriction = null)
    {
     ...
     */
    public function addToRestrictions(\Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\RestrictionsAType\RestrictionAType $restriction)
    {
     ...
     * A collections of restrictions.
     *
     * @param \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\RestrictionsAType\RestrictionAType[] $restrictions
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\GuestCountsAType\GuestCountAType $guestCount
     */
    public function addToGuestCounts(\Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\GuestCountsAType\GuestCountAType $guestCount)
    {
     ...
     * A collection of Guest Counts associated with the room rate.
     *
     * @return \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\GuestCountsAType\GuestCountAType[]
     */
     ...
     * A collection of Guest Counts associated with the room rate.
     *
     * @param \Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\GuestCountsAType\GuestCountAType[] $guestCounts
     * @return self
     */
