...
namespace Recranet\OTA\RoomStayType\RoomRatesAType\RoomRateAType\RestrictionsAType;
...
class RestrictionAType
{
     ...
     * @return self
     */
    public function setDOWRestrictions(\Recranet\OTA\DOWRestrictionsType $dOWRestrictions)
    {
