...
namespace Recranet\OTA\RateAmountMessageType;
...
class RatesAType
{
     ...
     *
     * @var \Recranet\OTA\RateAmountMessageType\RatesAType\RateAType[] $rate
     */
    private $rate = [
     ...
     */
    public function addToRate(\Recranet\OTA\RateAmountMessageType\RatesAType\RateAType $rate)
    {
        $this->rate[] = $rate;
        return $this;
    }
