...
class OperatingAirlineType extends CompanyNameType
{
    ...
    /**
     * If true, the information pertains to the marketing flight. If false, the information pertains to the operating flight.
     *
     * @var bool $marketingInd
     */
    private $marketingInd = null;

    /**
     * Identifies the Booked RBD. This may be different than the ticket class. RBD stands for reservation booking designator.
     *
     * @var string $bookedRBD
     */
     ...
     *
     * @var string $ticketedRBD
     */
    private $ticketedRBD = null;

    /**
     * Standard mileage that can be accrued for this flight (if flown by the passenger). This does not include bonus miles.
     *
     * @var string $frequentFlierMiles
     */
