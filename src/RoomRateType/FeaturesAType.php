...
namespace Recranet\OTA\RoomRateType;
...
class FeaturesAType
{
     ...
     *
     * @var \Recranet\OTA\RoomRateType\FeaturesAType\FeatureAType[] $feature
     */
    private $feature = [
     ...
     */
    public function addToFeature(\Recranet\OTA\RoomRateType\FeaturesAType\FeatureAType $feature)
    {
