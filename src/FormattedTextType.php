...
class FormattedTextType
{
     ...
     *
     * @var \Recranet\OTA\FormattedTextSubSectionType[] $subSection
     */
    private $subSection = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\FormattedTextSubSectionType $subSection
     */
    public function addToSubSection(\Recranet\OTA\FormattedTextSubSectionType $subSection)
    {
     ...
     * Subsection formatted text information.
     *
     * @return \Recranet\OTA\FormattedTextSubSectionType[]
     */
