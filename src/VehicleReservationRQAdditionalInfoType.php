...
class VehicleReservationRQAdditionalInfoType
{
     ...
     *
     * @var \Recranet\OTA\VehicleReservationRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType[] $coveragePrefs
     */
     ...
     *
     * @var \Recranet\OTA\VehicleReservationRQAdditionalInfoType\RentalPaymentPrefAType[] $rentalPaymentPref
     */
     ...
     *
     * @var \Recranet\OTA\VehicleReservationRQAdditionalInfoType\ReferenceAType $reference
     */
     ...
     */
    public function addToCoveragePrefs(\Recranet\OTA\VehicleReservationRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType $coveragePref)
    {
     ...
     * Indicates the preferences for one or more types of coverage (insurance).
     *
     * @param \Recranet\OTA\VehicleReservationRQAdditionalInfoType\CoveragePrefsAType\CoveragePrefAType[] $coveragePrefs
     * @return self
     */
     ...
     */
    public function addToOffLocService(\Recranet\OTA\OffLocationServiceType $offLocService)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\VehicleReservationRQAdditionalInfoType\RentalPaymentPrefAType $rentalPaymentPref
     */
    public function addToRentalPaymentPref(\Recranet\OTA\VehicleReservationRQAdditionalInfoType\RentalPaymentPrefAType $rentalPaymentPref)
    {
     ...
     * Indicates preferences for the form of payment that will be used, if the request results in a reservation. This element may repeat for different rental payment preferences.
     *
     * @return \Recranet\OTA\VehicleReservationRQAdditionalInfoType\RentalPaymentPrefAType[]
     */
     ...
     * Information identifying an earlier availability quote.
     *
     * @return \Recranet\OTA\VehicleReservationRQAdditionalInfoType\ReferenceAType
     */
     ...
     * Information identifying an earlier availability quote.
     *
     * @param \Recranet\OTA\VehicleReservationRQAdditionalInfoType\ReferenceAType $reference
     * @return self
     */
    public function setReference(?\Recranet\OTA\VehicleReservationRQAdditionalInfoType\ReferenceAType $reference = null)
    {
