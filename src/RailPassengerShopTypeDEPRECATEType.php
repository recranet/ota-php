...
class RailPassengerShopTypeDEPRECATEType
{
     ...
     *
     * @var \Recranet\OTA\RailPassengerOccupationType $occupation
     */
     ...
     *
     * @var \Recranet\OTA\RailPassengerShopTypeDEPRECATEType\PassengerQualifyingInfoAType[] $passengerQualifyingInfo
     */
     ...
     * The passenger occupation.
     *
     * @return \Recranet\OTA\RailPassengerOccupationType
     */
     ...
     * The passenger occupation.
     *
     * @param \Recranet\OTA\RailPassengerOccupationType $occupation
     * @return self
     */
    public function setOccupation(?\Recranet\OTA\RailPassengerOccupationType $occupation = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\RailPassengerShopTypeDEPRECATEType\PassengerQualifyingInfoAType $passengerQualifyingInfo
     */
    public function addToPassengerQualifyingInfo(\Recranet\OTA\RailPassengerShopTypeDEPRECATEType\PassengerQualifyingInfoAType $passengerQualifyingInfo)
    {
     ...
     * Age qualifying information for the passenger. Refer to OpenTravel code list Rail Passenger Type Code (PXC).
     *
     * @return \Recranet\OTA\RailPassengerShopTypeDEPRECATEType\PassengerQualifyingInfoAType[]
     */
