...
use Recranet\OTA\PaymentRulesType;
...
class PaymentRulesAType extends PaymentRulesType
{
     ...
     *
     * @var \Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType[] $acceptablePayments
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType $acceptablePayments
     */
    public function addToAcceptablePayments(\Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType $acceptablePayments)
    {
     ...
     * A collection of acceptable methods of payment.
     *
     * @return \Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType[]
     */
