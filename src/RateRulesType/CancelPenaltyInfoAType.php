...
class CancelPenaltyInfoAType
{
     ...
     *
     * @var \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\DeadlineAType[] $deadline
     */
    private $deadline = [
     ...
     *
     * @var \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\PenaltyFeeAType $penaltyFee
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\DeadlineAType $deadline
     */
    public function addToDeadline(\Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\DeadlineAType $deadline)
    {
     ...
     * Time by which a cancellation must be made before penalty fees are incurred or defines a period of time for which a specific fee is applied if a cancellation were to occur.
     *
     * @return \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\DeadlineAType[]
     */
     ...
     * The amounts of the penalty fee if cancellation is received after the deadline.
     *
     * @return \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\PenaltyFeeAType
     */
     ...
     * The amounts of the penalty fee if cancellation is received after the deadline.
     *
     * @param \Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\PenaltyFeeAType $penaltyFee
     * @return self
     */
    public function setPenaltyFee(?\Recranet\OTA\RateRulesType\CancelPenaltyInfoAType\PenaltyFeeAType $penaltyFee = null)
    {
