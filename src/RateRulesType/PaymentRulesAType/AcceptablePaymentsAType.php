...
namespace Recranet\OTA\RateRulesType\PaymentRulesAType;
...
class AcceptablePaymentsAType
{
     ...
     *
     * @var \Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType\AcceptablePaymentAType[] $acceptablePayment
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType\AcceptablePaymentAType $acceptablePayment
     */
    public function addToAcceptablePayment(\Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType\AcceptablePaymentAType $acceptablePayment)
    {
     ...
     * Specifies an acceptable method of payment.
     *
     * @return \Recranet\OTA\RateRulesType\PaymentRulesAType\AcceptablePaymentsAType\AcceptablePaymentAType[]
     */
