...
class RatePlanInclusionsType
{
     ...
     *
     * @var \Recranet\OTA\ParagraphType $ratePlanInclusionDesciption
     */
     ...
     * Description of what is included in the rate plan.
     *
     * @param \Recranet\OTA\ParagraphType $ratePlanInclusionDesciption
     * @return self
     */
    public function setRatePlanInclusionDesciption(?\Recranet\OTA\ParagraphType $ratePlanInclusionDesciption = null)
    {
