...
class AirLandProductType
{
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $productSupplier
     */
     ...
     * The name of the product supplier.
     *
     * @param \Recranet\OTA\CompanyNameType $productSupplier
     * @return self
     */
    public function setProductSupplier(?\Recranet\OTA\CompanyNameType $productSupplier = null)
    {
