...
class RailPassengerCategoryType
{
     ...
     *
     * @var \Recranet\OTA\RailPassengerCategoryType\PassengerQualifyingInfoAType[] $passengerQualifyingInfo
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RailPassengerCategoryType\PassengerQualifyingInfoAType $passengerQualifyingInfo
     */
    public function addToPassengerQualifyingInfo(\Recranet\OTA\RailPassengerCategoryType\PassengerQualifyingInfoAType $passengerQualifyingInfo)
    {
     ...
     * Age qualifying information for the passenger. Refer to OpenTravel code list Rail Passenger Type Code (PXC).
     *
     * @return \Recranet\OTA\RailPassengerCategoryType\PassengerQualifyingInfoAType[]
     */
