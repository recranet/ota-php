...
class PhysChallFeaturePrefType
{
    ...
    /**
     * Identifies the types of features the hotel offers to service physically challenged guests. Refer to OpenTravel Code List Disability Feature Code (PHY).
     *
     * @var string $physChallFeatureType
     */
