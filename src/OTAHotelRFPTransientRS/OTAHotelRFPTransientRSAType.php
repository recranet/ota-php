...
namespace Recranet\OTA\OTAHotelRFPTransientRS;
...
class OTAHotelRFPTransientRSAType
{
     ...
     *
     * @var \Recranet\OTA\RFPTransientDetailsType $rFPTransientDetail
     */
     ...
     * This has the ability to hold both the information for an acknowlegement as well as the full response depending on its use.
     *
     * @return \Recranet\OTA\RFPTransientDetailsType
     */
     ...
     * This has the ability to hold both the information for an acknowlegement as well as the full response depending on its use.
     *
     * @param \Recranet\OTA\RFPTransientDetailsType $rFPTransientDetail
     * @return self
     */
    public function setRFPTransientDetail(?\Recranet\OTA\RFPTransientDetailsType $rFPTransientDetail = null)
    {
