...
namespace Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType;
...
class RFPResponseSegmentAType
{
     ...
     *
     * @var \Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType\SitesAType\SiteAType[] $sites
     */
    private $sites = null;
     ...
     *
     * @var \Recranet\OTA\UniqueIDType[] $rFPID
     */
    private $rFPID = [
     ...
     */
    public function addToSites(\Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType\SitesAType\SiteAType $site)
    {
        $this->sites[] = $site;
        return $this;
    }
     ...
     * A collection of sites that the response is being submitted for (e.g. a hotel, national sales office, convention center).
     *
     * @param \Recranet\OTA\RFPResponseType\RFPResponseSegmentsAType\RFPResponseSegmentAType\SitesAType\SiteAType[] $sites
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\UniqueIDType $rFPID
     */
    public function addToRFPID(\Recranet\OTA\UniqueIDType $rFPID)
    {
        $this->rFPID[] = $rFPID;
        return $this;
    }
