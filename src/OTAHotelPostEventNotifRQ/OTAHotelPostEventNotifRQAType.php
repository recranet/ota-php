...
namespace Recranet\OTA\OTAHotelPostEventNotifRQ;

/**
 * Class representing OTAHotelPostEventNotifRQAType
 */
class OTAHotelPostEventNotifRQAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\EventReportType[] $eventReports
     */
     ...
     */
    public function addToEventReports(\Recranet\OTA\EventReportType $eventReport)
    {
     ...
     * Collection of event reports.
     *
     * @param \Recranet\OTA\EventReportType[] $eventReports
     * @return self
     */
    public function setEventReports(array $eventReports = null)
    {
