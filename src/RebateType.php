...
class RebateType
{
     ...
     *
     * @var \Recranet\OTA\PaymentCardType[] $paymentInformation
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PaymentCardType $paymentInformation
     */
    public function addToPaymentInformation(\Recranet\OTA\PaymentCardType $paymentInformation)
    {
