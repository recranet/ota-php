...
class HotelProductType
{
     ...
     *
     * @var \Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType[] $hotelRefs
     */
     ...
     *
     * @var \Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType[] $roomTypes
     */
     ...
     *
     * @var \Recranet\OTA\HotelProductType\RatePlansAType\RatePlanAType[] $ratePlans
     */
     ...
     *
     * @var \Recranet\OTA\HotelProductType\ValueAddInclusionsAType $valueAddInclusions
     */
     ...
     *
     * @var \Recranet\OTA\HotelProductType\PolicyInfoAType $policyInfo
     */
     ...
     *
     * @var \Recranet\OTA\TaxType[] $taxes
     */
    private $taxes = null;
     ...
     *
     * @var \Recranet\OTA\HotelProductType\DescriptionsAType\DescriptionAType[] $descriptions
     */
     ...
     *
     * @var \Recranet\OTA\HotelProductType\AdditionalGuestAmountsAType\AdditionalGuestAmountAType[] $additionalGuestAmounts
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType $hotelRef
     */
    public function addToHotelRefs(\Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType $hotelRef)
    {
     ...
     * A collection of HotelRef elements.
     *
     * @return \Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType[]
     */
     ...
     * A collection of HotelRef elements.
     *
     * @param \Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType[] $hotelRefs
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType $roomType
     */
    public function addToRoomTypes(\Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType $roomType)
    {
     ...
     * A collection of room types.
     *
     * @return \Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType[]
     */
     ...
     * A collection of room types.
     *
     * @param \Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType[] $roomTypes
     * @return self
     */
     ...
     */
    public function addToRatePlans(\Recranet\OTA\HotelProductType\RatePlansAType\RatePlanAType $ratePlan)
    {
     ...
     * A collection of rate plans.
     *
     * @param \Recranet\OTA\HotelProductType\RatePlansAType\RatePlanAType[] $ratePlans
     * @return self
     */
     ...
     * Identifies items that are included with this product that add value or differentiate this product from other products at no additional charge (i.e. breakfast, internet, parking).
     *
     * @return \Recranet\OTA\HotelProductType\ValueAddInclusionsAType
     */
     ...
     * Identifies items that are included with this product that add value or differentiate this product from other products at no additional charge (i.e. breakfast, internet, parking).
     *
     * @param \Recranet\OTA\HotelProductType\ValueAddInclusionsAType $valueAddInclusions
     * @return self
     */
    public function setValueAddInclusions(?\Recranet\OTA\HotelProductType\ValueAddInclusionsAType $valueAddInclusions = null)
    {
     ...
     * Policy Information for this product.
     *
     * @return \Recranet\OTA\HotelProductType\PolicyInfoAType
     */
     ...
     * Policy Information for this product.
     *
     * @param \Recranet\OTA\HotelProductType\PolicyInfoAType $policyInfo
     * @return self
     */
    public function setPolicyInfo(?\Recranet\OTA\HotelProductType\PolicyInfoAType $policyInfo = null)
    {
     ...
     */
    public function addToTaxes(\Recranet\OTA\TaxType $tax)
    {
        $this->taxes[] = $tax;
        return $this;
    }
     ...
     * Taxes that apply to the product.
     *
     * @param \Recranet\OTA\TaxType[] $taxes
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelProductType\DescriptionsAType\DescriptionAType $description
     */
    public function addToDescriptions(\Recranet\OTA\HotelProductType\DescriptionsAType\DescriptionAType $description)
    {
     ...
     * A Container for the repeating description element.
     *
     * @return \Recranet\OTA\HotelProductType\DescriptionsAType\DescriptionAType[]
     */
     ...
     * A Container for the repeating description element.
     *
     * @param \Recranet\OTA\HotelProductType\DescriptionsAType\DescriptionAType[] $descriptions
     * @return self
     */
     ...
     */
    public function addToAdditionalGuestAmounts(\Recranet\OTA\HotelProductType\AdditionalGuestAmountsAType\AdditionalGuestAmountAType $additionalGuestAmount)
    {
     ...
     * A collection of charges related to additional guests.
     *
     * @param \Recranet\OTA\HotelProductType\AdditionalGuestAmountsAType\AdditionalGuestAmountAType[] $additionalGuestAmounts
     * @return self
     */
