...
namespace Recranet\OTA\HotelResModifyType;
...
class HotelResModifyAType extends HotelReservationType
{
     ...
     *
     * @var \Recranet\OTA\HotelResModifyType\HotelResModifyAType\VerificationAType[] $verification
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelResModifyType\HotelResModifyAType\VerificationAType $verification
     */
    public function addToVerification(\Recranet\OTA\HotelResModifyType\HotelResModifyAType\VerificationAType $verification)
    {
     ...
     * The data used to ensure the correct reservation is modified (e.g. a CustLoyalty/ MembershipID would be verified as part of the reservation that you plan to modify to ensure the correct reservation is being modified).
     *
     * @return \Recranet\OTA\HotelResModifyType\HotelResModifyAType\VerificationAType[]
     */
