...
namespace Recranet\OTA\RatePlanCandidatesType;
...
class RatePlanCandidateAType
{
     ...
     *
     * @var bool $availRatesOnlyInd
     */
    private $availRatesOnlyInd = null;

    /**
     * Description: A string value that specifies the rate plan filter. A rate plan filter allows similar rate plans to be grouped together.
     *
     * @var string $ratePlanFilterCode
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType[] $hotelRefs
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType $mealsIncluded
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType $arrivalPolicy
     */
     ...
     *
     * @var \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType $ratePlanCommission
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType $hotelRef
     */
    public function addToHotelRefs(\Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType $hotelRef)
    {
     ...
     * A collection of hotel identifiers to which the rate plan applies.
     *
     * @return \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType[]
     */
     ...
     * A collection of hotel identifiers to which the rate plan applies.
     *
     * @param \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\HotelRefsAType\HotelRefAType[] $hotelRefs
     * @return self
     */
     ...
     * Defines which meals are included with this rate plan.
     *
     * @return \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType
     */
     ...
     * Defines which meals are included with this rate plan.
     *
     * @param \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType $mealsIncluded
     * @return self
     */
    public function setMealsIncluded(?\Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\MealsIncludedAType $mealsIncluded = null)
    {
     ...
     * Defines policy types for this rate plan.
     *
     * @return \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType
     */
     ...
     * Defines policy types for this rate plan.
     *
     * @param \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType $arrivalPolicy
     * @return self
     */
    public function setArrivalPolicy(?\Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\ArrivalPolicyAType $arrivalPolicy = null)
    {
     ...
     * Defines commission attributes for this rate plan.
     *
     * @return \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType
     */
     ...
     * Defines commission attributes for this rate plan.
     *
     * @param \Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType $ratePlanCommission
     * @return self
     */
    public function setRatePlanCommission(?\Recranet\OTA\RatePlanCandidatesType\RatePlanCandidateAType\RatePlanCommissionAType $ratePlanCommission = null)
    {
