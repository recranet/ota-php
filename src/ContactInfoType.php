...
class ContactInfoType
{
     ...
     *
     * @var \Recranet\OTA\ContactsType\NameAType[] $names
     */
    private $names = null;
     ...
     *
     * @var \Recranet\OTA\AddressesType\AddressAType[] $addresses
     */
     ...
     *
     * @var \Recranet\OTA\PhonesType\PhoneAType[] $phones
     */
    private $phones = null;
     ...
     *
     * @var \Recranet\OTA\EmailsType\EmailAType[] $emails
     */
    private $emails = null;
     ...
     *
     * @var \Recranet\OTA\URLsType\URLAType[] $uRLs
     */
    private $uRLs = null;
     ...
     *
     * @var \Recranet\OTA\ContactInfoType\CompanyNameAType $companyName
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\ContactsType\NameAType $name
     */
    public function addToNames(\Recranet\OTA\ContactsType\NameAType $name)
    {
        $this->names[] = $name;
        return $this;
    }
     ...
     * A collection of Name elements.
     *
     * @return \Recranet\OTA\ContactsType\NameAType[]
     */
     ...
     * A collection of Name elements.
     *
     * @param \Recranet\OTA\ContactsType\NameAType[] $names
     * @return self
     */
     ...
     */
    public function addToAddresses(\Recranet\OTA\AddressesType\AddressAType $address)
    {
     ...
     * A collection of Address elements.
     *
     * @param \Recranet\OTA\AddressesType\AddressAType[] $addresses
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\PhonesType\PhoneAType $phone
     */
    public function addToPhones(\Recranet\OTA\PhonesType\PhoneAType $phone)
    {
        $this->phones[] = $phone;
        return $this;
    }
     ...
     * A collection of Phone elements.
     *
     * @return \Recranet\OTA\PhonesType\PhoneAType[]
     */
     ...
     * A collection of Phone elements.
     *
     * @param \Recranet\OTA\PhonesType\PhoneAType[] $phones
     * @return self
     */
     ...
     */
    public function addToEmails(\Recranet\OTA\EmailsType\EmailAType $email)
    {
        $this->emails[] = $email;
        return $this;
    }
     ...
     * A collection of email elements.
     *
     * @param \Recranet\OTA\EmailsType\EmailAType[] $emails
     * @return self
     */
     ...
     */
    public function addToURLs(\Recranet\OTA\URLsType\URLAType $uRL)
    {
        $this->uRLs[] = $uRL;
        return $this;
    }
     ...
     * A collection of URL elements. Used to pass detailed URL information
     *
     * @param \Recranet\OTA\URLsType\URLAType[] $uRLs
     * @return self
     */
     ...
     * The name of the company with which this contact is associated.
     *
     * @return \Recranet\OTA\ContactInfoType\CompanyNameAType
     */
     ...
     * The name of the company with which this contact is associated.
     *
     * @param \Recranet\OTA\ContactInfoType\CompanyNameAType $companyName
     * @return self
     */
    public function setCompanyName(?\Recranet\OTA\ContactInfoType\CompanyNameAType $companyName = null)
    {
