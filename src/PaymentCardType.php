...
class PaymentCardType
{
     ...
     * Example: Mastercard
     *
     * @var \Recranet\OTA\ListPaymentCardIssuerType $cardType
     */
     ...
     *
     * @var \Recranet\OTA\PaymentCardType\IssuerAType $issuer
     */
    private $issuer = null;
     ...
     *
     * @var \Recranet\OTA\PersonNameType $cardHolderNameDetails
     */
     ...
     *
     * @var \Recranet\OTA\PaymentCardType\TelephoneAType[] $telephone
     */
    private $telephone = [
     ...
     *
     * @var \Recranet\OTA\EncryptionTokenType $cardNumber
     */
     ...
     * OpenTravel Best Practice: Payment Instruction Tokens-Any elements containing a token value MUST NOT and WILL NOT contain unmasked card account numbers, magnetic stripe data, or card security codes (CVV2,CVC, etc.) in other attributes or elements.
     *
     * @var \Recranet\OTA\EncryptionTokenType $seriesCode
     */
     ...
     *
     * @var \Recranet\OTA\PaymentCardType\CustLoyaltyAType[] $custLoyalty
     */
    private $custLoyalty = [
     ...
     *
     * @var \Recranet\OTA\EncryptionTokenType[] $magneticStripe
     */
     ...
     *
     * @var \Recranet\OTA\PaymentCardType\ThreeDomainSecurityAType $threeDomainSecurity
     */
     ...
     *
     * @var \Recranet\OTA\PaymentCardType\SignatureOnFileAType $signatureOnFile
     */
     ...
     * Example: Mastercard
     *
     * @return \Recranet\OTA\ListPaymentCardIssuerType
     */
     ...
     * Example: Mastercard
     *
     * @param \Recranet\OTA\ListPaymentCardIssuerType $cardType
     * @return self
     */
    public function setCardType(?\Recranet\OTA\ListPaymentCardIssuerType $cardType = null)
    {
     ...
     * Example: BritishAirwaysVisaSignatureCard
     *
     * @return \Recranet\OTA\PaymentCardType\IssuerAType
     */
     ...
     * Example: BritishAirwaysVisaSignatureCard
     *
     * @param \Recranet\OTA\PaymentCardType\IssuerAType $issuer
     * @return self
     */
    public function setIssuer(?\Recranet\OTA\PaymentCardType\IssuerAType $issuer = null)
    {
        $this->issuer = $issuer;
        return $this;
    }
     ...
     * Description: The details of the Card Holder's Name.
     *
     * @param \Recranet\OTA\PersonNameType $cardHolderNameDetails
     * @return self
     */
    public function setCardHolderNameDetails(?\Recranet\OTA\PersonNameType $cardHolderNameDetails = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\PaymentCardType\TelephoneAType $telephone
     */
    public function addToTelephone(\Recranet\OTA\PaymentCardType\TelephoneAType $telephone)
    {
     ...
     * Card holder telephone number.
     *
     * @return \Recranet\OTA\PaymentCardType\TelephoneAType[]
     */
     ...
     * OpenTravel Best Practice: Payment Instruction Tokens-Any elements containing a token value MUST NOT and WILL NOT contain unmasked card account numbers, magnetic stripe data, or card security codes (CVV2,CVC, etc.) in other attributes or elements.
     *
     * @param \Recranet\OTA\EncryptionTokenType $cardNumber
     * @return self
     */
    public function setCardNumber(?\Recranet\OTA\EncryptionTokenType $cardNumber = null)
    {
     ...
     * OpenTravel Best Practice: Payment Instruction Tokens-Any elements containing a token value MUST NOT and WILL NOT contain unmasked card account numbers, magnetic stripe data, or card security codes (CVV2,CVC, etc.) in other attributes or elements.
     *
     * @param \Recranet\OTA\EncryptionTokenType $seriesCode
     * @return self
     */
    public function setSeriesCode(?\Recranet\OTA\EncryptionTokenType $seriesCode = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\PaymentCardType\CustLoyaltyAType $custLoyalty
     */
    public function addToCustLoyalty(\Recranet\OTA\PaymentCardType\CustLoyaltyAType $custLoyalty)
    {
     ...
     * Card holder loyalty program.
     *
     * @return \Recranet\OTA\PaymentCardType\CustLoyaltyAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\EncryptionTokenType $magneticStripe
     */
    public function addToMagneticStripe(\Recranet\OTA\EncryptionTokenType $magneticStripe)
    {
     ...
     * Note: This contains 3-D Secure protocol information for online credit and debit card transactions for programs such as Verified by Visa, MasterCard SecureCode, J/Secure and SafeKey.
     *
     * @return \Recranet\OTA\PaymentCardType\ThreeDomainSecurityAType
     */
     ...
     * Note: This contains 3-D Secure protocol information for online credit and debit card transactions for programs such as Verified by Visa, MasterCard SecureCode, J/Secure and SafeKey.
     *
     * @param \Recranet\OTA\PaymentCardType\ThreeDomainSecurityAType $threeDomainSecurity
     * @return self
     */
    public function setThreeDomainSecurity(?\Recranet\OTA\PaymentCardType\ThreeDomainSecurityAType $threeDomainSecurity = null)
    {
     ...
     * Note: This indicates if the signature is authorized as a form of guarantee. In some countries, the customer can sign the payment card slip as a form of guarantee.
     *
     * @return \Recranet\OTA\PaymentCardType\SignatureOnFileAType
     */
     ...
     * Note: This indicates if the signature is authorized as a form of guarantee. In some countries, the customer can sign the payment card slip as a form of guarantee.
     *
     * @param \Recranet\OTA\PaymentCardType\SignatureOnFileAType $signatureOnFile
     * @return self
     */
    public function setSignatureOnFile(?\Recranet\OTA\PaymentCardType\SignatureOnFileAType $signatureOnFile = null)
    {
