...
class AddressType
{
     ...
     *
     * @var \Recranet\OTA\AddressType\StreetNmbrAType $streetNmbr
     */
     ...
     *
     * @var \Recranet\OTA\AddressType\BldgRoomAType[] $bldgRoom
     */
    private $bldgRoom = [
     ...
     * May contain the street number and optionally the street name.
     *
     * @return \Recranet\OTA\AddressType\StreetNmbrAType
     */
     ...
     * May contain the street number and optionally the street name.
     *
     * @param \Recranet\OTA\AddressType\StreetNmbrAType $streetNmbr
     * @return self
     */
    public function setStreetNmbr(?\Recranet\OTA\AddressType\StreetNmbrAType $streetNmbr = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\AddressType\BldgRoomAType $bldgRoom
     */
    public function addToBldgRoom(\Recranet\OTA\AddressType\BldgRoomAType $bldgRoom)
    {
     ...
     * Building name, room, apartment, or suite number.
     *
     * @return \Recranet\OTA\AddressType\BldgRoomAType[]
     */
