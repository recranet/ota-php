...
class QueuesAType
{
     ...
     *
     * @var \Recranet\OTA\AirReservationType\QueuesAType\QueueAType[] $queue
     */
    private $queue = [
     ...
     */
    public function addToQueue(\Recranet\OTA\AirReservationType\QueuesAType\QueueAType $queue)
    {
        $this->queue[] = $queue;
        return $this;
    }
