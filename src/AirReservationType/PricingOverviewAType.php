...
namespace Recranet\OTA\AirReservationType;
...
class PricingOverviewAType
{
     ...
     *
     * @var \Recranet\OTA\AirReservationType\PricingOverviewAType\PricingIndicatorAType[] $pricingIndicator
     */
     ...
     *
     * @var \Recranet\OTA\AirReservationType\PricingOverviewAType\AccountAType[] $account
     */
    private $account = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirReservationType\PricingOverviewAType\PricingIndicatorAType $pricingIndicator
     */
    public function addToPricingIndicator(\Recranet\OTA\AirReservationType\PricingOverviewAType\PricingIndicatorAType $pricingIndicator)
    {
     ...
     * Specific information about the price.
     *
     * @return \Recranet\OTA\AirReservationType\PricingOverviewAType\PricingIndicatorAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\AirReservationType\PricingOverviewAType\AccountAType $account
     */
    public function addToAccount(\Recranet\OTA\AirReservationType\PricingOverviewAType\AccountAType $account)
    {
     ...
     * Specifies an account code applicable to the pricing and reservation.
     *
     * @return \Recranet\OTA\AirReservationType\PricingOverviewAType\AccountAType[]
     */
