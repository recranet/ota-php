...
namespace Recranet\OTA\CategoryCodesType;
...
class GuestRoomInfoAType
{
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType\GuestRoomInfoAType\RateRangesAType\RateRangeAType[] $rateRanges
     */
     ...
     */
    public function addToRateRanges(\Recranet\OTA\CategoryCodesType\GuestRoomInfoAType\RateRangesAType\RateRangeAType $rateRange)
    {
     ...
     * A collection of rate range information.
     *
     * @param \Recranet\OTA\CategoryCodesType\GuestRoomInfoAType\RateRangesAType\RateRangeAType[] $rateRanges
     * @return self
     */
