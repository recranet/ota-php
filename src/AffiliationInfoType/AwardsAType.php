...
class AwardsAType
{
     ...
     *
     * @var \Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType[] $award
     */
    private $award = [
     ...
     */
    public function addToAward(\Recranet\OTA\AffiliationInfoType\AwardsAType\AwardAType $award)
    {
        $this->award[] = $award;
        return $this;
    }
