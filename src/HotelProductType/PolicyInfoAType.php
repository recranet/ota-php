...
class PolicyInfoAType
{
     ...
     *
     * @var \Recranet\OTA\RequiredPaymentsType\GuaranteePaymentAType[] $guaranteePaymentPolicy
     */
     ...
     *
     * @var \Recranet\OTA\HotelProductType\PolicyInfoAType\BookingRulesAType\BookingRuleAType[] $bookingRules
     */
     ...
     */
    public function addToGuaranteePaymentPolicy(\Recranet\OTA\RequiredPaymentsType\GuaranteePaymentAType $guaranteePayment)
    {
     ...
     * Guarantee and payment policy details.
     *
     * @param \Recranet\OTA\RequiredPaymentsType\GuaranteePaymentAType[] $guaranteePaymentPolicy
     * @return self
     */
     ...
     */
    public function addToBookingRules(\Recranet\OTA\HotelProductType\PolicyInfoAType\BookingRulesAType\BookingRuleAType $bookingRule)
    {
     ...
     * A collection of booking rules.
     *
     * @param \Recranet\OTA\HotelProductType\PolicyInfoAType\BookingRulesAType\BookingRuleAType[] $bookingRules
     * @return self
     */
