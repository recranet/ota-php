...
class HotelRefsAType
{
     ...
     *
     * @var \Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType[] $hotelRef
     */
    private $hotelRef = [
     ...
     */
    public function addToHotelRef(\Recranet\OTA\HotelProductType\HotelRefsAType\HotelRefAType $hotelRef)
    {
