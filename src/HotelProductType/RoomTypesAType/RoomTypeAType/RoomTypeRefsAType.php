...
class RoomTypeRefsAType
{
     ...
     *
     * @var \Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType\RoomTypeRefsAType\RoomTypeRefAType[] $roomTypeRef
     */
    private $roomTypeRef = [
     ...
     */
    public function addToRoomTypeRef(\Recranet\OTA\HotelProductType\RoomTypesAType\RoomTypeAType\RoomTypeRefsAType\RoomTypeRefAType $roomTypeRef)
    {
