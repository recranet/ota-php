...
{
    /**
     * The number of nights required to be booked in order to apply the discount (this may be the extact number of nights required or the minimum number of nights required).
     *
     * @var int $nightsRequired
     */
     ...
     *
     * @var int $nightsDiscounted
     */
    private $nightsDiscounted = null;

    /**
     * This defines the pattern for the night(s) the discount applies (e.g., if NightsRequired="7" and the NightsDiscounted="1" then DiscountPattern="NNNNNNY" or DiscountPattern="0000001" when the discount is applied to the last night).
     *
     * @var string $discountPattern
     */
    ...
    /**
     * Defines the percentage which is deducted from the rate amounts if this offer is applicable.
     *
     * @var float $percent
     */
    ...
    /**
     * Defines the unit per which the unit the discount applies (e.g., per person per stay). Refer to OpenTravel Code List Charge Type (CHG).
     *
     * @var string $chargeUnitCode
     */
