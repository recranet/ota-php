...
class AccessesType
{
     ...
     *
     * @var \Recranet\OTA\AccessesType\AccessAType[] $access
     */
    private $access = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\AccessesType\AccessAType $access
     */
    public function addToAccess(\Recranet\OTA\AccessesType\AccessAType $access)
    {
        $this->access[] = $access;
        return $this;
    }
     ...
     * Describes the action taken on the record.
     *
     * @return \Recranet\OTA\AccessesType\AccessAType[]
     */
