...
namespace Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType;
...
class RatePlanAType
{
     ...
     *
     * @var \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\DateRangeAType $dateRange
     */
     ...
     *
     * @var \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\OffersAType $offers
     */
    private $offers = null;
     ...
     *
     * @var \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\HotelRefAType $hotelRef
     */
     ...
     * A date or range of dates for the rate plan.
     *
     * @return \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\DateRangeAType
     */
     ...
     * A date or range of dates for the rate plan.
     *
     * @param \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\DateRangeAType $dateRange
     * @return self
     */
    public function setDateRange(?\Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\DateRangeAType $dateRange = null)
    {
     ...
     * Collection of requested offers.
     *
     * @return \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\OffersAType
     */
     ...
     * Collection of requested offers.
     *
     * @param \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\OffersAType $offers
     * @return self
     */
    public function setOffers(?\Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\OffersAType $offers = null)
    {
        $this->offers = $offers;
        return $this;
    }
     ...
     * Indicates the detail of hotel reference information.
     *
     * @return \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\HotelRefAType
     */
     ...
     * Indicates the detail of hotel reference information.
     *
     * @param \Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\HotelRefAType $hotelRef
     * @return self
     */
    public function setHotelRef(?\Recranet\OTA\OTAHotelRatePlanRQ\OTAHotelRatePlanRQAType\RatePlansAType\RatePlanAType\HotelRefAType $hotelRef = null)
    {
