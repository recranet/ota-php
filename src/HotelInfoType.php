...
class HotelInfoType
{
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\HotelNameAType $hotelName
     */
     ...
     *
     * @var \Recranet\OTA\DateTimeSpanType[] $closedSeasons
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType[] $blackoutDates
     */
     ...
     *
     * @var \Recranet\OTA\RelativePositionType[] $relativePositions
     */
     ...
     *
     * @var \Recranet\OTA\CategoryCodesType $categoryCodes
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\DescriptionsAType $descriptions
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\HotelInfoCodesAType\HotelInfoCodeAType[] $hotelInfoCodes
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\PositionAType $position
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType[] $services
     */
     ...
     *
     * @var \Recranet\OTA\WeatherInfoType[] $weatherInfos
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\OwnershipManagementInfosAType\OwnershipManagementInfoAType[] $ownershipManagementInfos
     */
     ...
     *
     * @var \Recranet\OTA\HotelInfoType\LanguagesAType\LanguageAType[] $languages
     */
     ...
     * The full name of the hotel.
     *
     * @return \Recranet\OTA\HotelInfoType\HotelNameAType
     */
     ...
     * The full name of the hotel.
     *
     * @param \Recranet\OTA\HotelInfoType\HotelNameAType $hotelName
     * @return self
     */
    public function setHotelName(?\Recranet\OTA\HotelInfoType\HotelNameAType $hotelName = null)
    {
     ...
     */
    public function addToClosedSeasons(\Recranet\OTA\DateTimeSpanType $closedSeason)
    {
     ...
     * A collection of date and time periods when the hotel facility is closed.
     *
     * @param \Recranet\OTA\DateTimeSpanType[] $closedSeasons
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType $blackoutDate
     */
    public function addToBlackoutDates(\Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType $blackoutDate)
    {
     ...
     * Identifies any Blackout Dates which are periods during which the hotel cannot guarantee rates and rooms availability due to peak occupancy.
     *
     * @return \Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType[]
     */
     ...
     * Identifies any Blackout Dates which are periods during which the hotel cannot guarantee rates and rooms availability due to peak occupancy.
     *
     * @param \Recranet\OTA\HotelInfoType\BlackoutDatesAType\BlackoutDateAType[] $blackoutDates
     * @return self
     */
     ...
     */
    public function addToRelativePositions(\Recranet\OTA\RelativePositionType $relativePosition)
    {
     ...
     * Collection of directions to/from one or more locations.
     *
     * @param \Recranet\OTA\RelativePositionType[] $relativePositions
     * @return self
     */
     ...
     * Collection of descriptive details about a hotel.
     *
     * @return \Recranet\OTA\CategoryCodesType
     */
     ...
     * Collection of descriptive details about a hotel.
     *
     * @param \Recranet\OTA\CategoryCodesType $categoryCodes
     * @return self
     */
    public function setCategoryCodes(?\Recranet\OTA\CategoryCodesType $categoryCodes = null)
    {
     ...
     * Collection of hotel and/or renovation information.
     *
     * @return \Recranet\OTA\HotelInfoType\DescriptionsAType
     */
     ...
     * Collection of hotel and/or renovation information.
     *
     * @param \Recranet\OTA\HotelInfoType\DescriptionsAType $descriptions
     * @return self
     */
    public function setDescriptions(?\Recranet\OTA\HotelInfoType\DescriptionsAType $descriptions = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelInfoType\HotelInfoCodesAType\HotelInfoCodeAType $hotelInfoCode
     */
    public function addToHotelInfoCodes(\Recranet\OTA\HotelInfoType\HotelInfoCodesAType\HotelInfoCodeAType $hotelInfoCode)
    {
     ...
     * A collection of hotel codes and descriptions.
     *
     * @return \Recranet\OTA\HotelInfoType\HotelInfoCodesAType\HotelInfoCodeAType[]
     */
     ...
     * A collection of hotel codes and descriptions.
     *
     * @param \Recranet\OTA\HotelInfoType\HotelInfoCodesAType\HotelInfoCodeAType[] $hotelInfoCodes
     * @return self
     */
     ...
     * Describes the geocoded location of the hotel.
     *
     * @return \Recranet\OTA\HotelInfoType\PositionAType
     */
     ...
     * Describes the geocoded location of the hotel.
     *
     * @param \Recranet\OTA\HotelInfoType\PositionAType $position
     * @return self
     */
    public function setPosition(?\Recranet\OTA\HotelInfoType\PositionAType $position = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType $service
     */
    public function addToServices(\Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType $service)
    {
     ...
     * Collection of hotel services and/or amenities available to the guest.
     *
     * @return \Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType[]
     */
     ...
     * Collection of hotel services and/or amenities available to the guest.
     *
     * @param \Recranet\OTA\HotelInfoType\ServicesAType\ServiceAType[] $services
     * @return self
     */
     ...
     */
    public function addToWeatherInfos(\Recranet\OTA\WeatherInfoType $weatherInfo)
    {
     ...
     * Collection of WeatherInfo elements. This may be used to provide information for multiple time periods.
     *
     * @param \Recranet\OTA\WeatherInfoType[] $weatherInfos
     * @return self
     */
     ...
     */
    public function addToOwnershipManagementInfos(\Recranet\OTA\HotelInfoType\OwnershipManagementInfosAType\OwnershipManagementInfoAType $ownershipManagementInfo)
    {
     ...
     * Collection of OwnershipManagementInfo.
     *
     * @param \Recranet\OTA\HotelInfoType\OwnershipManagementInfosAType\OwnershipManagementInfoAType[] $ownershipManagementInfos
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\HotelInfoType\LanguagesAType\LanguageAType $language
     */
    public function addToLanguages(\Recranet\OTA\HotelInfoType\LanguagesAType\LanguageAType $language)
    {
     ...
     * Collection of language details pertaining to the hotel.
     *
     * @return \Recranet\OTA\HotelInfoType\LanguagesAType\LanguageAType[]
     */
     ...
     * Collection of language details pertaining to the hotel.
     *
     * @param \Recranet\OTA\HotelInfoType\LanguagesAType\LanguageAType[] $languages
     * @return self
     */
