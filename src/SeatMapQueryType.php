...
class SeatMapQueryType
{
     ...
     *
     * @var \Recranet\OTA\SeatMapQueryType\FlightInfoAType[] $flightInfo
     */
    private $flightInfo = [
     ...
     *
     * @var \Recranet\OTA\BookingReferenceType[] $bookingReferenceID
     */
     ...
     *
     * @var \Recranet\OTA\SeatMapQueryType\CabinClassAType[] $cabinClass
     */
    private $cabinClass = [
     ...
     *
     * @var \Recranet\OTA\SeatMapQueryType\SpecificSeatInfoAType[] $specificSeatInfo
     */
     ...
     *
     * @var \Recranet\OTA\SeatMapQueryType\SeatDetailsAType $seatDetails
     */
     ...
     *
     * @var \Recranet\OTA\SeatZoneQueryType[] $zone
     */
    private $zone = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatMapQueryType\FlightInfoAType $flightInfo
     */
    public function addToFlightInfo(\Recranet\OTA\SeatMapQueryType\FlightInfoAType $flightInfo)
    {
     ...
     * Flight information, including flight number, airline, arrival, departure, origin/destination and flight segment(s).
     *
     * @return \Recranet\OTA\SeatMapQueryType\FlightInfoAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\BookingReferenceType $bookingReferenceID
     */
    public function addToBookingReferenceID(\Recranet\OTA\BookingReferenceType $bookingReferenceID)
    {
     ...
     * Booking reference (PNR) information if the seat map is being generated by PNR. Note that travelers with associated PNR(s) are defined here.
     *
     * @return \Recranet\OTA\BookingReferenceType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatMapQueryType\CabinClassAType $cabinClass
     */
    public function addToCabinClass(\Recranet\OTA\SeatMapQueryType\CabinClassAType $cabinClass)
    {
     ...
     * Cabin classes to be included or excluded from the seat map(s).
     *
     * @return \Recranet\OTA\SeatMapQueryType\CabinClassAType[]
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatMapQueryType\SpecificSeatInfoAType $specificSeatInfo
     */
    public function addToSpecificSeatInfo(\Recranet\OTA\SeatMapQueryType\SpecificSeatInfoAType $specificSeatInfo)
    {
     ...
     * Known or specifically requested seat information.
     *
     * @return \Recranet\OTA\SeatMapQueryType\SpecificSeatInfoAType[]
     */
     ...
     * Object to hold the seat details that is to be requested.
     *
     * @return \Recranet\OTA\SeatMapQueryType\SeatDetailsAType
     */
     ...
     * Object to hold the seat details that is to be requested.
     *
     * @param \Recranet\OTA\SeatMapQueryType\SeatDetailsAType $seatDetails
     * @return self
     */
    public function setSeatDetails(?\Recranet\OTA\SeatMapQueryType\SeatDetailsAType $seatDetails = null)
    {
     ...
     *
     * @return self
     * @param \Recranet\OTA\SeatZoneQueryType $zone
     */
    public function addToZone(\Recranet\OTA\SeatZoneQueryType $zone)
    {
        $this->zone[] = $zone;
        return $this;
    }
     ...
     * Zones to be included or excluded from the seat map(s).
     *
     * @return \Recranet\OTA\SeatZoneQueryType[]
     */
