...
namespace Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType;
...
class SiteAType
{
     ...
     *
     * @var \Recranet\OTA\ContactPersonType[] $contactInfos
     */
     ...
     *
     * @var \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\PromotionsAType\PromotionAType[] $promotions
     */
     ...
     *
     * @var \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\AdditionalInfosAType\AdditionalInfoAType[] $additionalInfos
     */
     ...
     */
    public function addToContactInfos(\Recranet\OTA\ContactPersonType $contactInfo)
    {
     ...
     * A collection of contacts (e.g. a catering manager, national sales office, management company, franchisee, etc.)
     *
     * @param \Recranet\OTA\ContactPersonType[] $contactInfos
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\PromotionsAType\PromotionAType $promotion
     */
    public function addToPromotions(\Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\PromotionsAType\PromotionAType $promotion)
    {
     ...
     * A collection of promotions that have similar date criteria as the meeting dates.
     *
     * @return \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\PromotionsAType\PromotionAType[]
     */
     ...
     * A collection of promotions that have similar date criteria as the meeting dates.
     *
     * @param \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\PromotionsAType\PromotionAType[] $promotions
     * @return self
     */
     ...
     *
     * @return self
     * @param \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\AdditionalInfosAType\AdditionalInfoAType $additionalInfo
     */
    public function addToAdditionalInfos(\Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\AdditionalInfosAType\AdditionalInfoAType $additionalInfo)
    {
     ...
     * A collection of additional information requests.
     *
     * @return \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\AdditionalInfosAType\AdditionalInfoAType[]
     */
     ...
     * A collection of additional information requests.
     *
     * @param \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType\AdditionalInfosAType\AdditionalInfoAType[] $additionalInfos
     * @return self
     */
