...
class EventDaysAType
{
    ...
    /**
     * @var \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType\EventDayAType[] $eventDay
     */
    private $eventDay = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType\EventDayAType $eventDay
     */
    public function addToEventDay(\Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType\EventDayAType $eventDay)
    {
     ...
     * Gets as eventDay
     *
     * @return \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\EventBlockAType\EventDaysAType\EventDayAType[]
     */
