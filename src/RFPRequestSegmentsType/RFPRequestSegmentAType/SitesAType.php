...
class SitesAType
{
     ...
     *
     * @var \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType[] $site
     */
    private $site = [
     ...
     */
    public function addToSite(\Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\SitesAType\SiteAType $site)
    {
        $this->site[] = $site;
        return $this;
    }
