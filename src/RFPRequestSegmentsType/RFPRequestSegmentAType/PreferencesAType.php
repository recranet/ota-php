...
class PreferencesAType
{
     ...
     *
     * @var \Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\PreferencesAType\PreferenceAType[] $preference
     */
    private $preference = [
     ...
     */
    public function addToPreference(\Recranet\OTA\RFPRequestSegmentsType\RFPRequestSegmentAType\PreferencesAType\PreferenceAType $preference)
    {
