...
namespace Recranet\OTA\OTAHotelStatsRS;

/**
 * Class representing OTAHotelStatsRSAType
 */
class OTAHotelStatsRSAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\StatisticType[] $statistics
     */
     ...
     */
    public function addToStatistics(\Recranet\OTA\StatisticType $statistic)
    {
     ...
     * Collection of Statistic elements, one for each report being returned.
     *
     * @param \Recranet\OTA\StatisticType[] $statistics
     * @return self
     */
