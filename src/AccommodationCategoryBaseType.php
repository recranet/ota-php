...
class AccommodationCategoryBaseType
{
     ...
     *
     * @var \Recranet\OTA\CompartmentType $compartment
     */
     ...
     * The compartment type, such as Family and Single.
     *
     * @return \Recranet\OTA\CompartmentType
     */
     ...
     * The compartment type, such as Family and Single.
     *
     * @param \Recranet\OTA\CompartmentType $compartment
     * @return self
     */
    public function setCompartment(?\Recranet\OTA\CompartmentType $compartment = null)
    {
