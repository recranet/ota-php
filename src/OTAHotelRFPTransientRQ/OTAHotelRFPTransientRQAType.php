...
namespace Recranet\OTA\OTAHotelRFPTransientRQ;

/**
 * Class representing OTAHotelRFPTransientRQAType
 */
class OTAHotelRFPTransientRQAType
{
    /**
     ...
     *
     * @var \Recranet\OTA\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType $transientRFPRequestSegments
     */
     ...
     *
     * @var \Recranet\OTA\UniqueIDType $messageID
     */
     ...
     * A collection of TransientRFP_RequestSegment. This allows for the RFP to be sent to multiple properties.
     *
     * @return \Recranet\OTA\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType
     */
     ...
     * A collection of TransientRFP_RequestSegment. This allows for the RFP to be sent to multiple properties.
     *
     * @param \Recranet\OTA\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType $transientRFPRequestSegments
     * @return self
     */
    public function setTransientRFPRequestSegments(\Recranet\OTA\OTAHotelRFPTransientRQ\OTAHotelRFPTransientRQAType\TransientRFPRequestSegmentsAType $transientRFPRequestSegments)
    {
     ...
     * The ID is used to identify the request.
     *
     * @param \Recranet\OTA\UniqueIDType $messageID
     * @return self
     */
    public function setMessageID(?\Recranet\OTA\UniqueIDType $messageID = null)
    {
