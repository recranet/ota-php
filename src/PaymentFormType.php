...
class PaymentFormType
{
     ...
     *
     * @var \Recranet\OTA\BankAcctType $bankAcct
     */
     ...
     *
     * @var \Recranet\OTA\DirectBillType $directBill
     */
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\VoucherAType $voucher
     */
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType $loyaltyRedemption
     */
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\MiscChargeOrderAType $miscChargeOrder
     */
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\TicketAType $ticket
     */
    private $ticket = null;
     ...
     *
     * @var \Recranet\OTA\PaymentFormType\CashAType $cash
     */
    private $cash = null;
     ...
     * Details of a bank account.
     *
     * @return \Recranet\OTA\BankAcctType
     */
     ...
     * Details of a bank account.
     *
     * @param \Recranet\OTA\BankAcctType $bankAcct
     * @return self
     */
    public function setBankAcct(?\Recranet\OTA\BankAcctType $bankAcct = null)
    {
     ...
     * Details of a direct billing arrangement.
     *
     * @return \Recranet\OTA\DirectBillType
     */
     ...
     * Details of a direct billing arrangement.
     *
     * @param \Recranet\OTA\DirectBillType $directBill
     * @return self
     */
    public function setDirectBill(?\Recranet\OTA\DirectBillType $directBill = null)
    {
     ...
     * Details of a paper or electronic document indicating prepayment.
     *
     * @return \Recranet\OTA\PaymentFormType\VoucherAType
     */
     ...
     * Details of a paper or electronic document indicating prepayment.
     *
     * @param \Recranet\OTA\PaymentFormType\VoucherAType $voucher
     * @return self
     */
    public function setVoucher(?\Recranet\OTA\PaymentFormType\VoucherAType $voucher = null)
    {
     ...
     * Details of a loyalty redemption arrangement. This is normally miles or points.
     *
     * @return \Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType
     */
     ...
     * Details of a loyalty redemption arrangement. This is normally miles or points.
     *
     * @param \Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType $loyaltyRedemption
     * @return self
     */
    public function setLoyaltyRedemption(?\Recranet\OTA\PaymentFormType\LoyaltyRedemptionAType $loyaltyRedemption = null)
    {
     ...
     * Details of a miscellaneous charge order (MCO).
     *
     * @return \Recranet\OTA\PaymentFormType\MiscChargeOrderAType
     */
     ...
     * Details of a miscellaneous charge order (MCO).
     *
     * @param \Recranet\OTA\PaymentFormType\MiscChargeOrderAType $miscChargeOrder
     * @return self
     */
    public function setMiscChargeOrder(?\Recranet\OTA\PaymentFormType\MiscChargeOrderAType $miscChargeOrder = null)
    {
     ...
     * Details of a ticket to be exchanged.
     *
     * @return \Recranet\OTA\PaymentFormType\TicketAType
     */
     ...
     * Details of a ticket to be exchanged.
     *
     * @param \Recranet\OTA\PaymentFormType\TicketAType $ticket
     * @return self
     */
    public function setTicket(?\Recranet\OTA\PaymentFormType\TicketAType $ticket = null)
    {
        $this->ticket = $ticket;
        return $this;
    }
     ...
     * Used to indicate payment in cash.
     *
     * @return \Recranet\OTA\PaymentFormType\CashAType
     */
     ...
     * Used to indicate payment in cash.
     *
     * @param \Recranet\OTA\PaymentFormType\CashAType $cash
     * @return self
     */
    public function setCash(?\Recranet\OTA\PaymentFormType\CashAType $cash = null)
    {
        $this->cash = $cash;
        return $this;
    }
