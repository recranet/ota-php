...
namespace Recranet\OTA\ContactsType;
...
class NameAType extends PersonNameType
{
    ...
    /**
     * @var \Recranet\OTA\ContactsType\NameAType\JobTitleAType[] $jobTitle
     */
    private $jobTitle = [
     ...
     *
     * @return self
     * @param \Recranet\OTA\ContactsType\NameAType\JobTitleAType $jobTitle
     */
    public function addToJobTitle(\Recranet\OTA\ContactsType\NameAType\JobTitleAType $jobTitle)
    {
     ...
     * Gets as jobTitle
     *
     * @return \Recranet\OTA\ContactsType\NameAType\JobTitleAType[]
     */
