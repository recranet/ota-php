...
class VehicleTourInfoType
{
     ...
     *
     * @var \Recranet\OTA\CompanyNameType $tourOperator
     */
     ...
     * This identifies the tour operator.
     *
     * @param \Recranet\OTA\CompanyNameType $tourOperator
     * @return self
     */
    public function setTourOperator(?\Recranet\OTA\CompanyNameType $tourOperator = null)
    {
